...
#[fhir_invariant(key="mea-0", severity="warning", human="Name should be usable as an identifier for the module by machine processing applications such as code generation", expr="name.matches('[A-Z]([A-Za-z0-9_]){0,254}')", path="Measure")]
