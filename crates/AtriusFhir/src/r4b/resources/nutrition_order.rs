...
pub struct NutritionOrder {
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="NutritionOrder.patient")]
    ...
    /// ## Conditions
    /// Used when: nor-1
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children unless an empty Parameters resource", expr="hasValue() or (children().count() > id.count()) or $this is Parameters", path="NutritionOrder.oralDiet")]
    ...
    /// ## Conditions
    /// Used when: nor-1
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children unless an empty Parameters resource", expr="hasValue() or (children().count() > id.count()) or $this is Parameters", path="NutritionOrder.supplement")]
    ...
    /// ## Conditions
    /// Used when: nor-1
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children unless an empty Parameters resource", expr="hasValue() or (children().count() > id.count()) or $this is Parameters", path="NutritionOrder.enteralFormula")]
...
pub struct NutritionOrderEnteralFormula {
    ...
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="NutritionOrder.enteralFormula.additiveType")]
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="NutritionOrder.enteralFormula.additiveProductName")]
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children unless an empty Parameters resource (error)
    ///   Expression: `hasValue() or (children().count() > id.count()) or $this is Parameters`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children unless an empty Parameters resource", expr="hasValue() or (children().count() > id.count()) or $this is Parameters", path="NutritionOrder.enteralFormula.administration")]
...
pub struct NutritionOrderOralDiet {
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children unless an empty Parameters resource (error)
    ///   Expression: `hasValue() or (children().count() > id.count()) or $this is Parameters`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children unless an empty Parameters resource", expr="hasValue() or (children().count() > id.count()) or $this is Parameters", path="NutritionOrder.oralDiet.nutrient")]
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children unless an empty Parameters resource (error)
    ///   Expression: `hasValue() or (children().count() > id.count()) or $this is Parameters`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children unless an empty Parameters resource", expr="hasValue() or (children().count() > id.count()) or $this is Parameters", path="NutritionOrder.oralDiet.texture")]
