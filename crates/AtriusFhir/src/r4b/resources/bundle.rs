...
#[fhir_invariant(key="bdl-2", severity="error", human="entry.search only when a search", expr="entry.search.empty() or (type = 'searchset')", path="Bundle")]
#[fhir_invariant(key="bdl-3", severity="error", human="entry.request mandatory for batch/transaction/history, otherwise prohibited", expr="entry.all(request.exists() = (%resource.type = 'batch' or %resource.type = 'transaction' or %resource.type = 'history'))", path="Bundle")]
#[fhir_invariant(key="bdl-4", severity="error", human="entry.response mandatory for batch-response/transaction-response/history, otherwise prohibited", expr="entry.all(response.exists() = (%resource.type = 'batch-response' or %resource.type = 'transaction-response' or %resource.type = 'history'))", path="Bundle")]
#[fhir_invariant(key="bdl-7", severity="error", human="FullUrl must be unique in a bundle, or else entries with the same fullUrl must have different meta.versionId (except in history bundles)", expr="(type = 'history') or entry.where(fullUrl.exists()).select(fullUrl&resource.meta.versionId).isDistinct()", path="Bundle")]
...
pub struct Bundle {
    ...
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children unless an empty Parameters resource", expr="hasValue() or (children().count() > id.count()) or $this is Parameters", path="Bundle.link")]
    ...
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children unless an empty Parameters resource", expr="hasValue() or (children().count() > id.count()) or $this is Parameters", path="Bundle.entry")]
...
pub struct BundleEntry {
    ...
    /// ## Conditions
    /// Used when: bdl-2
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children unless an empty Parameters resource", expr="hasValue() or (children().count() > id.count()) or $this is Parameters", path="Bundle.entry.search")]
    ...
    /// ## Conditions
    /// Used when: bdl-3
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children unless an empty Parameters resource", expr="hasValue() or (children().count() > id.count()) or $this is Parameters", path="Bundle.entry.request")]
    ...
    /// ## Conditions
    /// Used when: bdl-4
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children unless an empty Parameters resource", expr="hasValue() or (children().count() > id.count()) or $this is Parameters", path="Bundle.entry.response")]
