...
#[fhir_invariant(key="que-0", severity="warning", human="Name should be usable as an identifier for the module by machine processing applications such as code generation", expr="name.exists() implies name.matches('[A-Z]([A-Za-z0-9_]){0,254}')", path="Questionnaire")]
...
pub struct Questionnaire {
    ...
    /// ## Conditions
    /// Used when: que-3
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children unless an empty Parameters resource", expr="hasValue() or (children().count() > id.count()) or $this is Parameters", path="Questionnaire.item")]
    #[fhir_invariant(key="que-1a", severity="error", human="Group items must have nested items when Questionanire is complete", expr="(type='group' and %resource.status='complete') implies item.empty().not()", path="Questionnaire.item")]
...
pub struct QuestionnaireItem {
    ...
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children unless an empty Parameters resource", expr="hasValue() or (children().count() > id.count()) or $this is Parameters", path="Questionnaire.item.enableWhen")]
    ...
    /// ## Conditions
    /// Used when: que-4, que-5
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children unless an empty Parameters resource", expr="hasValue() or (children().count() > id.count()) or $this is Parameters", path="Questionnaire.item.answerOption")]
    ...
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children unless an empty Parameters resource", expr="hasValue() or (children().count() > id.count()) or $this is Parameters", path="Questionnaire.item.initial")]
