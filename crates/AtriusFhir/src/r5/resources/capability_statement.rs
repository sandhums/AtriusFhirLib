...
#[fhir_invariant(key="cnl-0", severity="warning", human="Name should be usable as an identifier for the module by machine processing applications such as code generation", expr="name.exists() implies name.matches('^[A-Z]([A-Za-z0-9_]){1,254}$')", path="CapabilityStatement")]
...
#[fhir_invariant(key="cpb-3", severity="error", human="Messaging end-point is only permitted when a capability statement is for an implementation.", expr="messaging.endpoint.empty() or kind = 'instance'", path="CapabilityStatement")]
#[fhir_invariant(key="cpb-4", severity="error", human="There should only be one CapabilityStatement.rest per mode.", expr="rest.mode.isDistinct()", path="CapabilityStatement")]
...
pub struct CapabilityStatement {
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="cnl-1", severity="warning", human="URL should not contain | or # - these characters make processing canonical references problematic", expr="exists() implies matches('^[^|# ]+$')", path="CapabilityStatement.url")]
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="CapabilityStatement.identifier")]
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="CapabilityStatement.copyrightLabel")]
...
pub struct CapabilityStatementRestResource {
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="CapabilityStatement.rest.resource.conditionalPatch")]
