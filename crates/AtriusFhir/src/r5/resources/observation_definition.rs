...
#[fhir_invariant(key="obd-0", severity="error", human="If permittedUnit exists, then permittedDataType=Quantity must exist.", expr="permittedUnit.exists() implies (permittedDataType = 'Quantity').exists()", path="ObservationDefinition")]
pub struct ObservationDefinition {
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ObservationDefinition.device")]
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ObservationDefinition.qualifiedValue")]
    ...
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ObservationDefinition.component")]
    #[fhir_invariant(key="obd-1", severity="error", human="If permittedUnit exists, then permittedDataType=Quantity must exist.", expr="permittedUnit.exists() implies (permittedDataType = 'Quantity').exists()", path="ObservationDefinition.component")]
...
pub struct ObservationDefinitionComponent {
    ...
    #[fhir_invariant(key="ext-1", severity="error", human="Must have either extensions or value[x], not both", expr="extension.exists() != value.exists()", path="ObservationDefinition.component.extension")]
    pub extension: Option<Vec<Extension>>,
    ...
    #[fhir_invariant(key="ext-1", severity="error", human="Must have either extensions or value[x], not both", expr="extension.exists() != value.exists()", path="ObservationDefinition.component.modifierExtension")]
    #[fhir_serde(rename = "modifierExtension")]
    pub modifier_extension: Option<Vec<Extension>>,
    /// Type of observation
    /// 
...
pub struct ObservationDefinitionQualifiedValue {
    ...
    #[fhir_invariant(key="ext-1", severity="error", human="Must have either extensions or value[x], not both", expr="extension.exists() != value.exists()", path="ObservationDefinition.qualifiedValue.extension")]
    pub extension: Option<Vec<Extension>>,
    /// Extensions that cannot be ignored even if unrecognized
    /// 
    /// May be used to represent additional information that is not part of the basic
    ...
    #[fhir_invariant(key="ext-1", severity="error", human="Must have either extensions or value[x], not both", expr="extension.exists() != value.exists()", path="ObservationDefinition.qualifiedValue.modifierExtension")]
    #[fhir_serde(rename = "modifierExtension")]
    pub modifier_extension: Option<Vec<Extension>>,
