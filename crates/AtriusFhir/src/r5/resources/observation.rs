...
#[fhir_invariant(key="obs-8", severity="error", human="bodyStructure SHALL only be present if Observation.bodySite is not present", expr="bodySite.exists() implies bodyStructure.empty()", path="Observation")]
pub struct Observation {
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="Observation.instantiates[x]")]
    #[fhir_serde(flatten)]
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="Observation.triggeredBy")]
    ...
    /// ## Conditions
    /// Used when: obs-6
    #[fhir_binding(strength="extensible", valueset="http://hl7.org/fhir/ValueSet/data-absent-reason")]
    ...
    /// ## Aliases
    /// Abnormal Flag
    #[fhir_binding(strength="extensible", valueset="http://hl7.org/fhir/ValueSet/observation-interpretation")]
...
pub struct ObservationReferenceRange {
    ...
    #[fhir_binding(strength="extensible", valueset="http://hl7.org/fhir/ValueSet/observation-referencerange-normalvalue")]
    ...
    #[fhir_binding(strength="preferred", valueset="http://hl7.org/fhir/ValueSet/referencerange-meaning")]
...
pub struct ObservationTriggeredBy {
    ...
    #[fhir_invariant(key="ext-1", severity="error", human="Must have either extensions or value[x], not both", expr="extension.exists() != value.exists()", path="Observation.triggeredBy.extension")]
    pub extension: Option<Vec<Extension>>,
    /// Extensions that cannot be ignored even if unrecognized
    /// 
    /// May be used to represent additional information that is not part of the basic
    ...
    #[fhir_invariant(key="ext-1", severity="error", human="Must have either extensions or value[x], not both", expr="extension.exists() != value.exists()", path="Observation.triggeredBy.modifierExtension")]
    #[fhir_serde(rename = "modifierExtension")]
    pub modifier_extension: Option<Vec<Extension>>,
    ...
    #[fhir_binding(strength="required", valueset="http://hl7.org/fhir/ValueSet/observation-triggeredbytype")]
