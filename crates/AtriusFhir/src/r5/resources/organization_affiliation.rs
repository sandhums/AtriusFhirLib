...
pub struct OrganizationAffiliation {
    ...
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="OrganizationAffiliation.contact")]
    #[fhir_invariant(key="org-3", severity="error", human="The telecom of an organization can never be of use 'home'", expr="telecom.where(use = 'home').empty()", path="OrganizationAffiliation.contact")]
    #[fhir_invariant(key="org-4", severity="error", human="The address of an organization can never be of use 'home'", expr="address.where(use = 'home').empty()", path="OrganizationAffiliation.contact")]
