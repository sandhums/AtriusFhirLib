...
///Canonical URL: http://hl7.org/fhir/specimen-status
///Version: 5.0.0
...
impl core::convert::TryFrom<&str> for SpecimenStatus {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "available" => Ok(SpecimenStatus::Available),
            "unavailable" => Ok(SpecimenStatus::Unavailable),
            "unsatisfactory" => Ok(SpecimenStatus::Unsatisfactory),
            "entered-in-error" => Ok(SpecimenStatus::EnteredInError),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for SpecimenStatus {
