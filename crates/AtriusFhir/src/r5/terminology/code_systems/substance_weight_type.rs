...
///FHIR CodeSystem: SubstanceWeightType
///Canonical URL: http://hl7.org/fhir/substance-weight-type
///Version: 5.0.0
...
impl SubstanceWeightType {
    pub fn as_code(&self) -> &'static str {
        match self {
            SubstanceWeightType::Exact => "Exact",
            SubstanceWeightType::Average => "Average",
            SubstanceWeightType::Weightaverage => "WeightAverage",
        }
    }
...
impl core::convert::TryFrom<&str> for SubstanceWeightType {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "Exact" => Ok(SubstanceWeightType::Exact),
            "Average" => Ok(SubstanceWeightType::Average),
            "WeightAverage" => Ok(SubstanceWeightType::Weightaverage),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for SubstanceWeightType {
