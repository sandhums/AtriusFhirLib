...
///Canonical URL: http://hl7.org/fhir/specimen-contained-preference
///Version: 5.0.0
...
impl core::convert::TryFrom<&str> for SpecimenContainedPreference {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "preferred" => Ok(SpecimenContainedPreference::Preferred),
            "alternate" => Ok(SpecimenContainedPreference::Alternate),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for SpecimenContainedPreference {
