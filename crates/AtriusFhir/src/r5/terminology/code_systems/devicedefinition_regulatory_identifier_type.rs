...
///FHIR CodeSystem: DeviceRegulatoryIdentifierType
///Canonical URL: http://hl7.org/fhir/devicedefinition-regulatory-identifier-type
///Version: 5.0.0
...
impl DeviceRegulatoryIdentifierType {
    pub fn as_code(&self) -> &'static str {
        match self {
            DeviceRegulatoryIdentifierType::Basic => "basic",
            DeviceRegulatoryIdentifierType::Master => "master",
            DeviceRegulatoryIdentifierType::License => "license",
        }
    }
...
impl core::convert::TryFrom<&str> for DeviceRegulatoryIdentifierType {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "basic" => Ok(DeviceRegulatoryIdentifierType::Basic),
            "master" => Ok(DeviceRegulatoryIdentifierType::Master),
            "license" => Ok(DeviceRegulatoryIdentifierType::License),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for DeviceRegulatoryIdentifierType {
