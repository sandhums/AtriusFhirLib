...
///FHIR CodeSystem: ProcedureDeviceActionCodes
///Canonical URL: http://hl7.org/fhir/device-action
///Version: 5.0.0
...
impl ProcedureDeviceActionCodes {
    pub fn as_code(&self) -> &'static str {
        match self {
            ProcedureDeviceActionCodes::Implanted => "implanted",
            ProcedureDeviceActionCodes::Explanted => "explanted",
            ProcedureDeviceActionCodes::Manipulated => "manipulated",
        }
    }
...
impl core::convert::TryFrom<&str> for ProcedureDeviceActionCodes {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "implanted" => Ok(ProcedureDeviceActionCodes::Implanted),
            "explanted" => Ok(ProcedureDeviceActionCodes::Explanted),
            "manipulated" => Ok(ProcedureDeviceActionCodes::Manipulated),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for ProcedureDeviceActionCodes {
