...
///FHIR CodeSystem: MeasureReportStratifierValueExample
///Canonical URL: http://hl7.org/fhir/measurereport-stratifier-value-example
///Version: 5.0.0
...
impl core::convert::TryFrom<&str> for MeasureReportStratifierValueExample {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "northwest" => Ok(MeasureReportStratifierValueExample::Northwest),
            "northeast" => Ok(MeasureReportStratifierValueExample::Northeast),
            "southwest" => Ok(MeasureReportStratifierValueExample::Southwest),
            "southeast" => Ok(MeasureReportStratifierValueExample::Southeast),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for MeasureReportStratifierValueExample {
