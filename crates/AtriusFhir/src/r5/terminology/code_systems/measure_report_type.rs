...
///Canonical URL: http://hl7.org/fhir/measure-report-type
///Version: 5.0.0
...
impl MeasureReportType {
    pub fn as_code(&self) -> &'static str {
        match self {
            ...
            MeasureReportType::DataExchange => "data-exchange",
        }
    }
...
impl core::convert::TryFrom<&str> for MeasureReportType {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "individual" => Ok(MeasureReportType::Individual),
            "subject-list" => Ok(MeasureReportType::SubjectList),
            "summary" => Ok(MeasureReportType::Summary),
            "data-exchange" => Ok(MeasureReportType::DataExchange),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for MeasureReportType {
