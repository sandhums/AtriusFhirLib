...
///FHIR CodeSystem: DeviceUsageAdherenceCode
///Canonical URL: http://hl7.org/fhir/deviceusage-adherence-code
///Version: 5.0.0
...
impl DeviceUsageAdherenceCode {
    pub fn as_code(&self) -> &'static str {
        match self {
            DeviceUsageAdherenceCode::Always => "always",
            DeviceUsageAdherenceCode::Never => "never",
            DeviceUsageAdherenceCode::Sometimes => "sometimes",
        }
    }
...
impl core::convert::TryFrom<&str> for DeviceUsageAdherenceCode {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "always" => Ok(DeviceUsageAdherenceCode::Always),
            "never" => Ok(DeviceUsageAdherenceCode::Never),
            "sometimes" => Ok(DeviceUsageAdherenceCode::Sometimes),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for DeviceUsageAdherenceCode {
