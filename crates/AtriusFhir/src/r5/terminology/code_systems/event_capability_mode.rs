...
///Canonical URL: http://hl7.org/fhir/event-capability-mode
///Version: 5.0.0
...
impl core::convert::TryFrom<&str> for EventCapabilityMode {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "sender" => Ok(EventCapabilityMode::Sender),
            "receiver" => Ok(EventCapabilityMode::Receiver),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for EventCapabilityMode {
