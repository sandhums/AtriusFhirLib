...
///FHIR CodeSystem: SubstanceSourceMaterialType
///Canonical URL: http://hl7.org/fhir/substance-source-material-type
///Version: 5.0.0
...
impl SubstanceSourceMaterialType {
    pub fn as_code(&self) -> &'static str {
        match self {
            SubstanceSourceMaterialType::Animal => "Animal",
            SubstanceSourceMaterialType::Plant => "Plant",
            SubstanceSourceMaterialType::Mineral => "Mineral",
        }
    }
...
impl core::convert::TryFrom<&str> for SubstanceSourceMaterialType {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "Animal" => Ok(SubstanceSourceMaterialType::Animal),
            "Plant" => Ok(SubstanceSourceMaterialType::Plant),
            "Mineral" => Ok(SubstanceSourceMaterialType::Mineral),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for SubstanceSourceMaterialType {
