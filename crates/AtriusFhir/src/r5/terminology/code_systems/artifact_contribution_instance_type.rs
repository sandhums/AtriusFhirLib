...
///FHIR CodeSystem: ArtifactContributionInstanceType
///Canonical URL: http://hl7.org/fhir/artifact-contribution-instance-type
///Version: 5.0.0
...
impl core::convert::TryFrom<&str> for ArtifactContributionInstanceType {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "reviewed" => Ok(ArtifactContributionInstanceType::Reviewed),
            "approved" => Ok(ArtifactContributionInstanceType::Approved),
            "edited" => Ok(ArtifactContributionInstanceType::Edited),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for ArtifactContributionInstanceType {
