...
///Canonical URL: http://hl7.org/fhir/strand-type
///Version: 5.0.0
///Title: strand Type
///Status: active
///Type for strand.
...
impl core::convert::TryFrom<&str> for StrandType {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "watson" => Ok(StrandType::Watson),
            "crick" => Ok(StrandType::Crick),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for StrandType {
