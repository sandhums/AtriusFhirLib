...
///Canonical URL: http://hl7.org/fhir/imagingselection-status
///Version: 5.0.0
...
impl core::convert::TryFrom<&str> for ImagingSelectionStatus {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "available" => Ok(ImagingSelectionStatus::Available),
            "entered-in-error" => Ok(ImagingSelectionStatus::EnteredInError),
            "unknown" => Ok(ImagingSelectionStatus::Unknown),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for ImagingSelectionStatus {
