...
///Canonical URL: http://hl7.org/fhir/conditional-delete-status
///Version: 5.0.0
...
impl ConditionalDeleteStatus {
    pub fn as_code(&self) -> &'static str {
        match self {
            ConditionalDeleteStatus::NotSupported => "not-supported",
...
impl core::convert::TryFrom<&str> for ConditionalDeleteStatus {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "not-supported" => Ok(ConditionalDeleteStatus::NotSupported),
            "single" => Ok(ConditionalDeleteStatus::Single),
            "multiple" => Ok(ConditionalDeleteStatus::Multiple),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for ConditionalDeleteStatus {
