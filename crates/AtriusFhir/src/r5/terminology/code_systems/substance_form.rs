...
///FHIR CodeSystem: SubstanceForm
///Canonical URL: http://hl7.org/fhir/substance-form
///Version: 5.0.0
...
impl SubstanceForm {
    pub fn as_code(&self) -> &'static str {
        match self {
            SubstanceForm::Salt => "salt",
            SubstanceForm::Base => "base",
        }
    }
...
impl core::convert::TryFrom<&str> for SubstanceForm {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "salt" => Ok(SubstanceForm::Salt),
            "base" => Ok(SubstanceForm::Base),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for SubstanceForm {
