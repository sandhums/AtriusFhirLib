...
///FHIR CodeSystem: SubstanceNameDomain
///Canonical URL: http://hl7.org/fhir/substance-name-domain
///Version: 5.0.0
...
impl core::convert::TryFrom<&str> for SubstanceNameDomain {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "ActiveIngredient" => Ok(SubstanceNameDomain::Activeingredient),
            "FoodColorAdditive" => Ok(SubstanceNameDomain::Foodcoloradditive),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for SubstanceNameDomain {
