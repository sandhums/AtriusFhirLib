...
///FHIR CodeSystem: ContractDefinitionType
///Canonical URL: http://hl7.org/fhir/contract-definition-type
///Version: 5.0.0
...
impl ContractDefinitionType {
    pub fn as_code(&self) -> &'static str {
        match self {
            ContractDefinitionType::Temp => "temp",
        }
    }
...
impl core::convert::TryFrom<&str> for ContractDefinitionType {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "temp" => Ok(ContractDefinitionType::Temp),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for ContractDefinitionType {
