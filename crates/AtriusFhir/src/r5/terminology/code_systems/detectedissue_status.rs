...
///FHIR CodeSystem: DetectedIssueStatus
///Canonical URL: http://hl7.org/fhir/detectedissue-status
///Version: 5.0.0
...
impl core::convert::TryFrom<&str> for DetectedIssueStatus {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "mitigated" => Ok(DetectedIssueStatus::Mitigated),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for DetectedIssueStatus {
