...
///FHIR CodeSystem: PackageType
///Canonical URL: http://hl7.org/fhir/package-type
///Version: 5.0.0
///Title: Package Type
///Status: active
...
impl PackageType {
    pub fn as_code(&self) -> &'static str {
        match self {
            ...
            PackageType::ShippingTransportcontainer => "Shipping-TransportContainer",
        }
    }
...
impl core::convert::TryFrom<&str> for PackageType {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "MedicinalProductPack" => Ok(PackageType::Medicinalproductpack),
            "RawMaterialPackage" => Ok(PackageType::Rawmaterialpackage),
            "Shipping-TransportContainer" => Ok(PackageType::ShippingTransportcontainer),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for PackageType {
