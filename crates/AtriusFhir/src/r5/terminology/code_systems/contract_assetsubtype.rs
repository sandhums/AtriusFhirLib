...
///FHIR CodeSystem: ContractAssetSubtype
///Canonical URL: http://hl7.org/fhir/contract-asset-subtype
///Version: 5.0.0
...
impl ContractAssetSubtype {
    pub fn as_code(&self) -> &'static str {
        match self {
            ContractAssetSubtype::Participation => "participation",
        }
    }
...
impl core::convert::TryFrom<&str> for ContractAssetSubtype {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "participation" => Ok(ContractAssetSubtype::Participation),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for ContractAssetSubtype {
