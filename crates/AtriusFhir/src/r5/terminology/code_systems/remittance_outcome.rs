...
///Canonical URL: http://hl7.org/fhir/remittance-outcome
///Version: 5.0.0
...
impl core::convert::TryFrom<&str> for RemittanceOutcome {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "complete" => Ok(RemittanceOutcome::Complete),
            "error" => Ok(RemittanceOutcome::Error),
            "partial" => Ok(RemittanceOutcome::Partial),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for RemittanceOutcome {
