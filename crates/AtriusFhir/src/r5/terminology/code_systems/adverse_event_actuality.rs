...
///Canonical URL: http://hl7.org/fhir/adverse-event-actuality
///Version: 5.0.0
...
impl core::convert::TryFrom<&str> for AdverseEventActuality {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "actual" => Ok(AdverseEventActuality::Actual),
            "potential" => Ok(AdverseEventActuality::Potential),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for AdverseEventActuality {
