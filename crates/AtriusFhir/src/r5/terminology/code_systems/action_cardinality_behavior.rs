...
///Canonical URL: http://hl7.org/fhir/action-cardinality-behavior
///Version: 5.0.0
...
impl core::convert::TryFrom<&str> for ActionCardinalityBehavior {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "single" => Ok(ActionCardinalityBehavior::Single),
            "multiple" => Ok(ActionCardinalityBehavior::Multiple),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for ActionCardinalityBehavior {
