...
///FHIR CodeSystem: ContractDecisionMode
///Canonical URL: http://hl7.org/fhir/contract-decision-mode
///Version: 5.0.0
...
impl ContractDecisionMode {
    pub fn as_code(&self) -> &'static str {
        match self {
            ContractDecisionMode::Policy => "policy",
        }
    }
...
impl core::convert::TryFrom<&str> for ContractDecisionMode {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "policy" => Ok(ContractDecisionMode::Policy),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for ContractDecisionMode {
