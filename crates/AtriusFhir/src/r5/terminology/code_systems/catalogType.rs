...
///FHIR CodeSystem: CatalogType
///Canonical URL: http://hl7.org/fhir/catalogType
///Version: 5.0.0
///Title: Catalog Type
///Status: draft
///CatalogType
...
impl CatalogType {
    pub fn as_code(&self) -> &'static str {
        match self {
            CatalogType::Medication => "medication",
            CatalogType::Device => "device",
            CatalogType::Protocol => "protocol",
        }
    }
...
impl core::convert::TryFrom<&str> for CatalogType {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "medication" => Ok(CatalogType::Medication),
            "device" => Ok(CatalogType::Device),
            "protocol" => Ok(CatalogType::Protocol),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for CatalogType {
