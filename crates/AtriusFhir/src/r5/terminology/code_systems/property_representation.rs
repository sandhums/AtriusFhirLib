...
///Canonical URL: http://hl7.org/fhir/property-representation
///Version: 5.0.0
...
impl core::convert::TryFrom<&str> for PropertyRepresentation {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "xmlAttr" => Ok(PropertyRepresentation::Xmlattr),
            "xmlText" => Ok(PropertyRepresentation::Xmltext),
            "typeAttr" => Ok(PropertyRepresentation::Typeattr),
            "cdaText" => Ok(PropertyRepresentation::Cdatext),
            "xhtml" => Ok(PropertyRepresentation::Xhtml),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for PropertyRepresentation {
