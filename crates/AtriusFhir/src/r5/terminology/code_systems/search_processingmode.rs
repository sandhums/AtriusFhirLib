...
///FHIR CodeSystem: SearchProcessingModeType
///Canonical URL: http://hl7.org/fhir/search-processingmode
///Version: 5.0.0
...
impl SearchProcessingModeType {
    pub fn as_code(&self) -> &'static str {
        match self {
            SearchProcessingModeType::Normal => "normal",
            SearchProcessingModeType::Phonetic => "phonetic",
            SearchProcessingModeType::Other => "other",
        }
    }
...
impl core::convert::TryFrom<&str> for SearchProcessingModeType {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "normal" => Ok(SearchProcessingModeType::Normal),
            "phonetic" => Ok(SearchProcessingModeType::Phonetic),
            "other" => Ok(SearchProcessingModeType::Other),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for SearchProcessingModeType {
