...
///FHIR CodeSystem: BiologicallyDerivedProductDispenseMatchStatus
///Canonical URL: http://hl7.org/fhir/CodeSystem/biologicallyderivedproductdispense-match-status
///Version: 5.0.0
...
impl BiologicallyDerivedProductDispenseMatchStatus {
    pub fn as_code(&self) -> &'static str {
        match self {
            BiologicallyDerivedProductDispenseMatchStatus::Crossmatched => "crossmatched",
            BiologicallyDerivedProductDispenseMatchStatus::Selected => "selected",
            BiologicallyDerivedProductDispenseMatchStatus::Unmatched => "unmatched",
            BiologicallyDerivedProductDispenseMatchStatus::LeastIncompatible => {
                "least-incompatible"
            }
        }
    }
...
impl core::convert::TryFrom<&str> for BiologicallyDerivedProductDispenseMatchStatus {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "crossmatched" => {
                Ok(BiologicallyDerivedProductDispenseMatchStatus::Crossmatched)
            }
            "selected" => Ok(BiologicallyDerivedProductDispenseMatchStatus::Selected),
            "unmatched" => Ok(BiologicallyDerivedProductDispenseMatchStatus::Unmatched),
            "least-incompatible" => {
                Ok(BiologicallyDerivedProductDispenseMatchStatus::LeastIncompatible)
            }
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for BiologicallyDerivedProductDispenseMatchStatus {
