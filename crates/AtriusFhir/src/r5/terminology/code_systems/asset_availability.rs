...
///FHIR CodeSystem: ContractAssetAvailability
///Canonical URL: http://hl7.org/fhir/asset-availability
///Version: 5.0.0
...
impl ContractAssetAvailability {
    pub fn as_code(&self) -> &'static str {
        match self {
            ContractAssetAvailability::Lease => "lease",
        }
    }
...
impl core::convert::TryFrom<&str> for ContractAssetAvailability {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "lease" => Ok(ContractAssetAvailability::Lease),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for ContractAssetAvailability {
