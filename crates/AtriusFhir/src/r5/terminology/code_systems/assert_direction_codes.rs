...
///FHIR CodeSystem: AssertionDirectionType
///Canonical URL: http://hl7.org/fhir/assert-direction-codes
///Version: 5.0.0
...
impl core::convert::TryFrom<&str> for AssertionDirectionType {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "response" => Ok(AssertionDirectionType::Response),
            "request" => Ok(AssertionDirectionType::Request),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for AssertionDirectionType {
