...
///Canonical URL: http://hl7.org/fhir/orientation-type
///Version: 5.0.0
...
impl core::convert::TryFrom<&str> for OrientationType {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "sense" => Ok(OrientationType::Sense),
            "antisense" => Ok(OrientationType::Antisense),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for OrientationType {
