...
///Canonical URL: http://hl7.org/fhir/observation-range-category
///Version: 5.0.0
...
impl core::convert::TryFrom<&str> for ObservationRangeCategory {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "reference" => Ok(ObservationRangeCategory::Reference),
            "critical" => Ok(ObservationRangeCategory::Critical),
            "absolute" => Ok(ObservationRangeCategory::Absolute),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for ObservationRangeCategory {
