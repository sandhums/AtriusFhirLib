...
///Canonical URL: http://hl7.org/fhir/document-mode
///Version: 5.0.0
///Title: Document Mode
///Status: active
...
impl core::convert::TryFrom<&str> for DocumentMode {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "producer" => Ok(DocumentMode::Producer),
            "consumer" => Ok(DocumentMode::Consumer),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for DocumentMode {
