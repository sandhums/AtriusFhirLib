...
///Canonical URL: http://hl7.org/fhir/audit-event-action
///Version: 5.0.0
...
impl core::convert::TryFrom<&str> for AuditEventAction {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "C" => Ok(AuditEventAction::C),
            "R" => Ok(AuditEventAction::R),
            "U" => Ok(AuditEventAction::U),
            "D" => Ok(AuditEventAction::D),
            "E" => Ok(AuditEventAction::E),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for AuditEventAction {
