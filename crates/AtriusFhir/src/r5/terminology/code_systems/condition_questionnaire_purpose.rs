...
///Canonical URL: http://hl7.org/fhir/condition-questionnaire-purpose
///Version: 5.0.0
...
impl ConditionQuestionnairePurpose {
    pub fn as_code(&self) -> &'static str {
        match self {
            ConditionQuestionnairePurpose::Preadmit => "preadmit",
            ConditionQuestionnairePurpose::DiffDiagnosis => "diff-diagnosis",
            ConditionQuestionnairePurpose::Outcome => "outcome",
        }
    }
...
impl core::convert::TryFrom<&str> for ConditionQuestionnairePurpose {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "preadmit" => Ok(ConditionQuestionnairePurpose::Preadmit),
            "diff-diagnosis" => Ok(ConditionQuestionnairePurpose::DiffDiagnosis),
            "outcome" => Ok(ConditionQuestionnairePurpose::Outcome),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for ConditionQuestionnairePurpose {
