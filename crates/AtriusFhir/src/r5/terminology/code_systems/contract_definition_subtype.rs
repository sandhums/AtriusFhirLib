...
///FHIR CodeSystem: ContractDefinitionSubtype
///Canonical URL: http://hl7.org/fhir/contract-definition-subtype
///Version: 5.0.0
...
impl ContractDefinitionSubtype {
    pub fn as_code(&self) -> &'static str {
        match self {
            ContractDefinitionSubtype::Temp => "temp",
        }
    }
...
impl core::convert::TryFrom<&str> for ContractDefinitionSubtype {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "temp" => Ok(ContractDefinitionSubtype::Temp),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for ContractDefinitionSubtype {
