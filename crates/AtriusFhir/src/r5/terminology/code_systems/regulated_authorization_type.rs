...
///FHIR CodeSystem: RegulatedAuthorizationType
///Canonical URL: http://hl7.org/fhir/regulated-authorization-type
///Version: 5.0.0
...
impl core::convert::TryFrom<&str> for RegulatedAuthorizationType {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "MarketingAuth" => Ok(RegulatedAuthorizationType::Marketingauth),
            "Orphan" => Ok(RegulatedAuthorizationType::Orphan),
            "Pediatric" => Ok(RegulatedAuthorizationType::Pediatric),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for RegulatedAuthorizationType {
