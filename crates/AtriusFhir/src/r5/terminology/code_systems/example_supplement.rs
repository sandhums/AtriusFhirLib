...
///FHIR CodeSystem: CholCodeLegacyStatus
///Canonical URL: http://hl7.org/fhir/CodeSystem/example-supplement
///Version: 5.0.0
...
impl CholCodeLegacyStatus {
    pub fn as_code(&self) -> &'static str {
        match self {
            CholCodeLegacyStatus::CholMmol => "chol-mmol",
            CholCodeLegacyStatus::CholMass => "chol-mass",
            CholCodeLegacyStatus::Chol => "chol",
        }
    }
...
impl core::convert::TryFrom<&str> for CholCodeLegacyStatus {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "chol-mmol" => Ok(CholCodeLegacyStatus::CholMmol),
            "chol-mass" => Ok(CholCodeLegacyStatus::CholMass),
            "chol" => Ok(CholCodeLegacyStatus::Chol),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for CholCodeLegacyStatus {
