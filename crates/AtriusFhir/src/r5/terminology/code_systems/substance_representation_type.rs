...
///FHIR CodeSystem: SubstanceRepresentationType
///Canonical URL: http://hl7.org/fhir/substance-representation-type
///Version: 5.0.0
...
impl core::convert::TryFrom<&str> for SubstanceRepresentationType {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "Systematic" => Ok(SubstanceRepresentationType::Systematic),
            "Scientific" => Ok(SubstanceRepresentationType::Scientific),
            "Brand" => Ok(SubstanceRepresentationType::Brand),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for SubstanceRepresentationType {
