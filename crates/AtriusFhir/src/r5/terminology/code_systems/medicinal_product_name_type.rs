...
///FHIR CodeSystem: ProductNameType
///Canonical URL: http://hl7.org/fhir/medicinal-product-name-type
///Version: 5.0.0
...
impl core::convert::TryFrom<&str> for ProductNameType {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "BAN" => Ok(ProductNameType::Ban),
            "INN" => Ok(ProductNameType::Inn),
            "INNM" => Ok(ProductNameType::Innm),
            "pINN" => Ok(ProductNameType::Pinn),
            "rINN" => Ok(ProductNameType::Rinn),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for ProductNameType {
