...
///FHIR CodeSystem: AllergyIntoleranceSeverity
///Canonical URL: http://hl7.org/fhir/reaction-event-severity
///Version: 5.0.0
...
impl core::convert::TryFrom<&str> for AllergyIntoleranceSeverity {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "mild" => Ok(AllergyIntoleranceSeverity::Mild),
            "moderate" => Ok(AllergyIntoleranceSeverity::Moderate),
            "severe" => Ok(AllergyIntoleranceSeverity::Severe),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for AllergyIntoleranceSeverity {
