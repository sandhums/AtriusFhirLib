...
///FHIR CodeSystem: FHIRSubstanceStatus
///Canonical URL: http://hl7.org/fhir/substance-status
///Version: 5.0.0
...
impl FHIRSubstanceStatus {
    pub fn as_code(&self) -> &'static str {
        match self {
            ...
            FHIRSubstanceStatus::EnteredInError => "entered-in-error",
        }
    }
...
impl core::convert::TryFrom<&str> for FHIRSubstanceStatus {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "active" => Ok(FHIRSubstanceStatus::Active),
            "inactive" => Ok(FHIRSubstanceStatus::Inactive),
            "entered-in-error" => Ok(FHIRSubstanceStatus::EnteredInError),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for FHIRSubstanceStatus {
