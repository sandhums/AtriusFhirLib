...
///FHIR CodeSystem: MeasureSupplementalDataExample
///Canonical URL: http://hl7.org/fhir/measure-supplemental-data-example
///Version: 5.0.0
...
impl core::convert::TryFrom<&str> for MeasureSupplementalDataExample {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "age" => Ok(MeasureSupplementalDataExample::Age),
            "gender" => Ok(MeasureSupplementalDataExample::Gender),
            "ethnicity" => Ok(MeasureSupplementalDataExample::Ethnicity),
            "payer" => Ok(MeasureSupplementalDataExample::Payer),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for MeasureSupplementalDataExample {
