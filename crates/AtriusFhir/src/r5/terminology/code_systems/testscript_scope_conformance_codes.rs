...
///FHIR CodeSystem: TestScriptScopeConformanceType
///Canonical URL: http://hl7.org/fhir/testscript-scope-conformance-codes
///Version: 5.0.0
...
impl TestScriptScopeConformanceType {
    pub fn as_code(&self) -> &'static str {
        match self {
            TestScriptScopeConformanceType::Required => "required",
            TestScriptScopeConformanceType::Optional => "optional",
            TestScriptScopeConformanceType::Strict => "strict",
        }
    }
...
impl core::convert::TryFrom<&str> for TestScriptScopeConformanceType {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "required" => Ok(TestScriptScopeConformanceType::Required),
            "optional" => Ok(TestScriptScopeConformanceType::Optional),
            "strict" => Ok(TestScriptScopeConformanceType::Strict),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for TestScriptScopeConformanceType {
