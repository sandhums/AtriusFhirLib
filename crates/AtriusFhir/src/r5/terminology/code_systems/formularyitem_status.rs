...
///FHIR CodeSystem: FormularyItemStatusCodes
///Canonical URL: http://hl7.org/fhir/CodeSystem/formularyitem-status
///Version: 5.0.0
...
impl FormularyItemStatusCodes {
    pub fn as_code(&self) -> &'static str {
        match self {
            FormularyItemStatusCodes::Active => "active",
            FormularyItemStatusCodes::EnteredInError => "entered-in-error",
            FormularyItemStatusCodes::Inactive => "inactive",
        }
    }
...
impl core::convert::TryFrom<&str> for FormularyItemStatusCodes {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "active" => Ok(FormularyItemStatusCodes::Active),
            "entered-in-error" => Ok(FormularyItemStatusCodes::EnteredInError),
            "inactive" => Ok(FormularyItemStatusCodes::Inactive),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for FormularyItemStatusCodes {
