...
///FHIR CodeSystem: Use
///Canonical URL: http://hl7.org/fhir/claim-use
///Version: 5.0.0
///Title: Use
///Status: active
...
impl core::convert::TryFrom<&str> for Use {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "claim" => Ok(Use::Claim),
            "preauthorization" => Ok(Use::Preauthorization),
            "predetermination" => Ok(Use::Predetermination),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for Use {
