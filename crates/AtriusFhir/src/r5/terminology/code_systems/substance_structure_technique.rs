...
///FHIR CodeSystem: SubstanceStructureTechnique
///Canonical URL: http://hl7.org/fhir/substance-structure-technique
///Version: 5.0.0
...
impl SubstanceStructureTechnique {
    pub fn as_code(&self) -> &'static str {
        match self {
            SubstanceStructureTechnique::XRay => "X-Ray",
            SubstanceStructureTechnique::Hplc => "HPLC",
            SubstanceStructureTechnique::Nmr => "NMR",
            SubstanceStructureTechnique::Peptidemapping => "PeptideMapping",
            SubstanceStructureTechnique::Ligandbindingassay => "LigandBindingAssay",
        }
    }
...
impl core::convert::TryFrom<&str> for SubstanceStructureTechnique {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "X-Ray" => Ok(SubstanceStructureTechnique::XRay),
            "HPLC" => Ok(SubstanceStructureTechnique::Hplc),
            "NMR" => Ok(SubstanceStructureTechnique::Nmr),
            "PeptideMapping" => Ok(SubstanceStructureTechnique::Peptidemapping),
            "LigandBindingAssay" => Ok(SubstanceStructureTechnique::Ligandbindingassay),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for SubstanceStructureTechnique {
