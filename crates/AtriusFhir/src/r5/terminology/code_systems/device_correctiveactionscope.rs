...
///Canonical URL: http://hl7.org/fhir/device-correctiveactionscope
///Version: 5.0.0
...
impl DeviceCorrectiveActionScope {
    pub fn as_code(&self) -> &'static str {
        match self {
            DeviceCorrectiveActionScope::Model => "model",
            DeviceCorrectiveActionScope::LotNumbers => "lot-numbers",
            DeviceCorrectiveActionScope::SerialNumbers => "serial-numbers",
        }
    }
...
impl core::convert::TryFrom<&str> for DeviceCorrectiveActionScope {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "model" => Ok(DeviceCorrectiveActionScope::Model),
            "lot-numbers" => Ok(DeviceCorrectiveActionScope::LotNumbers),
            "serial-numbers" => Ok(DeviceCorrectiveActionScope::SerialNumbers),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for DeviceCorrectiveActionScope {
