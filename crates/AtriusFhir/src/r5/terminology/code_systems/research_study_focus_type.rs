...
///FHIR CodeSystem: ResearchStudyFocusType
///Canonical URL: http://hl7.org/fhir/research-study-focus-type
///Version: 5.0.0
...
impl ResearchStudyFocusType {
    pub fn as_code(&self) -> &'static str {
        match self {
            ResearchStudyFocusType::Medication => "medication",
            ResearchStudyFocusType::Device => "device",
            ResearchStudyFocusType::Intervention => "intervention",
            ResearchStudyFocusType::Factor => "factor",
        }
    }
...
impl core::convert::TryFrom<&str> for ResearchStudyFocusType {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "medication" => Ok(ResearchStudyFocusType::Medication),
            "device" => Ok(ResearchStudyFocusType::Device),
            "intervention" => Ok(ResearchStudyFocusType::Intervention),
            "factor" => Ok(ResearchStudyFocusType::Factor),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for ResearchStudyFocusType {
