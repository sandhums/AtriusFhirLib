...
///Canonical URL: http://hl7.org/fhir/graph-compartment-use
///Version: 5.0.0
...
impl GraphCompartmentUse {
    pub fn as_code(&self) -> &'static str {
        match self {
            GraphCompartmentUse::Where => "where",
            GraphCompartmentUse::Requires => "requires",
        }
    }
...
impl core::convert::TryFrom<&str> for GraphCompartmentUse {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "where" => Ok(GraphCompartmentUse::Where),
            "requires" => Ok(GraphCompartmentUse::Requires),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for GraphCompartmentUse {
