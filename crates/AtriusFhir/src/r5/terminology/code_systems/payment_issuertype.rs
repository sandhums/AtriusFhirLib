...
///FHIR CodeSystem: PaymentIssuerTypeCodes
///Canonical URL: http://hl7.org/fhir/payment-issuertype
///Version: 5.0.0
...
impl PaymentIssuerTypeCodes {
    pub fn as_code(&self) -> &'static str {
        match self {
            PaymentIssuerTypeCodes::Patient => "patient",
            PaymentIssuerTypeCodes::Insurance => "insurance",
        }
    }
...
impl core::convert::TryFrom<&str> for PaymentIssuerTypeCodes {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "patient" => Ok(PaymentIssuerTypeCodes::Patient),
            "insurance" => Ok(PaymentIssuerTypeCodes::Insurance),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for PaymentIssuerTypeCodes {
