...
///FHIR CodeSystem: EncounterDiagnosisUse
///Canonical URL: http://hl7.org/fhir/encounter-diagnosis-use
///Version: 5.0.0
...
impl EncounterDiagnosisUse {
    pub fn as_code(&self) -> &'static str {
        match self {
            EncounterDiagnosisUse::Working => "working",
            EncounterDiagnosisUse::Final => "final",
        }
    }
...
impl core::convert::TryFrom<&str> for EncounterDiagnosisUse {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "working" => Ok(EncounterDiagnosisUse::Working),
            "final" => Ok(EncounterDiagnosisUse::Final),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for EncounterDiagnosisUse {
