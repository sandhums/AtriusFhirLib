...
///FHIR CodeSystem: FHIRDeviceSpecializationCategory
///Canonical URL: http://hl7.org/fhir/device-specification-category
///Version: 5.0.0
...
impl FHIRDeviceSpecializationCategory {
    pub fn as_code(&self) -> &'static str {
        match self {
            FHIRDeviceSpecializationCategory::Communication => "communication",
            FHIRDeviceSpecializationCategory::Performance => "performance",
            FHIRDeviceSpecializationCategory::Measurement => "measurement",
            FHIRDeviceSpecializationCategory::RiskClass => "risk-class",
            FHIRDeviceSpecializationCategory::Electrical => "electrical",
            FHIRDeviceSpecializationCategory::Material => "material",
            FHIRDeviceSpecializationCategory::Exchange => "exchange",
        }
    }
...
impl core::convert::TryFrom<&str> for FHIRDeviceSpecializationCategory {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "communication" => Ok(FHIRDeviceSpecializationCategory::Communication),
            "performance" => Ok(FHIRDeviceSpecializationCategory::Performance),
            "measurement" => Ok(FHIRDeviceSpecializationCategory::Measurement),
            "risk-class" => Ok(FHIRDeviceSpecializationCategory::RiskClass),
            "electrical" => Ok(FHIRDeviceSpecializationCategory::Electrical),
            "material" => Ok(FHIRDeviceSpecializationCategory::Material),
            "exchange" => Ok(FHIRDeviceSpecializationCategory::Exchange),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for FHIRDeviceSpecializationCategory {
