...
///FHIR CodeSystem: ContractLegalState
///Canonical URL: http://hl7.org/fhir/contract-legalstate
///Version: 5.0.0
...
impl ContractLegalState {
    pub fn as_code(&self) -> &'static str {
        match self {
            ContractLegalState::Amended => "amended",
            ContractLegalState::Appended => "appended",
            ContractLegalState::Cancelled => "cancelled",
            ContractLegalState::Disputed => "disputed",
            ContractLegalState::EnteredInError => "entered-in-error",
            ContractLegalState::Executable => "executable",
            ContractLegalState::Executed => "executed",
            ContractLegalState::Negotiable => "negotiable",
            ContractLegalState::Offered => "offered",
            ContractLegalState::Policy => "policy",
            ContractLegalState::Rejected => "rejected",
            ContractLegalState::Renewed => "renewed",
            ContractLegalState::Revoked => "revoked",
            ContractLegalState::Resolved => "resolved",
            ContractLegalState::Terminated => "terminated",
        }
    }
...
impl core::convert::TryFrom<&str> for ContractLegalState {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "amended" => Ok(ContractLegalState::Amended),
            "appended" => Ok(ContractLegalState::Appended),
            "cancelled" => Ok(ContractLegalState::Cancelled),
            "disputed" => Ok(ContractLegalState::Disputed),
            "entered-in-error" => Ok(ContractLegalState::EnteredInError),
            "executable" => Ok(ContractLegalState::Executable),
            "executed" => Ok(ContractLegalState::Executed),
            "negotiable" => Ok(ContractLegalState::Negotiable),
            "offered" => Ok(ContractLegalState::Offered),
            "policy" => Ok(ContractLegalState::Policy),
            "rejected" => Ok(ContractLegalState::Rejected),
            "renewed" => Ok(ContractLegalState::Renewed),
            "revoked" => Ok(ContractLegalState::Revoked),
            "resolved" => Ok(ContractLegalState::Resolved),
            "terminated" => Ok(ContractLegalState::Terminated),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for ContractLegalState {
