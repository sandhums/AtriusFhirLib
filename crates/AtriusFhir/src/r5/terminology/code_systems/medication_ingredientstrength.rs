...
///FHIR CodeSystem: MedicationIngredientStrengthCodes
///Canonical URL: http://hl7.org/fhir/CodeSystem/medication-ingredientstrength
///Version: 5.0.0
...
impl MedicationIngredientStrengthCodes {
    pub fn as_code(&self) -> &'static str {
        match self {
            MedicationIngredientStrengthCodes::Qs => "qs",
            MedicationIngredientStrengthCodes::Trace => "trace",
        }
    }
...
impl core::convert::TryFrom<&str> for MedicationIngredientStrengthCodes {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "qs" => Ok(MedicationIngredientStrengthCodes::Qs),
            "trace" => Ok(MedicationIngredientStrengthCodes::Trace),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for MedicationIngredientStrengthCodes {
