...
///FHIR CodeSystem: SubstanceSourceMaterialSpecies
///Canonical URL: http://hl7.org/fhir/substance-source-material-species
///Version: 5.0.0
...
impl SubstanceSourceMaterialSpecies {
    pub fn as_code(&self) -> &'static str {
        match self {
            SubstanceSourceMaterialSpecies::Ginkgobiloba => "GinkgoBiloba",
            SubstanceSourceMaterialSpecies::Oleaeuropaea => "OleaEuropaea",
        }
    }
...
impl core::convert::TryFrom<&str> for SubstanceSourceMaterialSpecies {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "GinkgoBiloba" => Ok(SubstanceSourceMaterialSpecies::Ginkgobiloba),
            "OleaEuropaea" => Ok(SubstanceSourceMaterialSpecies::Oleaeuropaea),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for SubstanceSourceMaterialSpecies {
