...
///FHIR CodeSystem: DatesEventTypeCodes
///Canonical URL: http://hl7.org/fhir/datestype
///Version: 5.0.0
...
impl DatesEventTypeCodes {
    pub fn as_code(&self) -> &'static str {
        match self {
            DatesEventTypeCodes::CardIssued => "card-issued",
            DatesEventTypeCodes::ClaimReceived => "claim-received",
            DatesEventTypeCodes::ServiceExpected => "service-expected",
        }
    }
...
impl core::convert::TryFrom<&str> for DatesEventTypeCodes {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "card-issued" => Ok(DatesEventTypeCodes::CardIssued),
            "claim-received" => Ok(DatesEventTypeCodes::ClaimReceived),
            "service-expected" => Ok(DatesEventTypeCodes::ServiceExpected),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for DatesEventTypeCodes {
