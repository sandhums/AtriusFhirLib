...
///Canonical URL: http://hl7.org/fhir/flag-status
///Version: 5.0.0
///Title: Flag Status
///Status: active
...
impl core::convert::TryFrom<&str> for FlagStatus {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "active" => Ok(FlagStatus::Active),
            "inactive" => Ok(FlagStatus::Inactive),
            "entered-in-error" => Ok(FlagStatus::EnteredInError),
            _ => Err(()),
        }
    }
}
