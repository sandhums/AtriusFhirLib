...
///FHIR CodeSystem: ResourceVersionPolicy
///Canonical URL: http://hl7.org/fhir/versioning-policy
///Version: 5.0.0
...
impl ResourceVersionPolicy {
    pub fn as_code(&self) -> &'static str {
        match self {
            ResourceVersionPolicy::NoVersion => "no-version",
            ResourceVersionPolicy::Versioned => "versioned",
            ResourceVersionPolicy::VersionedUpdate => "versioned-update",
        }
    }
...
impl core::convert::TryFrom<&str> for ResourceVersionPolicy {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "no-version" => Ok(ResourceVersionPolicy::NoVersion),
            "versioned" => Ok(ResourceVersionPolicy::Versioned),
            "versioned-update" => Ok(ResourceVersionPolicy::VersionedUpdate),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for ResourceVersionPolicy {
