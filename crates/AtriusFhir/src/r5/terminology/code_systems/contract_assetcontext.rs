...
///FHIR CodeSystem: ContractAssetContext
///Canonical URL: http://hl7.org/fhir/contract-asset-context
///Version: 5.0.0
...
impl ContractAssetContext {
    pub fn as_code(&self) -> &'static str {
        match self {
            ContractAssetContext::Custodian => "custodian",
        }
    }
...
impl core::convert::TryFrom<&str> for ContractAssetContext {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "custodian" => Ok(ContractAssetContext::Custodian),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for ContractAssetContext {
