...
///FHIR CodeSystem: ContractScope
///Canonical URL: http://hl7.org/fhir/contract-scope
///Version: 5.0.0
...
impl core::convert::TryFrom<&str> for ContractScope {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "policy" => Ok(ContractScope::Policy),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for ContractScope {
