...
///FHIR CodeSystem: InventoryCountType
///Canonical URL: http://hl7.org/fhir/inventoryreport-counttype
///Version: 5.0.0
...
impl InventoryCountType {
    pub fn as_code(&self) -> &'static str {
        match self {
            InventoryCountType::Snapshot => "snapshot",
            InventoryCountType::Difference => "difference",
        }
    }
...
impl core::convert::TryFrom<&str> for InventoryCountType {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "snapshot" => Ok(InventoryCountType::Snapshot),
            "difference" => Ok(InventoryCountType::Difference),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for InventoryCountType {
