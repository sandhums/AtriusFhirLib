...
///FHIR CodeSystem: ContractSecurityControl
///Canonical URL: http://hl7.org/fhir/contract-security-control
///Version: 5.0.0
...
impl ContractSecurityControl {
    pub fn as_code(&self) -> &'static str {
        match self {
            ContractSecurityControl::Policy => "policy",
        }
    }
...
impl core::convert::TryFrom<&str> for ContractSecurityControl {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "policy" => Ok(ContractSecurityControl::Policy),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for ContractSecurityControl {
