...
///FHIR CodeSystem: CitationClassificationType
///Canonical URL: http://hl7.org/fhir/citation-classification-type
///Version: 5.0.0
...
impl CitationClassificationType {
    pub fn as_code(&self) -> &'static str {
        match self {
            CitationClassificationType::CitationSource => "citation-source",
            CitationClassificationType::MedlineOwner => "medline-owner",
            CitationClassificationType::FevirPlatformUse => "fevir-platform-use",
        }
    }
...
impl core::convert::TryFrom<&str> for CitationClassificationType {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "citation-source" => Ok(CitationClassificationType::CitationSource),
            "medline-owner" => Ok(CitationClassificationType::MedlineOwner),
            "fevir-platform-use" => Ok(CitationClassificationType::FevirPlatformUse),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for CitationClassificationType {
