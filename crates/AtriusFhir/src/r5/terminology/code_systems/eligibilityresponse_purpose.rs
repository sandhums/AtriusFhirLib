...
///Canonical URL: http://hl7.org/fhir/eligibilityresponse-purpose
///Version: 5.0.0
...
impl EligibilityResponsePurpose {
    pub fn as_code(&self) -> &'static str {
        match self {
            EligibilityResponsePurpose::AuthRequirements => "auth-requirements",
...
impl core::convert::TryFrom<&str> for EligibilityResponsePurpose {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "auth-requirements" => Ok(EligibilityResponsePurpose::AuthRequirements),
            "benefits" => Ok(EligibilityResponsePurpose::Benefits),
            "discovery" => Ok(EligibilityResponsePurpose::Discovery),
            "validation" => Ok(EligibilityResponsePurpose::Validation),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for EligibilityResponsePurpose {
