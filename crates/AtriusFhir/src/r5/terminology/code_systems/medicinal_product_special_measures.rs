...
///FHIR CodeSystem: SpecialMeasures
///Canonical URL: http://hl7.org/fhir/medicinal-product-special-measures
///Version: 5.0.0
...
impl SpecialMeasures {
    pub fn as_code(&self) -> &'static str {
        match self {
            SpecialMeasures::PostAuthorizationstudies => "Post-authorizationStudies",
        }
    }
...
impl core::convert::TryFrom<&str> for SpecialMeasures {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "Post-authorizationStudies" => Ok(SpecialMeasures::PostAuthorizationstudies),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for SpecialMeasures {
