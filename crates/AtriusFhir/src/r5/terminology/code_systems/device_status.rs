...
///FHIR CodeSystem: FHIRDeviceStatus
///Canonical URL: http://hl7.org/fhir/device-status
///Version: 5.0.0
...
impl FHIRDeviceStatus {
    pub fn as_code(&self) -> &'static str {
        match self {
            ...
            FHIRDeviceStatus::EnteredInError => "entered-in-error",
        }
    }
...
impl core::convert::TryFrom<&str> for FHIRDeviceStatus {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "active" => Ok(FHIRDeviceStatus::Active),
            "inactive" => Ok(FHIRDeviceStatus::Inactive),
            "entered-in-error" => Ok(FHIRDeviceStatus::EnteredInError),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for FHIRDeviceStatus {
