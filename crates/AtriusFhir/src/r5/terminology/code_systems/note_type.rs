...
///Canonical URL: http://hl7.org/fhir/note-type
///Version: 5.0.0
///Title: NoteType
///Status: draft
...
impl core::convert::TryFrom<&str> for NoteType {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "display" => Ok(NoteType::Display),
            "print" => Ok(NoteType::Print),
            "printoper" => Ok(NoteType::Printoper),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for NoteType {
