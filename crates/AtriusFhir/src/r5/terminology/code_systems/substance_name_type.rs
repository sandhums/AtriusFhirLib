...
///FHIR CodeSystem: SubstanceNameType
///Canonical URL: http://hl7.org/fhir/substance-name-type
///Version: 5.0.0
...
impl core::convert::TryFrom<&str> for SubstanceNameType {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "Systematic" => Ok(SubstanceNameType::Systematic),
            "Scientific" => Ok(SubstanceNameType::Scientific),
            "Brand" => Ok(SubstanceNameType::Brand),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for SubstanceNameType {
