...
///Canonical URL: http://hl7.org/fhir/message-significance-category
///Version: 5.0.0
...
impl core::convert::TryFrom<&str> for MessageSignificanceCategory {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "consequence" => Ok(MessageSignificanceCategory::Consequence),
            "currency" => Ok(MessageSignificanceCategory::Currency),
            "notification" => Ok(MessageSignificanceCategory::Notification),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for MessageSignificanceCategory {
