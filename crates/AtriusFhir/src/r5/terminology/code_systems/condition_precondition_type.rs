...
///Canonical URL: http://hl7.org/fhir/condition-precondition-type
///Version: 5.0.0
...
impl ConditionPreconditionType {
    pub fn as_code(&self) -> &'static str {
        match self {
            ConditionPreconditionType::Sensitive => "sensitive",
            ConditionPreconditionType::Specific => "specific",
        }
    }
...
impl core::convert::TryFrom<&str> for ConditionPreconditionType {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "sensitive" => Ok(ConditionPreconditionType::Sensitive),
            "specific" => Ok(ConditionPreconditionType::Specific),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for ConditionPreconditionType {
