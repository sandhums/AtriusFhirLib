...
///FHIR CodeSystem: MedDispenseAdminLocationCodes
///Canonical URL: http://hl7.org/fhir/medicationdispense-admin-location
///Version: 5.0.0
...
impl MedDispenseAdminLocationCodes {
    pub fn as_code(&self) -> &'static str {
        match self {
            MedDispenseAdminLocationCodes::Inpatient => "inpatient",
            MedDispenseAdminLocationCodes::Outpatient => "outpatient",
            MedDispenseAdminLocationCodes::Community => "community",
        }
    }
...
impl core::convert::TryFrom<&str> for MedDispenseAdminLocationCodes {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "inpatient" => Ok(MedDispenseAdminLocationCodes::Inpatient),
            "outpatient" => Ok(MedDispenseAdminLocationCodes::Outpatient),
            "community" => Ok(MedDispenseAdminLocationCodes::Community),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for MedDispenseAdminLocationCodes {
