...
///Canonical URL: http://hl7.org/fhir/consent-provision-type
///Version: 5.0.0
...
impl core::convert::TryFrom<&str> for ConsentProvisionType {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "deny" => Ok(ConsentProvisionType::Deny),
            "permit" => Ok(ConsentProvisionType::Permit),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for ConsentProvisionType {
