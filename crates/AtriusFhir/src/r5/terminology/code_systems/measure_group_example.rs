...
///FHIR CodeSystem: MeasureGroupExample
///Canonical URL: http://hl7.org/fhir/measure-group-example
///Version: 5.0.0
...
impl MeasureGroupExample {
    pub fn as_code(&self) -> &'static str {
        match self {
            MeasureGroupExample::PrimaryRate => "primary-rate",
            MeasureGroupExample::SecondaryRate => "secondary-rate",
        }
    }
...
impl core::convert::TryFrom<&str> for MeasureGroupExample {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "primary-rate" => Ok(MeasureGroupExample::PrimaryRate),
            "secondary-rate" => Ok(MeasureGroupExample::SecondaryRate),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for MeasureGroupExample {
