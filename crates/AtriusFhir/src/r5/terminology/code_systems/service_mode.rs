...
///FHIR CodeSystem: ServiceMode
///Canonical URL: http://hl7.org/fhir/service-mode
///Version: 5.0.0
///Title: Service Mode
///Status: active
...
impl ServiceMode {
    pub fn as_code(&self) -> &'static str {
        match self {
            ServiceMode::InPerson => "in-person",
            ServiceMode::Telephone => "telephone",
            ServiceMode::Videoconference => "videoconference",
            ServiceMode::Chat => "chat",
        }
    }
...
impl core::convert::TryFrom<&str> for ServiceMode {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "in-person" => Ok(ServiceMode::InPerson),
            "telephone" => Ok(ServiceMode::Telephone),
            "videoconference" => Ok(ServiceMode::Videoconference),
            "chat" => Ok(ServiceMode::Chat),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for ServiceMode {
