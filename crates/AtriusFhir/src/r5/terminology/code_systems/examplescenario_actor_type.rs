...
///Canonical URL: http://hl7.org/fhir/examplescenario-actor-type
///Version: 5.0.0
...
impl core::convert::TryFrom<&str> for ExampleScenarioActorType {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "person" => Ok(ExampleScenarioActorType::Person),
            "system" => Ok(ExampleScenarioActorType::System),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for ExampleScenarioActorType {
