...
///Canonical URL: http://hl7.org/fhir/allergy-intolerance-type
///Version: 5.0.0
...
impl core::convert::TryFrom<&str> for AllergyIntoleranceType {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "allergy" => Ok(AllergyIntoleranceType::Allergy),
            "intolerance" => Ok(AllergyIntoleranceType::Intolerance),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for AllergyIntoleranceType {
