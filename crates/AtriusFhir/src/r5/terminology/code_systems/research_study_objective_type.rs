...
///FHIR CodeSystem: ResearchStudyObjectiveType
///Canonical URL: http://hl7.org/fhir/research-study-objective-type
///Version: 5.0.0
...
impl core::convert::TryFrom<&str> for ResearchStudyObjectiveType {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "primary" => Ok(ResearchStudyObjectiveType::Primary),
            "secondary" => Ok(ResearchStudyObjectiveType::Secondary),
            "exploratory" => Ok(ResearchStudyObjectiveType::Exploratory),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for ResearchStudyObjectiveType {
