...
///Canonical URL: http://hl7.org/fhir/contributor-type
///Version: 5.0.0
...
impl core::convert::TryFrom<&str> for ContributorType {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "author" => Ok(ContributorType::Author),
            "editor" => Ok(ContributorType::Editor),
            "reviewer" => Ok(ContributorType::Reviewer),
            "endorser" => Ok(ContributorType::Endorser),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for ContributorType {
