...
///FHIR CodeSystem: ClinicalUseDefinitionCategory
///Canonical URL: http://hl7.org/fhir/clinical-use-definition-category
///Version: 5.0.0
...
impl core::convert::TryFrom<&str> for ClinicalUseDefinitionCategory {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "Pregnancy" => Ok(ClinicalUseDefinitionCategory::Pregnancy),
            "Overdose" => Ok(ClinicalUseDefinitionCategory::Overdose),
            "DriveAndMachines" => Ok(ClinicalUseDefinitionCategory::Driveandmachines),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for ClinicalUseDefinitionCategory {
