...
///FHIR CodeSystem: ACMECholCodesBlood
///Canonical URL: http://hl7.org/fhir/CodeSystem/example
///Version: 5.0.0
...
impl ACMECholCodesBlood {
    pub fn as_code(&self) -> &'static str {
        match self {
            ACMECholCodesBlood::CholMmol => "chol-mmol",
            ACMECholCodesBlood::CholMass => "chol-mass",
            ACMECholCodesBlood::Chol => "chol",
        }
    }
...
impl core::convert::TryFrom<&str> for ACMECholCodesBlood {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "chol-mmol" => Ok(ACMECholCodesBlood::CholMmol),
            "chol-mass" => Ok(ACMECholCodesBlood::CholMass),
            "chol" => Ok(ACMECholCodesBlood::Chol),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for ACMECholCodesBlood {
