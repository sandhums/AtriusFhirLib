...
///Canonical URL: http://hl7.org/fhir/specimen-combined
///Version: 5.0.0
...
impl core::convert::TryFrom<&str> for SpecimenCombined {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "grouped" => Ok(SpecimenCombined::Grouped),
            "pooled" => Ok(SpecimenCombined::Pooled),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for SpecimenCombined {
