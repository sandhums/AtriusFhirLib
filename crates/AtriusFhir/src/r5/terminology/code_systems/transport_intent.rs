...
///FHIR CodeSystem: TransportIntent
///Canonical URL: http://hl7.org/fhir/transport-intent
///Version: 5.0.0
...
impl core::convert::TryFrom<&str> for TransportIntent {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "unknown" => Ok(TransportIntent::Unknown),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for TransportIntent {
