...
///FHIR CodeSystem: MedicationDoseAid
///Canonical URL: http://hl7.org/fhir/CodeSystem/medication-dose-aid
///Version: 5.0.0
...
impl MedicationDoseAid {
    pub fn as_code(&self) -> &'static str {
        match self {
            MedicationDoseAid::Blisterpack => "blisterpack",
            MedicationDoseAid::Dosette => "dosette",
            MedicationDoseAid::Sachets => "sachets",
        }
    }
...
impl core::convert::TryFrom<&str> for MedicationDoseAid {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "blisterpack" => Ok(MedicationDoseAid::Blisterpack),
            "dosette" => Ok(MedicationDoseAid::Dosette),
            "sachets" => Ok(MedicationDoseAid::Sachets),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for MedicationDoseAid {
