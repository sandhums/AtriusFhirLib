...
///FHIR CodeSystem: AdditionalMonitoring
///Canonical URL: http://hl7.org/fhir/medicinal-product-additional-monitoring
///Version: 5.0.0
...
impl core::convert::TryFrom<&str> for AdditionalMonitoring {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "BlackTriangleMonitoring" => {
                Ok(AdditionalMonitoring::Blacktrianglemonitoring)
            }
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for AdditionalMonitoring {
