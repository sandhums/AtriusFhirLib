...
///FHIR CodeSystem: MessageTransport
///Canonical URL: http://hl7.org/fhir/message-transport
///Version: 5.0.0
...
impl core::convert::TryFrom<&str> for MessageTransport {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "http" => Ok(MessageTransport::Http),
            "ftp" => Ok(MessageTransport::Ftp),
            "mllp" => Ok(MessageTransport::Mllp),
            _ => Err(()),
        }
    }
}
