...
///FHIR CodeSystem: TestScriptRequestMethodCode
///Canonical URL: http://hl7.org/fhir/http-operations
///Version: 5.0.0
...
impl core::convert::TryFrom<&str> for TestScriptRequestMethodCode {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "delete" => Ok(TestScriptRequestMethodCode::Delete),
            "get" => Ok(TestScriptRequestMethodCode::Get),
            "options" => Ok(TestScriptRequestMethodCode::Options),
            "patch" => Ok(TestScriptRequestMethodCode::Patch),
            "post" => Ok(TestScriptRequestMethodCode::Post),
            "put" => Ok(TestScriptRequestMethodCode::Put),
            "head" => Ok(TestScriptRequestMethodCode::Head),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for TestScriptRequestMethodCode {
