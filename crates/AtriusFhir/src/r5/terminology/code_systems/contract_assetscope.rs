...
///FHIR CodeSystem: ContractAssetScope
///Canonical URL: http://hl7.org/fhir/contract-asset-scope
///Version: 5.0.0
...
impl ContractAssetScope {
    pub fn as_code(&self) -> &'static str {
        match self {
            ContractAssetScope::Thing => "thing",
        }
    }
...
impl core::convert::TryFrom<&str> for ContractAssetScope {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "thing" => Ok(ContractAssetScope::Thing),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for ContractAssetScope {
