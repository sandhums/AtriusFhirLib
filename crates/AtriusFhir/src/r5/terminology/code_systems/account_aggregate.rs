...
///FHIR CodeSystem: AccountAggregate
///Canonical URL: http://hl7.org/fhir/account-aggregate
///Version: 5.0.0
...
impl AccountAggregate {
    pub fn as_code(&self) -> &'static str {
        match self {
            AccountAggregate::Patient => "patient",
            AccountAggregate::Insurance => "insurance",
            AccountAggregate::Total => "total",
        }
    }
...
impl core::convert::TryFrom<&str> for AccountAggregate {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "patient" => Ok(AccountAggregate::Patient),
            "insurance" => Ok(AccountAggregate::Insurance),
            "total" => Ok(AccountAggregate::Total),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for AccountAggregate {
