...
///Canonical URL: http://hl7.org/fhir/artifactassessment-disposition
///Version: 5.0.0
...
impl ArtifactAssessmentDisposition {
    pub fn as_code(&self) -> &'static str {
        match self {
            ...
            ArtifactAssessmentDisposition::NotPersuasive => "not-persuasive",
            ArtifactAssessmentDisposition::Persuasive => "persuasive",
            ArtifactAssessmentDisposition::PersuasiveWithModification => {
                "persuasive-with-modification"
            }
            ArtifactAssessmentDisposition::NotPersuasiveWithModification => {
...
impl core::convert::TryFrom<&str> for ArtifactAssessmentDisposition {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "unresolved" => Ok(ArtifactAssessmentDisposition::Unresolved),
            "not-persuasive" => Ok(ArtifactAssessmentDisposition::NotPersuasive),
            "persuasive" => Ok(ArtifactAssessmentDisposition::Persuasive),
            "persuasive-with-modification" => {
                Ok(ArtifactAssessmentDisposition::PersuasiveWithModification)
            }
            "not-persuasive-with-modification" => {
                Ok(ArtifactAssessmentDisposition::NotPersuasiveWithModification)
            }
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for ArtifactAssessmentDisposition {
