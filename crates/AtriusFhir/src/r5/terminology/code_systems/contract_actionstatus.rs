...
///FHIR CodeSystem: ContractActionStatus
///Canonical URL: http://hl7.org/fhir/contract-action-status
///Version: 5.0.0
...
impl ContractActionStatus {
    pub fn as_code(&self) -> &'static str {
        match self {
            ContractActionStatus::Complete => "complete",
        }
    }
...
impl core::convert::TryFrom<&str> for ContractActionStatus {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "complete" => Ok(ContractActionStatus::Complete),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for ContractActionStatus {
