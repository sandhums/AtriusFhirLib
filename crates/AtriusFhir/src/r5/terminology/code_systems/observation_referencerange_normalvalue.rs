...
///FHIR CodeSystem: ObservationReferenceRangeNormalValue
///Canonical URL: http://hl7.org/fhir/observation-referencerange-normalvalue
///Version: 5.0.0
...
impl ObservationReferenceRangeNormalValue {
    pub fn as_code(&self) -> &'static str {
        match self {
            ObservationReferenceRangeNormalValue::Negative => "negative",
            ObservationReferenceRangeNormalValue::Absent => "absent",
        }
    }
...
impl core::convert::TryFrom<&str> for ObservationReferenceRangeNormalValue {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "negative" => Ok(ObservationReferenceRangeNormalValue::Negative),
            "absent" => Ok(ObservationReferenceRangeNormalValue::Absent),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for ObservationReferenceRangeNormalValue {
