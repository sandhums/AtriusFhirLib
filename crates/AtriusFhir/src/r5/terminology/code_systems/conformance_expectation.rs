...
///Canonical URL: http://hl7.org/fhir/conformance-expectation
///Version: 5.0.0
...
impl ConformanceExpectation {
    pub fn as_code(&self) -> &'static str {
        match self {
            ConformanceExpectation::Shall => "SHALL",
            ConformanceExpectation::Should => "SHOULD",
            ConformanceExpectation::May => "MAY",
            ConformanceExpectation::ShouldNot => "SHOULD-NOT",
        }
    }
...
impl core::convert::TryFrom<&str> for ConformanceExpectation {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "SHALL" => Ok(ConformanceExpectation::Shall),
            "SHOULD" => Ok(ConformanceExpectation::Should),
            "MAY" => Ok(ConformanceExpectation::May),
            "SHOULD-NOT" => Ok(ConformanceExpectation::ShouldNot),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for ConformanceExpectation {
