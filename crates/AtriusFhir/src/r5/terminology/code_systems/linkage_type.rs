...
///Canonical URL: http://hl7.org/fhir/linkage-type
///Version: 5.0.0
///Title: Linkage Type
///Status: active
...
impl core::convert::TryFrom<&str> for LinkageType {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "source" => Ok(LinkageType::Source),
            "alternate" => Ok(LinkageType::Alternate),
            "historical" => Ok(LinkageType::Historical),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for LinkageType {
