...
///FHIR CodeSystem: DeviceMetricCategory
///Canonical URL: http://hl7.org/fhir/metric-category
///Version: 5.0.0
...
impl core::convert::TryFrom<&str> for DeviceMetricCategory {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "measurement" => Ok(DeviceMetricCategory::Measurement),
            "setting" => Ok(DeviceMetricCategory::Setting),
            "calculation" => Ok(DeviceMetricCategory::Calculation),
            "unspecified" => Ok(DeviceMetricCategory::Unspecified),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for DeviceMetricCategory {
