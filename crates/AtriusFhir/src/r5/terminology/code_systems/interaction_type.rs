...
///FHIR CodeSystem: InteractionType
///Canonical URL: http://hl7.org/fhir/interaction-type
///Version: 5.0.0
...
impl InteractionType {
    pub fn as_code(&self) -> &'static str {
        match self {
            InteractionType::DrugDrug => "drug-drug",
            InteractionType::DrugFood => "drug-food",
            InteractionType::DrugTest => "drug-test",
...
impl core::convert::TryFrom<&str> for InteractionType {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "drug-drug" => Ok(InteractionType::DrugDrug),
            "drug-food" => Ok(InteractionType::DrugFood),
            "drug-test" => Ok(InteractionType::DrugTest),
            "other" => Ok(InteractionType::Other),
            _ => Err(()),
        }
    }
}
