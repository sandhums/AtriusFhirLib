...
///FHIR CodeSystem: RelatedArtifactTypeExpanded
///Canonical URL: http://hl7.org/fhir/related-artifact-type-expanded
///Version: 5.0.0
...
impl RelatedArtifactTypeExpanded {
    pub fn as_code(&self) -> &'static str {
        match self {
            RelatedArtifactTypeExpanded::Reprint => "reprint",
            RelatedArtifactTypeExpanded::ReprintOf => "reprint-of",
        }
    }
...
impl core::convert::TryFrom<&str> for RelatedArtifactTypeExpanded {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "reprint" => Ok(RelatedArtifactTypeExpanded::Reprint),
            "reprint-of" => Ok(RelatedArtifactTypeExpanded::ReprintOf),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for RelatedArtifactTypeExpanded {
