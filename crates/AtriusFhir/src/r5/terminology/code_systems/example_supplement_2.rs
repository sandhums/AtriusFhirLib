...
///FHIR CodeSystem: BundleTypeGerman
///Canonical URL: http://hl7.org/fhir/bundle-type-de
///Version: 5.0.0
///Title: Bundle Type German
///Status: draft
///German Translations for Bundle Type
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash, Serialize, Deserialize)]
pub enum BundleTypeGerman {
...
impl BundleTypeGerman {
    pub fn as_code(&self) -> &'static str {
        match self {
            BundleTypeGerman::Document => "document",
            BundleTypeGerman::Message => "message",
            BundleTypeGerman::Transaction => "transaction",
            BundleTypeGerman::TransactionResponse => "transaction-response",
            BundleTypeGerman::Batch => "batch",
            BundleTypeGerman::BatchResponse => "batch-response",
            BundleTypeGerman::History => "history",
            BundleTypeGerman::Searchset => "searchset",
            BundleTypeGerman::Collection => "collection",
        }
    }
    pub fn system() -> &'static str {
        "http://hl7.org/fhir/bundle-type-de"
    }
...
impl core::convert::TryFrom<&str> for BundleTypeGerman {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "document" => Ok(BundleTypeGerman::Document),
            "message" => Ok(BundleTypeGerman::Message),
            "transaction" => Ok(BundleTypeGerman::Transaction),
            "transaction-response" => Ok(BundleTypeGerman::TransactionResponse),
            "batch" => Ok(BundleTypeGerman::Batch),
            "batch-response" => Ok(BundleTypeGerman::BatchResponse),
            "history" => Ok(BundleTypeGerman::History),
            "searchset" => Ok(BundleTypeGerman::Searchset),
            "collection" => Ok(BundleTypeGerman::Collection),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for BundleTypeGerman {
