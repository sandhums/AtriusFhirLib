...
///FHIR CodeSystem: MedicationStatusCodes
///Canonical URL: http://hl7.org/fhir/CodeSystem/medication-status
///Version: 5.0.0
...
impl MedicationStatusCodes {
    pub fn as_code(&self) -> &'static str {
        match self {
            ...
            MedicationStatusCodes::EnteredInError => "entered-in-error",
        }
    }
...
impl core::convert::TryFrom<&str> for MedicationStatusCodes {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "active" => Ok(MedicationStatusCodes::Active),
            "inactive" => Ok(MedicationStatusCodes::Inactive),
            "entered-in-error" => Ok(MedicationStatusCodes::EnteredInError),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for MedicationStatusCodes {
