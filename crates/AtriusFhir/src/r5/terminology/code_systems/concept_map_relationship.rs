...
///Canonical URL: http://hl7.org/fhir/concept-map-relationship
///Version: 5.0.0
...
impl core::convert::TryFrom<&str> for ConceptMapRelationship {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "related-to" => Ok(ConceptMapRelationship::RelatedTo),
            "not-related-to" => Ok(ConceptMapRelationship::NotRelatedTo),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for ConceptMapRelationship {
