...
///FHIR CodeSystem: SubstanceSourceMaterialGenus
///Canonical URL: http://hl7.org/fhir/substance-source-material-genus
///Version: 5.0.0
...
impl SubstanceSourceMaterialGenus {
    pub fn as_code(&self) -> &'static str {
        match self {
            SubstanceSourceMaterialGenus::Mycobacterium => "Mycobacterium",
            SubstanceSourceMaterialGenus::Influenzavirusa => "InfluenzavirusA",
            SubstanceSourceMaterialGenus::Ginkgo => "Ginkgo",
        }
    }
...
impl core::convert::TryFrom<&str> for SubstanceSourceMaterialGenus {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "Mycobacterium" => Ok(SubstanceSourceMaterialGenus::Mycobacterium),
            "InfluenzavirusA" => Ok(SubstanceSourceMaterialGenus::Influenzavirusa),
            "Ginkgo" => Ok(SubstanceSourceMaterialGenus::Ginkgo),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for SubstanceSourceMaterialGenus {
