...
///FHIR CodeSystem: ProductConfidentiality
///Canonical URL: http://hl7.org/fhir/medicinal-product-confidentiality
///Version: 5.0.0
...
impl ProductConfidentiality {
    pub fn as_code(&self) -> &'static str {
        match self {
            ...
            ProductConfidentiality::Notcommerciallysensitive => {
                "NotCommerciallySensitive"
            }
        }
    }
...
impl core::convert::TryFrom<&str> for ProductConfidentiality {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "CommerciallySensitive" => Ok(ProductConfidentiality::Commerciallysensitive),
            "NotCommerciallySensitive" => {
                Ok(ProductConfidentiality::Notcommerciallysensitive)
            }
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for ProductConfidentiality {
