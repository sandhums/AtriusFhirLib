...
///FHIR CodeSystem: MedicationIntendedPerformerRole
///Canonical URL: http://hl7.org/fhir/CodeSystem/medication-intended-performer-role
///Version: 5.0.0
...
impl MedicationIntendedPerformerRole {
    pub fn as_code(&self) -> &'static str {
        match self {
            MedicationIntendedPerformerRole::Registerednurse => "registerednurse",
            MedicationIntendedPerformerRole::Oncologynurse => "oncologynurse",
            MedicationIntendedPerformerRole::Paincontrolnurse => "paincontrolnurse",
            MedicationIntendedPerformerRole::Physician => "physician",
            MedicationIntendedPerformerRole::Pharmacist => "pharmacist",
        }
    }
...
impl core::convert::TryFrom<&str> for MedicationIntendedPerformerRole {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "registerednurse" => Ok(MedicationIntendedPerformerRole::Registerednurse),
            "oncologynurse" => Ok(MedicationIntendedPerformerRole::Oncologynurse),
            "paincontrolnurse" => Ok(MedicationIntendedPerformerRole::Paincontrolnurse),
            "physician" => Ok(MedicationIntendedPerformerRole::Physician),
            "pharmacist" => Ok(MedicationIntendedPerformerRole::Pharmacist),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for MedicationIntendedPerformerRole {
