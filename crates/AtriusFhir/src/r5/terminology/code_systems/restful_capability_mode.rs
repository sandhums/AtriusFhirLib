...
///Canonical URL: http://hl7.org/fhir/restful-capability-mode
///Version: 5.0.0
...
impl core::convert::TryFrom<&str> for RestfulCapabilityMode {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "client" => Ok(RestfulCapabilityMode::Client),
            "server" => Ok(RestfulCapabilityMode::Server),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for RestfulCapabilityMode {
