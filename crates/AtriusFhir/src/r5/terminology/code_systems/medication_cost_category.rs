...
///FHIR CodeSystem: MedicationCostCategoryCodes
///Canonical URL: http://hl7.org/fhir/medication-cost-category
///Version: 5.0.0
...
impl MedicationCostCategoryCodes {
    pub fn as_code(&self) -> &'static str {
        match self {
            MedicationCostCategoryCodes::Banda => "banda",
            MedicationCostCategoryCodes::Bandb => "bandb",
        }
    }
...
impl core::convert::TryFrom<&str> for MedicationCostCategoryCodes {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "banda" => Ok(MedicationCostCategoryCodes::Banda),
            "bandb" => Ok(MedicationCostCategoryCodes::Bandb),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for MedicationCostCategoryCodes {
