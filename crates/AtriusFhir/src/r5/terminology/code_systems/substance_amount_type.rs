...
///FHIR CodeSystem: SubstanceAmountType
///Canonical URL: http://hl7.org/fhir/substance-amount-type
///Version: 5.0.0
...
impl core::convert::TryFrom<&str> for SubstanceAmountType {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "Average" => Ok(SubstanceAmountType::Average),
            "Approximately" => Ok(SubstanceAmountType::Approximately),
            "LessThan" => Ok(SubstanceAmountType::Lessthan),
            "MoreThan" => Ok(SubstanceAmountType::Morethan),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for SubstanceAmountType {
