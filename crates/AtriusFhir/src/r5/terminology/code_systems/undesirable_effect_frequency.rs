...
///FHIR CodeSystem: UndesirablEffectFrequency
///Canonical URL: http://hl7.org/fhir/undesirable-effect-frequency
///Version: 5.0.0
...
impl core::convert::TryFrom<&str> for UndesirablEffectFrequency {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "Common" => Ok(UndesirablEffectFrequency::Common),
            "Uncommon" => Ok(UndesirablEffectFrequency::Uncommon),
            "Rare" => Ok(UndesirablEffectFrequency::Rare),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for UndesirablEffectFrequency {
