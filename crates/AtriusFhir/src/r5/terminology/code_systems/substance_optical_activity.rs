...
///FHIR CodeSystem: SubstanceOpticalActivity
///Canonical URL: http://hl7.org/fhir/substance-optical-activity
///Version: 5.0.0
...
impl SubstanceOpticalActivity {
    pub fn as_code(&self) -> &'static str {
        match self {
            SubstanceOpticalActivity::Sym_2b => "+",
            SubstanceOpticalActivity::Sym_2d => "-",
        }
    }
...
impl core::convert::TryFrom<&str> for SubstanceOpticalActivity {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "+" => Ok(SubstanceOpticalActivity::Sym_2b),
            "-" => Ok(SubstanceOpticalActivity::Sym_2d),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for SubstanceOpticalActivity {
