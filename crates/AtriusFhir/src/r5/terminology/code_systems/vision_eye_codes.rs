...
///FHIR CodeSystem: VisionEyes
///Canonical URL: http://hl7.org/fhir/vision-eye-codes
///Version: 5.0.0
///Title: Vision Eyes
///Status: active
...
impl core::convert::TryFrom<&str> for VisionEyes {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "right" => Ok(VisionEyes::Right),
            "left" => Ok(VisionEyes::Left),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for VisionEyes {
