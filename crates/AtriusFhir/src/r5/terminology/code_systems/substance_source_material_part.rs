...
///FHIR CodeSystem: SubstanceSourceMaterialPart
///Canonical URL: http://hl7.org/fhir/substance-source-material-part
///Version: 5.0.0
...
impl SubstanceSourceMaterialPart {
    pub fn as_code(&self) -> &'static str {
        match self {
            SubstanceSourceMaterialPart::Animal => "Animal",
            SubstanceSourceMaterialPart::Plant => "Plant",
            SubstanceSourceMaterialPart::Mineral => "Mineral",
        }
    }
...
impl core::convert::TryFrom<&str> for SubstanceSourceMaterialPart {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "Animal" => Ok(SubstanceSourceMaterialPart::Animal),
            "Plant" => Ok(SubstanceSourceMaterialPart::Plant),
            "Mineral" => Ok(SubstanceSourceMaterialPart::Mineral),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for SubstanceSourceMaterialPart {
