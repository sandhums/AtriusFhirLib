...
///FHIR CodeSystem: ClaimProcessingCodes
///Canonical URL: http://hl7.org/fhir/eligibility-outcome
///Version: 5.0.0
...
impl core::convert::TryFrom<&str> for ClaimProcessingCodes {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "queued" => Ok(ClaimProcessingCodes::Queued),
            "complete" => Ok(ClaimProcessingCodes::Complete),
            "error" => Ok(ClaimProcessingCodes::Error),
            "partial" => Ok(ClaimProcessingCodes::Partial),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for ClaimProcessingCodes {
