...
///FHIR CodeSystem: VisionBase
///Canonical URL: http://hl7.org/fhir/vision-base-codes
///Version: 5.0.0
///Title: Vision Base
///Status: active
...
impl core::convert::TryFrom<&str> for VisionBase {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "up" => Ok(VisionBase::Up),
            "down" => Ok(VisionBase::Down),
            "in" => Ok(VisionBase::In),
            "out" => Ok(VisionBase::Out),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for VisionBase {
