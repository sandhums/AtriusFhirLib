...
///FHIR CodeSystem: FHIRFormatType
///Canonical URL: http://hl7.org/fhir/fhir-format-type
///Version: 5.0.0
...
impl FHIRFormatType {
    pub fn as_code(&self) -> &'static str {
        match self {
            FHIRFormatType::Xml => "xml",
            FHIRFormatType::Json => "json",
            FHIRFormatType::Ttl => "ttl",
        }
    }
...
impl core::convert::TryFrom<&str> for FHIRFormatType {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "xml" => Ok(FHIRFormatType::Xml),
            "json" => Ok(FHIRFormatType::Json),
            "ttl" => Ok(FHIRFormatType::Ttl),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for FHIRFormatType {
