...
///Canonical URL: http://hl7.org/fhir/operation-parameter-use
///Version: 5.0.0
...
impl core::convert::TryFrom<&str> for OperationParameterUse {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "in" => Ok(OperationParameterUse::In),
            "out" => Ok(OperationParameterUse::Out),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for OperationParameterUse {
