...
///FHIR CodeSystem: MeasureDefinitionExample
///Canonical URL: http://hl7.org/fhir/measure-definition-example
///Version: 5.0.0
...
impl MeasureDefinitionExample {
    pub fn as_code(&self) -> &'static str {
        match self {
            MeasureDefinitionExample::Screening => "screening",
            MeasureDefinitionExample::StandardizedDepressionScreeningTool => {
...
impl core::convert::TryFrom<&str> for MeasureDefinitionExample {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "screening" => Ok(MeasureDefinitionExample::Screening),
            "standardized-depression-screening-tool" => {
                Ok(MeasureDefinitionExample::StandardizedDepressionScreeningTool)
            }
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for MeasureDefinitionExample {
