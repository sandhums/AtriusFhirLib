...
///FHIR CodeSystem: ExampleMetadata
///Canonical URL: http://hl7.org/fhir/CodeSystem/example-metadata-2
///Version: 5.0.0
///Title: Metadata Example
///Status: draft
///This is an example code system that illustrates usage of the metadata resource elements introduced in R5
...
impl ExampleMetadata {
    ...
    pub fn system() -> &'static str {
        "http://hl7.org/fhir/CodeSystem/example-metadata-2"
    }
...
impl core::convert::TryFrom<&str> for ExampleMetadata {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "A" => Ok(ExampleMetadata::A),
            "B" => Ok(ExampleMetadata::B),
            "C" => Ok(ExampleMetadata::C),
            "D" => Ok(ExampleMetadata::D),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for ExampleMetadata {
