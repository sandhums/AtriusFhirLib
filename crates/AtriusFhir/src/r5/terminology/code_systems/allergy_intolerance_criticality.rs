...
///Canonical URL: http://hl7.org/fhir/allergy-intolerance-criticality
///Version: 5.0.0
...
impl core::convert::TryFrom<&str> for AllergyIntoleranceCriticality {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "low" => Ok(AllergyIntoleranceCriticality::Low),
            "high" => Ok(AllergyIntoleranceCriticality::High),
            "unable-to-assess" => Ok(AllergyIntoleranceCriticality::UnableToAssess),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for AllergyIntoleranceCriticality {
