...
///FHIR CodeSystem: TransportCode
///Canonical URL: http://hl7.org/fhir/CodeSystem/transport-code
///Version: 5.0.0
...
impl TransportCode {
    pub fn as_code(&self) -> &'static str {
        match self {
            TransportCode::Approve => "approve",
            TransportCode::Fulfill => "fulfill",
            TransportCode::Instantiate => "instantiate",
            TransportCode::Abort => "abort",
            TransportCode::Replace => "replace",
            TransportCode::Change => "change",
            TransportCode::Suspend => "suspend",
            TransportCode::Resume => "resume",
        }
    }
...
impl core::convert::TryFrom<&str> for TransportCode {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "approve" => Ok(TransportCode::Approve),
            "fulfill" => Ok(TransportCode::Fulfill),
            "instantiate" => Ok(TransportCode::Instantiate),
            "abort" => Ok(TransportCode::Abort),
            "replace" => Ok(TransportCode::Replace),
            "change" => Ok(TransportCode::Change),
            "suspend" => Ok(TransportCode::Suspend),
            "resume" => Ok(TransportCode::Resume),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for TransportCode {
