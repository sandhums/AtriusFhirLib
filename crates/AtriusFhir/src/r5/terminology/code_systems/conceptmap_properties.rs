...
///FHIR CodeSystem: ConceptMapProperties
///Canonical URL: http://hl7.org/fhir/conceptmap-properties
///Version: 5.0.0
...
impl ConceptMapProperties {
    pub fn as_code(&self) -> &'static str {
        match self {
            ConceptMapProperties::Relationshiprefinement => "relationshipRefinement",
        }
    }
...
impl core::convert::TryFrom<&str> for ConceptMapProperties {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "relationshipRefinement" => Ok(ConceptMapProperties::Relationshiprefinement),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for ConceptMapProperties {
