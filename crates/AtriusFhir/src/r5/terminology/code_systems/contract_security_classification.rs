...
///FHIR CodeSystem: ContractSecurityClassification
///Canonical URL: http://hl7.org/fhir/contract-security-classification
///Version: 5.0.0
...
impl ContractSecurityClassification {
    pub fn as_code(&self) -> &'static str {
        match self {
            ContractSecurityClassification::Policy => "policy",
        }
    }
...
impl core::convert::TryFrom<&str> for ContractSecurityClassification {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "policy" => Ok(ContractSecurityClassification::Policy),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for ContractSecurityClassification {
