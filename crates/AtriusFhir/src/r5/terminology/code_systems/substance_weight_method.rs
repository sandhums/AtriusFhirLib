...
///FHIR CodeSystem: SubstanceWeightMethod
///Canonical URL: http://hl7.org/fhir/substance-weight-method
///Version: 5.0.0
...
impl SubstanceWeightMethod {
    pub fn as_code(&self) -> &'static str {
        match self {
            SubstanceWeightMethod::SdsPage => "SDS-PAGE",
            SubstanceWeightMethod::Calculated => "Calculated",
            SubstanceWeightMethod::Lighscattering => "LighScattering",
            SubstanceWeightMethod::Viscosity => "Viscosity",
            SubstanceWeightMethod::Gelpermeationcentrifugation => {
                "GelPermeationCentrifugation"
            }
            SubstanceWeightMethod::EndGroupanalysis => "End-groupAnalysis",
            SubstanceWeightMethod::EndGrouptitration => "End-groupTitration",
            SubstanceWeightMethod::SizeExclusionchromatography => {
...
impl core::convert::TryFrom<&str> for SubstanceWeightMethod {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "SDS-PAGE" => Ok(SubstanceWeightMethod::SdsPage),
            "Calculated" => Ok(SubstanceWeightMethod::Calculated),
            "LighScattering" => Ok(SubstanceWeightMethod::Lighscattering),
            "Viscosity" => Ok(SubstanceWeightMethod::Viscosity),
            "GelPermeationCentrifugation" => {
                Ok(SubstanceWeightMethod::Gelpermeationcentrifugation)
            }
            "End-groupAnalysis" => Ok(SubstanceWeightMethod::EndGroupanalysis),
            "End-groupTitration" => Ok(SubstanceWeightMethod::EndGrouptitration),
            "Size-ExclusionChromatography" => {
                Ok(SubstanceWeightMethod::SizeExclusionchromatography)
            }
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for SubstanceWeightMethod {
