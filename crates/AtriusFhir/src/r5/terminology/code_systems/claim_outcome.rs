...
///FHIR CodeSystem: ClaimProcessingOutcomeCodes
///Canonical URL: http://hl7.org/fhir/claim-outcome
///Version: 5.0.0
...
impl ClaimProcessingOutcomeCodes {
    pub fn as_code(&self) -> &'static str {
        match self {
            ClaimProcessingOutcomeCodes::Queued => "queued",
            ClaimProcessingOutcomeCodes::Complete => "complete",
            ClaimProcessingOutcomeCodes::Error => "error",
            ClaimProcessingOutcomeCodes::Partial => "partial",
        }
    }
...
impl core::convert::TryFrom<&str> for ClaimProcessingOutcomeCodes {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "queued" => Ok(ClaimProcessingOutcomeCodes::Queued),
            "complete" => Ok(ClaimProcessingOutcomeCodes::Complete),
            "error" => Ok(ClaimProcessingOutcomeCodes::Error),
            "partial" => Ok(ClaimProcessingOutcomeCodes::Partial),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for ClaimProcessingOutcomeCodes {
