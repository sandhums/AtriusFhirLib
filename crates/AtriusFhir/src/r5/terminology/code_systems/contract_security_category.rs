...
///FHIR CodeSystem: ContractSecurityCategory
///Canonical URL: http://hl7.org/fhir/contract-security-category
///Version: 5.0.0
...
impl ContractSecurityCategory {
    pub fn as_code(&self) -> &'static str {
        match self {
            ContractSecurityCategory::Policy => "policy",
        }
    }
...
impl core::convert::TryFrom<&str> for ContractSecurityCategory {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "policy" => Ok(ContractSecurityCategory::Policy),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for ContractSecurityCategory {
