...
///FHIR CodeSystem: CharacteristicOffset
///Canonical URL: http://hl7.org/fhir/characteristic-offset
///Version: 5.0.0
...
impl CharacteristicOffset {
    pub fn as_code(&self) -> &'static str {
        match self {
            CharacteristicOffset::Unl => "UNL",
            CharacteristicOffset::Lnl => "LNL",
        }
    }
...
impl core::convert::TryFrom<&str> for CharacteristicOffset {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "UNL" => Ok(CharacteristicOffset::Unl),
            "LNL" => Ok(CharacteristicOffset::Lnl),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for CharacteristicOffset {
