...
///FHIR CodeSystem: SubstanceStereochemistry
///Canonical URL: http://hl7.org/fhir/substance-stereochemistry
///Version: 5.0.0
...
impl SubstanceStereochemistry {
    pub fn as_code(&self) -> &'static str {
        match self {
            SubstanceStereochemistry::Constitutionalisomer => "ConstitutionalIsomer",
            SubstanceStereochemistry::Stereoisomer => "Stereoisomer",
            SubstanceStereochemistry::Enantiomer => "Enantiomer",
        }
    }
...
impl core::convert::TryFrom<&str> for SubstanceStereochemistry {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "ConstitutionalIsomer" => Ok(SubstanceStereochemistry::Constitutionalisomer),
            "Stereoisomer" => Ok(SubstanceStereochemistry::Stereoisomer),
            "Enantiomer" => Ok(SubstanceStereochemistry::Enantiomer),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for SubstanceStereochemistry {
