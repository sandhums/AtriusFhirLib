...
///Canonical URL: http://hl7.org/fhir/action-relationship-type
///Version: 5.0.0
...
impl core::convert::TryFrom<&str> for ActionRelationshipType {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "before" => Ok(ActionRelationshipType::Before),
            "concurrent" => Ok(ActionRelationshipType::Concurrent),
            "after" => Ok(ActionRelationshipType::After),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for ActionRelationshipType {
