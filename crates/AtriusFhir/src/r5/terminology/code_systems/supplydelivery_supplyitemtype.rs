...
///FHIR CodeSystem: SupplyDeliverySupplyItemType
///Canonical URL: http://hl7.org/fhir/supplydelivery-supplyitemtype
///Version: 5.0.0
...
impl SupplyDeliverySupplyItemType {
    pub fn as_code(&self) -> &'static str {
        match self {
            SupplyDeliverySupplyItemType::Medication => "medication",
            SupplyDeliverySupplyItemType::Device => "device",
            SupplyDeliverySupplyItemType::Biologicallyderivedproduct => {
                "biologicallyderivedproduct"
            }
        }
    }
...
impl core::convert::TryFrom<&str> for SupplyDeliverySupplyItemType {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "medication" => Ok(SupplyDeliverySupplyItemType::Medication),
            "device" => Ok(SupplyDeliverySupplyItemType::Device),
            "biologicallyderivedproduct" => {
                Ok(SupplyDeliverySupplyItemType::Biologicallyderivedproduct)
            }
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for SupplyDeliverySupplyItemType {
