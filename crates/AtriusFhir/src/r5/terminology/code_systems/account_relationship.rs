...
///FHIR CodeSystem: AccountRelationship
///Canonical URL: http://hl7.org/fhir/account-relationship
///Version: 5.0.0
...
impl AccountRelationship {
    pub fn as_code(&self) -> &'static str {
        match self {
            AccountRelationship::Parent => "parent",
            AccountRelationship::Guarantor => "guarantor",
        }
    }
...
impl core::convert::TryFrom<&str> for AccountRelationship {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "parent" => Ok(AccountRelationship::Parent),
            "guarantor" => Ok(AccountRelationship::Guarantor),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for AccountRelationship {
