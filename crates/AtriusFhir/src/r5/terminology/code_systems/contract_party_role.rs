...
///FHIR CodeSystem: ContractPartyRole
///Canonical URL: http://hl7.org/fhir/contract-party-role
///Version: 5.0.0
...
impl ContractPartyRole {
    pub fn as_code(&self) -> &'static str {
        match self {
            ContractPartyRole::Flunky => "flunky",
        }
    }
...
impl core::convert::TryFrom<&str> for ContractPartyRole {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "flunky" => Ok(ContractPartyRole::Flunky),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for ContractPartyRole {
