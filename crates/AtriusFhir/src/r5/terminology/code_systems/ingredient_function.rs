...
///FHIR CodeSystem: IngredientFunction
///Canonical URL: http://hl7.org/fhir/ingredient-function
///Version: 5.0.0
...
impl core::convert::TryFrom<&str> for IngredientFunction {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "Antioxidant" => Ok(IngredientFunction::Antioxidant),
            "AlkalizingAgent" => Ok(IngredientFunction::Alkalizingagent),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for IngredientFunction {
