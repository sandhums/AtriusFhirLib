...
///Canonical URL: http://hl7.org/fhir/type-derivation-rule
///Version: 5.0.0
...
impl core::convert::TryFrom<&str> for TypeDerivationRule {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "specialization" => Ok(TypeDerivationRule::Specialization),
            "constraint" => Ok(TypeDerivationRule::Constraint),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for TypeDerivationRule {
