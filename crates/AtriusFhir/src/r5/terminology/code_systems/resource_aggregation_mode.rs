...
///FHIR CodeSystem: AggregationMode
///Canonical URL: http://hl7.org/fhir/resource-aggregation-mode
///Version: 5.0.0
...
impl core::convert::TryFrom<&str> for AggregationMode {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "contained" => Ok(AggregationMode::Contained),
            "referenced" => Ok(AggregationMode::Referenced),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for AggregationMode {
