...
///FHIR CodeSystem: InteractionIncidence
///Canonical URL: http://hl7.org/fhir/interaction-incidence
///Version: 5.0.0
...
impl core::convert::TryFrom<&str> for InteractionIncidence {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "Theoretical" => Ok(InteractionIncidence::Theoretical),
            "Observed" => Ok(InteractionIncidence::Observed),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for InteractionIncidence {
