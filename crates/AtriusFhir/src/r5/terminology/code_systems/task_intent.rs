...
///FHIR CodeSystem: TaskIntent
///Canonical URL: http://hl7.org/fhir/task-intent
///Version: 5.0.0
///Title: Task Intent
///Status: active
...
impl core::convert::TryFrom<&str> for TaskIntent {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "unknown" => Ok(TaskIntent::Unknown),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for TaskIntent {
