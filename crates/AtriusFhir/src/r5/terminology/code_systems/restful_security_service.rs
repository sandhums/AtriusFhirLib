...
///FHIR CodeSystem: RestfulSecurityService
///Canonical URL: http://hl7.org/fhir/restful-security-service
///Version: 5.0.0
...
impl RestfulSecurityService {
    pub fn as_code(&self) -> &'static str {
        match self {
            ...
            RestfulSecurityService::SmartOnFhir => "SMART-on-FHIR",
...
impl core::convert::TryFrom<&str> for RestfulSecurityService {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "OAuth" => Ok(RestfulSecurityService::Oauth),
            "SMART-on-FHIR" => Ok(RestfulSecurityService::SmartOnFhir),
            "NTLM" => Ok(RestfulSecurityService::Ntlm),
            "Basic" => Ok(RestfulSecurityService::Basic),
            "Kerberos" => Ok(RestfulSecurityService::Kerberos),
            "Certificates" => Ok(RestfulSecurityService::Certificates),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for RestfulSecurityService {
