...
///FHIR CodeSystem: TestReportParticipantType
///Canonical URL: http://hl7.org/fhir/report-participant-type
///Version: 5.0.0
...
impl core::convert::TryFrom<&str> for TestReportParticipantType {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "test-engine" => Ok(TestReportParticipantType::TestEngine),
            "client" => Ok(TestReportParticipantType::Client),
            "server" => Ok(TestReportParticipantType::Server),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for TestReportParticipantType {
