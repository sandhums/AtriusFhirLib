...
///Canonical URL: http://hl7.org/fhir/composition-attestation-mode
///Version: 5.0.0
...
impl core::convert::TryFrom<&str> for CompositionAttestationMode {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "personal" => Ok(CompositionAttestationMode::Personal),
            "professional" => Ok(CompositionAttestationMode::Professional),
            "legal" => Ok(CompositionAttestationMode::Legal),
            "official" => Ok(CompositionAttestationMode::Official),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for CompositionAttestationMode {
