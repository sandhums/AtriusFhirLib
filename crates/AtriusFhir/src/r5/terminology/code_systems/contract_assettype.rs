...
///FHIR CodeSystem: ContractAssetType
///Canonical URL: http://hl7.org/fhir/contract-asset-type
///Version: 5.0.0
...
impl ContractAssetType {
    pub fn as_code(&self) -> &'static str {
        match self {
            ContractAssetType::Participation => "participation",
        }
    }
...
impl core::convert::TryFrom<&str> for ContractAssetType {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "participation" => Ok(ContractAssetType::Participation),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for ContractAssetType {
