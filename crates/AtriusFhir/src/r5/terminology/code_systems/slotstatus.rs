...
///Canonical URL: http://hl7.org/fhir/slotstatus
///Version: 5.0.0
///Title: Slot Status
///Status: active
...
impl core::convert::TryFrom<&str> for SlotStatus {
    type Error = ();
    fn try_from(s: &str) -> Result<Self, <Self as core::convert::TryFrom<&str>>::Error> {
        match s {
            "busy" => Ok(SlotStatus::Busy),
            "free" => Ok(SlotStatus::Free),
            "busy-unavailable" => Ok(SlotStatus::BusyUnavailable),
            "busy-tentative" => Ok(SlotStatus::BusyTentative),
            "entered-in-error" => Ok(SlotStatus::EnteredInError),
            _ => Err(()),
        }
    }
}
impl core::fmt::Display for SlotStatus {
