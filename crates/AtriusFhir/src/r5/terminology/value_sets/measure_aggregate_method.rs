...
///FHIR ValueSet: MeasureAggregateMethod
...
impl MeasureAggregateMethod {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/CodeSystem/measure-aggregate-method", "sum"),
            ("http://hl7.org/fhir/CodeSystem/measure-aggregate-method", "average"),
            ("http://hl7.org/fhir/CodeSystem/measure-aggregate-method", "median"),
            ("http://hl7.org/fhir/CodeSystem/measure-aggregate-method", "minimum"),
            ("http://hl7.org/fhir/CodeSystem/measure-aggregate-method", "maximum"),
            ("http://hl7.org/fhir/CodeSystem/measure-aggregate-method", "count"),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/CodeSystem/measure-aggregate-method" => {
                super::super::code_systems::measure_aggregate_method::MeasureAggregateMethod::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for MeasureAggregateMethod {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for MeasureAggregateMethod {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for MeasureAggregateMethod {
