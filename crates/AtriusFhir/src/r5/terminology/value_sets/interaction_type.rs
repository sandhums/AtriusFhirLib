...
impl InteractionType {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                "http://hl7.org/fhir/interaction-type",
                "drug-drug",
                Some("drug to drug interaction"),
                None,
            ),
            (
                "http://hl7.org/fhir/interaction-type",
                "drug-food",
                Some("drug to food interaction"),
                None,
            ),
            (
                "http://hl7.org/fhir/interaction-type",
                "drug-test",
                Some("drug to laboratory test interaction"),
                None,
            ),
            (
                "http://hl7.org/fhir/interaction-type",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/interaction-type" => {
                super::super::code_systems::interaction_type::InteractionType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for InteractionType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for InteractionType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for InteractionType {
