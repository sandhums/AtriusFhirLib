...
///Expansion contains 3 explicit codes
...
impl YesNoDontKnow {
    ...
    fn expansion_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://terminology.hl7.org/CodeSystem/v2-0532", "Y"),
            ("http://terminology.hl7.org/CodeSystem/v2-0532", "N"),
            ("http://terminology.hl7.org/CodeSystem/data-absent-reason", "asked-unknown"),
        ]
    }
...
impl super::super::bindings::ValueSetMembership<Code> for YesNoDontKnow {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for YesNoDontKnow {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for YesNoDontKnow {
