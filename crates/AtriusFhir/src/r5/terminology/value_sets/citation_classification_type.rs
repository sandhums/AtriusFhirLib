...
///FHIR ValueSet: CitationClassificationType
...
impl CitationClassificationType {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/citation-classification-type", "citation-source"),
            ("http://hl7.org/fhir/citation-classification-type", "medline-owner"),
            ("http://hl7.org/fhir/citation-classification-type", "fevir-platform-use"),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/citation-classification-type" => {
                super::super::code_systems::citation_classification_type::CitationClassificationType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for CitationClassificationType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for CitationClassificationType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for CitationClassificationType {
