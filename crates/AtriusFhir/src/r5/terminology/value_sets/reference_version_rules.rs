...
///FHIR ValueSet: ReferenceVersionRules
...
impl ReferenceVersionRules {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                ...
                Some("The reference must be version independent."),
            ),
            (
                "http://hl7.org/fhir/reference-version-rules",
                "specific",
                Some("Version Specific"),
                Some("The reference must be version specific."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/reference-version-rules" => {
                super::super::code_systems::reference_version_rules::ReferenceVersionRules::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ReferenceVersionRules {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ReferenceVersionRules {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ReferenceVersionRules {
