...
///FHIR ValueSet: ExampleClaimSubTypeCodes
...
impl super::super::bindings::ValueSetMembership<Code> for ExampleClaimSubTypeCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ExampleClaimSubTypeCodes {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ExampleClaimSubTypeCodes {
