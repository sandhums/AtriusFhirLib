...
impl TransportStatus {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/transport-status", "in-progress"),
            ("http://hl7.org/fhir/transport-status", "completed"),
            ("http://hl7.org/fhir/transport-status", "abandoned"),
            ("http://hl7.org/fhir/transport-status", "cancelled"),
            ("http://hl7.org/fhir/transport-status", "planned"),
            ("http://hl7.org/fhir/transport-status", "entered-in-error"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "abandoned",
                Some("Abandoned"),
                Some("Transport was started but not completed."),
            ),
            (
                "http://hl7.org/fhir/transport-status",
                "cancelled",
                Some("Cancelled"),
                Some("Transport was cancelled before started."),
            ),
            (
                "http://hl7.org/fhir/transport-status",
                "completed",
                Some("Completed"),
                Some("Transport has been completed."),
            ),
            (
                "http://hl7.org/fhir/transport-status",
                "entered-in-error",
            ...
            (
                ...
                "in-progress",
                Some("In Progress"),
                Some("Transport has started but not completed."),
            ),
            (
                "http://hl7.org/fhir/transport-status",
                "planned",
                Some("Planned"),
                Some("Planned transport that is not yet requested."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/transport-status" => {
                super::super::code_systems::transport_status::TransportStatus::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for TransportStatus {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for TransportStatus {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for TransportStatus {
