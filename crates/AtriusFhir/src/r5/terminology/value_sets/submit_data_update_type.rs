...
///FHIR ValueSet: SubmitDataUpdateType
...
impl SubmitDataUpdateType {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/CodeSystem/submit-data-update-type", "incremental"),
            ("http://hl7.org/fhir/CodeSystem/submit-data-update-type", "snapshot"),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/CodeSystem/submit-data-update-type" => {
                super::super::code_systems::submit_data_update_type::SubmitDataUpdateType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for SubmitDataUpdateType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for SubmitDataUpdateType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for SubmitDataUpdateType {
