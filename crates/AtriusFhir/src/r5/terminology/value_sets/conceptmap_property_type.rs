...
///FHIR ValueSet: ConceptMapPropertyType
...
impl ConceptMapPropertyType {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/conceptmap-property-type", "Coding"),
            ("http://hl7.org/fhir/conceptmap-property-type", "string"),
            ("http://hl7.org/fhir/conceptmap-property-type", "integer"),
            ("http://hl7.org/fhir/conceptmap-property-type", "boolean"),
            ("http://hl7.org/fhir/conceptmap-property-type", "dateTime"),
            ("http://hl7.org/fhir/conceptmap-property-type", "decimal"),
            ("http://hl7.org/fhir/conceptmap-property-type", "code"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                ...
                "boolean",
                Some("boolean"),
                Some("The property value is a boolean true | false."),
            ),
            (
                "http://hl7.org/fhir/conceptmap-property-type",
                "code",
            ...
            (
                ...
                "dateTime",
                Some("dateTime"),
                Some("The property is a date or a date + time."),
            ),
            (
                "http://hl7.org/fhir/conceptmap-property-type",
                "decimal",
                Some("decimal"),
                Some("The property value is a decimal number."),
            ),
            (
                "http://hl7.org/fhir/conceptmap-property-type",
                "integer",
            ...
            (
                ...
                "string",
                Some("string"),
                Some("The property value is a string."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/conceptmap-property-type" => {
                super::super::code_systems::conceptmap_property_type::ConceptMapPropertyType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ConceptMapPropertyType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ConceptMapPropertyType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ConceptMapPropertyType {
