...
///FHIR ValueSet: ObservationReferenceRangeAppliesToCodes
...
impl ObservationReferenceRangeAppliesToCodes {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ("http://snomed.info/sct", "248152002", None, None),
            ("http://snomed.info/sct", "248153007", None, None),
            ("http://snomed.info/sct", "77386006", None, None),
        ]
    }
...
for ObservationReferenceRangeAppliesToCodes {
