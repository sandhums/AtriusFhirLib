...
///FHIR ValueSet: EvidenceVariableEvent
...
impl EvidenceVariableEvent {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/evidence-variable-event", "study-start"),
            ("http://hl7.org/fhir/evidence-variable-event", "treatment-start"),
            ("http://hl7.org/fhir/evidence-variable-event", "condition-detection"),
            ("http://hl7.org/fhir/evidence-variable-event", "condition-treatment"),
            ("http://hl7.org/fhir/evidence-variable-event", "hospital-admission"),
            ("http://hl7.org/fhir/evidence-variable-event", "hospital-discharge"),
            ("http://hl7.org/fhir/evidence-variable-event", "operative-procedure"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                "http://hl7.org/fhir/evidence-variable-event",
                "condition-detection",
                Some("Detection of Condition"),
                Some("The time of first detection of the condition"),
            ),
            (
                "http://hl7.org/fhir/evidence-variable-event",
                "condition-treatment",
                Some("Treatment of Condition"),
                Some("The time of first treatment of the condition"),
            ),
            (
                "http://hl7.org/fhir/evidence-variable-event",
                "hospital-admission",
                Some("Hospital Admission"),
                Some("The time of admission to the hospital"),
            ),
            (
                "http://hl7.org/fhir/evidence-variable-event",
                "hospital-discharge",
                Some("Hospital Discharge"),
                Some("The time of discharge from the hospital"),
            ),
            (
                "http://hl7.org/fhir/evidence-variable-event",
                "operative-procedure",
                Some("Operative Procedure"),
                Some("The time of surgery"),
            ),
            (
                "http://hl7.org/fhir/evidence-variable-event",
                "study-start",
                Some("Study Start"),
                Some("The time of enrollment for the study participant"),
            ),
            (
                "http://hl7.org/fhir/evidence-variable-event",
                "treatment-start",
                Some("Start of Treatment"),
                Some("The time of initiation of the treatment"),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/evidence-variable-event" => {
                super::super::code_systems::evidence_variable_event::EvidenceVariableEvent::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for EvidenceVariableEvent {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for EvidenceVariableEvent {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for EvidenceVariableEvent {
