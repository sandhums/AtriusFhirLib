...
///FHIR ValueSet: DeviceAssociationCodes
...
impl DeviceAssociationCodes {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/deviceassociation-status-reason", "attached"),
            ("http://hl7.org/fhir/deviceassociation-status-reason", "disconnected"),
            ("http://hl7.org/fhir/deviceassociation-status-reason", "failed"),
            ("http://hl7.org/fhir/deviceassociation-status-reason", "placed"),
            ("http://hl7.org/fhir/deviceassociation-status-reason", "replaced"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "attached",
                Some("Attached"),
                Some("The device is connected to the patient."),
            ),
            (
                "http://hl7.org/fhir/deviceassociation-status-reason",
                "disconnected",
                Some("Disconnected"),
                Some("The device is no longer connected."),
            ),
            (
                "http://hl7.org/fhir/deviceassociation-status-reason",
                "failed",
                Some("Failed"),
                Some("The device has failed to work, or continue to function."),
            ),
            (
                "http://hl7.org/fhir/deviceassociation-status-reason",
                "placed",
                Some("placed"),
                Some("The device was placed in the patient."),
            ),
            (
                "http://hl7.org/fhir/deviceassociation-status-reason",
                "replaced",
                Some("Replaced"),
                Some("The device was updated with a new device or device part."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/deviceassociation-status-reason" => {
                super::super::code_systems::deviceassociation_status_reason::DeviceAssociation::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for DeviceAssociationCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for DeviceAssociationCodes {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for DeviceAssociationCodes {
