...
///FHIR ValueSet: EndpointEnvironment
...
impl EndpointEnvironment {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/endpoint-environment", "prod"),
            ("http://hl7.org/fhir/endpoint-environment", "staging"),
            ("http://hl7.org/fhir/endpoint-environment", "dev"),
            ("http://hl7.org/fhir/endpoint-environment", "test"),
            ("http://hl7.org/fhir/endpoint-environment", "train"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "dev",
                Some("Development"),
                Some("Development environment used while building systems"),
            ),
            (
                "http://hl7.org/fhir/endpoint-environment",
                "prod",
            ...
            (
                ...
                "test",
                Some("Test"),
                Some("Test environment, it is not intended for production usage."),
            ),
            (
                "http://hl7.org/fhir/endpoint-environment",
                "train",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/endpoint-environment" => {
                super::super::code_systems::endpoint_environment::EndpointEnvironment::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for EndpointEnvironment {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for EndpointEnvironment {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for EndpointEnvironment {
