...
impl DesignationUse {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ("http://snomed.info/sct", "900000000000003001", None, None),
            ("http://snomed.info/sct", "900000000000013009", None, None),
        ]
    }
...
impl super::super::bindings::ValueSetMembership<Code> for DesignationUse {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for DesignationUse {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for DesignationUse {
