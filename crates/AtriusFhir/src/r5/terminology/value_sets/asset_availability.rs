...
///FHIR ValueSet: ContractResourceAssetAvailiabilityCodes
...
impl ContractResourceAssetAvailiabilityCodes {
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/asset-availability" => {
                super::super::code_systems::asset_availability::ContractAssetAvailability::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
for ContractResourceAssetAvailiabilityCodes {
