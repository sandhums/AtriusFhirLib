...
///FHIR ValueSet: OperationParameterUse
...
impl OperationParameterUse {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "in",
                Some("In"),
                Some("This is an input parameter."),
            ),
            (
                "http://hl7.org/fhir/operation-parameter-use",
                "out",
                Some("Out"),
                Some("This is an output parameter."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/operation-parameter-use" => {
                super::super::code_systems::operation_parameter_use::OperationParameterUse::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for OperationParameterUse {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for OperationParameterUse {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for OperationParameterUse {
