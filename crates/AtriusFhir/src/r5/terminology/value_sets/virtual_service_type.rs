...
///FHIR ValueSet: VirtualServiceType
...
impl VirtualServiceType {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/virtual-service-type", "zoom"),
            ("http://hl7.org/fhir/virtual-service-type", "ms-teams"),
            ("http://hl7.org/fhir/virtual-service-type", "whatsapp"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                Some("Microsoft Teams web conferencing meeting"),
            ),
            (
                "http://hl7.org/fhir/virtual-service-type",
                "whatsapp",
                Some("WhatsApp conference call"),
                Some("A conference call using the WhatsApp conference call service"),
            ),
            (
                "http://hl7.org/fhir/virtual-service-type",
                "zoom",
                Some("Zoom web conferencing"),
                Some(
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/virtual-service-type" => {
                super::super::code_systems::virtual_service_type::VirtualServiceType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for VirtualServiceType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for VirtualServiceType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for VirtualServiceType {
