...
impl ResearchStudyArmType {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/research-study-arm-type", "active-comparator"),
            ("http://hl7.org/fhir/research-study-arm-type", "placebo-comparator"),
            ("http://hl7.org/fhir/research-study-arm-type", "sham-comparator"),
            ("http://hl7.org/fhir/research-study-arm-type", "no-intervention"),
            ("http://hl7.org/fhir/research-study-arm-type", "experimental"),
            ("http://hl7.org/fhir/research-study-arm-type", "other-arm-type"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                "http://hl7.org/fhir/research-study-arm-type",
                "placebo-comparator",
                Some("Placebo Comparator"),
                None,
            ),
            (
                "http://hl7.org/fhir/research-study-arm-type",
                "sham-comparator",
                Some("Sham Comparator"),
                None,
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/research-study-arm-type" => {
                super::super::code_systems::research_study_arm_type::ResearchStudyArmType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ResearchStudyArmType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ResearchStudyArmType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ResearchStudyArmType {
