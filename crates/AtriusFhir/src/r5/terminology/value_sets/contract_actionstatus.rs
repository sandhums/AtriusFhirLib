...
///FHIR ValueSet: ContractResourceActionStatusCodes
...
impl ContractResourceActionStatusCodes {
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/contract-action-status" => {
                super::super::code_systems::contract_actionstatus::ContractActionStatus::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
for ContractResourceActionStatusCodes {
