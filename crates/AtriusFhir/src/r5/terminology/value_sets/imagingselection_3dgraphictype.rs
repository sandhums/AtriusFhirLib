...
///FHIR ValueSet: ImagingSelection3DGraphicType
...
impl ImagingSelection3DGraphicType {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/imagingselection-3dgraphictype", "point"),
            ("http://hl7.org/fhir/imagingselection-3dgraphictype", "multipoint"),
            ("http://hl7.org/fhir/imagingselection-3dgraphictype", "polyline"),
            ("http://hl7.org/fhir/imagingselection-3dgraphictype", "polygon"),
            ("http://hl7.org/fhir/imagingselection-3dgraphictype", "ellipse"),
            ("http://hl7.org/fhir/imagingselection-3dgraphictype", "ellipsoid"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                ...
                "point",
                Some("POINT"),
                Some("A single location denoted by a single (x,y,z) triplet."),
            ),
            (
                "http://hl7.org/fhir/imagingselection-3dgraphictype",
                "polygon",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/imagingselection-3dgraphictype" => {
                super::super::code_systems::imagingselection_3dgraphictype::ImagingSelection3DGraphicType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ImagingSelection3DGraphicType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding>
for ImagingSelection3DGraphicType {
