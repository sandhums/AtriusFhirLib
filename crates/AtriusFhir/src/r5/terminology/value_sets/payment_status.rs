...
///FHIR ValueSet: PaymentStatusCodes
...
impl super::super::bindings::ValueSetMembership<Code> for PaymentStatusCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for PaymentStatusCodes {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for PaymentStatusCodes {
