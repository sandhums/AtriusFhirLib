...
///Expansion contains 5 explicit codes
...
impl super::super::bindings::ValueSetMembership<Code> for ExampleInactive {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ExampleInactive {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for ExampleInactive {
