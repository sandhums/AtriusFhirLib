...
impl FilterOperator {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ...
            ("http://hl7.org/fhir/filter-operator", "child-of"),
            ("http://hl7.org/fhir/filter-operator", "descendent-leaf"),
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "=",
                Some("Equals"),
                Some("The specified property of the code equals the provided value."),
            ),
            (
                "http://hl7.org/fhir/filter-operator",
                "child-of",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/filter-operator" => {
                super::super::code_systems::filter_operator::FilterOperator::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for FilterOperator {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for FilterOperator {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for FilterOperator {
