...
///FHIR ValueSet: TextureModifierCodes
...
impl TextureModifierCodes {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ("http://snomed.info/sct", "228049004", Some("Chopped food"), None),
            ("http://snomed.info/sct", "228053002", Some("Cut-up food"), None),
            ("http://snomed.info/sct", "228055009", Some("Liquidized food"), None),
            ("http://snomed.info/sct", "228056005", Some("Lumpy food"), None),
            ("http://snomed.info/sct", "228057001", Some("Semi-solid food"), None),
            ("http://snomed.info/sct", "228058006", Some("Single texture food"), None),
            ("http://snomed.info/sct", "228059003", Some("Soft food"), None),
            ("http://snomed.info/sct", "228060008", Some("Solid food"), None),
            (
                "http://snomed.info/sct",
                "439091000124107",
            ...
            ("http://snomed.info/sct", "441751000124100", Some("Mashed food"), None),
            ("http://snomed.info/sct", "441761000124103", Some("Minced food"), None),
            ("http://snomed.info/sct", "441771000124105", Some("Moist food"), None),
            ("http://snomed.info/sct", "441791000124106", Some("Strained food"), None),
            ("http://snomed.info/sct", "441881000124103", Some("Ground food"), None),
        ]
    }
...
impl super::super::bindings::ValueSetMembership<Code> for TextureModifierCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for TextureModifierCodes {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for TextureModifierCodes {
