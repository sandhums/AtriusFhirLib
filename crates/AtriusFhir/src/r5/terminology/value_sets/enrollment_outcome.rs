...
///FHIR ValueSet: EnrollmentOutcome
...
impl EnrollmentOutcome {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/enrollment-outcome", "queued"),
            ("http://hl7.org/fhir/enrollment-outcome", "complete"),
            ("http://hl7.org/fhir/enrollment-outcome", "error"),
            ("http://hl7.org/fhir/enrollment-outcome", "partial"),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/enrollment-outcome" => {
                super::super::code_systems::enrollment_outcome::ClaimProcessingCodes::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for EnrollmentOutcome {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for EnrollmentOutcome {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for EnrollmentOutcome {
