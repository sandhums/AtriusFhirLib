...
///FHIR ValueSet: SNOMEDCTSupplyItem
...
impl SNOMEDCTSupplyItem {
    ...
    pub fn filter_rules() -> &'static [(&'static str, &'static str, &'static str)] {
        &[("concept", "is-a", "105590001"), ("concept", "is-a", "260787004")]
    }
...
impl super::super::bindings::ValueSetMembership<Code> for SNOMEDCTSupplyItem {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for SNOMEDCTSupplyItem {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for SNOMEDCTSupplyItem {
