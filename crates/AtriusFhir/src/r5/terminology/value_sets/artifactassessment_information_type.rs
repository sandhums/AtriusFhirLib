...
///FHIR ValueSet: ArtifactAssessmentInformationType
...
impl ArtifactAssessmentInformationType {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/artifactassessment-information-type", "comment"),
            ("http://hl7.org/fhir/artifactassessment-information-type", "classifier"),
            ("http://hl7.org/fhir/artifactassessment-information-type", "rating"),
            ("http://hl7.org/fhir/artifactassessment-information-type", "container"),
            ("http://hl7.org/fhir/artifactassessment-information-type", "response"),
            ("http://hl7.org/fhir/artifactassessment-information-type", "change-request"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "change-request",
                Some("Change Request"),
                Some("A change request for the artifact"),
            ),
            (
                "http://hl7.org/fhir/artifactassessment-information-type",
                "classifier",
                Some("Classifier"),
                Some("A classifier of the artifact"),
            ),
            (
                "http://hl7.org/fhir/artifactassessment-information-type",
                "comment",
                Some("Comment"),
                Some("A comment on the artifact"),
            ),
            (
                "http://hl7.org/fhir/artifactassessment-information-type",
                "container",
                Some("Container"),
                Some("A container for multiple components"),
            ),
            (
                "http://hl7.org/fhir/artifactassessment-information-type",
                "rating",
                Some("Rating"),
                Some("A rating of the artifact"),
            ),
            (
                "http://hl7.org/fhir/artifactassessment-information-type",
                "response",
                Some("Response"),
                Some("A response to a comment"),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/artifactassessment-information-type" => {
                super::super::code_systems::artifactassessment_information_type::ArtifactAssessmentInformationType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
for ArtifactAssessmentInformationType {
