...
///FHIR ValueSet: MeasurePopulationType
...
impl super::super::bindings::ValueSetMembership<Code> for MeasurePopulationType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for MeasurePopulationType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for MeasurePopulationType {
