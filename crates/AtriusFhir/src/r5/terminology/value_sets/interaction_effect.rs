...
///FHIR ValueSet: InteractionEffect
...
impl super::super::bindings::ValueSetMembership<Code> for InteractionEffect {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for InteractionEffect {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for InteractionEffect {
