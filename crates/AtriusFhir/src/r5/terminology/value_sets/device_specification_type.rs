...
///FHIR ValueSet: DeviceSpecificationType
...
impl DeviceSpecificationType {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            ("urn:iso:std:iso:11073:10101", "528457", Some("Generic 20601 Device"), None),
        ]
    }
...
impl super::super::bindings::ValueSetMembership<Code> for DeviceSpecificationType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for DeviceSpecificationType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for DeviceSpecificationType {
