...
///FHIR ValueSet: AuditEventOutcomeDetail
///Canonical URL: http://hl7.org/fhir/ValueSet/audit-event-outcome-detail
///Version: 5.0.0
///Title: Audit Event Outcome Detail
///Status: draft
...
impl super::super::bindings::ValueSetMembership<Code> for AuditEventOutcomeDetail {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for AuditEventOutcomeDetail {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for AuditEventOutcomeDetail {
