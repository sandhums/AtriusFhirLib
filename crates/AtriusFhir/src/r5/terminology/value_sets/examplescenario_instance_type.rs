...
///FHIR ValueSet: ExampleScenarioResourceType
...
impl super::super::bindings::ValueSetMembership<Code> for ExampleScenarioResourceType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ExampleScenarioResourceType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ExampleScenarioResourceType {
