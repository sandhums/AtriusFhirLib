...
impl TaskIntent {
    ...
    pub fn include_systems() -> &'static [&'static str] {
        &["http://hl7.org/fhir/request-intent", "http://hl7.org/fhir/task-intent"]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            ...
            "http://hl7.org/fhir/task-intent" => {
                super::super::code_systems::task_intent::TaskIntent::try_from_code(code)
                    .is_ok()
            }
            _ => false,
        }
...
impl super::super::bindings::ValueSetMembership<Code> for TaskIntent {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for TaskIntent {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for TaskIntent {
