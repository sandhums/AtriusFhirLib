...
///FHIR ValueSet: TestScriptRequestMethodCode
...
impl TestScriptRequestMethodCode {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "delete",
                Some("DELETE"),
                Some("HTTP DELETE operation."),
            ),
            (
                "http://hl7.org/fhir/http-operations",
                "get",
                Some("GET"),
                Some("HTTP GET operation."),
            ),
            (
                "http://hl7.org/fhir/http-operations",
                "head",
                Some("HEAD"),
                Some("HTTP HEAD operation."),
            ),
            (
                "http://hl7.org/fhir/http-operations",
                "options",
                Some("OPTIONS"),
                Some("HTTP OPTIONS operation."),
            ),
            (
                "http://hl7.org/fhir/http-operations",
                "patch",
                Some("PATCH"),
                Some("HTTP PATCH operation."),
            ),
            (
                "http://hl7.org/fhir/http-operations",
                "post",
                Some("POST"),
                Some("HTTP POST operation."),
            ),
            (
                "http://hl7.org/fhir/http-operations",
                "put",
                Some("PUT"),
                Some("HTTP PUT operation."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/http-operations" => {
                super::super::code_systems::http_operations::TestScriptRequestMethodCode::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for TestScriptRequestMethodCode {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for TestScriptRequestMethodCode {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for TestScriptRequestMethodCode {
