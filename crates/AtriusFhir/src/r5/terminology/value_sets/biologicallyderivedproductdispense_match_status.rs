...
///FHIR ValueSet: BiologicallyDerivedProductDispenseMatchStatus
...
impl BiologicallyDerivedProductDispenseMatchStatus {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                ...
                "unmatched",
                Some("Unmatched"),
                Some("No specific matching has been carried out"),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/CodeSystem/biologicallyderivedproductdispense-match-status" => {
                super::super::code_systems::biologicallyderivedproductdispense_match_status::BiologicallyDerivedProductDispenseMatchStatus::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
for BiologicallyDerivedProductDispenseMatchStatus {
