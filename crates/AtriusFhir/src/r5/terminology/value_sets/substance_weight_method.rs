...
impl WeightMethod {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                "http://hl7.org/fhir/substance-weight-method",
                "End-groupAnalysis",
                Some("End-group analysis"),
                None,
            ),
            (
                "http://hl7.org/fhir/substance-weight-method",
                "End-groupTitration",
                Some("End-group titration"),
                None,
            ),
            (
                "http://hl7.org/fhir/substance-weight-method",
                "GelPermeationCentrifugation",
                Some("gel permeation centrifugation"),
                None,
            ),
            (
                "http://hl7.org/fhir/substance-weight-method",
            ...
            (
                "http://hl7.org/fhir/substance-weight-method",
                "Size-ExclusionChromatography",
                Some("Size-exclusion chromatography"),
                None,
            ),
            (
                "http://hl7.org/fhir/substance-weight-method",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/substance-weight-method" => {
                super::super::code_systems::substance_weight_method::SubstanceWeightMethod::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for WeightMethod {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for WeightMethod {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for WeightMethod {
