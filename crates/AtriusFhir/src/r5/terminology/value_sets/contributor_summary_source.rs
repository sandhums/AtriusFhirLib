...
///FHIR ValueSet: ContributorSummarySource
...
impl ContributorSummarySource {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/contributor-summary-source", "publisher-data"),
            ("http://hl7.org/fhir/contributor-summary-source", "article-copy"),
            ("http://hl7.org/fhir/contributor-summary-source", "citation-manager"),
            ("http://hl7.org/fhir/contributor-summary-source", "custom"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                "http://hl7.org/fhir/contributor-summary-source",
                "article-copy",
                Some("Copied from article"),
                Some("Data copied by human from article text."),
            ),
            (
                "http://hl7.org/fhir/contributor-summary-source",
                "citation-manager",
                Some("Reported by citation manager"),
                Some("Data copied by machine from citation manager data."),
            ),
            (
                "http://hl7.org/fhir/contributor-summary-source",
                "custom",
                Some("custom format"),
                Some("Custom format (may be described in text note)."),
            ),
            (
                "http://hl7.org/fhir/contributor-summary-source",
                "publisher-data",
                Some("Publisher provided"),
                Some("Data copied by machine from publisher data."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/contributor-summary-source" => {
                super::super::code_systems::contributor_summary_source::ContributorSummarySource::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ContributorSummarySource {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ContributorSummarySource {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ContributorSummarySource {
