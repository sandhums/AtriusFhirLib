...
///FHIR ValueSet: StructureMapInputMode
...
impl StructureMapInputMode {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                Some("Names an input instance used a source for mapping."),
            ),
            (
                "http://hl7.org/fhir/map-input-mode",
                "target",
                Some("Target Instance"),
                Some("Names an instance that is being populated."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/map-input-mode" => {
                super::super::code_systems::map_input_mode::StructureMapInputMode::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for StructureMapInputMode {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for StructureMapInputMode {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for StructureMapInputMode {
