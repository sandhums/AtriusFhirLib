...
impl ProductNameType {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                "http://hl7.org/fhir/medicinal-product-name-type",
                "BAN",
                Some("British Approved Name"),
                None,
            ),
            (
                "http://hl7.org/fhir/medicinal-product-name-type",
                "INN",
                Some("International Non-Proprietary Name"),
                None,
            ),
            (
                "http://hl7.org/fhir/medicinal-product-name-type",
                "INNM",
                Some("Modified International Non-Proprietary Name"),
                None,
            ),
            (
                "http://hl7.org/fhir/medicinal-product-name-type",
                "pINN",
                Some("Proposed International Non-Proprietary Name"),
                None,
            ),
            (
                "http://hl7.org/fhir/medicinal-product-name-type",
                "rINN",
                Some("Recommended International Non-Proprietary Name"),
                None,
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/medicinal-product-name-type" => {
                super::super::code_systems::medicinal_product_name_type::ProductNameType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ProductNameType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ProductNameType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for ProductNameType {
