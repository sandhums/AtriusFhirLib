...
///FHIR ValueSet: AppointmentRecurrenceType
...
impl super::super::bindings::ValueSetMembership<Code> for AppointmentRecurrenceType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for AppointmentRecurrenceType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for AppointmentRecurrenceType {
