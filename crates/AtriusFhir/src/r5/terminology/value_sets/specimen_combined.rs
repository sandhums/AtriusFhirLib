...
///FHIR ValueSet: SpecimenCombined
...
impl SpecimenCombined {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/specimen-combined", "grouped"),
            ("http://hl7.org/fhir/specimen-combined", "pooled"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "grouped",
                Some("Grouped"),
                Some("The specimen is in a group."),
            ),
            (
                "http://hl7.org/fhir/specimen-combined",
                "pooled",
                Some("Pooled"),
                Some("The specimen is pooled."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/specimen-combined" => {
                super::super::code_systems::specimen_combined::SpecimenCombined::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for SpecimenCombined {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for SpecimenCombined {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for SpecimenCombined {
