...
///FHIR ValueSet: TestReportParticipantType
...
impl TestReportParticipantType {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                ...
                "test-engine",
                Some("Test Engine"),
                Some("The test execution engine."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/report-participant-type" => {
                super::super::code_systems::report_participant_type::TestReportParticipantType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for TestReportParticipantType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for TestReportParticipantType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for TestReportParticipantType {
