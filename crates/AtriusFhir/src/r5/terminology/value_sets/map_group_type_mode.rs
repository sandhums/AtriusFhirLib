...
///FHIR ValueSet: StructureMapGroupTypeMode
...
impl StructureMapGroupTypeMode {
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/map-group-type-mode" => {
                super::super::code_systems::map_group_type_mode::StructureMapGroupTypeMode::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for StructureMapGroupTypeMode {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for StructureMapGroupTypeMode {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for StructureMapGroupTypeMode {
