...
///FHIR ValueSet: DeviceCorrectiveActionScope
...
impl DeviceCorrectiveActionScope {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/device-correctiveactionscope", "model"),
            ("http://hl7.org/fhir/device-correctiveactionscope", "lot-numbers"),
            ("http://hl7.org/fhir/device-correctiveactionscope", "serial-numbers"),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/device-correctiveactionscope" => {
                super::super::code_systems::device_correctiveactionscope::DeviceCorrectiveActionScope::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for DeviceCorrectiveActionScope {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for DeviceCorrectiveActionScope {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for DeviceCorrectiveActionScope {
