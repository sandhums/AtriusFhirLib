...
///FHIR ValueSet: QuestionnaireQuestionCodes
...
impl super::super::bindings::ValueSetMembership<Code> for QuestionnaireQuestionCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for QuestionnaireQuestionCodes {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for QuestionnaireQuestionCodes {
