...
///FHIR ValueSet: DeviceUsageAdherenceReason
...
impl DeviceUsageAdherenceReason {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/deviceusage-adherence-reason", "lost"),
            ("http://hl7.org/fhir/deviceusage-adherence-reason", "stolen"),
            ("http://hl7.org/fhir/deviceusage-adherence-reason", "prescribed"),
            ("http://hl7.org/fhir/deviceusage-adherence-reason", "broken"),
            ("http://hl7.org/fhir/deviceusage-adherence-reason", "burned"),
            ("http://hl7.org/fhir/deviceusage-adherence-reason", "forgot"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "broken",
                Some("Broken"),
                Some("The device is broken."),
            ),
            (
                "http://hl7.org/fhir/deviceusage-adherence-reason",
                "burned",
                Some("Burned"),
                Some("The device is burned."),
            ),
            (
                "http://hl7.org/fhir/deviceusage-adherence-reason",
                "forgot",
                Some("Forgot"),
                Some("The device is forgotten."),
            ),
            (
                "http://hl7.org/fhir/deviceusage-adherence-reason",
                "lost",
                Some("Lost"),
                Some("The device is lost."),
            ),
            (
                "http://hl7.org/fhir/deviceusage-adherence-reason",
                "prescribed",
                Some("Prescribed"),
                Some("The device is prescribed."),
            ),
            (
                "http://hl7.org/fhir/deviceusage-adherence-reason",
                "stolen",
                Some("Stolen"),
                Some("The device is stolen."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/deviceusage-adherence-reason" => {
                super::super::code_systems::deviceusage_adherence_reason::DeviceUsageAdherenceReason::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for DeviceUsageAdherenceReason {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for DeviceUsageAdherenceReason {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for DeviceUsageAdherenceReason {
