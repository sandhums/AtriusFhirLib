...
///FHIR ValueSet: ListEmptyReasons
...
impl super::super::bindings::ValueSetMembership<Code> for ListEmptyReasons {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ListEmptyReasons {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for ListEmptyReasons {
