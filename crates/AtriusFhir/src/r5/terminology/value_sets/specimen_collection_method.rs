...
///FHIR ValueSet: FHIRSpecimenCollectionMethod
...
impl super::super::bindings::ValueSetMembership<Code> for FHIRSpecimenCollectionMethod {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding>
for FHIRSpecimenCollectionMethod {
