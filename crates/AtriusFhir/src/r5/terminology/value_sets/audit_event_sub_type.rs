...
///FHIR ValueSet: AuditEventSubType
...
impl super::super::bindings::ValueSetMembership<Code> for AuditEventSubType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for AuditEventSubType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for AuditEventSubType {
