...
///FHIR ValueSet: GroupMembershipBasis
...
impl GroupMembershipBasis {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/group-membership-basis", "definitional"),
            ("http://hl7.org/fhir/group-membership-basis", "enumerated"),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/group-membership-basis" => {
                super::super::code_systems::group_membership_basis::GroupMembershipBasis::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for GroupMembershipBasis {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for GroupMembershipBasis {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for GroupMembershipBasis {
