...
///FHIR ValueSet: UsageContextAgreementScope
...
impl UsageContextAgreementScope {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ...
            ("http://hl7.org/fhir/CodeSystem/usage-context-agreement-scope", "domain"),
            (
                "http://hl7.org/fhir/CodeSystem/usage-context-agreement-scope",
                "community",
            ),
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/CodeSystem/usage-context-agreement-scope" => {
                super::super::code_systems::usage_context_agreement_scope::UsageContextAgreementScope::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for UsageContextAgreementScope {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for UsageContextAgreementScope {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for UsageContextAgreementScope {
