...
///FHIR ValueSet: CommunicationNotDoneReason
///Canonical URL: http://hl7.org/fhir/ValueSet/communication-not-done-reason
///Version: 5.0.0
///Title: Communication Not Done Reason
///Status: draft
...
impl super::super::bindings::ValueSetMembership<Code> for CommunicationNotDoneReason {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for CommunicationNotDoneReason {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for CommunicationNotDoneReason {
