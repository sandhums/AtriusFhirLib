...
///FHIR ValueSet: TypeDerivationRule
...
impl TypeDerivationRule {
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/type-derivation-rule" => {
                super::super::code_systems::type_derivation_rule::TypeDerivationRule::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for TypeDerivationRule {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for TypeDerivationRule {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for TypeDerivationRule {
