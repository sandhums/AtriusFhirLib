...
///FHIR ValueSet: AdverseEventType
...
impl AdverseEventType {
    ...
    fn include_entries() -> &'static [(
        ...
        &[("http://snomed.info/sct", "1912002", None, None)]
    }
...
impl super::super::bindings::ValueSetMembership<Code> for AdverseEventType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for AdverseEventType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for AdverseEventType {
