...
///FHIR ValueSet: SupplyRequestStatus
...
impl SupplyRequestStatus {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "active",
                Some("Active"),
                Some("The request is ready to be acted upon."),
            ),
            (
                "http://hl7.org/fhir/supplyrequest-status",
                "cancelled",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/supplyrequest-status" => {
                super::super::code_systems::supplyrequest_status::SupplyRequestStatus::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for SupplyRequestStatus {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for SupplyRequestStatus {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for SupplyRequestStatus {
