...
impl ConditionStage {
    ...
    pub fn filter_rules() -> &'static [(&'static str, &'static str, &'static str)] {
        &[
            ("concept", "is-a", "385356007"),
            ("concept", "is-a", "408847006"),
            ("concept", "is-a", "408848001"),
            ("concept", "is-a", "408849009"),
            ("concept", "is-a", "408850009"),
            ("concept", "is-a", "408851008"),
            ("concept", "is-a", "431855005"),
            ("concept", "is-a", "431856006"),
            ("concept", "is-a", "431857002"),
            ("concept", "is-a", "433144002"),
            ("concept", "is-a", "433146000"),
        ]
    }
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://snomed.info/sct", "416780008"),
            ("http://snomed.info/sct", "715345007"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            ("http://snomed.info/sct", "416780008", None, None),
            ("http://snomed.info/sct", "715345007", None, None),
        ]
    }
...
impl super::super::bindings::ValueSetMembership<Code> for ConditionStage {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ConditionStage {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for ConditionStage {
