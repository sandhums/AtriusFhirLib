...
///FHIR ValueSet: ContractResourceAssetScopeCodes
...
impl ContractResourceAssetScopeCodes {
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/contract-asset-scope" => {
                super::super::code_systems::contract_assetscope::ContractAssetScope::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
for ContractResourceAssetScopeCodes {
