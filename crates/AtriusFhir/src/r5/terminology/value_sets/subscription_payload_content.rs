...
///FHIR ValueSet: SubscriptionPayloadContent
...
impl SubscriptionPayloadContent {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/subscription-payload-content", "empty"),
            ("http://hl7.org/fhir/subscription-payload-content", "id-only"),
            ("http://hl7.org/fhir/subscription-payload-content", "full-resource"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "empty",
                Some("Empty"),
                Some("No resource content is transacted in the notification payload."),
            ),
            (
                "http://hl7.org/fhir/subscription-payload-content",
                "full-resource",
            ...
            (
                ...
                "id-only",
                Some("Id-only"),
                Some("Only the resource id is transacted in the notification payload."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/subscription-payload-content" => {
                super::super::code_systems::subscription_payload_content::SubscriptionPayloadContent::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for SubscriptionPayloadContent {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for SubscriptionPayloadContent {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for SubscriptionPayloadContent {
