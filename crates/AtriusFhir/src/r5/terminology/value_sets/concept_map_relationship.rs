...
///FHIR ValueSet: ConceptMapRelationship
...
impl ConceptMapRelationship {
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/concept-map-relationship" => {
                super::super::code_systems::concept_map_relationship::ConceptMapRelationship::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ConceptMapRelationship {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ConceptMapRelationship {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ConceptMapRelationship {
