...
///FHIR ValueSet: FinancialResourceStatusCodes
...
impl FinancialResourceStatusCodes {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "active",
                Some("Active"),
                Some("The instance is currently in-force."),
            ),
            (
                "http://hl7.org/fhir/fm-status",
                "cancelled",
                Some("Cancelled"),
                Some("The instance is withdrawn, rescinded or reversed."),
            ),
            (
                "http://hl7.org/fhir/fm-status",
                "draft",
                Some("Draft"),
                Some("A new instance the contents of which is not complete."),
            ),
            (
                "http://hl7.org/fhir/fm-status",
                "entered-in-error",
                Some("Entered in Error"),
                Some("The instance was entered in error."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/fm-status" => {
                super::super::code_systems::fm_status::FinancialResourceStatusCodes::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for FinancialResourceStatusCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding>
for FinancialResourceStatusCodes {
