...
///FHIR ValueSet: TestReportResult
...
impl TestReportResult {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "fail",
                Some("Fail"),
                Some("One or more test operations failed one or more asserts."),
            ),
            (
                "http://hl7.org/fhir/report-result-codes",
                "pass",
                Some("Pass"),
                Some("All test operations successfully passed all asserts."),
            ),
            (
                "http://hl7.org/fhir/report-result-codes",
                "pending",
                Some("Pending"),
                Some("One or more test operations is pending execution completion."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/report-result-codes" => {
                super::super::code_systems::report_result_codes::TestReportResult::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for TestReportResult {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for TestReportResult {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for TestReportResult {
