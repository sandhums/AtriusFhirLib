...
///FHIR ValueSet: DeviceDispenseStatusCodes
...
impl DeviceDispenseStatusCodes {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/devicedispense-status", "preparation"),
            ("http://hl7.org/fhir/devicedispense-status", "in-progress"),
            ("http://hl7.org/fhir/devicedispense-status", "cancelled"),
            ("http://hl7.org/fhir/devicedispense-status", "on-hold"),
            ("http://hl7.org/fhir/devicedispense-status", "completed"),
            ("http://hl7.org/fhir/devicedispense-status", "entered-in-error"),
            ("http://hl7.org/fhir/devicedispense-status", "stopped"),
            ("http://hl7.org/fhir/devicedispense-status", "declined"),
            ("http://hl7.org/fhir/devicedispense-status", "unknown"),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/devicedispense-status" => {
                super::super::code_systems::devicedispense_status::DeviceDispenseStatusCodes::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for DeviceDispenseStatusCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for DeviceDispenseStatusCodes {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for DeviceDispenseStatusCodes {
