...
///FHIR ValueSet: DeviceMetricOperationalStatus
...
impl DeviceMetricOperationalStatus {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                Some("The DeviceMetric was entered in error."),
            ),
            (
                "http://hl7.org/fhir/metric-operational-status",
                "off",
                Some("Off"),
                Some("The DeviceMetric is not operating."),
            ),
            (
                "http://hl7.org/fhir/metric-operational-status",
                "on",
                Some("On"),
                Some("The DeviceMetric is operating and will generate Observations."),
            ),
            (
                "http://hl7.org/fhir/metric-operational-status",
                "standby",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/metric-operational-status" => {
                super::super::code_systems::metric_operational_status::DeviceMetricOperationalStatus::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for DeviceMetricOperationalStatus {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding>
for DeviceMetricOperationalStatus {
