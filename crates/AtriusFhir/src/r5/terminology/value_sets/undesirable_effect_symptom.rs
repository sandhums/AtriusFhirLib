...
///FHIR ValueSet: UndesirableEffectSymptom
///Canonical URL: http://hl7.org/fhir/ValueSet/undesirable-effect-symptom
///Version: 5.0.0
///Title: Undesirable Effect Symptom
///Status: draft
...
impl super::super::bindings::ValueSetMembership<Code> for UndesirableEffectSymptom {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for UndesirableEffectSymptom {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for UndesirableEffectSymptom {
