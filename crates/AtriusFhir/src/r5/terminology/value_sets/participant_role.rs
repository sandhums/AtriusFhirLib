...
///FHIR ValueSet: ParticipantRoles
...
impl ParticipantRoles {
    ...
    pub fn filter_rules() -> &'static [(&'static str, &'static str, &'static str)] {
        &[("concept", "is-a", "223366009"), ("concept", "is-a", "224930009")]
    }
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ("http://snomed.info/sct", "116154003", None, None),
            ("http://snomed.info/sct", "133932002", None, None),
            ("http://snomed.info/sct", "429577009", None, None),
        ]
    }
...
impl super::super::bindings::ValueSetMembership<Code> for ParticipantRoles {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ParticipantRoles {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for ParticipantRoles {
