...
///FHIR ValueSet: AccountRelationship
...
impl AccountRelationship {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/account-relationship", "parent"),
            ("http://hl7.org/fhir/account-relationship", "guarantor"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            ("http://hl7.org/fhir/account-relationship", "parent", Some("Parent"), None),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/account-relationship" => {
                super::super::code_systems::account_relationship::AccountRelationship::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for AccountRelationship {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for AccountRelationship {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for AccountRelationship {
