...
///FHIR ValueSet: CompositeMeasureScoring
///Canonical URL: http://hl7.org/fhir/ValueSet/composite-measure-scoring
///Version: 5.0.0
///Title: Composite Measure Scoring
///Status: draft
...
impl super::super::bindings::ValueSetMembership<Code> for CompositeMeasureScoring {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for CompositeMeasureScoring {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for CompositeMeasureScoring {
