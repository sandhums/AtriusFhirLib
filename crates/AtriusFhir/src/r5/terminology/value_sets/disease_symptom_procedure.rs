...
///FHIR ValueSet: DiseaseSymptomProcedure
///Canonical URL: http://hl7.org/fhir/ValueSet/disease-symptom-procedure
///Version: 5.0.0
///Title: Disease Symptom Procedure
///Status: draft
...
impl DiseaseSymptomProcedure {
    ...
    pub fn filter_rules() -> &'static [(&'static str, &'static str, &'static str)] {
        &[
            ("concept", "is-a", "363788007"),
            ("concept", "is-a", "64572001"),
...
impl super::super::bindings::ValueSetMembership<Code> for DiseaseSymptomProcedure {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for DiseaseSymptomProcedure {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for DiseaseSymptomProcedure {
