...
///FHIR ValueSet: EvidenceCertaintyType
...
impl EvidenceCertaintyType {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/certainty-type", "Overall"),
            ("http://hl7.org/fhir/certainty-type", "RiskOfBias"),
            ("http://hl7.org/fhir/certainty-type", "Inconsistency"),
            ("http://hl7.org/fhir/certainty-type", "Indirectness"),
            ("http://hl7.org/fhir/certainty-type", "Imprecision"),
            ("http://hl7.org/fhir/certainty-type", "PublicationBias"),
            ("http://hl7.org/fhir/certainty-type", "DoseResponseGradient"),
            ("http://hl7.org/fhir/certainty-type", "PlausibleConfounding"),
            ("http://hl7.org/fhir/certainty-type", "LargeEffect"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                ...
                "Imprecision",
                Some("Imprecision"),
                Some("fuzzy or wide variability."),
            ),
            (
                "http://hl7.org/fhir/certainty-type",
                "Inconsistency",
            ...
            (
                ...
                "Indirectness",
                Some("Indirectness"),
                Some("concerns reducing external validity."),
            ),
            (
                "http://hl7.org/fhir/certainty-type",
                "LargeEffect",
                Some("Large effect"),
                Some("higher certainty due to large effect size."),
            ),
            (
                "http://hl7.org/fhir/certainty-type",
                "Overall",
                Some("Overall certainty"),
                Some("Overall certainty of evidence (quality of evidence)."),
            ),
            (
                "http://hl7.org/fhir/certainty-type",
                "PlausibleConfounding",
                Some("Plausible confounding"),
            ...
            (
                ...
                "RiskOfBias",
                Some("Risk of bias"),
                Some("methodologic concerns reducing internal validity."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/certainty-type" => {
                super::super::code_systems::certainty_type::EvidenceCertaintyType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for EvidenceCertaintyType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for EvidenceCertaintyType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for EvidenceCertaintyType {
