...
///FHIR ValueSet: AllergyIntoleranceType
...
impl AllergyIntoleranceType {
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/allergy-intolerance-type" => {
                super::super::code_systems::allergy_intolerance_type::AllergyIntoleranceType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for AllergyIntoleranceType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for AllergyIntoleranceType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for AllergyIntoleranceType {
