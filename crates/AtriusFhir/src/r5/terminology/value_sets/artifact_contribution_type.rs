...
///FHIR ValueSet: ArtifactContributionType
...
impl ArtifactContributionType {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/artifact-contribution-type", "conceptualization"),
            ("http://hl7.org/fhir/artifact-contribution-type", "data-curation"),
            ("http://hl7.org/fhir/artifact-contribution-type", "formal-analysis"),
            ("http://hl7.org/fhir/artifact-contribution-type", "funding-acquisition"),
            ("http://hl7.org/fhir/artifact-contribution-type", "investigation"),
            ("http://hl7.org/fhir/artifact-contribution-type", "methodology"),
            ("http://hl7.org/fhir/artifact-contribution-type", "project-administration"),
            ("http://hl7.org/fhir/artifact-contribution-type", "resources"),
            ("http://hl7.org/fhir/artifact-contribution-type", "software"),
            ("http://hl7.org/fhir/artifact-contribution-type", "supervision"),
            ("http://hl7.org/fhir/artifact-contribution-type", "validation"),
            ("http://hl7.org/fhir/artifact-contribution-type", "visualization"),
            ("http://hl7.org/fhir/artifact-contribution-type", "writing-original-draft"),
            ("http://hl7.org/fhir/artifact-contribution-type", "writing-review-editing"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                ...
                "data-curation",
                Some("Data curation"),
                Some("Data curation (see https://jats4r.org/credit-taxonomy)."),
            ),
            (
                "http://hl7.org/fhir/artifact-contribution-type",
                "formal-analysis",
            ...
            (
                ...
                "investigation",
                Some("Investigation"),
                Some("Investigation (see https://jats4r.org/credit-taxonomy)."),
            ),
            (
                "http://hl7.org/fhir/artifact-contribution-type",
                "methodology",
                Some("Methodology"),
                Some("Methodology (see https://jats4r.org/credit-taxonomy)."),
            ),
            (
                "http://hl7.org/fhir/artifact-contribution-type",
            ...
            (
                ...
                "resources",
                Some("Resources"),
                Some("Resources (see https://jats4r.org/credit-taxonomy)."),
            ),
            (
                "http://hl7.org/fhir/artifact-contribution-type",
                "software",
                Some("Software"),
                Some("Software (see https://jats4r.org/credit-taxonomy)."),
            ),
            (
                "http://hl7.org/fhir/artifact-contribution-type",
                "supervision",
                Some("Supervision"),
                Some("Supervision (see https://jats4r.org/credit-taxonomy)."),
            ),
            (
                "http://hl7.org/fhir/artifact-contribution-type",
                "validation",
                Some("Validation"),
                Some("Validation (see https://jats4r.org/credit-taxonomy)."),
            ),
            (
                "http://hl7.org/fhir/artifact-contribution-type",
                "visualization",
                Some("Visualization"),
                Some("Visualization (see https://jats4r.org/credit-taxonomy)."),
            ),
            (
                "http://hl7.org/fhir/artifact-contribution-type",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/artifact-contribution-type" => {
                super::super::code_systems::artifact_contribution_type::ArtifactContributionType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ArtifactContributionType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ArtifactContributionType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ArtifactContributionType {
