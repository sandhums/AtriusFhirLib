...
///FHIR ValueSet: QuantityComparator
...
impl QuantityComparator {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ...
            ("http://hl7.org/fhir/quantity-comparator", ">="),
            ("http://hl7.org/fhir/quantity-comparator", ">"),
            ("http://hl7.org/fhir/quantity-comparator", "ad"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "<",
                Some("Less than"),
                Some("The actual value is less than the given value."),
            ),
            (
                "http://hl7.org/fhir/quantity-comparator",
                "<=",
                Some("Less or Equal to"),
                Some("The actual value is less than or equal to the given value."),
            ),
            (
                "http://hl7.org/fhir/quantity-comparator",
                ">",
                Some("Greater than"),
                Some("The actual value is greater than the given value."),
            ),
            (
                "http://hl7.org/fhir/quantity-comparator",
                ">=",
                Some("Greater or Equal to"),
                Some("The actual value is greater than or equal to the given value."),
            ),
            (
                "http://hl7.org/fhir/quantity-comparator",
                "ad",
                Some("Sufficient to achieve this total quantity"),
                Some(
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/quantity-comparator" => {
                super::super::code_systems::quantity_comparator::QuantityComparator::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for QuantityComparator {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for QuantityComparator {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for QuantityComparator {
