...
///FHIR ValueSet: ProductCrossReferenceType
...
impl ProductCrossReferenceType {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                "http://hl7.org/fhir/medicinal-product-cross-reference-type",
                "ActualProduct",
                Some("Link Virtual to Actual Product"),
                Some("Link Virtual to Actual Product"),
            ),
            (
                "http://hl7.org/fhir/medicinal-product-cross-reference-type",
                "BrandedProduct",
                Some("Link Generic to Branded Product"),
                Some("Link Generic to Branded Product"),
            ),
            (
                "http://hl7.org/fhir/medicinal-product-cross-reference-type",
                "GenericProduct",
                Some("Link Branded to Generic Product"),
                Some("Link Branded to Generic Product"),
            ),
            (
                "http://hl7.org/fhir/medicinal-product-cross-reference-type",
                "InvestigationalProduct",
                Some("Link to Investigational Product"),
                Some("Link to Investigational (Development) Product"),
            ),
            (
                "http://hl7.org/fhir/medicinal-product-cross-reference-type",
                "Parallel",
                Some("Link to Parallel Import Product"),
                Some("Link to Parallel Import Product"),
            ),
            (
                "http://hl7.org/fhir/medicinal-product-cross-reference-type",
                "VirtualProduct",
                Some("Link Actual to Virtual Product"),
                Some("Link Actual to Virtual Product"),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/medicinal-product-cross-reference-type" => {
                super::super::code_systems::medicinal_product_cross_reference_type::ProductCrossReferenceType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ProductCrossReferenceType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ProductCrossReferenceType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ProductCrossReferenceType {
