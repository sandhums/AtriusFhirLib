...
///FHIR ValueSet: MeasureStratifierExample
...
impl MeasureStratifierExample {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/measure-stratifier-example", "age"),
            ("http://hl7.org/fhir/measure-stratifier-example", "gender"),
            ("http://hl7.org/fhir/measure-stratifier-example", "region"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                ...
                "gender",
                Some("Gender"),
                Some("Gender Stratification."),
            ),
            (
                "http://hl7.org/fhir/measure-stratifier-example",
                "region",
                Some("Region"),
                Some("Region Stratification."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/measure-stratifier-example" => {
                super::super::code_systems::measure_stratifier_example::MeasureStratifierExample::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for MeasureStratifierExample {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for MeasureStratifierExample {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for MeasureStratifierExample {
