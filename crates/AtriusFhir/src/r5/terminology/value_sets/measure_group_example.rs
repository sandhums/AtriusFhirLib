...
impl MeasureGroupExample {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/measure-group-example", "primary-rate"),
            ("http://hl7.org/fhir/measure-group-example", "secondary-rate"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "primary-rate",
                Some("Primary Rate"),
                Some("Primary Measure Group."),
            ),
            (
                "http://hl7.org/fhir/measure-group-example",
                "secondary-rate",
                Some("Secondary Rate"),
                Some("Secondary Measure Group"),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/measure-group-example" => {
                super::super::code_systems::measure_group_example::MeasureGroupExample::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for MeasureGroupExample {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for MeasureGroupExample {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for MeasureGroupExample {
