...
impl InventoryItemStatusCodes {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/inventoryitem-status", "active"),
            ("http://hl7.org/fhir/inventoryitem-status", "inactive"),
            ("http://hl7.org/fhir/inventoryitem-status", "entered-in-error"),
            ("http://hl7.org/fhir/inventoryitem-status", "unknown"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "active",
                Some("Active"),
                Some("The item is active and can be referenced."),
            ),
            (
                "http://hl7.org/fhir/inventoryitem-status",
                "entered-in-error",
                Some("Entered in Error"),
                Some("The item record was entered in error."),
            ),
            (
                "http://hl7.org/fhir/inventoryitem-status",
                "inactive",
            ...
            (
                ...
                "unknown",
                Some("Unknown"),
                Some("The item status has not been determined."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/inventoryitem-status" => {
                super::super::code_systems::inventoryitem_status::InventoryItemStatus::try_from_code(
                        code,
                    )
                    .is_ok()
            }
