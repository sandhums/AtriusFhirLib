...
///FHIR ValueSet: FHIRSubstanceStatus
...
impl FHIRSubstanceStatus {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "active",
                Some("Active"),
                Some("The substance is considered for use or reference."),
            ),
            (
                "http://hl7.org/fhir/substance-status",
                "entered-in-error",
                Some("Entered in Error"),
                Some("The substance was entered in error."),
            ),
            (
                "http://hl7.org/fhir/substance-status",
                "inactive",
                Some("Inactive"),
                Some("The substance is considered for reference, but not for use."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/substance-status" => {
                super::super::code_systems::substance_status::FHIRSubstanceStatus::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for FHIRSubstanceStatus {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for FHIRSubstanceStatus {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for FHIRSubstanceStatus {
