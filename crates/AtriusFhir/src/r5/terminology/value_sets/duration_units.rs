...
///FHIR ValueSet: CommonUCUMCodesForDuration
...
impl CommonUCUMCodesForDuration {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ("http://unitsofmeasure.org", "a", Some("years"), None),
            ("http://unitsofmeasure.org", "d", Some("days"), None),
            ("http://unitsofmeasure.org", "h", Some("hours"), None),
            ("http://unitsofmeasure.org", "min", Some("minutes"), None),
            ("http://unitsofmeasure.org", "mo", Some("months"), None),
            ("http://unitsofmeasure.org", "ms", Some("milliseconds"), None),
            ("http://unitsofmeasure.org", "s", Some("seconds"), None),
            ("http://unitsofmeasure.org", "wk", Some("weeks"), None),
        ]
    }
...
impl super::super::bindings::ValueSetMembership<Code> for CommonUCUMCodesForDuration {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for CommonUCUMCodesForDuration {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for CommonUCUMCodesForDuration {
