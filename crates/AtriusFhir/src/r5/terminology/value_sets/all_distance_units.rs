...
///FHIR ValueSet: AllUCUMExpressionForDistance
...
impl super::super::bindings::ValueSetMembership<Code> for AllUCUMExpressionForDistance {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding>
for AllUCUMExpressionForDistance {
