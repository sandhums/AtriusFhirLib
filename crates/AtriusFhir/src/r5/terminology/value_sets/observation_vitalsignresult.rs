...
impl VitalSigns {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ("http://loinc.org", "2708-6", None, None),
            ("http://loinc.org", "29463-7", None, None),
            ("http://loinc.org", "39156-5", None, None),
            ("http://loinc.org", "8302-2", None, None),
            ("http://loinc.org", "8310-5", None, None),
            ("http://loinc.org", "8462-4", None, None),
            ("http://loinc.org", "8478-0", None, None),
            ("http://loinc.org", "8480-6", None, None),
            ("http://loinc.org", "85353-1", None, None),
            ("http://loinc.org", "85354-9", None, None),
            ("http://loinc.org", "8867-4", None, None),
            ("http://loinc.org", "9279-1", None, None),
            ("http://loinc.org", "9843-4", None, None),
        ]
    }
...
impl super::super::bindings::ValueSetMembership<Code> for VitalSigns {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for VitalSigns {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for VitalSigns {
