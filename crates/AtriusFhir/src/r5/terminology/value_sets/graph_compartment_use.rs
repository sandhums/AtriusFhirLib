...
///FHIR ValueSet: GraphCompartmentUse
...
impl GraphCompartmentUse {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/graph-compartment-use", "where"),
            ("http://hl7.org/fhir/graph-compartment-use", "requires"),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/graph-compartment-use" => {
                super::super::code_systems::graph_compartment_use::GraphCompartmentUse::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for GraphCompartmentUse {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for GraphCompartmentUse {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for GraphCompartmentUse {
