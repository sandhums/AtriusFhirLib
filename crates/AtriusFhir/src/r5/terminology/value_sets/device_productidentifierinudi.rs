...
///FHIR ValueSet: DeviceProductionIdentifierInUDI
...
impl DeviceProductionIdentifierInUDI {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/device-productidentifierinudi", "lot-number"),
            ("http://hl7.org/fhir/device-productidentifierinudi", "manufactured-date"),
            ("http://hl7.org/fhir/device-productidentifierinudi", "serial-number"),
            ("http://hl7.org/fhir/device-productidentifierinudi", "expiration-date"),
            ("http://hl7.org/fhir/device-productidentifierinudi", "biological-source"),
            ("http://hl7.org/fhir/device-productidentifierinudi", "software-version"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                "http://hl7.org/fhir/device-productidentifierinudi",
                "biological-source",
                Some("Biological source"),
                Some("The label includes the biological source identifier."),
            ),
            (
                "http://hl7.org/fhir/device-productidentifierinudi",
                "expiration-date",
                Some("Expiration date"),
                Some("The label includes the expiration date."),
            ),
            (
                "http://hl7.org/fhir/device-productidentifierinudi",
                "lot-number",
                Some("Lot Number"),
                Some("The label includes the lot number."),
            ),
            (
                "http://hl7.org/fhir/device-productidentifierinudi",
                "manufactured-date",
                Some("Manufactured date"),
                Some("The label includes the manufacture date."),
            ),
            (
                "http://hl7.org/fhir/device-productidentifierinudi",
                "serial-number",
                Some("Serial Number"),
                Some("The label includes the serial number."),
            ),
            (
                "http://hl7.org/fhir/device-productidentifierinudi",
                "software-version",
                Some("Software Version"),
                Some("The label includes the software version."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/device-productidentifierinudi" => {
                super::super::code_systems::device_productidentifierinudi::DeviceProductionIdentifierInUDI::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
for DeviceProductionIdentifierInUDI {
