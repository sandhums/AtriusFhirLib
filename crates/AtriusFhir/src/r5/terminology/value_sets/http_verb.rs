...
impl HTTPVerb {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "DELETE",
                Some("DELETE"),
                Some("HTTP DELETE Command."),
            ),
            (
                "http://hl7.org/fhir/http-verb",
                "GET",
                Some("GET"),
                Some("HTTP GET Command."),
            ),
            (
                "http://hl7.org/fhir/http-verb",
                "HEAD",
                Some("HEAD"),
                Some("HTTP HEAD Command."),
            ),
            (
                "http://hl7.org/fhir/http-verb",
                "PATCH",
                Some("PATCH"),
                Some("HTTP PATCH Command."),
            ),
            (
                "http://hl7.org/fhir/http-verb",
                "POST",
                Some("POST"),
                Some("HTTP POST Command."),
            ),
            (
                "http://hl7.org/fhir/http-verb",
                "PUT",
                Some("PUT"),
                Some("HTTP PUT Command."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/http-verb" => {
                super::super::code_systems::http_verb::HTTPVerb::try_from_code(code)
                    .is_ok()
            }
            _ => false,
        }
...
impl super::super::bindings::ValueSetMembership<Code> for HTTPVerb {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for HTTPVerb {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for HTTPVerb {
