...
impl CompartmentType {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ...
            ("http://hl7.org/fhir/compartment-type", "EpisodeOfCare"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "Device",
                Some("Device"),
                Some("The compartment definition is for the device compartment."),
            ),
            (
                "http://hl7.org/fhir/compartment-type",
                "Encounter",
                Some("Encounter"),
                Some("The compartment definition is for the encounter compartment."),
            ),
            (
                "http://hl7.org/fhir/compartment-type",
                "EpisodeOfCare",
            ...
            (
                ...
                "Patient",
                Some("Patient"),
                Some("The compartment definition is for the patient compartment."),
            ),
            (
                "http://hl7.org/fhir/compartment-type",
                "Practitioner",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/compartment-type" => {
                super::super::code_systems::compartment_type::CompartmentType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for CompartmentType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for CompartmentType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for CompartmentType {
