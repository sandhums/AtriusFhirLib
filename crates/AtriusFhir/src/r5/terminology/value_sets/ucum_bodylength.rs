...
impl BodyLengthUnits {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[("http://unitsofmeasure.org", "cm"), ("http://unitsofmeasure.org", "[in_i]")]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            ("http://unitsofmeasure.org", "[in_i]", None, None),
            ("http://unitsofmeasure.org", "cm", None, None),
        ]
    }
...
impl super::super::bindings::ValueSetMembership<Code> for BodyLengthUnits {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for BodyLengthUnits {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for BodyLengthUnits {
