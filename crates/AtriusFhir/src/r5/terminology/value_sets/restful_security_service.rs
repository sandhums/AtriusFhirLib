...
///FHIR ValueSet: RestfulSecurityService
...
impl RestfulSecurityService {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "Basic",
                Some("Basic"),
                Some("Basic authentication defined in HTTP specification."),
            ),
            (
                "http://hl7.org/fhir/restful-security-service",
                "Certificates",
            ...
            (
                ...
                "Kerberos",
                Some("Kerberos"),
                Some("see http://www.ietf.org/rfc/rfc4120.txt."),
            ),
            (
                "http://hl7.org/fhir/restful-security-service",
                "NTLM",
                Some("NTLM"),
                Some("Microsoft NTLM Authentication."),
            ),
            (
                "http://hl7.org/fhir/restful-security-service",
                "OAuth",
                Some("OAuth"),
                Some("OAuth (unspecified version see oauth.net)."),
            ),
            (
                "http://hl7.org/fhir/restful-security-service",
                "SMART-on-FHIR",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/restful-security-service" => {
                super::super::code_systems::restful_security_service::RestfulSecurityService::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for RestfulSecurityService {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for RestfulSecurityService {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for RestfulSecurityService {
