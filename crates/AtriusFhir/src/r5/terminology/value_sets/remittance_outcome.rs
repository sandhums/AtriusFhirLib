...
///FHIR ValueSet: RemittanceOutcome
...
impl RemittanceOutcome {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "complete",
                Some("Complete"),
                Some("The processing completed without errors."),
            ),
            (
                "http://hl7.org/fhir/remittance-outcome",
                "error",
                Some("Error"),
                Some("The processing identified errors."),
            ),
            (
                "http://hl7.org/fhir/remittance-outcome",
                "partial",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/remittance-outcome" => {
                super::super::code_systems::remittance_outcome::RemittanceOutcome::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for RemittanceOutcome {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for RemittanceOutcome {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for RemittanceOutcome {
