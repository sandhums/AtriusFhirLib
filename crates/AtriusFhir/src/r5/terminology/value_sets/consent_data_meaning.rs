...
///FHIR ValueSet: ConsentDataMeaning
...
impl ConsentDataMeaning {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                ...
                "instance",
                Some("Instance"),
                Some("The consent applies directly to the instance of the resource."),
            ),
            (
                "http://hl7.org/fhir/consent-data-meaning",
                "related",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/consent-data-meaning" => {
                super::super::code_systems::consent_data_meaning::ConsentDataMeaning::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ConsentDataMeaning {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ConsentDataMeaning {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for ConsentDataMeaning {
