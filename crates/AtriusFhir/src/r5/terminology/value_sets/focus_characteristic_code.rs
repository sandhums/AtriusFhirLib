...
///FHIR ValueSet: FocusCharacteristicCode
...
impl FocusCharacteristicCode {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/focus-characteristic-code", "citation"),
            (
                "http://hl7.org/fhir/focus-characteristic-code",
                "clinical-outcomes-observed",
            ),
            ("http://hl7.org/fhir/focus-characteristic-code", "population"),
            ("http://hl7.org/fhir/focus-characteristic-code", "exposure"),
            ("http://hl7.org/fhir/focus-characteristic-code", "comparator"),
            ("http://hl7.org/fhir/focus-characteristic-code", "outcome"),
            ("http://hl7.org/fhir/focus-characteristic-code", "medication-exposures"),
            ("http://hl7.org/fhir/focus-characteristic-code", "study-type"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "citation",
                Some("Citation"),
                Some("Used to reference a specific article."),
            ),
            (
                "http://hl7.org/fhir/focus-characteristic-code",
                "clinical-outcomes-observed",
                Some("Observed outcomes are clinical outcomes"),
                Some(
            ...
            (
                ...
                "comparator",
                Some("Comparator"),
                Some("The comparator (intervention or control state) of interest."),
            ),
            (
                "http://hl7.org/fhir/focus-characteristic-code",
                "exposure",
                Some("Exposure"),
                Some("The exposure of interest, such as an intervention."),
            ),
            (
                "http://hl7.org/fhir/focus-characteristic-code",
            ...
            (
                ...
                "outcome",
                Some("Outcome"),
                Some("the outcome of interest."),
            ),
            (
                "http://hl7.org/fhir/focus-characteristic-code",
                "population",
                Some("Population"),
                Some("The population of interest."),
            ),
            (
                "http://hl7.org/fhir/focus-characteristic-code",
                "study-type",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/focus-characteristic-code" => {
                super::super::code_systems::focus_characteristic_code::FocusCharacteristicCode::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for FocusCharacteristicCode {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for FocusCharacteristicCode {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for FocusCharacteristicCode {
