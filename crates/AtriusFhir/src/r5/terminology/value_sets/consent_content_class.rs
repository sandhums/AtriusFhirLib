...
///FHIR ValueSet: ConsentContentClass
...
impl ConsentContentClass {
    ...
    pub fn include_systems() -> &'static [&'static str] {
        &["urn:ietf:bcp:13", "urn:ietf:rfc:3986"]
    }
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ("urn:ietf:bcp:13", "application/hl7-cda+xml", Some("CDA Documents"), None),
            (
                "urn:ietf:rfc:3986",
                "http://hl7.org/fhir/StructureDefinition/lipidprofile",
                Some("Lipid Lab Report"),
                None,
            ),
        ]
    }
...
impl super::super::bindings::ValueSetMembership<Code> for ConsentContentClass {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ConsentContentClass {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ConsentContentClass {
