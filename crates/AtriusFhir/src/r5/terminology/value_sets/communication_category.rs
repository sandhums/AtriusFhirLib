...
///FHIR ValueSet: CommunicationCategory
...
impl super::super::bindings::ValueSetMembership<Code> for CommunicationCategory {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for CommunicationCategory {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for CommunicationCategory {
