...
impl NameUse {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                "http://hl7.org/fhir/name-use",
                "maiden",
                Some("Name changed for Marriage"),
                Some(
            ...
            (
                ...
                "usual",
                Some("Usual"),
                Some("Known as/conventional/the one you normally use."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/name-use" => {
                super::super::code_systems::name_use::NameUse::try_from_code(code)
                    .is_ok()
            }
            _ => false,
        }
...
impl super::super::bindings::ValueSetMembership<Code> for NameUse {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for NameUse {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for NameUse {
