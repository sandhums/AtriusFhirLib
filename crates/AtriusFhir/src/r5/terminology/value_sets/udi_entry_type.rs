...
impl UDIEntryType {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ...
            ("http://hl7.org/fhir/udi-entry-type", "electronic-transmission"),
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "barcode",
                Some("Barcode"),
                Some("a barcodescanner captured the data from the device label."),
            ),
            (
                "http://hl7.org/fhir/udi-entry-type",
                "card",
            ...
            (
                ...
                "rfid",
                Some("RFID"),
                Some("An RFID chip reader captured the data from the device label."),
            ),
            (
                "http://hl7.org/fhir/udi-entry-type",
                "self-reported",
            ...
            (
                ...
                "unknown",
                Some("Unknown"),
                Some("The method of data capture has not been determined."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/udi-entry-type" => {
                super::super::code_systems::udi_entry_type::UDIEntryType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for UDIEntryType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for UDIEntryType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for UDIEntryType {
