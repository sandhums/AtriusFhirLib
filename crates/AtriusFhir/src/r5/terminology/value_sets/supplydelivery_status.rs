...
///FHIR ValueSet: SupplyDeliveryStatus
...
impl SupplyDeliveryStatus {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "abandoned",
                Some("Abandoned"),
                Some("Delivery was not completed."),
            ),
            (
                "http://hl7.org/fhir/supplydelivery-status",
                "completed",
                Some("Delivered"),
                Some("Supply has been delivered (\"completed\")."),
            ),
            (
                "http://hl7.org/fhir/supplydelivery-status",
                "entered-in-error",
            ...
            (
                ...
                "in-progress",
                Some("In Progress"),
                Some("Supply has been requested, but not delivered."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/supplydelivery-status" => {
                super::super::code_systems::supplydelivery_status::SupplyDeliveryStatus::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for SupplyDeliveryStatus {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for SupplyDeliveryStatus {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for SupplyDeliveryStatus {
