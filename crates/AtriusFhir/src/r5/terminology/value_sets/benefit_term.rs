...
///FHIR ValueSet: BenefitTermCodes
...
impl super::super::bindings::ValueSetMembership<Code> for BenefitTermCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for BenefitTermCodes {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for BenefitTermCodes {
