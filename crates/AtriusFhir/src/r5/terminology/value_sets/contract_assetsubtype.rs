...
///FHIR ValueSet: ContractResourceAssetSubTypeCodes
...
impl ContractResourceAssetSubTypeCodes {
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/contract-asset-subtype" => {
                super::super::code_systems::contract_assetsubtype::ContractAssetSubtype::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
for ContractResourceAssetSubTypeCodes {
