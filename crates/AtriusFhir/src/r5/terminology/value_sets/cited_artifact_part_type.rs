...
///FHIR ValueSet: CitedArtifactPartType
...
impl CitedArtifactPartType {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/cited-artifact-part-type", "pages"),
            ("http://hl7.org/fhir/cited-artifact-part-type", "sections"),
            ("http://hl7.org/fhir/cited-artifact-part-type", "paragraphs"),
            ("http://hl7.org/fhir/cited-artifact-part-type", "lines"),
            ("http://hl7.org/fhir/cited-artifact-part-type", "tables"),
            ("http://hl7.org/fhir/cited-artifact-part-type", "figures"),
            ("http://hl7.org/fhir/cited-artifact-part-type", "supplement"),
            ("http://hl7.org/fhir/cited-artifact-part-type", "supplement-subpart"),
            ("http://hl7.org/fhir/cited-artifact-part-type", "article-set"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                ...
                "figures",
                Some("figures"),
                Some("Denotes specific figure or figures of an article or artifact."),
            ),
            (
                "http://hl7.org/fhir/cited-artifact-part-type",
                "lines",
                Some("lines"),
                Some("Denotes specific line or lines of an article or artifact."),
            ),
            (
                "http://hl7.org/fhir/cited-artifact-part-type",
                "pages",
                Some("pages"),
                Some("Denotes specific page or pages of an article or artifact."),
            ),
            (
                "http://hl7.org/fhir/cited-artifact-part-type",
                "paragraphs",
            ...
            (
                "http://hl7.org/fhir/cited-artifact-part-type",
                "supplement-subpart",
                Some("Supplement or Appendix Subpart"),
            ...
            (
                ...
                "tables",
                Some("tables"),
                Some("Denotes specific table or tables of an article or artifact."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/cited-artifact-part-type" => {
                super::super::code_systems::cited_artifact_part_type::CitedArtifactPartType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for CitedArtifactPartType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for CitedArtifactPartType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for CitedArtifactPartType {
