...
///FHIR ValueSet: CoverageClassCodes
...
impl super::super::bindings::ValueSetMembership<Code> for CoverageClassCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for CoverageClassCodes {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for CoverageClassCodes {
