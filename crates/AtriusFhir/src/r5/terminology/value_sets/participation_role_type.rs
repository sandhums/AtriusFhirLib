...
///FHIR ValueSet: ParticipationRoleType
///Canonical URL: http://hl7.org/fhir/ValueSet/participation-role-type
///Version: 5.0.0
///Title: Participation Role Type
///Status: draft
...
impl super::super::bindings::ValueSetMembership<Code> for ParticipationRoleType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ParticipationRoleType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ParticipationRoleType {
