...
impl CitedMedium {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/cited-medium", "internet"),
            ("http://hl7.org/fhir/cited-medium", "print"),
            ("http://hl7.org/fhir/cited-medium", "offline-digital-storage"),
            ("http://hl7.org/fhir/cited-medium", "internet-without-issue"),
            ("http://hl7.org/fhir/cited-medium", "print-without-issue"),
            ("http://hl7.org/fhir/cited-medium", "offline-digital-storage-without-issue"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                "http://hl7.org/fhir/cited-medium",
                "print-without-issue",
                Some("Print without issue"),
                Some("Print publication without any periodic release."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/cited-medium" => {
                super::super::code_systems::cited_medium::CitedMedium::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for CitedMedium {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for CitedMedium {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for CitedMedium {
