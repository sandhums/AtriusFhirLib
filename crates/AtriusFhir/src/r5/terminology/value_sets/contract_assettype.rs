...
///FHIR ValueSet: ContractResourceAssetTypeCodes
...
impl ContractResourceAssetTypeCodes {
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/contract-asset-type" => {
                super::super::code_systems::contract_assettype::ContractAssetType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
for ContractResourceAssetTypeCodes {
