...
///FHIR ValueSet: SNOMEDCTMedicationCodes
...
impl super::super::bindings::ValueSetMembership<Code> for SNOMEDCTMedicationCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for SNOMEDCTMedicationCodes {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for SNOMEDCTMedicationCodes {
