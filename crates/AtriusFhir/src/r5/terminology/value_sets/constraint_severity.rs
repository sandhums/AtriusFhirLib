...
///FHIR ValueSet: ConstraintSeverity
...
impl ConstraintSeverity {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "error",
                Some("Error"),
                Some("If the constraint is violated, the resource is not conformant."),
            ),
            (
                "http://hl7.org/fhir/constraint-severity",
                "warning",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/constraint-severity" => {
                super::super::code_systems::constraint_severity::ConstraintSeverity::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ConstraintSeverity {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ConstraintSeverity {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for ConstraintSeverity {
