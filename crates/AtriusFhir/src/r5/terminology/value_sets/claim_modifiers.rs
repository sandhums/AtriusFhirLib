...
///FHIR ValueSet: ModifierTypeCodes
...
impl super::super::bindings::ValueSetMembership<Code> for ModifierTypeCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ModifierTypeCodes {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for ModifierTypeCodes {
