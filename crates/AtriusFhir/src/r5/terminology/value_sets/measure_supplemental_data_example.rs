...
///FHIR ValueSet: MeasureSupplementalDataExample
...
impl MeasureSupplementalDataExample {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/measure-supplemental-data-example", "age"),
            ("http://hl7.org/fhir/measure-supplemental-data-example", "gender"),
            ("http://hl7.org/fhir/measure-supplemental-data-example", "ethnicity"),
            ("http://hl7.org/fhir/measure-supplemental-data-example", "payer"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "age",
                Some("Age"),
                Some("Age Supplemental Data."),
            ),
            (
                "http://hl7.org/fhir/measure-supplemental-data-example",
                "ethnicity",
                Some("Ethnicity"),
                Some("Ethnicity Supplemental Data ."),
            ),
            (
                "http://hl7.org/fhir/measure-supplemental-data-example",
                "gender",
                Some("Gender"),
                Some("Gender Supplemental Data ."),
            ),
            (
                "http://hl7.org/fhir/measure-supplemental-data-example",
                "payer",
                Some("Payer"),
                Some("Payer Supplemental Data."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/measure-supplemental-data-example" => {
                super::super::code_systems::measure_supplemental_data_example::MeasureSupplementalDataExample::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
for MeasureSupplementalDataExample {
