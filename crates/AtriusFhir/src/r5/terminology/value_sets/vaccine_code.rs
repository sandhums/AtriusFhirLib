...
///FHIR ValueSet: VaccineAdministeredValueSet
...
impl VaccineAdministeredValueSet {
    ...
    pub fn include_systems() -> &'static [&'static str] {
        &["http://hl7.org/fhir/sid/cvx", "urn:oid:1.2.36.1.2001.1005.17"]
    }
...
impl super::super::bindings::ValueSetMembership<Code> for VaccineAdministeredValueSet {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for VaccineAdministeredValueSet {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for VaccineAdministeredValueSet {
