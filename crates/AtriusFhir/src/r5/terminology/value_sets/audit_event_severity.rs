...
///FHIR ValueSet: AuditEventSeverity
...
impl AuditEventSeverity {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/audit-event-severity", "emergency"),
            ("http://hl7.org/fhir/audit-event-severity", "alert"),
            ("http://hl7.org/fhir/audit-event-severity", "critical"),
            ("http://hl7.org/fhir/audit-event-severity", "error"),
            ("http://hl7.org/fhir/audit-event-severity", "warning"),
            ("http://hl7.org/fhir/audit-event-severity", "notice"),
            ("http://hl7.org/fhir/audit-event-severity", "informational"),
            ("http://hl7.org/fhir/audit-event-severity", "debug"),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/audit-event-severity" => {
                super::super::code_systems::audit_event_severity::AuditEventSeverity::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for AuditEventSeverity {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for AuditEventSeverity {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for AuditEventSeverity {
