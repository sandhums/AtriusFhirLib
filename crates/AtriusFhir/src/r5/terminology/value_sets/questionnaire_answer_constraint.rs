...
///FHIR ValueSet: QuestionnaireAnswerConstraint
...
impl QuestionnaireAnswerConstraint {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/questionnaire-answer-constraint", "optionsOnly"),
            ("http://hl7.org/fhir/questionnaire-answer-constraint", "optionsOrType"),
            ("http://hl7.org/fhir/questionnaire-answer-constraint", "optionsOrString"),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/questionnaire-answer-constraint" => {
                super::super::code_systems::questionnaire_answer_constraint::QuestionnaireAnswerConstraint::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for QuestionnaireAnswerConstraint {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding>
for QuestionnaireAnswerConstraint {
