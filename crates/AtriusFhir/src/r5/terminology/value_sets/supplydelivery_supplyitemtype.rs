...
///FHIR ValueSet: SupplyDeliverySupplyItemType
...
impl SupplyDeliverySupplyItemType {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                "http://hl7.org/fhir/supplydelivery-supplyitemtype",
                "biologicallyderivedproduct",
                Some("Biologically Derived Product"),
            ...
            (
                ...
                "device",
                Some("Device"),
                Some("What is supplied (or requested) is a device."),
            ),
            (
                "http://hl7.org/fhir/supplydelivery-supplyitemtype",
                "medication",
                Some("Medication"),
                Some("Supply is a kind of medication."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/supplydelivery-supplyitemtype" => {
                super::super::code_systems::supplydelivery_supplyitemtype::SupplyDeliverySupplyItemType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for SupplyDeliverySupplyItemType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding>
for SupplyDeliverySupplyItemType {
