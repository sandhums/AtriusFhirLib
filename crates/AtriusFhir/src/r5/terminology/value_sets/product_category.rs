...
///FHIR ValueSet: BiologicallyDerivedProductCategory
...
impl BiologicallyDerivedProductCategory {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                "http://hl7.org/fhir/product-category",
                "biologicalAgent",
                Some("BiologicalAgent"),
                Some("Biological agent of unspecified type."),
            ),
            (
                "http://hl7.org/fhir/product-category",
                "cells",
                Some("Cells"),
                Some("Collection of cells."),
            ),
            (
                "http://hl7.org/fhir/product-category",
                "fluid",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/product-category" => {
                super::super::code_systems::product_category::BiologicallyDerivedProductCategory::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
for BiologicallyDerivedProductCategory {
