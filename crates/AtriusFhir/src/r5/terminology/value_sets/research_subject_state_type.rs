...
///FHIR ValueSet: ResearchSubjectStateType
///Canonical URL: http://hl7.org/fhir/ValueSet/research-subject-state-type
///Version: 5.0.0
///Title: Research Subject State Type
///Status: draft
...
impl super::super::bindings::ValueSetMembership<Code> for ResearchSubjectStateType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ResearchSubjectStateType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ResearchSubjectStateType {
