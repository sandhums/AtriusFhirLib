...
///FHIR ValueSet: ConditionPreconditionType
...
impl ConditionPreconditionType {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/condition-precondition-type", "sensitive"),
            ("http://hl7.org/fhir/condition-precondition-type", "specific"),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/condition-precondition-type" => {
                super::super::code_systems::condition_precondition_type::ConditionPreconditionType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ConditionPreconditionType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ConditionPreconditionType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ConditionPreconditionType {
