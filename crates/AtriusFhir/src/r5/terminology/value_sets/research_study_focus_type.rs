...
///FHIR ValueSet: ResearchStudyFocusType
///Canonical URL: http://hl7.org/fhir/ValueSet/research-study-focus-type
///Version: 5.0.0
///Title: Research Study Focus Type
///Status: draft
...
impl ResearchStudyFocusType {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/research-study-focus-type", "medication"),
            ("http://hl7.org/fhir/research-study-focus-type", "device"),
            ("http://hl7.org/fhir/research-study-focus-type", "intervention"),
            ("http://hl7.org/fhir/research-study-focus-type", "factor"),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/research-study-focus-type" => {
                super::super::code_systems::research_study_focus_type::ResearchStudyFocusType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ResearchStudyFocusType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ResearchStudyFocusType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ResearchStudyFocusType {
