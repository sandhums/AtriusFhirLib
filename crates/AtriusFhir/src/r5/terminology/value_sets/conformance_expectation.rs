...
///FHIR ValueSet: ConformanceExpectation
...
impl ConformanceExpectation {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/conformance-expectation", "SHALL"),
            ("http://hl7.org/fhir/conformance-expectation", "SHOULD"),
            ("http://hl7.org/fhir/conformance-expectation", "MAY"),
            ("http://hl7.org/fhir/conformance-expectation", "SHOULD-NOT"),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/conformance-expectation" => {
                super::super::code_systems::conformance_expectation::ConformanceExpectation::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ConformanceExpectation {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ConformanceExpectation {
