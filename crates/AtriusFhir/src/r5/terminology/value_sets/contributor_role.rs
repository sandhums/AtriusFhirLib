...
impl ContributorRole {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/contributor-role", "publisher"),
            ("http://hl7.org/fhir/contributor-role", "author"),
            ("http://hl7.org/fhir/contributor-role", "reviewer"),
            ("http://hl7.org/fhir/contributor-role", "endorser"),
            ("http://hl7.org/fhir/contributor-role", "editor"),
            ("http://hl7.org/fhir/contributor-role", "informant"),
            ("http://hl7.org/fhir/contributor-role", "funder"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                ...
                "editor",
                Some("Editor"),
                Some("Entity that revises or has authority to control the content"),
            ),
            (
                "http://hl7.org/fhir/contributor-role",
                "endorser",
                Some("Endorser"),
                Some("Entity that supports, approves, or advocates for the content"),
            ),
            (
                "http://hl7.org/fhir/contributor-role",
                "funder",
                Some("Funder"),
                Some("Entity that supplies financial support"),
            ),
            (
                "http://hl7.org/fhir/contributor-role",
                "informant",
                Some("Informant"),
                Some("Entity that supplies information"),
            ),
            (
                "http://hl7.org/fhir/contributor-role",
                "publisher",
                Some("Publisher"),
                Some("Entity that makes the content available for public use"),
            ),
            (
                "http://hl7.org/fhir/contributor-role",
                "reviewer",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/contributor-role" => {
                super::super::code_systems::contributor_role::ContributorRole::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ContributorRole {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ContributorRole {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for ContributorRole {
