...
///FHIR ValueSet: CharacteristicCombination
...
impl CharacteristicCombination {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/characteristic-combination", "all-of"),
            ("http://hl7.org/fhir/characteristic-combination", "any-of"),
            ("http://hl7.org/fhir/characteristic-combination", "at-least"),
            ("http://hl7.org/fhir/characteristic-combination", "at-most"),
            ("http://hl7.org/fhir/characteristic-combination", "statistical"),
            ("http://hl7.org/fhir/characteristic-combination", "net-effect"),
            ("http://hl7.org/fhir/characteristic-combination", "dataset"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "all-of",
                Some("All of"),
                Some("Combine characteristics with AND."),
            ),
            (
                "http://hl7.org/fhir/characteristic-combination",
                "any-of",
                Some("Any of"),
                Some("Combine characteristics with OR."),
            ),
            (
                "http://hl7.org/fhir/characteristic-combination",
                "at-least",
            ...
            (
                ...
                "dataset",
                Some("Dataset"),
                Some("Combine characteristics as a collection used as the dataset."),
            ),
            (
                "http://hl7.org/fhir/characteristic-combination",
                "net-effect",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/characteristic-combination" => {
                super::super::code_systems::characteristic_combination::CharacteristicCombination::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for CharacteristicCombination {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for CharacteristicCombination {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for CharacteristicCombination {
