...
///FHIR ValueSet: MaritalStatusCodes
...
impl MaritalStatusCodes {
    ...
    fn include_entries() -> &'static [(
        ...
        &[("http://terminology.hl7.org/CodeSystem/v3-NullFlavor", "UNK", None, None)]
    }
...
impl super::super::bindings::ValueSetMembership<Code> for MaritalStatusCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for MaritalStatusCodes {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for MaritalStatusCodes {
