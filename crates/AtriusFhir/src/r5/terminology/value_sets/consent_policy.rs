...
///FHIR ValueSet: ConsentPolicyRuleCodes
...
impl super::super::bindings::ValueSetMembership<Code> for ConsentPolicyRuleCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ConsentPolicyRuleCodes {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ConsentPolicyRuleCodes {
