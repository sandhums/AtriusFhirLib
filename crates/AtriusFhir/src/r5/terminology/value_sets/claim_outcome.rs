...
///FHIR ValueSet: ClaimProcessingCodes
...
impl ClaimProcessingCodes {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/claim-outcome", "queued"),
            ("http://hl7.org/fhir/claim-outcome", "complete"),
            ("http://hl7.org/fhir/claim-outcome", "error"),
            ("http://hl7.org/fhir/claim-outcome", "partial"),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/claim-outcome" => {
                super::super::code_systems::claim_outcome::ClaimProcessingOutcomeCodes::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ClaimProcessingCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ClaimProcessingCodes {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ClaimProcessingCodes {
