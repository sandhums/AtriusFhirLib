...
impl PaymentKind {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/payment-kind", "deposit"),
            ("http://hl7.org/fhir/payment-kind", "periodic-payment"),
            ("http://hl7.org/fhir/payment-kind", "online"),
            ("http://hl7.org/fhir/payment-kind", "kiosk"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                ...
                "kiosk",
                Some("Kiosk Payment"),
                Some("Payment made at an authorized Kiosk."),
            ),
            (
                "http://hl7.org/fhir/payment-kind",
                "online",
                Some("Online Bill Payment"),
                Some(
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/payment-kind" => {
                super::super::code_systems::payment_kind::PaymentKindCodes::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for PaymentKind {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for PaymentKind {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for PaymentKind {
