...
///FHIR ValueSet: BodystructureBodyLandmarkClockFacePosition
...
impl BodystructureBodyLandmarkClockFacePosition {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://snomed.info/sct", "260318004"),
            ("http://snomed.info/sct", "260328008"),
            ("http://snomed.info/sct", "260330005"),
            ("http://snomed.info/sct", "260333007"),
            ("http://snomed.info/sct", "260335000"),
            ("http://snomed.info/sct", "260337008"),
            ("http://snomed.info/sct", "260339006"),
            ("http://snomed.info/sct", "260341007"),
            ("http://snomed.info/sct", "260343005"),
            ("http://snomed.info/sct", "260322009"),
            ("http://snomed.info/sct", "260324005"),
            ("http://snomed.info/sct", "260326007"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            ("http://snomed.info/sct", "260318004", Some("1 o'clock position"), None),
            ("http://snomed.info/sct", "260322009", Some("10 o'clock position"), None),
            ("http://snomed.info/sct", "260324005", Some("11 o'clock position"), None),
            ("http://snomed.info/sct", "260326007", Some("12 o'clock position"), None),
            ("http://snomed.info/sct", "260328008", Some("2 o'clock position"), None),
            ("http://snomed.info/sct", "260330005", Some("3 o'clock position"), None),
            ("http://snomed.info/sct", "260333007", Some("4 o'clock position"), None),
            ("http://snomed.info/sct", "260335000", Some("5 o'clock position"), None),
            ("http://snomed.info/sct", "260337008", Some("6 o'clock position"), None),
            ("http://snomed.info/sct", "260339006", Some("7 o'clock position"), None),
            ("http://snomed.info/sct", "260341007", Some("8 o'clock position"), None),
            ("http://snomed.info/sct", "260343005", Some("9 o'clock position"), None),
        ]
    }
...
for BodystructureBodyLandmarkClockFacePosition {
