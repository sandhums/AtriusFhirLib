...
///FHIR ValueSet: ImmunizationRecommendationDateCriterionCodes
...
impl ImmunizationRecommendationDateCriterionCodes {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ("http://loinc.org", "30980-7", None, None),
            ("http://loinc.org", "30981-5", None, None),
            ("http://loinc.org", "59777-3", None, None),
            ("http://loinc.org", "59778-1", None, None),
        ]
    }
...
for ImmunizationRecommendationDateCriterionCodes {
