...
///FHIR ValueSet: ActionConditionKind
...
impl ActionConditionKind {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                ...
                "start",
                Some("Start"),
                Some("The condition is a starting condition for the action."),
            ),
            (
                "http://hl7.org/fhir/action-condition-kind",
                "stop",
                Some("Stop"),
                Some("The condition is a stop, or exit condition for the action."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/action-condition-kind" => {
                super::super::code_systems::action_condition_kind::ActionConditionKind::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ActionConditionKind {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ActionConditionKind {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ActionConditionKind {
