...
///FHIR ValueSet: ConditionalDeleteStatus
...
impl ConditionalDeleteStatus {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                ...
                "not-supported",
                Some("Not Supported"),
                Some("No support for conditional deletes."),
            ),
            (
                "http://hl7.org/fhir/conditional-delete-status",
                "single",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/conditional-delete-status" => {
                super::super::code_systems::conditional_delete_status::ConditionalDeleteStatus::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ConditionalDeleteStatus {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ConditionalDeleteStatus {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ConditionalDeleteStatus {
