...
///FHIR ValueSet: ServiceRequestCategoryCodes
...
impl ServiceRequestCategoryCodes {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ("http://snomed.info/sct", "108252007", Some("Laboratory procedure"), None),
            ("http://snomed.info/sct", "363679005", Some("Imaging"), None),
            ("http://snomed.info/sct", "387713003", Some("Surgical procedure"), None),
            ("http://snomed.info/sct", "409063005", Some("Counselling"), None),
            ("http://snomed.info/sct", "409073007", Some("Education"), None),
        ]
    }
...
impl super::super::bindings::ValueSetMembership<Code> for ServiceRequestCategoryCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ServiceRequestCategoryCodes {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ServiceRequestCategoryCodes {
