...
impl InvoiceStatus {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "balanced",
                Some("balanced"),
                Some("the invoice has been balaced / completely paid."),
            ),
            (
                "http://hl7.org/fhir/invoice-status",
                "cancelled",
                Some("cancelled"),
                Some("the invoice was cancelled."),
            ),
            (
                "http://hl7.org/fhir/invoice-status",
                "draft",
                Some("draft"),
                Some("the invoice has been prepared but not yet finalized."),
            ),
            (
                "http://hl7.org/fhir/invoice-status",
                "entered-in-error",
            ...
            (
                ...
                "issued",
                Some("issued"),
                Some("the invoice has been finalized and sent to the recipient."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/invoice-status" => {
                super::super::code_systems::invoice_status::InvoiceStatus::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for InvoiceStatus {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for InvoiceStatus {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for InvoiceStatus {
