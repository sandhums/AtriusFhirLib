...
impl SubstanceGrade {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                "http://hl7.org/fhir/substance-grade",
                "BP",
                Some("British Pharmacopoeia"),
                None,
            ),
            (
                "http://hl7.org/fhir/substance-grade",
                "CompanyStandard",
                Some("Company Standard"),
                None,
            ),
            (
                "http://hl7.org/fhir/substance-grade",
                "JP",
                Some("Japanese Pharmacopoeia"),
                None,
            ),
            (
                "http://hl7.org/fhir/substance-grade",
                "Ph.Eur",
                Some("European Pharmacopoeia"),
                None,
            ),
            (
                "http://hl7.org/fhir/substance-grade",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/substance-grade" => {
                super::super::code_systems::substance_grade::SubstanceGrade::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for SubstanceGrade {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for SubstanceGrade {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for SubstanceGrade {
