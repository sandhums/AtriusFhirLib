...
impl TransportCode {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/CodeSystem/transport-code", "approve"),
            ("http://hl7.org/fhir/CodeSystem/transport-code", "fulfill"),
            ("http://hl7.org/fhir/CodeSystem/transport-code", "instantiate"),
            ("http://hl7.org/fhir/CodeSystem/transport-code", "abort"),
            ("http://hl7.org/fhir/CodeSystem/transport-code", "replace"),
            ("http://hl7.org/fhir/CodeSystem/transport-code", "change"),
            ("http://hl7.org/fhir/CodeSystem/transport-code", "suspend"),
            ("http://hl7.org/fhir/CodeSystem/transport-code", "resume"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                "http://hl7.org/fhir/CodeSystem/transport-code",
                "abort",
                Some("Mark the focal resource as no longer active"),
                Some(
            ...
            (
                "http://hl7.org/fhir/CodeSystem/transport-code",
                "approve",
                Some("Activate/approve the focal resource"),
                Some(
            ...
            (
                "http://hl7.org/fhir/CodeSystem/transport-code",
                "change",
                Some("Change the focal resource"),
                Some(
            ...
            (
                "http://hl7.org/fhir/CodeSystem/transport-code",
                "fulfill",
                Some("Fulfill the focal request"),
                Some(
            ...
            (
                "http://hl7.org/fhir/CodeSystem/transport-code",
                "instantiate",
                Some("Instantiate the focal definition"),
                Some(
            ...
            (
                "http://hl7.org/fhir/CodeSystem/transport-code",
                "replace",
                Some("Replace the focal resource with the input resource"),
                Some("Replace the focal resource with the specified input resource"),
            ),
            (
                "http://hl7.org/fhir/CodeSystem/transport-code",
                "resume",
                Some("Re-activate the focal resource"),
                Some(
            ...
            (
                "http://hl7.org/fhir/CodeSystem/transport-code",
                "suspend",
                Some("Suspend the focal resource"),
                Some(
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/CodeSystem/transport-code" => {
                super::super::code_systems::transport_code::TransportCode::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for TransportCode {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for TransportCode {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for TransportCode {
