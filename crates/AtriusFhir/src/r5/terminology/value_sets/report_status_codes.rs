...
///FHIR ValueSet: TestReportStatus
...
impl TestReportStatus {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "completed",
                Some("Completed"),
                Some("All test operations have completed."),
            ),
            (
                "http://hl7.org/fhir/report-status-codes",
                "entered-in-error",
                Some("Entered In Error"),
                Some("This test report was entered or created in error."),
            ),
            (
                "http://hl7.org/fhir/report-status-codes",
                "in-progress",
                Some("In Progress"),
                Some("A test operations is currently executing."),
            ),
            (
                "http://hl7.org/fhir/report-status-codes",
                "stopped",
                Some("Stopped"),
                Some("The test script execution was manually stopped."),
            ),
            (
                "http://hl7.org/fhir/report-status-codes",
                "waiting",
                Some("Waiting"),
                Some("A test operation is waiting for an external client request."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/report-status-codes" => {
                super::super::code_systems::report_status_codes::TestReportStatus::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for TestReportStatus {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for TestReportStatus {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for TestReportStatus {
