...
///FHIR ValueSet: AuditEventSourceType
...
impl super::super::bindings::ValueSetMembership<Code> for AuditEventSourceType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for AuditEventSourceType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for AuditEventSourceType {
