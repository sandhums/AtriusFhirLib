...
///FHIR ValueSet: JurisdictionValueSet
...
impl JurisdictionValueSet {
    ...
    pub fn include_whole_systems() -> &'static [&'static str] {
        &["urn:iso:std:iso:3166", "urn:iso:std:iso:3166:-2"]
    }
...
impl super::super::bindings::ValueSetMembership<Code> for JurisdictionValueSet {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for JurisdictionValueSet {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for JurisdictionValueSet {
