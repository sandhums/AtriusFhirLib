...
///Canonical URL: http://hl7.org/fhir/ValueSet/deviceassociation-status
///Version: 5.0.0
...
impl DeviceAssociationCodes {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/deviceassociation-status", "implanted"),
            ("http://hl7.org/fhir/deviceassociation-status", "explanted"),
            ("http://hl7.org/fhir/deviceassociation-status", "entered-in-error"),
            ("http://hl7.org/fhir/deviceassociation-status", "attached"),
            ("http://hl7.org/fhir/deviceassociation-status", "unknown"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                ...
                "implanted",
                Some("Implanted"),
                Some("The device is implanted in the patient."),
            ),
            (
                "http://hl7.org/fhir/deviceassociation-status",
                "unknown",
                Some("Unknown"),
                Some("The association status of the device has not been determined."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/deviceassociation-status" => {
                super::super::code_systems::deviceassociation_status::DeviceAssociation::try_from_code(
                        code,
                    )
                    .is_ok()
            }
