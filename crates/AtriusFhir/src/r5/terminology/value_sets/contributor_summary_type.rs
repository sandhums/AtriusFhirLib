...
///FHIR ValueSet: ContributorSummaryType
...
impl ContributorSummaryType {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/contributor-summary-type", "author-string"),
            ("http://hl7.org/fhir/contributor-summary-type", "contributorship-list"),
            (
                "http://hl7.org/fhir/contributor-summary-type",
                "contributorship-statement",
            ),
            ("http://hl7.org/fhir/contributor-summary-type", "acknowledgement-list"),
            ("http://hl7.org/fhir/contributor-summary-type", "acknowledgment-statement"),
            ("http://hl7.org/fhir/contributor-summary-type", "funding-statement"),
            (
                "http://hl7.org/fhir/contributor-summary-type",
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                ...
                "author-string",
                Some("Author string"),
                Some("Display of the author list as a complete string."),
            ),
            (
                "http://hl7.org/fhir/contributor-summary-type",
                "competing-interests-statement",
                Some("Competing interests statement"),
                Some(
            ...
            (
                ...
                Some("Contributorship list"),
                Some("Display of the list of contributors as a complete string."),
            ),
            (
                "http://hl7.org/fhir/contributor-summary-type",
                "contributorship-statement",
                Some("Contributorship statement"),
                Some("Compiled summary of contributions."),
            ),
            (
                "http://hl7.org/fhir/contributor-summary-type",
                "funding-statement",
                Some("Funding statement"),
                Some(
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/contributor-summary-type" => {
                super::super::code_systems::contributor_summary_type::ContributorSummaryType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ContributorSummaryType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ContributorSummaryType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ContributorSummaryType {
