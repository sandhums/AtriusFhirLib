...
///FHIR ValueSet: EpisodeOfCareStatus
...
impl EpisodeOfCareStatus {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "active",
                Some("Active"),
                Some("This episode of care is current."),
            ),
            (
                "http://hl7.org/fhir/episode-of-care-status",
                "cancelled",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/episode-of-care-status" => {
                super::super::code_systems::episode_of_care_status::EpisodeOfCareStatus::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for EpisodeOfCareStatus {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for EpisodeOfCareStatus {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for EpisodeOfCareStatus {
