...
///FHIR ValueSet: ContractResourcePartyRoleCodes
...
impl ContractResourcePartyRoleCodes {
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/contract-party-role" => {
                super::super::code_systems::contract_party_role::ContractPartyRole::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
for ContractResourcePartyRoleCodes {
