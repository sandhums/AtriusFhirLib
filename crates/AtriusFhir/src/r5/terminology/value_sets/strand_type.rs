...
impl StrandType {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                "http://hl7.org/fhir/strand-type",
                "crick",
                Some("Crick strand of starting sequence"),
                Some("Crick strand of starting sequence."),
            ),
            (
                "http://hl7.org/fhir/strand-type",
                "watson",
                Some("Watson strand of starting sequence"),
                Some("Watson strand of starting sequence."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/strand-type" => {
                super::super::code_systems::strand_type::StrandType::try_from_code(code)
                    .is_ok()
            }
            _ => false,
        }
...
impl super::super::bindings::ValueSetMembership<Code> for StrandType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for StrandType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for StrandType {
