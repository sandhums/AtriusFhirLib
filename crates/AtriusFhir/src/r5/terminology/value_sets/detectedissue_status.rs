...
///FHIR ValueSet: DetectedIssueStatus
...
impl DetectedIssueStatus {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ...
            ("http://hl7.org/fhir/detectedissue-status", "mitigated"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            ("http://hl7.org/fhir/observation-status", "final", Some("Final"), None),
            (
                "http://hl7.org/fhir/observation-status",
                "preliminary",
                Some("Preliminary"),
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/detectedissue-status" => {
                super::super::code_systems::detectedissue_status::DetectedIssueStatus::try_from_code(
                        code,
                    )
                    .is_ok()
            }
            "http://hl7.org/fhir/observation-status" => {
                super::super::code_systems::observation_status::ObservationStatus::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for DetectedIssueStatus {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for DetectedIssueStatus {
