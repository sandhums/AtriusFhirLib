...
///FHIR ValueSet: ProcedureNotPerformedReasonSNOMEDCT
...
impl ProcedureNotPerformedReasonSNOMEDCT {
    ...
    pub fn filter_rules() -> &'static [(&'static str, &'static str, &'static str)] {
        &[
            ("concept", "is-a", "183932001"),
            ("concept", "is-a", "183944003"),
            ("concept", "is-a", "394908001"),
            ("concept", "is-a", "416064006"),
            ("concept", "is-a", "416237000"),
            ("concept", "is-a", "416406003"),
            ("concept", "is-a", "416432009"),
            ("concept", "is-a", "428119001"),
        ]
    }
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[("http://snomed.info/sct", "410536001")]
    }
    fn include_entries() -> &'static [(
        ...
        &[("http://snomed.info/sct", "410536001", None, None)]
    }
...
for ProcedureNotPerformedReasonSNOMEDCT {
