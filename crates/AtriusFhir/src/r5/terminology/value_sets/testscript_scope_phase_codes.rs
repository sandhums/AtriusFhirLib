...
///FHIR ValueSet: TestScriptScopePhaseType
...
impl TestScriptScopePhaseType {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/testscript-scope-phase-codes", "unit"),
            ("http://hl7.org/fhir/testscript-scope-phase-codes", "integration"),
            ("http://hl7.org/fhir/testscript-scope-phase-codes", "production"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "integration",
                Some("Integration"),
                Some("The internal system to system phase."),
            ),
            (
                "http://hl7.org/fhir/testscript-scope-phase-codes",
                "production",
            ...
            (
                ...
                "unit",
                Some("Unit"),
                Some("The development or implementation phase."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/testscript-scope-phase-codes" => {
                super::super::code_systems::testscript_scope_phase_codes::TestScriptScopePhaseType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for TestScriptScopePhaseType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for TestScriptScopePhaseType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for TestScriptScopePhaseType {
