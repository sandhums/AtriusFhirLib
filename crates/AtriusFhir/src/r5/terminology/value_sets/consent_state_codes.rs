...
impl ConsentState {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ...
            ("http://hl7.org/fhir/consent-state-codes", "not-done"),
            ("http://hl7.org/fhir/consent-state-codes", "entered-in-error"),
            ("http://hl7.org/fhir/consent-state-codes", "unknown"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "active",
                Some("Active"),
                Some("The consent is to be followed and enforced."),
            ),
            (
                "http://hl7.org/fhir/consent-state-codes",
                "draft",
            ...
            (
                ...
                "inactive",
                Some("Inactive"),
                Some("The consent is terminated or replaced."),
            ),
            (
                "http://hl7.org/fhir/consent-state-codes",
                "not-done",
            ...
            (
                ...
                "unknown",
                Some("Unknown"),
                Some("The resource is in an indeterminate state."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/consent-state-codes" => {
                super::super::code_systems::consent_state_codes::ConsentState::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ConsentState {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ConsentState {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for ConsentState {
