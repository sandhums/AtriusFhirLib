...
///FHIR ValueSet: ManifestationAndSymptomCodes
...
impl super::super::bindings::ValueSetMembership<Code> for ManifestationAndSymptomCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding>
for ManifestationAndSymptomCodes {
