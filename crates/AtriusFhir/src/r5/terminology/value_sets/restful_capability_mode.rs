...
///FHIR ValueSet: RestfulCapabilityMode
...
impl RestfulCapabilityMode {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "client",
                Some("Client"),
                Some("The application acts as a client for this resource."),
            ),
            (
                "http://hl7.org/fhir/restful-capability-mode",
                "server",
                Some("Server"),
                Some("The application acts as a server for this resource."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/restful-capability-mode" => {
                super::super::code_systems::restful_capability_mode::RestfulCapabilityMode::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for RestfulCapabilityMode {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for RestfulCapabilityMode {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for RestfulCapabilityMode {
