...
///FHIR ValueSet: ContractResourceAssetContextCodes
...
impl ContractResourceAssetContextCodes {
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/contract-asset-context" => {
                super::super::code_systems::contract_assetcontext::ContractAssetContext::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
for ContractResourceAssetContextCodes {
