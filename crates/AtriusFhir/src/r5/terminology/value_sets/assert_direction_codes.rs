...
///FHIR ValueSet: AssertionDirectionType
...
impl AssertionDirectionType {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "request",
                Some("request"),
                Some("The assertion is evaluated on the request."),
            ),
            (
                "http://hl7.org/fhir/assert-direction-codes",
                "response",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/assert-direction-codes" => {
                super::super::code_systems::assert_direction_codes::AssertionDirectionType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for AssertionDirectionType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for AssertionDirectionType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for AssertionDirectionType {
