...
///FHIR ValueSet: ImmunizationRouteCodes
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                "http://terminology.hl7.org/CodeSystem/v3-RouteOfAdministration",
                "IDINJ",
                Some("Injection, intradermal"),
                None,
            ),
            (
                "http://terminology.hl7.org/CodeSystem/v3-RouteOfAdministration",
                "IM",
                Some("Injection, intramuscular"),
                None,
            ),
            (
                "http://terminology.hl7.org/CodeSystem/v3-RouteOfAdministration",
                "IVINJ",
                Some("Injection, intravenous"),
                None,
            ),
            (
                "http://terminology.hl7.org/CodeSystem/v3-RouteOfAdministration",
...
impl super::super::bindings::ValueSetMembership<Code> for ImmunizationRouteCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ImmunizationRouteCodes {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ImmunizationRouteCodes {
