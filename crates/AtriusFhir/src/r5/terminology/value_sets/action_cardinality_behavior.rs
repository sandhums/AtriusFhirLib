...
///FHIR ValueSet: ActionCardinalityBehavior
...
impl ActionCardinalityBehavior {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "multiple",
                Some("Multiple"),
                Some("The action may be selected multiple times."),
            ),
            (
                "http://hl7.org/fhir/action-cardinality-behavior",
                "single",
                Some("Single"),
                Some("The action may only be selected one time."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/action-cardinality-behavior" => {
                super::super::code_systems::action_cardinality_behavior::ActionCardinalityBehavior::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ActionCardinalityBehavior {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ActionCardinalityBehavior {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ActionCardinalityBehavior {
