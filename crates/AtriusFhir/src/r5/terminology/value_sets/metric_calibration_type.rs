...
///FHIR ValueSet: DeviceMetricCalibrationType
...
impl DeviceMetricCalibrationType {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "gain",
                Some("Gain"),
                Some("Gain metric calibration method."),
            ),
            (
                "http://hl7.org/fhir/metric-calibration-type",
                "offset",
                Some("Offset"),
                Some("Offset metric calibration method."),
            ),
            (
                "http://hl7.org/fhir/metric-calibration-type",
                "two-point",
                Some("Two Point"),
                Some("Two-point metric calibration method."),
            ),
            (
                "http://hl7.org/fhir/metric-calibration-type",
                "unspecified",
                Some("Unspecified"),
                Some("Metric calibration method has not been identified."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/metric-calibration-type" => {
                super::super::code_systems::metric_calibration_type::DeviceMetricCalibrationType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for DeviceMetricCalibrationType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for DeviceMetricCalibrationType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for DeviceMetricCalibrationType {
