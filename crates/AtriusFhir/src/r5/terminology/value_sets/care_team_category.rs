...
///FHIR ValueSet: CareTeamCategory
...
impl CareTeamCategory {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://loinc.org", "LA27975-4"),
            ("http://loinc.org", "LA27976-2"),
            ("http://loinc.org", "LA27977-0"),
            ("http://loinc.org", "LA27978-8"),
            ("http://loinc.org", "LA28865-6"),
            ("http://loinc.org", "LA28866-4"),
            ("http://loinc.org", "LA27980-4"),
            ("http://loinc.org", "LA28867-2"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            ("http://loinc.org", "LA27975-4", Some("Event-focused care team"), None),
            ("http://loinc.org", "LA27976-2", Some("Encounter-focused care team"), None),
            (
                "http://loinc.org",
                "LA27977-0",
                Some("Episode of care-focused care team"),
                None,
            ),
            ("http://loinc.org", "LA27978-8", Some("Condition-focused care team"), None),
            (
                "http://loinc.org",
                "LA27980-4",
                Some("Clinical research-focused care team"),
                None,
            ),
            (
                "http://loinc.org",
                "LA28865-6",
                Some("Longitudinal care-coordination focused care team"),
                None,
            ),
            (
                "http://loinc.org",
                "LA28866-4",
                Some("Home & Community Based Services (HCBS)-focused care team"),
                None,
            ),
            (
                "http://loinc.org",
                "LA28867-2",
                Some("Public health-focused care team"),
                None,
            ),
        ]
    }
...
impl super::super::bindings::ValueSetMembership<Code> for CareTeamCategory {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for CareTeamCategory {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for CareTeamCategory {
