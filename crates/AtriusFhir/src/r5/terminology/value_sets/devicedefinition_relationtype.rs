...
///FHIR ValueSet: DeviceDefinitionRelationType
...
impl DeviceDefinitionRelationType {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/devicedefinition-relationtype", "gateway"),
            ("http://hl7.org/fhir/devicedefinition-relationtype", "replaces"),
            ("http://hl7.org/fhir/devicedefinition-relationtype", "previous"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                ...
                "replaces",
                Some("Replaces"),
                Some("The current device replaces the linked device."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/devicedefinition-relationtype" => {
                super::super::code_systems::devicedefinition_relationtype::DeviceDefinitionRelationType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for DeviceDefinitionRelationType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding>
for DeviceDefinitionRelationType {
