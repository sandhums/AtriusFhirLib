...
///FHIR ValueSet: InventoryItemStatusCodes
///Canonical URL: http://hl7.org/fhir/ValueSet/inventoryitem-nametype
///Version: 5.0.0
///Title: InventoryItem Name Typess
///Status: draft
...
impl InventoryItemStatusCodes {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/inventoryitem-nametype", "trade-name"),
            ("http://hl7.org/fhir/inventoryitem-nametype", "alias"),
            ("http://hl7.org/fhir/inventoryitem-nametype", "original-name"),
            ("http://hl7.org/fhir/inventoryitem-nametype", "preferred"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "alias",
                Some("Alias"),
                Some("An alias or common name for the item."),
            ),
            (
                "http://hl7.org/fhir/inventoryitem-nametype",
                "original-name",
                Some("Original Name"),
                Some("The original name of the item."),
            ),
            (
                "http://hl7.org/fhir/inventoryitem-nametype",
                "preferred",
                Some("Preferred"),
                Some("The preferred name of the item."),
            ),
            (
                "http://hl7.org/fhir/inventoryitem-nametype",
                "trade-name",
                Some("Trade Name"),
                Some("The official trade name of the item."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/inventoryitem-nametype" => {
                super::super::code_systems::inventoryitem_nametype::InventoryItemNameType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for InventoryItemStatusCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for InventoryItemStatusCodes {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for InventoryItemStatusCodes {
