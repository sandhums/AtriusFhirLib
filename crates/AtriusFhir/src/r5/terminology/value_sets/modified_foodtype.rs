...
///FHIR ValueSet: TextureModifiedFoodTypeCodes
...
impl TextureModifiedFoodTypeCodes {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ("http://snomed.info/sct", "102263004", Some("Eggs"), None),
            ("http://snomed.info/sct", "226529007", Some("Starchy food"), None),
            ("http://snomed.info/sct", "226760005", Some("Dairy foods"), None),
            ("http://snomed.info/sct", "226887002", Some("Dietary Fats and Oils"), None),
            (
                "http://snomed.info/sct",
                "227210005",
                Some("Vegetables plus herbs and spices"),
                None,
            ),
            ("http://snomed.info/sct", "227415002", Some("Fruit Nuts and Seeds"), None),
            (
                "http://snomed.info/sct",
                "227518002",
                Some("Sauce seasonings and soups"),
                None,
            ),
            ("http://snomed.info/sct", "22836000", Some("Vegetables"), None),
            ("http://snomed.info/sct", "255620007", Some("Foods"), None),
            ("http://snomed.info/sct", "264331002", Some("Grain"), None),
            ("http://snomed.info/sct", "28647000", Some("Meat"), None),
            ("http://snomed.info/sct", "44027008", Some("Seafood"), None),
            ("http://snomed.info/sct", "72511004", Some("Fruit"), None),
            ("http://snomed.info/sct", "74242007", Some("Food Starch"), None),
        ]
    }
...
impl super::super::bindings::ValueSetMembership<Code> for TextureModifiedFoodTypeCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding>
for TextureModifiedFoodTypeCodes {
