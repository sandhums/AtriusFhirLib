...
///FHIR ValueSet: ImmunizationReasonCodes
...
impl ImmunizationReasonCodes {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ("http://snomed.info/sct", "14747002", None, None),
            ("http://snomed.info/sct", "429060002", None, None),
        ]
    }
...
impl super::super::bindings::ValueSetMembership<Code> for ImmunizationReasonCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ImmunizationReasonCodes {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ImmunizationReasonCodes {
