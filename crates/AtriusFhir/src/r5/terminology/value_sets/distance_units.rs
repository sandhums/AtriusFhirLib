...
///FHIR ValueSet: CommonUCUMCodesForDistance
...
impl CommonUCUMCodesForDistance {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ("http://unitsofmeasure.org", "km", Some("kilometers"), None),
            ("http://unitsofmeasure.org", "m", Some("meters"), None),
            ("http://unitsofmeasure.org", "mm", Some("millimeters"), None),
            ("http://unitsofmeasure.org", "nm", Some("nanometers"), None),
            ("http://unitsofmeasure.org", "um", Some("micrometers"), None),
        ]
    }
...
impl super::super::bindings::ValueSetMembership<Code> for CommonUCUMCodesForDistance {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for CommonUCUMCodesForDistance {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for CommonUCUMCodesForDistance {
