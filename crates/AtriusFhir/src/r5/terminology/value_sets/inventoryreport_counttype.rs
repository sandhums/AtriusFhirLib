...
///FHIR ValueSet: InventoryCountType
...
impl InventoryCountType {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/inventoryreport-counttype", "snapshot"),
            ("http://hl7.org/fhir/inventoryreport-counttype", "difference"),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/inventoryreport-counttype" => {
                super::super::code_systems::inventoryreport_counttype::InventoryCountType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for InventoryCountType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for InventoryCountType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for InventoryCountType {
