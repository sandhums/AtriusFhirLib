...
///FHIR ValueSet: GenomicStudyChangeType
...
impl GenomicStudyChangeType {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/genomicstudy-changetype", "DNA"),
            ("http://hl7.org/fhir/genomicstudy-changetype", "RNA"),
            ("http://hl7.org/fhir/genomicstudy-changetype", "AA"),
            ("http://hl7.org/fhir/genomicstudy-changetype", "CHR"),
            ("http://hl7.org/fhir/genomicstudy-changetype", "CNV"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                "http://hl7.org/fhir/genomicstudy-changetype",
                "AA",
                Some("Protein/amino Acids change "),
                Some("Change that involves Amino Acid (AA) or protein sequences."),
            ),
            (
                "http://hl7.org/fhir/genomicstudy-changetype",
                "CHR",
                Some("Chromosomal changes"),
                Some("Change that involves number or strcture of chromosomes."),
            ),
            (
                "http://hl7.org/fhir/genomicstudy-changetype",
                "CNV",
            ...
            (
                ...
                "DNA",
                Some("DNA change"),
                Some("Change that involves Deoxyribonucleic acid (DNA) sequences."),
            ),
            (
                "http://hl7.org/fhir/genomicstudy-changetype",
                "RNA",
                Some("RNA change"),
                Some("Change that involves Ribonucleic Acid (RNA) sequences."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/genomicstudy-changetype" => {
                super::super::code_systems::genomicstudy_changetype::GenomicStudyChangeType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for GenomicStudyChangeType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for GenomicStudyChangeType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for GenomicStudyChangeType {
