...
///FHIR ValueSet: MedicinalProductDomain
...
impl MedicinalProductDomain {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "Human",
                Some("Human use"),
                Some("Product intended for use with humans"),
            ),
            (
                "http://hl7.org/fhir/medicinal-product-domain",
                "HumanAndVeterinary",
                Some("Human and Veterinary use"),
            ...
            (
                ...
                "Veterinary",
                Some("Veterinary use"),
                Some("Product intended for use with animals"),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/medicinal-product-domain" => {
                super::super::code_systems::medicinal_product_domain::MedicinalProductDomain::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for MedicinalProductDomain {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for MedicinalProductDomain {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for MedicinalProductDomain {
