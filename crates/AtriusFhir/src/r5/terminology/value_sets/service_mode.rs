...
impl ServiceMode {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/service-mode", "in-person"),
            ("http://hl7.org/fhir/service-mode", "telephone"),
            ("http://hl7.org/fhir/service-mode", "videoconference"),
            ("http://hl7.org/fhir/service-mode", "chat"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                ...
                "in-person",
                Some("In Person"),
                Some("The service will be provided in person"),
            ),
            (
                "http://hl7.org/fhir/service-mode",
                "telephone",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/service-mode" => {
                super::super::code_systems::service_mode::ServiceMode::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ServiceMode {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ServiceMode {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for ServiceMode {
