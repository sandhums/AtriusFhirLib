...
///FHIR ValueSet: AuditEventEntityRole
///Canonical URL: http://hl7.org/fhir/ValueSet/object-role
///Version: 5.0.0
///Title: Audit Event Entity Role
///Status: draft
...
impl super::super::bindings::ValueSetMembership<Code> for AuditEventEntityRole {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for AuditEventEntityRole {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for AuditEventEntityRole {
