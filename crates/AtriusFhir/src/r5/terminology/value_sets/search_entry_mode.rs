...
impl SearchEntryMode {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                ...
                "match",
                Some("Match"),
                Some("This resource matched the search specification."),
            ),
            (
                "http://hl7.org/fhir/search-entry-mode",
                "outcome",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/search-entry-mode" => {
                super::super::code_systems::search_entry_mode::SearchEntryMode::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for SearchEntryMode {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for SearchEntryMode {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for SearchEntryMode {
