...
///FHIR ValueSet: ObservationReferenceRangeNormalValueCodes
...
impl ObservationReferenceRangeNormalValueCodes {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/observation-referencerange-normalvalue", "negative"),
            ("http://hl7.org/fhir/observation-referencerange-normalvalue", "absent"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "absent",
                Some("Absent"),
                Some("The expected normal value for the observation is absent."),
            ),
            (
                "http://hl7.org/fhir/observation-referencerange-normalvalue",
                "negative",
                Some("Negative"),
                Some("The expected normal value for the observation is negative."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/observation-referencerange-normalvalue" => {
                super::super::code_systems::observation_referencerange_normalvalue::ObservationReferenceRangeNormalValue::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
for ObservationReferenceRangeNormalValueCodes {
