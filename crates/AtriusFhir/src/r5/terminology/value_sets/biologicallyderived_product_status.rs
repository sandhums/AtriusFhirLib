...
///FHIR ValueSet: BiologicallyDerivedProductStatus
...
impl BiologicallyDerivedProductStatus {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/biologicallyderived-product-status", "available"),
            ("http://hl7.org/fhir/biologicallyderived-product-status", "unavailable"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "available",
                Some("Available"),
                Some("Product is currently available for use."),
            ),
            (
                "http://hl7.org/fhir/biologicallyderived-product-status",
                "unavailable",
                Some("Unavailable"),
                Some("Product is not currently available for use."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/biologicallyderived-product-status" => {
                super::super::code_systems::biologicallyderived_product_status::BiologicallyDerivedProductStatus::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
for BiologicallyDerivedProductStatus {
