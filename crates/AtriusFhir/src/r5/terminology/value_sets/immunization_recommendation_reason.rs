...
///FHIR ValueSet: ImmunizationRecommendationReasonCodes
...
impl ImmunizationRecommendationReasonCodes {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[("http://snomed.info/sct", "77176002"), ("http://snomed.info/sct", "77386006")]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            ("http://snomed.info/sct", "77176002", None, None),
...
for ImmunizationRecommendationReasonCodes {
