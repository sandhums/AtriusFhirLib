...
///FHIR ValueSet: AccountAggregate
...
impl AccountAggregate {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/account-aggregate", "patient"),
            ("http://hl7.org/fhir/account-aggregate", "insurance"),
            ("http://hl7.org/fhir/account-aggregate", "total"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                ...
                "total",
                Some("Total"),
                Some("There is no aggregation on this balance"),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/account-aggregate" => {
                super::super::code_systems::account_aggregate::AccountAggregate::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for AccountAggregate {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for AccountAggregate {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for AccountAggregate {
