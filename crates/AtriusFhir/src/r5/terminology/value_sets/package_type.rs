...
impl PackageType {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                Some("Medicinal product pack"),
                None,
            ),
            (
                "http://hl7.org/fhir/package-type",
                "RawMaterialPackage",
                Some("Raw material package"),
                None,
            ),
            (
                "http://hl7.org/fhir/package-type",
                "Shipping-TransportContainer",
                Some("Shipping or transport container"),
                None,
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/package-type" => {
                super::super::code_systems::package_type::PackageType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for PackageType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for PackageType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for PackageType {
