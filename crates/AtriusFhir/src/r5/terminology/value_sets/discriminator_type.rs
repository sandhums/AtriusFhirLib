...
///FHIR ValueSet: DiscriminatorType
...
impl DiscriminatorType {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ...
            ("http://hl7.org/fhir/discriminator-type", "position"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                ...
                "type",
                Some("Type"),
                Some("The slices are differentiated by type of the nominated element."),
            ),
            (
                "http://hl7.org/fhir/discriminator-type",
                "value",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/discriminator-type" => {
                super::super::code_systems::discriminator_type::DiscriminatorType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for DiscriminatorType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for DiscriminatorType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for DiscriminatorType {
