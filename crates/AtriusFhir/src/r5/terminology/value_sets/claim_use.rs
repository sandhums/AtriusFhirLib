...
impl Use {
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/claim-use" => {
                super::super::code_systems::claim_use::Use::try_from_code(code).is_ok()
            }
            _ => false,
        }
    }
...
impl super::super::bindings::ValueSetMembership<Code> for Use {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for Use {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for Use {
