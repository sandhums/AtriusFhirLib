...
impl DaysOfWeek {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ("http://hl7.org/fhir/days-of-week", "fri", Some("Friday"), Some("Friday.")),
            ("http://hl7.org/fhir/days-of-week", "mon", Some("Monday"), Some("Monday.")),
            (
                "http://hl7.org/fhir/days-of-week",
                "sat",
                Some("Saturday"),
            ...
            ("http://hl7.org/fhir/days-of-week", "sun", Some("Sunday"), Some("Sunday.")),
            (
                "http://hl7.org/fhir/days-of-week",
                "thu",
                Some("Thursday"),
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/days-of-week" => {
                super::super::code_systems::days_of_week::DaysOfWeek::try_from_code(code)
                    .is_ok()
            }
            _ => false,
        }
...
impl super::super::bindings::ValueSetMembership<Code> for DaysOfWeek {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for DaysOfWeek {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for DaysOfWeek {
