...
///FHIR ValueSet: ProductContactType
...
impl ProductContactType {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                "http://hl7.org/fhir/medicinal-product-contact-type",
                "PVEnquiries",
                Some("Pharmacovigilance Enquiry Information"),
                Some("Pharmacovigilance Enquiry Information"),
            ),
            (
                "http://hl7.org/fhir/medicinal-product-contact-type",
            ...
            (
                "http://hl7.org/fhir/medicinal-product-contact-type",
                "ProposedMAH",
                Some("Proposed Marketing Authorization Holder/Person"),
                Some("Proposed Marketing Authorization Holder/Person"),
            ),
            (
                "http://hl7.org/fhir/medicinal-product-contact-type",
                "QPPV",
                Some("Qualified Person Responsible for Pharmacovigilance"),
                Some("Qualified Person Responsible for Pharmacovigilance"),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/medicinal-product-contact-type" => {
                super::super::code_systems::medicinal_product_contact_type::ProductContactType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ProductContactType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ProductContactType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for ProductContactType {
