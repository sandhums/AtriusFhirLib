...
///FHIR ValueSet: IngredientManufacturerRole
...
impl IngredientManufacturerRole {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                "http://hl7.org/fhir/ingredient-manufacturer-role",
                "actual",
                Some("Manufacturer actually makes this particular ingredient"),
                None,
            ),
            (
                "http://hl7.org/fhir/ingredient-manufacturer-role",
                "allowed",
                Some("Manufacturer is specifically allowed for this ingredient"),
                None,
            ),
            (
                "http://hl7.org/fhir/ingredient-manufacturer-role",
                "possible",
                Some("Manufacturer is known to make this ingredient in general"),
                None,
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/ingredient-manufacturer-role" => {
                super::super::code_systems::ingredient_manufacturer_role::IngredientManufacturerRole::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for IngredientManufacturerRole {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for IngredientManufacturerRole {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for IngredientManufacturerRole {
