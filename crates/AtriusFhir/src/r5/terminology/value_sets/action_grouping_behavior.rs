...
///FHIR ValueSet: ActionGroupingBehavior
...
impl ActionGroupingBehavior {
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/action-grouping-behavior" => {
                super::super::code_systems::action_grouping_behavior::ActionGroupingBehavior::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ActionGroupingBehavior {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ActionGroupingBehavior {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ActionGroupingBehavior {
