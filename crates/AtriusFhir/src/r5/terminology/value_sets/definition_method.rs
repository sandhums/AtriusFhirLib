...
///FHIR ValueSet: DefinitionMethod
...
impl DefinitionMethod {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/definition-method", "systematic-assessment"),
            ("http://hl7.org/fhir/definition-method", "non-systematic-assessment"),
            ("http://hl7.org/fhir/definition-method", "mean"),
            ("http://hl7.org/fhir/definition-method", "median"),
            ("http://hl7.org/fhir/definition-method", "mean-of-mean"),
            ("http://hl7.org/fhir/definition-method", "mean-of-median"),
            ("http://hl7.org/fhir/definition-method", "median-of-mean"),
            ("http://hl7.org/fhir/definition-method", "median-of-median"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "mean",
                Some("Mean"),
                Some("Aggregated using mean of observed values."),
            ),
            (
                "http://hl7.org/fhir/definition-method",
                "mean-of-mean",
                Some("Mean of Means"),
                Some("Aggregated using mean of means (e.g. study mean values)."),
            ),
            (
                "http://hl7.org/fhir/definition-method",
                "mean-of-median",
                Some("Mean of Medians"),
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/definition-method" => {
                super::super::code_systems::definition_method::DefinitionMethod::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for DefinitionMethod {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for DefinitionMethod {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for DefinitionMethod {
