...
///FHIR ValueSet: AttributeEstimateType
///Canonical URL: http://hl7.org/fhir/ValueSet/attribute-estimate-type
///Version: 5.0.0
///Title: Attribute Estimate Type
///Status: draft
...
impl super::super::bindings::ValueSetMembership<Code> for AttributeEstimateType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for AttributeEstimateType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for AttributeEstimateType {
