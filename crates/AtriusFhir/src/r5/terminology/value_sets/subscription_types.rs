...
///FHIR ValueSet: SubscriptionTypes
///Canonical URL: http://hl7.org/fhir/ValueSet/subscription-types
///Version: 5.0.0
///Title: Types used with Subscriptions
///Status: active
///Types used with Subscriptions
///Compose includes 1 explicit concept codes
...
impl super::super::bindings::ValueSetMembership<Code> for SubscriptionTypes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for SubscriptionTypes {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for SubscriptionTypes {
