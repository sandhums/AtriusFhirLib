...
///FHIR ValueSet: TherapyRelationshipType
...
impl TherapyRelationshipType {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ...
            ("http://hl7.org/fhir/therapy-relationship-type", "indicated-only-after"),
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                ...
                Some("Indicated except when the other therapy is given"),
                Some("Indicated except when the other therapy is given"),
            ),
            (
                "http://hl7.org/fhir/therapy-relationship-type",
            ...
            (
                ...
                Some("Indicated to replace the other therapy"),
                Some("Indicated to replace the other therapy"),
            ),
            (
                "http://hl7.org/fhir/therapy-relationship-type",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/therapy-relationship-type" => {
                super::super::code_systems::therapy_relationship_type::TherapyRelationshipType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for TherapyRelationshipType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for TherapyRelationshipType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for TherapyRelationshipType {
