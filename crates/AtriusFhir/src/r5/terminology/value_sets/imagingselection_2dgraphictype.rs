...
///FHIR ValueSet: ImagingSelection2DGraphicType
...
impl ImagingSelection2DGraphicType {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/imagingselection-2dgraphictype", "point"),
            ("http://hl7.org/fhir/imagingselection-2dgraphictype", "polyline"),
            ("http://hl7.org/fhir/imagingselection-2dgraphictype", "interpolated"),
            ("http://hl7.org/fhir/imagingselection-2dgraphictype", "circle"),
            ("http://hl7.org/fhir/imagingselection-2dgraphictype", "ellipse"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                ...
                "point",
                Some("POINT"),
                Some("A single location denoted by a single (x,y) pair."),
            ),
            (
                "http://hl7.org/fhir/imagingselection-2dgraphictype",
                "polyline",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/imagingselection-2dgraphictype" => {
                super::super::code_systems::imagingselection_2dgraphictype::ImagingSelection2DGraphicType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ImagingSelection2DGraphicType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding>
for ImagingSelection2DGraphicType {
