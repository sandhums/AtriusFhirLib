...
impl Indicator {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://cds-hooks.hl7.org/CodeSystem/indicator", "info"),
            ("http://cds-hooks.hl7.org/CodeSystem/indicator", "warning"),
            ("http://cds-hooks.hl7.org/CodeSystem/indicator", "critical"),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://cds-hooks.hl7.org/CodeSystem/indicator" => {
                super::super::code_systems::cdshooks_indicator::Indicator::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for Indicator {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for Indicator {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for Indicator {
