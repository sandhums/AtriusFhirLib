...
///FHIR ValueSet: DeviceUsageStatus
...
impl DeviceUsageStatus {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ...
            ("http://hl7.org/fhir/deviceusage-status", "not-done"),
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "active",
                Some("Active"),
                Some("The device is still being used."),
            ),
            (
                "http://hl7.org/fhir/deviceusage-status",
                "completed",
                Some("Completed"),
                Some("The device is no longer being used."),
            ),
            (
                "http://hl7.org/fhir/deviceusage-status",
                "entered-in-error",
                Some("Entered in Error"),
                Some("The statement was recorded incorrectly."),
            ),
            (
                "http://hl7.org/fhir/deviceusage-status",
                "intended",
                Some("Intended"),
                Some("The device may be used at some time in the future."),
            ),
            (
                "http://hl7.org/fhir/deviceusage-status",
                "not-done",
                Some("Not done"),
                Some("The device was not used."),
            ),
            (
                "http://hl7.org/fhir/deviceusage-status",
                "on-hold",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/deviceusage-status" => {
                super::super::code_systems::deviceusage_status::DeviceUsageStatus::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for DeviceUsageStatus {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for DeviceUsageStatus {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for DeviceUsageStatus {
