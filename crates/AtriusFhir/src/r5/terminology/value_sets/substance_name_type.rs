...
///FHIR ValueSet: SubstanceNameType
...
impl SubstanceNameType {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ("http://hl7.org/fhir/substance-name-type", "Brand", Some("brand"), None),
            (
                "http://hl7.org/fhir/substance-name-type",
                "Scientific",
                Some("scientific"),
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/substance-name-type" => {
                super::super::code_systems::substance_name_type::SubstanceNameType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for SubstanceNameType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for SubstanceNameType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for SubstanceNameType {
