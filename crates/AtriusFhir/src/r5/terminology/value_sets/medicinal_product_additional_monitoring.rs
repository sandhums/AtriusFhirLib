...
///FHIR ValueSet: AdditionalMonitoring
...
impl AdditionalMonitoring {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                "http://hl7.org/fhir/medicinal-product-additional-monitoring",
                "BlackTriangleMonitoring",
                Some("Requirement for Black Triangle Monitoring"),
                Some("Requirement for Black Triangle Monitoring"),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/medicinal-product-additional-monitoring" => {
                super::super::code_systems::medicinal_product_additional_monitoring::AdditionalMonitoring::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for AdditionalMonitoring {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for AdditionalMonitoring {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for AdditionalMonitoring {
