...
///FHIR ValueSet: BiologicallyDerivedProductDispenseOriginRelationship
...
impl BiologicallyDerivedProductDispenseOriginRelationship {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "allogeneic",
                Some("Allogeneic"),
                Some("The donor and the recipient are unrelated"),
            ),
            (
                "http://hl7.org/fhir/CodeSystem/biologicallyderivedproductdispense-origin-relationship",
                "autologous",
                Some("Autologous"),
                Some("The product was pre-donated by the recipient"),
            ),
            (
                "http://hl7.org/fhir/CodeSystem/biologicallyderivedproductdispense-origin-relationship",
                "directed",
            ...
            (
                ...
                "related",
                Some("Related"),
                Some("The product is from a blood relation of the recipient"),
            ),
            (
                "http://hl7.org/fhir/CodeSystem/biologicallyderivedproductdispense-origin-relationship",
                "xenogenic",
                Some("Xenogenic"),
                Some("The product is from a different species to the recipient"),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/CodeSystem/biologicallyderivedproductdispense-origin-relationship" => {
                super::super::code_systems::biologicallyderivedproductdispense_origin_relationship::BiologicallyDerivedProductDispenseOriginRelationship::try_from_code(
                        code,
                    )
                    .is_ok()
            }
