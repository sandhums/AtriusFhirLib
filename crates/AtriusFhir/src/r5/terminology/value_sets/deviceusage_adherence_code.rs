...
///FHIR ValueSet: DeviceUsageAdherenceCode
...
impl DeviceUsageAdherenceCode {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/deviceusage-adherence-code", "always"),
            ("http://hl7.org/fhir/deviceusage-adherence-code", "never"),
            ("http://hl7.org/fhir/deviceusage-adherence-code", "sometimes"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "always",
                Some("Always"),
                Some("The device is always used."),
            ),
            (
                "http://hl7.org/fhir/deviceusage-adherence-code",
                "never",
                Some("Never"),
                Some("The device is never used."),
            ),
            (
                "http://hl7.org/fhir/deviceusage-adherence-code",
                "sometimes",
                Some("Sometimes"),
                Some("The device is sometimes used."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/deviceusage-adherence-code" => {
                super::super::code_systems::deviceusage_adherence_code::DeviceUsageAdherenceCode::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for DeviceUsageAdherenceCode {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for DeviceUsageAdherenceCode {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for DeviceUsageAdherenceCode {
