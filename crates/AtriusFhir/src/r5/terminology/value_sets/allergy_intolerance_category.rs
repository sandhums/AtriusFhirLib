...
///FHIR ValueSet: AllergyIntoleranceCategory
...
impl AllergyIntoleranceCategory {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                ...
                "medication",
                Some("Medication"),
                Some("Substances administered to achieve a physiological effect."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/allergy-intolerance-category" => {
                super::super::code_systems::allergy_intolerance_category::AllergyIntoleranceCategory::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for AllergyIntoleranceCategory {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for AllergyIntoleranceCategory {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for AllergyIntoleranceCategory {
