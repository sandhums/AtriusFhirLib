...
///FHIR ValueSet: ServiceProvisionConditions
///Canonical URL: http://hl7.org/fhir/ValueSet/service-provision-conditions
///Version: 5.0.0
///Title: Service Provision Conditions
///Status: draft
...
impl super::super::bindings::ValueSetMembership<Code> for ServiceProvisionConditions {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ServiceProvisionConditions {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ServiceProvisionConditions {
