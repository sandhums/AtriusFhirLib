...
impl AddressUse {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "billing",
                Some("Billing"),
                Some("An address to be used to send bills, invoices, receipts etc."),
            ),
            (
                "http://hl7.org/fhir/address-use",
                "home",
                Some("Home"),
                Some("A communication address at a home."),
            ),
            (
                "http://hl7.org/fhir/address-use",
                "old",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/address-use" => {
                super::super::code_systems::address_use::AddressUse::try_from_code(code)
                    .is_ok()
            }
            _ => false,
        }
...
impl super::super::bindings::ValueSetMembership<Code> for AddressUse {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for AddressUse {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for AddressUse {
