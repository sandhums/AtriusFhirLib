...
///FHIR ValueSet: MeasureReportStratifierValueExample
...
impl MeasureReportStratifierValueExample {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ...
            ("http://hl7.org/fhir/measurereport-stratifier-value-example", "northeast"),
            ("http://hl7.org/fhir/measurereport-stratifier-value-example", "southwest"),
            ("http://hl7.org/fhir/measurereport-stratifier-value-example", "southeast"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "northeast",
                Some("Northeast"),
                Some("Northeast region stratification."),
            ),
            (
                "http://hl7.org/fhir/measurereport-stratifier-value-example",
                "northwest",
                Some("Northwest"),
                Some("Northwest region stratification."),
            ),
            (
                "http://hl7.org/fhir/measurereport-stratifier-value-example",
                "southeast",
                Some("Southeast"),
                Some("Southeast region stratification."),
            ),
            (
                "http://hl7.org/fhir/measurereport-stratifier-value-example",
                "southwest",
                Some("Soutwest"),
                Some("Soutwest region stratification."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/measurereport-stratifier-value-example" => {
                super::super::code_systems::measurereport_stratifier_value_example::MeasureReportStratifierValueExample::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
for MeasureReportStratifierValueExample {
