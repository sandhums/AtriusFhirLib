...
///FHIR ValueSet: DetectedIssueCategory
...
impl DetectedIssueCategory {
    ...
    pub fn filter_rules() -> &'static [(&'static str, &'static str, &'static str)] {
        &[
            ("concept", "is-a", "_ActSuppliedItemDetectedIssueCode"),
            ("concept", "is-a", "_AdministrationDetectedIssueCode"),
            ("concept", "is-a", "_ClinicalActionDetectedIssueCode"),
            ("concept", "is-a", "_SupplyDetectedIssueCode"),
        ]
    }
...
impl super::super::bindings::ValueSetMembership<Code> for DetectedIssueCategory {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for DetectedIssueCategory {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for DetectedIssueCategory {
