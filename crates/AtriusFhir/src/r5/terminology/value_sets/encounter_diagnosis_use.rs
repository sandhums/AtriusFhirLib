...
///FHIR ValueSet: EncounterDiagnosisUse
...
impl EncounterDiagnosisUse {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/encounter-diagnosis-use", "working"),
            ("http://hl7.org/fhir/encounter-diagnosis-use", "final"),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/encounter-diagnosis-use" => {
                super::super::code_systems::encounter_diagnosis_use::EncounterDiagnosisUse::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for EncounterDiagnosisUse {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for EncounterDiagnosisUse {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for EncounterDiagnosisUse {
