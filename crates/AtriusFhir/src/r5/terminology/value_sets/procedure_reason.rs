...
///FHIR ValueSet: ProcedureReasonCodes
...
impl ProcedureReasonCodes {
    ...
    pub fn filter_rules() -> &'static [(&'static str, &'static str, &'static str)] {
        &[("concept", "is-a", "404684003"), ("concept", "is-a", "71388002")]
    }
...
impl super::super::bindings::ValueSetMembership<Code> for ProcedureReasonCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ProcedureReasonCodes {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ProcedureReasonCodes {
