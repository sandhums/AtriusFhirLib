...
///FHIR ValueSet: TestScriptProfileOriginType
...
impl super::super::bindings::ValueSetMembership<Code> for TestScriptProfileOriginType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for TestScriptProfileOriginType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for TestScriptProfileOriginType {
