...
///FHIR ValueSet: EventResourceTypes
...
impl super::super::bindings::ValueSetMembership<Code> for EventResourceTypes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for EventResourceTypes {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for EventResourceTypes {
