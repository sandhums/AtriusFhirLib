...
///FHIR ValueSet: AdverseEventCausalityMethod
///Canonical URL: http://hl7.org/fhir/ValueSet/adverse-event-causality-method
///Version: 5.0.0
///Title: Adverse Event Causality Method
///Status: draft
///TODO.
...
impl super::super::bindings::ValueSetMembership<Code> for AdverseEventCausalityMethod {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for AdverseEventCausalityMethod {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for AdverseEventCausalityMethod {
