...
///FHIR ValueSet: MeasureScoringUnit
...
impl MeasureScoringUnit {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[("http://unitsofmeasure.org", "1"), ("http://unitsofmeasure.org", "/1000.d")]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                "http://unitsofmeasure.org",
                "/1000.d",
                Some("per 1000 patient days"),
                None,
            ),
            ("http://unitsofmeasure.org", "1", Some("Default units"), None),
        ]
    }
...
impl super::super::bindings::ValueSetMembership<Code> for MeasureScoringUnit {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for MeasureScoringUnit {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for MeasureScoringUnit {
