...
///FHIR ValueSet: AssertionManualCompletionType
...
impl AssertionManualCompletionType {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/assert-manual-completion-codes", "fail"),
            ("http://hl7.org/fhir/assert-manual-completion-codes", "pass"),
            ("http://hl7.org/fhir/assert-manual-completion-codes", "skip"),
            ("http://hl7.org/fhir/assert-manual-completion-codes", "stop"),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/assert-manual-completion-codes" => {
                super::super::code_systems::assert_manual_completion_codes::AssertionManualCompletionType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for AssertionManualCompletionType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding>
for AssertionManualCompletionType {
