...
///FHIR ValueSet: ResourceValidationMode
...
impl ResourceValidationMode {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/resource-validation-mode", "create"),
            ("http://hl7.org/fhir/resource-validation-mode", "update"),
            ("http://hl7.org/fhir/resource-validation-mode", "delete"),
            ("http://hl7.org/fhir/resource-validation-mode", "profile"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                "http://hl7.org/fhir/resource-validation-mode",
                "profile",
                Some("Validate Against a Profile"),
                Some(
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/resource-validation-mode" => {
                super::super::code_systems::resource_validation_mode::ResourceValidationMode::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ResourceValidationMode {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ResourceValidationMode {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ResourceValidationMode {
