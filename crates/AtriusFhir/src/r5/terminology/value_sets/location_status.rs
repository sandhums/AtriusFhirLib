...
impl LocationStatus {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "active",
                Some("Active"),
                Some("The location is operational."),
            ),
            (
                "http://hl7.org/fhir/location-status",
                "inactive",
                Some("Inactive"),
                Some("The location is no longer used."),
            ),
            (
                "http://hl7.org/fhir/location-status",
                "suspended",
                Some("Suspended"),
                Some("The location is temporarily closed."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/location-status" => {
                super::super::code_systems::location_status::LocationStatus::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for LocationStatus {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for LocationStatus {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for LocationStatus {
