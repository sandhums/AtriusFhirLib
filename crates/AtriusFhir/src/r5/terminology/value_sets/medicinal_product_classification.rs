...
///FHIR ValueSet: ProductClassification
...
impl super::super::bindings::ValueSetMembership<Code> for ProductClassification {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ProductClassification {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ProductClassification {
