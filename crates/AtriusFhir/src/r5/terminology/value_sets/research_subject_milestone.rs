...
///FHIR ValueSet: ResearchSubjectMilestone
///Canonical URL: http://hl7.org/fhir/ValueSet/research-subject-milestone
///Version: 5.0.0
///Title: Research Subject Milestone
///Status: draft
...
impl super::super::bindings::ValueSetMembership<Code> for ResearchSubjectMilestone {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ResearchSubjectMilestone {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ResearchSubjectMilestone {
