...
///FHIR ValueSet: ArtifactAssessmentWorkflowStatus
...
impl ArtifactAssessmentWorkflowStatus {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/artifactassessment-workflow-status", "submitted"),
            ("http://hl7.org/fhir/artifactassessment-workflow-status", "triaged"),
            (
                "http://hl7.org/fhir/artifactassessment-workflow-status",
                "waiting-for-input",
            ),
            ...
            ("http://hl7.org/fhir/artifactassessment-workflow-status", "deferred"),
            ("http://hl7.org/fhir/artifactassessment-workflow-status", "duplicate"),
            ("http://hl7.org/fhir/artifactassessment-workflow-status", "applied"),
            ("http://hl7.org/fhir/artifactassessment-workflow-status", "published"),
            (
                "http://hl7.org/fhir/artifactassessment-workflow-status",
                "entered-in-error",
            ),
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                ...
                Some("The assessment was entered in error"),
            ),
            (
                "http://hl7.org/fhir/artifactassessment-workflow-status",
                "published",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/artifactassessment-workflow-status" => {
                super::super::code_systems::artifactassessment_workflow_status::ArtifactAssessmentWorkflowStatus::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
for ArtifactAssessmentWorkflowStatus {
