...
///FHIR ValueSet: ConceptSubsumptionOutcome
...
impl ConceptSubsumptionOutcome {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/concept-subsumption-outcome", "equivalent"),
            ("http://hl7.org/fhir/concept-subsumption-outcome", "subsumes"),
            ("http://hl7.org/fhir/concept-subsumption-outcome", "subsumed-by"),
            ("http://hl7.org/fhir/concept-subsumption-outcome", "not-subsumed"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "equivalent",
                Some("Equivalent"),
                Some("A equivalent to B if A subsumes B and B subsumes A"),
            ),
            (
                "http://hl7.org/fhir/concept-subsumption-outcome",
                "not-subsumed",
                Some("Not-Subsumed"),
                Some("Neither A subsumes B nor B subsumes A"),
            ),
            (
                "http://hl7.org/fhir/concept-subsumption-outcome",
                "subsumed-by",
                Some("Subsumed-By"),
                Some("A subsumed by B if B subsumes A"),
            ),
            (
                "http://hl7.org/fhir/concept-subsumption-outcome",
                "subsumes",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/concept-subsumption-outcome" => {
                super::super::code_systems::concept_subsumption_outcome::ConceptSubsumptionOutcome::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ConceptSubsumptionOutcome {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ConceptSubsumptionOutcome {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ConceptSubsumptionOutcome {
