...
///FHIR ValueSet: AuditEventAction
...
impl AuditEventAction {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "C",
                Some("Create"),
                Some("Create a new database object, such as placing an order."),
            ),
            (
                "http://hl7.org/fhir/audit-event-action",
                "D",
                Some("Delete"),
                Some("Delete items, such as a doctor master file record."),
            ),
            (
                "http://hl7.org/fhir/audit-event-action",
                "E",
            ...
            (
                ...
                "R",
                Some("Read"),
                Some("Read data, such as to print or display to a doctor."),
            ),
            (
                "http://hl7.org/fhir/audit-event-action",
                "U",
                Some("Update"),
                Some("Update data, such as revise patient information."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/audit-event-action" => {
                super::super::code_systems::audit_event_action::AuditEventAction::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for AuditEventAction {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for AuditEventAction {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for AuditEventAction {
