...
///FHIR ValueSet: PropertyRepresentation
...
impl PropertyRepresentation {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                Some("Use CDA narrative instead of XHTML."),
            ),
            (
                "http://hl7.org/fhir/property-representation",
                "typeAttr",
                Some("Type Attribute"),
                Some("The type of this element is indicated using xsi:type."),
            ),
            (
                "http://hl7.org/fhir/property-representation",
                "xhtml",
                Some("XHTML"),
                Some("The property is represented using XHTML."),
            ),
            (
                "http://hl7.org/fhir/property-representation",
                "xmlAttr",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/property-representation" => {
                super::super::code_systems::property_representation::PropertyRepresentation::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for PropertyRepresentation {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for PropertyRepresentation {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for PropertyRepresentation {
