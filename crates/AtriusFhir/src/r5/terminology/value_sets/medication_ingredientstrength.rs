...
///FHIR ValueSet: MedicationIngredientStrengthCodes
...
impl MedicationIngredientStrengthCodes {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/CodeSystem/medication-ingredientstrength", "qs"),
            ("http://hl7.org/fhir/CodeSystem/medication-ingredientstrength", "trace"),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/CodeSystem/medication-ingredientstrength" => {
                super::super::code_systems::medication_ingredientstrength::MedicationIngredientStrengthCodes::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
for MedicationIngredientStrengthCodes {
