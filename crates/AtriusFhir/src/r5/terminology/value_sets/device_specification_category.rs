...
///FHIR ValueSet: DeviceSpecificationCategory
///Canonical URL: http://hl7.org/fhir/ValueSet/device-specification-category
///Version: 5.0.0
///Title: Device Specification Category
///Status: draft
...
impl DeviceSpecificationCategory {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/device-specification-category", "communication"),
            ("http://hl7.org/fhir/device-specification-category", "performance"),
            ("http://hl7.org/fhir/device-specification-category", "measurement"),
            ("http://hl7.org/fhir/device-specification-category", "risk-class"),
            ("http://hl7.org/fhir/device-specification-category", "electrical"),
            ("http://hl7.org/fhir/device-specification-category", "material"),
            ("http://hl7.org/fhir/device-specification-category", "exchange"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "communication",
                Some("Communication"),
                Some("A communication standard."),
            ),
            (
                "http://hl7.org/fhir/device-specification-category",
                "electrical",
                Some("Electrical"),
                Some("Electrical classification."),
            ),
            (
                "http://hl7.org/fhir/device-specification-category",
                "exchange",
                Some("Exchange"),
                Some("Exchange category."),
            ),
            (
                "http://hl7.org/fhir/device-specification-category",
                "material",
                Some("Material"),
                Some("Classification related to materials."),
            ),
            (
                "http://hl7.org/fhir/device-specification-category",
                "measurement",
                Some("Measurement"),
                Some("A measurement standard."),
            ),
            (
                "http://hl7.org/fhir/device-specification-category",
                "performance",
                Some("Performance"),
                Some("A performance standard."),
            ),
            (
                "http://hl7.org/fhir/device-specification-category",
                "risk-class",
                Some("Risk Class"),
                Some("Class or catefory of risk."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/device-specification-category" => {
                super::super::code_systems::device_specification_category::FHIRDeviceSpecializationCategory::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for DeviceSpecificationCategory {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for DeviceSpecificationCategory {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for DeviceSpecificationCategory {
