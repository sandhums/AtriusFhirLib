...
///FHIR ValueSet: CapabilityFormatType
...
impl CapabilityFormatType {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/fhir-format-type", "xml"),
            ("http://hl7.org/fhir/fhir-format-type", "json"),
            ("http://hl7.org/fhir/fhir-format-type", "ttl"),
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                ...
                "ttl",
                Some("TTL"),
                Some("RDF content-type corresponding to the text/turtle mime-type."),
            ),
            (
                "http://hl7.org/fhir/fhir-format-type",
                "xml",
            ...
            ("urn:ietf:bcp:13", "application/fhir+json", None, None),
            ("urn:ietf:bcp:13", "application/fhir+ttl", None, None),
            ("urn:ietf:bcp:13", "application/fhir+xml", None, None),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/fhir-format-type" => {
                super::super::code_systems::fhir_format_type::FHIRFormatType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for CapabilityFormatType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for CapabilityFormatType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for CapabilityFormatType {
