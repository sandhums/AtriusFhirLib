...
///FHIR ValueSet: AccountBalanceTerm
...
impl AccountBalanceTerm {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/account-balance-term", "current"),
            ("http://hl7.org/fhir/account-balance-term", "30"),
            ("http://hl7.org/fhir/account-balance-term", "60"),
            ("http://hl7.org/fhir/account-balance-term", "90"),
            ("http://hl7.org/fhir/account-balance-term", "120"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "120",
                Some("120 day"),
                Some("This balance is outstanding over 120 days"),
            ),
            (
                "http://hl7.org/fhir/account-balance-term",
                "30",
                Some("30 day"),
                Some("This balance is outstanding over 30 days"),
            ),
            (
                "http://hl7.org/fhir/account-balance-term",
                "60",
                Some("60 day"),
                Some("This balance is outstanding over 60 days"),
            ),
            (
                "http://hl7.org/fhir/account-balance-term",
                "90",
                Some("90 day"),
                Some("This balance is outstanding over 90 days"),
            ),
            (
                "http://hl7.org/fhir/account-balance-term",
                "current",
                Some("Current"),
                Some("This balance is the current balance"),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/account-balance-term" => {
                super::super::code_systems::account_balance_term::AccountBalanceTerm::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for AccountBalanceTerm {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for AccountBalanceTerm {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for AccountBalanceTerm {
