...
///FHIR ValueSet: MedicationAdministrationStatusCodes
...
impl MedicationAdministrationStatusCodes {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/CodeSystem/medication-admin-status", "in-progress"),
            ("http://hl7.org/fhir/CodeSystem/medication-admin-status", "not-done"),
            ("http://hl7.org/fhir/CodeSystem/medication-admin-status", "on-hold"),
            ("http://hl7.org/fhir/CodeSystem/medication-admin-status", "completed"),
            (
                "http://hl7.org/fhir/CodeSystem/medication-admin-status",
                "entered-in-error",
            ),
            ("http://hl7.org/fhir/CodeSystem/medication-admin-status", "stopped"),
            ("http://hl7.org/fhir/CodeSystem/medication-admin-status", "unknown"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                ...
                "in-progress",
                Some("In Progress"),
                Some("The administration has started but has not yet completed."),
            ),
            (
                "http://hl7.org/fhir/CodeSystem/medication-admin-status",
                "not-done",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/CodeSystem/medication-admin-status" => {
                super::super::code_systems::medication_admin_status::MedicationAdministrationStatusCodes::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
for MedicationAdministrationStatusCodes {
