...
///FHIR ValueSet: EpisodeOfCareType
...
impl super::super::bindings::ValueSetMembership<Code> for EpisodeOfCareType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for EpisodeOfCareType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for EpisodeOfCareType {
