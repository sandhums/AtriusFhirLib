...
///FHIR ValueSet: ReferenceHandlingPolicy
...
impl ReferenceHandlingPolicy {
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/reference-handling-policy" => {
                super::super::code_systems::reference_handling_policy::ReferenceHandlingPolicy::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ReferenceHandlingPolicy {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ReferenceHandlingPolicy {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ReferenceHandlingPolicy {
