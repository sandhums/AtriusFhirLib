...
impl TransportIntent {
    ...
    pub fn include_systems() -> &'static [&'static str] {
        &["http://hl7.org/fhir/request-intent", "http://hl7.org/fhir/transport-intent"]
    }
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/transport-intent", "unknown"),
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ("http://hl7.org/fhir/request-intent", "filler-order", None, None),
            ("http://hl7.org/fhir/request-intent", "instance-order", None, None),
            ("http://hl7.org/fhir/request-intent", "option", None, None),
            ("http://hl7.org/fhir/request-intent", "order", None, None),
            ("http://hl7.org/fhir/request-intent", "original-order", None, None),
            ("http://hl7.org/fhir/request-intent", "plan", None, None),
            ("http://hl7.org/fhir/request-intent", "proposal", None, None),
            ("http://hl7.org/fhir/request-intent", "reflex-order", None, None),
            (
                "http://hl7.org/fhir/transport-intent",
                "unknown",
                Some("Unknown"),
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/request-intent" => {
                super::super::code_systems::request_intent::RequestIntent::try_from_code(
                        code,
                    )
                    .is_ok()
            }
            "http://hl7.org/fhir/transport-intent" => {
                super::super::code_systems::transport_intent::TransportIntent::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for TransportIntent {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for TransportIntent {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for TransportIntent {
