...
///FHIR ValueSet: ConsentProvisionType
...
impl ConsentProvisionType {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "deny",
                Some("Deny"),
                Some("Consent is denied for actions meeting these rules."),
            ),
            (
                "http://hl7.org/fhir/consent-provision-type",
                "permit",
                Some("Permit"),
                Some("Consent is provided for actions meeting these rules."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/consent-provision-type" => {
                super::super::code_systems::consent_provision_type::ConsentProvisionType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ConsentProvisionType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ConsentProvisionType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ConsentProvisionType {
