...
///FHIR ValueSet: DiagnosticServiceSectionCodes
...
impl super::super::bindings::ValueSetMembership<Code> for DiagnosticServiceSectionCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding>
for DiagnosticServiceSectionCodes {
