...
///FHIR ValueSet: SpecimenContainedPreference
...
impl SpecimenContainedPreference {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "alternate",
                Some("Alternate"),
                Some("This type of conditioned specimen is an alternate."),
            ),
            (
                "http://hl7.org/fhir/specimen-contained-preference",
                "preferred",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/specimen-contained-preference" => {
                super::super::code_systems::specimen_contained_preference::SpecimenContainedPreference::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for SpecimenContainedPreference {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for SpecimenContainedPreference {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for SpecimenContainedPreference {
