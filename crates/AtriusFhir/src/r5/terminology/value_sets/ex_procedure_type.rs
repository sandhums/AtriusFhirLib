...
///FHIR ValueSet: ExampleProcedureTypeCodes
...
impl super::super::bindings::ValueSetMembership<Code> for ExampleProcedureTypeCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ExampleProcedureTypeCodes {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ExampleProcedureTypeCodes {
