...
///FHIR ValueSet: ProcedureCategoryCodesSNOMEDCT
...
impl ProcedureCategoryCodesSNOMEDCT {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ("http://snomed.info/sct", "103693007", None, None),
            ("http://snomed.info/sct", "24642003", None, None),
            ("http://snomed.info/sct", "387713003", None, None),
            ("http://snomed.info/sct", "409063005", None, None),
            ("http://snomed.info/sct", "409073007", None, None),
            ("http://snomed.info/sct", "410606002", None, None),
            ("http://snomed.info/sct", "46947000", None, None),
        ]
    }
...
for ProcedureCategoryCodesSNOMEDCT {
