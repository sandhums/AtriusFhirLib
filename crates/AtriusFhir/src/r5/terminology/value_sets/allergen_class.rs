...
///FHIR ValueSet: CodesForAllergenClasses
...
impl super::super::bindings::ValueSetMembership<Code> for CodesForAllergenClasses {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for CodesForAllergenClasses {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for CodesForAllergenClasses {
