...
///FHIR ValueSet: ImmunizationStatusCodes
...
impl ImmunizationStatusCodes {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            ("http://hl7.org/fhir/event-status", "not-done", None, None),
        ]
    }
...
impl super::super::bindings::ValueSetMembership<Code> for ImmunizationStatusCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ImmunizationStatusCodes {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ImmunizationStatusCodes {
