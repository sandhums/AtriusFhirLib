...
///FHIR ValueSet: ConditionVerificationStatus
...
impl super::super::bindings::ValueSetMembership<Code> for ConditionVerificationStatus {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ConditionVerificationStatus {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ConditionVerificationStatus {
