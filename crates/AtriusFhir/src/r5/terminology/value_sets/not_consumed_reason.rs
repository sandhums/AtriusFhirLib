...
///FHIR ValueSet: ReasonsFoodItemNotConsumed
///Canonical URL: http://hl7.org/fhir/ValueSet/not-consumed-reason
///Version: 5.0.0
///Title: Reasons for why a food item was not consumed
///Status: draft
...
impl ReasonsFoodItemNotConsumed {
    ...
    pub fn filter_rules() -> &'static [(&'static str, &'static str, &'static str)] {
        &[
            ("concept", "is-a", "228018009"),
            ("concept", "is-a", "302188001"),
            ("concept", "is-a", "386617003"),
        ]
    }
...
impl super::super::bindings::ValueSetMembership<Code> for ReasonsFoodItemNotConsumed {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ReasonsFoodItemNotConsumed {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ReasonsFoodItemNotConsumed {
