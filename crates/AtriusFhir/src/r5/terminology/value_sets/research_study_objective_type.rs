...
///FHIR ValueSet: ResearchStudyObjectiveType
///Canonical URL: http://hl7.org/fhir/ValueSet/research-study-objective-type
///Version: 5.0.0
///Title: Research Study Objective Type
///Status: draft
...
impl ResearchStudyObjectiveType {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/research-study-objective-type", "primary"),
            ("http://hl7.org/fhir/research-study-objective-type", "secondary"),
            ("http://hl7.org/fhir/research-study-objective-type", "exploratory"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "exploratory",
                Some("Exploratory"),
                Some("Exploratory questions to be answered in the study."),
            ),
            (
                "http://hl7.org/fhir/research-study-objective-type",
                "primary",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/research-study-objective-type" => {
                super::super::code_systems::research_study_objective_type::ResearchStudyObjectiveType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ResearchStudyObjectiveType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ResearchStudyObjectiveType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ResearchStudyObjectiveType {
