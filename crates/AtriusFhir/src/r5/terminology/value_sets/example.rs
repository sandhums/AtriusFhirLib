...
///FHIR ValueSet: LOINCCodesForCholesterolInSerumPlasma
///Canonical URL: http://hl7.org/fhir/ValueSet/example
///Version: 5.0.0
...
impl LOINCCodesForCholesterolInSerumPlasma {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ...
            ("http://loinc.org", "35200-5"),
            ("http://loinc.org", "9342-7"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            ("http://loinc.org", "14647-2", Some("Cholesterol [Moles/Volume]"), None),
            ("http://loinc.org", "2093-3", Some("Cholesterol [Mass/Volume]"), None),
            (
                "http://loinc.org",
                "35200-5",
                Some("Cholesterol [Mass Or Moles/Volume]"),
                None,
            ),
            ("http://loinc.org", "9342-7", Some("Cholesterol [Percentile]"), None),
        ]
    }
...
for LOINCCodesForCholesterolInSerumPlasma {
