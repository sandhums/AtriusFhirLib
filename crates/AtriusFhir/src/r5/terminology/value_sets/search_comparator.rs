...
///FHIR ValueSet: SearchComparator
...
impl super::super::bindings::ValueSetMembership<Code> for SearchComparator {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for SearchComparator {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for SearchComparator {
