...
///FHIR ValueSet: ValueFilterComparator
...
impl ValueFilterComparator {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ("http://hl7.org/fhir/search-comparator", "eb", Some("Ends Before"), None),
            ("http://hl7.org/fhir/search-comparator", "eq", Some("Equals"), None),
            (
                "http://hl7.org/fhir/search-comparator",
                "ge",
            ...
            ("http://hl7.org/fhir/search-comparator", "gt", Some("Greater Than"), None),
            ("http://hl7.org/fhir/search-comparator", "le", Some("Less of Equal"), None),
            ("http://hl7.org/fhir/search-comparator", "lt", Some("Less Than"), None),
            ("http://hl7.org/fhir/search-comparator", "sa", Some("Starts After"), None),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/search-comparator" => {
                super::super::code_systems::search_comparator::SearchComparator::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ValueFilterComparator {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ValueFilterComparator {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ValueFilterComparator {
