...
impl WeightType {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            ("http://hl7.org/fhir/substance-weight-type", "Exact", Some("exact"), None),
            (
                "http://hl7.org/fhir/substance-weight-type",
                "WeightAverage",
                Some("weight average"),
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/substance-weight-type" => {
                super::super::code_systems::substance_weight_type::SubstanceWeightType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for WeightType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for WeightType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for WeightType {
