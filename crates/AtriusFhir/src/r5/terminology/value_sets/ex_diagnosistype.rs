...
///FHIR ValueSet: ExampleDiagnosisTypeCodes
...
impl super::super::bindings::ValueSetMembership<Code> for ExampleDiagnosisTypeCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ExampleDiagnosisTypeCodes {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ExampleDiagnosisTypeCodes {
