...
///FHIR ValueSet: MedicinalProductPackageType
...
impl MedicinalProductPackageType {
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/medicinal-product-package-type" => {
                super::super::code_systems::medicinal_product_package_type::MedicinalProductPackageType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for MedicinalProductPackageType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for MedicinalProductPackageType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for MedicinalProductPackageType {
