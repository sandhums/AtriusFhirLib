...
///FHIR ValueSet: ChargeItemStatus
...
impl ChargeItemStatus {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "aborted",
                Some("Aborted"),
                Some("The processing of the charge was aborted."),
            ),
            (
                "http://hl7.org/fhir/chargeitem-status",
                "billable",
                Some("Billable"),
                Some("The charge item is ready for billing."),
            ),
            (
                "http://hl7.org/fhir/chargeitem-status",
                "billed",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/chargeitem-status" => {
                super::super::code_systems::chargeitem_status::ChargeItemStatus::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ChargeItemStatus {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ChargeItemStatus {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for ChargeItemStatus {
