...
///FHIR ValueSet: EnableWhenBehavior
...
impl EnableWhenBehavior {
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/questionnaire-enable-behavior" => {
                super::super::code_systems::questionnaire_enable_behavior::EnableWhenBehavior::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for EnableWhenBehavior {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for EnableWhenBehavior {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for EnableWhenBehavior {
