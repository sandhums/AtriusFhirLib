...
///FHIR ValueSet: ICD10ProcedureCodes
...
impl ICD10ProcedureCodes {
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/sid/ex-icd-10-procedures" => {
                super::super::code_systems::icd_10_procedures::ICD10ProcedureCodes::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ICD10ProcedureCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ICD10ProcedureCodes {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ICD10ProcedureCodes {
