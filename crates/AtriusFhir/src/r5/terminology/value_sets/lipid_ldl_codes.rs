...
impl LDLCodes {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[("http://loinc.org", "18262-6"), ("http://loinc.org", "13457-7")]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            ("http://loinc.org", "18262-6", Some("LDL Cholesterol (Assay)"), None),
        ]
    }
...
impl super::super::bindings::ValueSetMembership<Code> for LDLCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for LDLCodes {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for LDLCodes {
