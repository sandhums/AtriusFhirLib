...
///FHIR ValueSet: DatesTypeCodes
///Canonical URL: http://hl7.org/fhir/ValueSet/datestype
///Version: 5.0.0
///Title: Dates Type Codes
///Status: draft
...
impl DatesTypeCodes {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/datestype", "card-issued"),
            ("http://hl7.org/fhir/datestype", "claim-received"),
            ("http://hl7.org/fhir/datestype", "service-expected"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "card-issued",
                Some("Card Issued"),
                Some("The date when an insurance card was issued."),
            ),
            (
                "http://hl7.org/fhir/datestype",
                "claim-received",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/datestype" => {
                super::super::code_systems::datestype::DatesEventTypeCodes::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for DatesTypeCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for DatesTypeCodes {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for DatesTypeCodes {
