...
///FHIR ValueSet: CategoriesOfNutritionProducts
...
impl CategoriesOfNutritionProducts {
    ...
    pub fn filter_rules() -> &'static [(&'static str, &'static str, &'static str)] {
        &[("concept", "is-a", "226465004"), ("concept", "is-a", "255620007")]
    }
...
impl super::super::bindings::ValueSetMembership<Code> for CategoriesOfNutritionProducts {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding>
for CategoriesOfNutritionProducts {
