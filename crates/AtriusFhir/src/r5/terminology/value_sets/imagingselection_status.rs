...
///FHIR ValueSet: ImagingSelectionStatus
...
impl ImagingSelectionStatus {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/imagingselection-status", "available"),
            ("http://hl7.org/fhir/imagingselection-status", "entered-in-error"),
            ("http://hl7.org/fhir/imagingselection-status", "unknown"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "available",
                Some("Available"),
                Some("The selected resources are available.."),
            ),
            (
                "http://hl7.org/fhir/imagingselection-status",
                "entered-in-error",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/imagingselection-status" => {
                super::super::code_systems::imagingselection_status::ImagingSelectionStatus::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ImagingSelectionStatus {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ImagingSelectionStatus {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ImagingSelectionStatus {
