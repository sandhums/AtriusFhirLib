...
impl NoteType {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "display",
                Some("Display"),
                Some("Display the note."),
            ),
            (
                "http://hl7.org/fhir/note-type",
                "print",
                Some("Print (Form)"),
                Some("Print the note on the form."),
            ),
            (
                "http://hl7.org/fhir/note-type",
                "printoper",
                Some("Print (Operator)"),
                Some("Print the note for the operator."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/note-type" => {
                super::super::code_systems::note_type::NoteType::try_from_code(code)
                    .is_ok()
            }
            _ => false,
        }
...
impl super::super::bindings::ValueSetMembership<Code> for NoteType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for NoteType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for NoteType {
