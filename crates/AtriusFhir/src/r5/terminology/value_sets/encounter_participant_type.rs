...
impl ParticipantType {
    ...
    pub fn filter_rules() -> &'static [(&'static str, &'static str, &'static str)] {
        &[("concept", "is-a", "_ParticipationAncillary")]
    }
...
impl super::super::bindings::ValueSetMembership<Code> for ParticipantType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ParticipantType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for ParticipantType {
