...
///FHIR ValueSet: PatientRelationshipType
...
impl PatientRelationshipType {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ...
            ("http://terminology.hl7.org/CodeSystem/v3-RoleClass", "GUAR"),
            ("http://terminology.hl7.org/CodeSystem/v3-RoleClass", "CAREGIVER"),
            ...
            ("http://terminology.hl7.org/CodeSystem/v3-RoleCode", "BILL"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            ("http://terminology.hl7.org/CodeSystem/v2-0131", "E", None, None),
            ("http://terminology.hl7.org/CodeSystem/v2-0131", "O", None, None),
            ("http://terminology.hl7.org/CodeSystem/v2-0131", "U", None, None),
            (
                "http://terminology.hl7.org/CodeSystem/v3-ParticipationType",
                "WIT",
                None,
            ...
            ("http://terminology.hl7.org/CodeSystem/v3-RoleClass", "DEPEN", None, None),
            ("http://terminology.hl7.org/CodeSystem/v3-RoleClass", "ECON", None, None),
            ("http://terminology.hl7.org/CodeSystem/v3-RoleClass", "EMP", None, None),
            ("http://terminology.hl7.org/CodeSystem/v3-RoleClass", "GUAR", None, None),
            ("http://terminology.hl7.org/CodeSystem/v3-RoleClass", "GUARD", None, None),
            ("http://terminology.hl7.org/CodeSystem/v3-RoleClass", "NOK", None, None),
            ("http://terminology.hl7.org/CodeSystem/v3-RoleClass", "NOT", None, None),
            ("http://terminology.hl7.org/CodeSystem/v3-RoleCode", "BILL", None, None),
            ("http://terminology.hl7.org/CodeSystem/v3-RoleCode", "DPOWATT", None, None),
            ("http://terminology.hl7.org/CodeSystem/v3-RoleCode", "HPOWATT", None, None),
            (
                "http://terminology.hl7.org/CodeSystem/v3-RoleCode",
                "INTPRTER",
                None,
            ...
            ("http://terminology.hl7.org/CodeSystem/v3-RoleCode", "POWATT", None, None),
            ("http://terminology.hl7.org/CodeSystem/v3-RoleCode", "SPOWATT", None, None),
        ]
    }
...
impl super::super::bindings::ValueSetMembership<Code> for PatientRelationshipType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for PatientRelationshipType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for PatientRelationshipType {
