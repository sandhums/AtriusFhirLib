...
///FHIR ValueSet: ResearchStudyPartyOrgType
///Canonical URL: http://hl7.org/fhir/ValueSet/research-study-party-organization-type
///Version: 5.0.0
///Title: Research Study Party Organization Type
///Status: draft
...
impl ResearchStudyPartyOrgType {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/research-study-party-organization-type", "nih"),
            ("http://hl7.org/fhir/research-study-party-organization-type", "fda"),
            ("http://hl7.org/fhir/research-study-party-organization-type", "government"),
            ("http://hl7.org/fhir/research-study-party-organization-type", "nonprofit"),
            ("http://hl7.org/fhir/research-study-party-organization-type", "academic"),
            ("http://hl7.org/fhir/research-study-party-organization-type", "industry"),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/research-study-party-organization-type" => {
                super::super::code_systems::research_study_party_organization_type::ResearchStudyPartyOrganizationType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ResearchStudyPartyOrgType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ResearchStudyPartyOrgType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ResearchStudyPartyOrgType {
