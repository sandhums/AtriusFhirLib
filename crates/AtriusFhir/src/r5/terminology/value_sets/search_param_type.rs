...
impl SearchParamType {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                ...
                "quantity",
                Some("Quantity"),
                Some("A search parameter that searches on a quantity."),
            ),
            (
                "http://hl7.org/fhir/search-param-type",
                "reference",
                Some("Reference"),
                Some("A reference to another resource (Reference or canonical)."),
            ),
            (
                "http://hl7.org/fhir/search-param-type",
                "special",
            ...
            (
                ...
                "uri",
                Some("URI"),
                Some("A search parameter that searches on a URI (RFC 3986)."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/search-param-type" => {
                super::super::code_systems::search_param_type::SearchParamType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for SearchParamType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for SearchParamType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for SearchParamType {
