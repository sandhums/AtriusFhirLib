...
///FHIR ValueSet: ConditionClinicalStatusCodes
...
impl super::super::bindings::ValueSetMembership<Code> for ConditionClinicalStatusCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding>
for ConditionClinicalStatusCodes {
