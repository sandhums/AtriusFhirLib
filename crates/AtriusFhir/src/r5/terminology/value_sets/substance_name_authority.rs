...
///FHIR ValueSet: SubstanceNameAuthority
...
impl SubstanceNameAuthority {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ("http://hl7.org/fhir/substance-name-authority", "BAN", Some("BAN"), None),
            (
                "http://hl7.org/fhir/substance-name-authority",
                "COSING",
                Some("COSING"),
            ...
            ("http://hl7.org/fhir/substance-name-authority", "FCC", Some("FCC"), None),
            ("http://hl7.org/fhir/substance-name-authority", "HAB", Some("HAB"), None),
            ("http://hl7.org/fhir/substance-name-authority", "INCI", Some("INCI"), None),
            ("http://hl7.org/fhir/substance-name-authority", "INN", Some("INN"), None),
            ("http://hl7.org/fhir/substance-name-authority", "IUIS", Some("IUIS"), None),
            ("http://hl7.org/fhir/substance-name-authority", "JAN", Some("JAN"), None),
            (
                "http://hl7.org/fhir/substance-name-authority",
                "JECFA",
                Some("JECFA"),
            ...
            ("http://hl7.org/fhir/substance-name-authority", "PHF", Some("PHF"), None),
            (
                "http://hl7.org/fhir/substance-name-authority",
                "Ph.Eur.",
                Some("Ph.Eur."),
            ...
            (
                "http://hl7.org/fhir/substance-name-authority",
                "PhF",
                Some("PhF (Pharmacopée française)"),
                None,
            ),
            ("http://hl7.org/fhir/substance-name-authority", "USAN", Some("USAN"), None),
            ("http://hl7.org/fhir/substance-name-authority", "USP", Some("USP"), None),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/substance-name-authority" => {
                super::super::code_systems::substance_name_authority::SubstanceNameAuthority::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for SubstanceNameAuthority {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for SubstanceNameAuthority {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for SubstanceNameAuthority {
