...
///FHIR ValueSet: CapabilityStatementKind
...
impl CapabilityStatementKind {
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/capability-statement-kind" => {
                super::super::code_systems::capability_statement_kind::CapabilityStatementKind::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for CapabilityStatementKind {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for CapabilityStatementKind {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for CapabilityStatementKind {
