...
///FHIR ValueSet: ConditionStageType
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                "http://snomed.info/sct",
                "260998006",
                Some("Clinical staging (qualifier value)"),
                None,
            ),
            (
                "http://snomed.info/sct",
                "261023001",
                Some("Pathological staging (qualifier value)"),
                None,
            ),
        ]
    }
...
impl super::super::bindings::ValueSetMembership<Code> for ConditionStageType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ConditionStageType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for ConditionStageType {
