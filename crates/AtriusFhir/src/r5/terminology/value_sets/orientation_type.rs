...
impl OrientationType {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                Some("Antisense orientation of reference sequence."),
            ),
            (
                "http://hl7.org/fhir/orientation-type",
                "sense",
                Some("Sense orientation of referenceSeq"),
                Some("Sense orientation of reference sequence."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/orientation-type" => {
                super::super::code_systems::orientation_type::OrientationType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for OrientationType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for OrientationType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for OrientationType {
