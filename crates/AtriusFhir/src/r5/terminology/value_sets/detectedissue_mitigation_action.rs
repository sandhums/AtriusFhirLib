...
///FHIR ValueSet: DetectedIssueMitigationAction
...
impl DetectedIssueMitigationAction {
    ...
    pub fn filter_rules() -> &'static [(&'static str, &'static str, &'static str)] {
        &[("concept", "is-a", "_ActDetectedIssueManagementCode")]
    }
...
impl super::super::bindings::ValueSetMembership<Code> for DetectedIssueMitigationAction {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding>
for DetectedIssueMitigationAction {
