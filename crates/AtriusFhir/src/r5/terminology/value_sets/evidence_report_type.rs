...
///FHIR ValueSet: EvidenceReportType
...
impl EvidenceReportType {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/evidence-report-type", "classification"),
            ("http://hl7.org/fhir/evidence-report-type", "search-results"),
            ("http://hl7.org/fhir/evidence-report-type", "resources-compiled"),
            ("http://hl7.org/fhir/evidence-report-type", "text-structured"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                ...
                Some("The report is a structured representation of text."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/evidence-report-type" => {
                super::super::code_systems::evidence_report_type::EvidenceReportType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for EvidenceReportType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for EvidenceReportType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for EvidenceReportType {
