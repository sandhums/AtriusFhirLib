...
impl Kind {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/coverage-kind", "insurance"),
            ("http://hl7.org/fhir/coverage-kind", "self-pay"),
            ("http://hl7.org/fhir/coverage-kind", "other"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                ...
                "other",
                Some("Other"),
                Some("Some other organization is paying for the service."),
            ),
            (
                "http://hl7.org/fhir/coverage-kind",
                "self-pay",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/coverage-kind" => {
                super::super::code_systems::coverage_kind::Kind::try_from_code(code)
                    .is_ok()
            }
            _ => false,
        }
...
impl super::super::bindings::ValueSetMembership<Code> for Kind {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for Kind {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for Kind {
