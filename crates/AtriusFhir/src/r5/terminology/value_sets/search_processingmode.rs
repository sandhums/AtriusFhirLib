...
///FHIR ValueSet: SearchProcessingModeType
...
impl SearchProcessingModeType {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/search-processingmode", "normal"),
            ("http://hl7.org/fhir/search-processingmode", "phonetic"),
            ("http://hl7.org/fhir/search-processingmode", "other"),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/search-processingmode" => {
                super::super::code_systems::search_processingmode::SearchProcessingModeType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for SearchProcessingModeType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for SearchProcessingModeType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for SearchProcessingModeType {
