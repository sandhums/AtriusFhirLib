...
impl WeekOfMonth {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/week-of-month", "first"),
            ("http://hl7.org/fhir/week-of-month", "second"),
            ("http://hl7.org/fhir/week-of-month", "third"),
            ("http://hl7.org/fhir/week-of-month", "fourth"),
            ("http://hl7.org/fhir/week-of-month", "last"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "first",
                Some("First"),
                Some("First week of the month."),
            ),
            (
                "http://hl7.org/fhir/week-of-month",
                "fourth",
                Some("Fourth"),
                Some("Fourth week of the month."),
            ),
            (
                "http://hl7.org/fhir/week-of-month",
                "last",
                Some("Last"),
                Some("Last week of the month."),
            ),
            (
                "http://hl7.org/fhir/week-of-month",
                "second",
                Some("Second"),
                Some("Second week of the month."),
            ),
            (
                "http://hl7.org/fhir/week-of-month",
                "third",
                Some("Third"),
                Some("Third week of the month."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/week-of-month" => {
                super::super::code_systems::week_of_month::WeekOfMonth::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for WeekOfMonth {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for WeekOfMonth {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for WeekOfMonth {
