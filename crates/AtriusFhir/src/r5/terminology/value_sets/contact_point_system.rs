...
///FHIR ValueSet: ContactPointSystem
...
impl ContactPointSystem {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "email",
                Some("Email"),
                Some("The value is an email address."),
            ),
            (
                "http://hl7.org/fhir/contact-point-system",
                "fax",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/contact-point-system" => {
                super::super::code_systems::contact_point_system::ContactPointSystem::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ContactPointSystem {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ContactPointSystem {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for ContactPointSystem {
