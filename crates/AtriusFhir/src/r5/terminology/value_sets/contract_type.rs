...
///FHIR ValueSet: ContractTypeCodes
...
impl super::super::bindings::ValueSetMembership<Code> for ContractTypeCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ContractTypeCodes {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for ContractTypeCodes {
