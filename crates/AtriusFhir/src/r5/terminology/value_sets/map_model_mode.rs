...
///FHIR ValueSet: StructureMapModelMode
...
impl StructureMapModelMode {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                "http://hl7.org/fhir/map-model-mode",
                "source",
                Some("Source Structure Definition"),
                Some(
            ...
            (
                "http://hl7.org/fhir/map-model-mode",
                "target",
                Some("Target Structure Definition"),
                Some(
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/map-model-mode" => {
                super::super::code_systems::map_model_mode::StructureMapModelMode::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for StructureMapModelMode {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for StructureMapModelMode {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for StructureMapModelMode {
