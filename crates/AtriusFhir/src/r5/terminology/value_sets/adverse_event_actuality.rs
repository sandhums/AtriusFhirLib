...
///FHIR ValueSet: AdverseEventActuality
...
impl AdverseEventActuality {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                ...
                Some("A potential adverse event."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/adverse-event-actuality" => {
                super::super::code_systems::adverse_event_actuality::AdverseEventActuality::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for AdverseEventActuality {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for AdverseEventActuality {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for AdverseEventActuality {
