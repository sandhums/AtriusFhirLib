...
///FHIR ValueSet: AdjudicationReasonCodes
...
impl super::super::bindings::ValueSetMembership<Code> for AdjudicationReasonCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for AdjudicationReasonCodes {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for AdjudicationReasonCodes {
