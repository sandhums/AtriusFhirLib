...
///FHIR ValueSet: SpecimenCollection
...
impl SpecimenCollection {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ("http://snomed.info/sct", "129300006", Some("Puncture - action"), None),
            ("http://snomed.info/sct", "129304002", Some("Excision - action"), None),
            ("http://snomed.info/sct", "129314006", Some("Biopsy - action"), None),
            ("http://snomed.info/sct", "129316008", Some("Aspiration - action"), None),
            ("http://snomed.info/sct", "129323009", Some("Scraping - action"), None),
            (
                "http://snomed.info/sct",
                "225113003",
                Some("Timed urine collection"),
                None,
            ),
            ("http://snomed.info/sct", "278450005", Some("Finger-prick sampling"), None),
            (
                "http://snomed.info/sct",
                "386089008",
                Some("Collection of coughed sputum"),
                None,
            ),
            (
                "http://snomed.info/sct",
                "70777001",
                Some("Urine specimen collection, catheterized"),
                None,
            ),
            (
                "http://snomed.info/sct",
                "73416001",
                Some("Urine specimen collection, clean catch"),
                None,
            ),
        ]
    }
...
impl super::super::bindings::ValueSetMembership<Code> for SpecimenCollection {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for SpecimenCollection {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for SpecimenCollection {
