...
///FHIR ValueSet: VersionAlgorithm
...
impl VersionAlgorithm {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/version-algorithm", "semver"),
            ("http://hl7.org/fhir/version-algorithm", "integer"),
            ("http://hl7.org/fhir/version-algorithm", "alpha"),
            ("http://hl7.org/fhir/version-algorithm", "date"),
            ("http://hl7.org/fhir/version-algorithm", "natural"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                ...
                "integer",
                Some("Integer"),
                Some("Versions are integers and ordered numerically"),
            ),
            (
                "http://hl7.org/fhir/version-algorithm",
                "natural",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/version-algorithm" => {
                super::super::code_systems::version_algorithm::VersionAlgorithm::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for VersionAlgorithm {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for VersionAlgorithm {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for VersionAlgorithm {
