...
///FHIR ValueSet: MissingToothReasonCodes
...
impl super::super::bindings::ValueSetMembership<Code> for MissingToothReasonCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for MissingToothReasonCodes {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for MissingToothReasonCodes {
