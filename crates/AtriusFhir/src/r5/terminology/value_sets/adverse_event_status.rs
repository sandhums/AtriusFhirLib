...
///FHIR ValueSet: AdverseEventStatus
...
impl AdverseEventStatus {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ("http://hl7.org/fhir/event-status", "completed", None, None),
            ("http://hl7.org/fhir/event-status", "entered-in-error", None, None),
            ("http://hl7.org/fhir/event-status", "in-progress", None, None),
            ("http://hl7.org/fhir/event-status", "unknown", None, None),
        ]
    }
...
impl super::super::bindings::ValueSetMembership<Code> for AdverseEventStatus {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for AdverseEventStatus {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for AdverseEventStatus {
