...
impl MedicationDoseAids {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/CodeSystem/medication-dose-aid", "blisterpack"),
            ("http://hl7.org/fhir/CodeSystem/medication-dose-aid", "dosette"),
            ("http://hl7.org/fhir/CodeSystem/medication-dose-aid", "sachets"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                ...
                "sachets",
                Some("Sachets"),
                Some("A small packet that contains medication for individual use."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/CodeSystem/medication-dose-aid" => {
                super::super::code_systems::medication_dose_aid::MedicationDoseAid::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for MedicationDoseAids {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for MedicationDoseAids {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for MedicationDoseAids {
