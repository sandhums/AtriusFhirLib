...
///FHIR ValueSet: ClaimInformationCategoryCodes
...
impl super::super::bindings::ValueSetMembership<Code> for ClaimInformationCategoryCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding>
for ClaimInformationCategoryCodes {
