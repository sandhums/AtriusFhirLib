...
///FHIR ValueSet: IdentityAssuranceLevel
...
impl IdentityAssuranceLevel {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "level1",
                Some("Level 1"),
                Some("Little or no confidence in the asserted identity's accuracy."),
            ),
            (
                "http://hl7.org/fhir/identity-assuranceLevel",
                "level2",
                Some("Level 2"),
                Some("Some confidence in the asserted identity's accuracy."),
            ),
            (
                "http://hl7.org/fhir/identity-assuranceLevel",
                "level3",
                Some("Level 3"),
                Some("High confidence in the asserted identity's accuracy."),
            ),
            (
                "http://hl7.org/fhir/identity-assuranceLevel",
                "level4",
                Some("Level 4"),
                Some("Very high confidence in the asserted identity's accuracy."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/identity-assuranceLevel" => {
                super::super::code_systems::identity_assuranceLevel::IdentityAssuranceLevel::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for IdentityAssuranceLevel {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for IdentityAssuranceLevel {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for IdentityAssuranceLevel {
