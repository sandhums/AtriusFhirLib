...
///FHIR ValueSet: BenefitCategoryCodes
...
impl super::super::bindings::ValueSetMembership<Code> for BenefitCategoryCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for BenefitCategoryCodes {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for BenefitCategoryCodes {
