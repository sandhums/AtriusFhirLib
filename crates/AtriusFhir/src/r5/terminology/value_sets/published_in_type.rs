...
impl PublishedInType {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/published-in-type", "D020492"),
            ("http://hl7.org/fhir/published-in-type", "D019991"),
            ("http://hl7.org/fhir/published-in-type", "D001877"),
            ("http://hl7.org/fhir/published-in-type", "D064886"),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/published-in-type" => {
                super::super::code_systems::published_in_type::PublishedInType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for PublishedInType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for PublishedInType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for PublishedInType {
