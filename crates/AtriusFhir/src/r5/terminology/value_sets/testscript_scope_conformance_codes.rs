...
///FHIR ValueSet: TestScriptScopeConformanceType
...
impl TestScriptScopeConformanceType {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/testscript-scope-conformance-codes", "required"),
            ("http://hl7.org/fhir/testscript-scope-conformance-codes", "optional"),
            ("http://hl7.org/fhir/testscript-scope-conformance-codes", "strict"),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/testscript-scope-conformance-codes" => {
                super::super::code_systems::testscript_scope_conformance_codes::TestScriptScopeConformanceType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
for TestScriptScopeConformanceType {
