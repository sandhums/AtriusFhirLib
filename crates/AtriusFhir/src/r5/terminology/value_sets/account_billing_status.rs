...
///FHIR ValueSet: AccountBillingStatus
...
impl AccountBillingStatus {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/account-billing-status", "open"),
            ("http://hl7.org/fhir/account-billing-status", "carecomplete-notbilled"),
            ("http://hl7.org/fhir/account-billing-status", "billing"),
            ("http://hl7.org/fhir/account-billing-status", "closed-baddebt"),
            ("http://hl7.org/fhir/account-billing-status", "closed-voided"),
            ("http://hl7.org/fhir/account-billing-status", "closed-completed"),
            ("http://hl7.org/fhir/account-billing-status", "closed-combined"),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/account-billing-status" => {
                super::super::code_systems::account_billing_status::AccountBillingStatus::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for AccountBillingStatus {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for AccountBillingStatus {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for AccountBillingStatus {
