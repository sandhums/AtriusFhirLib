...
///FHIR ValueSet: ProductCharacteristic
...
impl super::super::bindings::ValueSetMembership<Code> for ProductCharacteristic {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ProductCharacteristic {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ProductCharacteristic {
