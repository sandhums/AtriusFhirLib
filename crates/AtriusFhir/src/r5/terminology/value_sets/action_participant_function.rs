...
///FHIR ValueSet: ActionParticipantFunction
...
impl ActionParticipantFunction {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/action-participant-function", "performer"),
            ("http://hl7.org/fhir/action-participant-function", "author"),
            ("http://hl7.org/fhir/action-participant-function", "reviewer"),
            ("http://hl7.org/fhir/action-participant-function", "witness"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "author",
                Some("Author"),
                Some("The participant is the author of the result of the action."),
            ),
            (
                "http://hl7.org/fhir/action-participant-function",
                "performer",
                Some("Performer"),
                Some("The participant is the performer of the action."),
            ),
            (
                "http://hl7.org/fhir/action-participant-function",
                "reviewer",
                Some("Reviewer"),
                Some("The participant is reviewing the result of the action."),
            ),
            (
                "http://hl7.org/fhir/action-participant-function",
                "witness",
                Some("Witness"),
                Some("The participant is a witness to the action being performed."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/action-participant-function" => {
                super::super::code_systems::action_participant_function::ActionParticipantFunction::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ActionParticipantFunction {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ActionParticipantFunction {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ActionParticipantFunction {
