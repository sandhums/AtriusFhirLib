...
impl UnitsOfTime {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ("http://unitsofmeasure.org", "a", Some("year"), Some("year")),
            ("http://unitsofmeasure.org", "d", Some("day"), Some("day")),
            ("http://unitsofmeasure.org", "h", Some("hour"), Some("hour")),
            ("http://unitsofmeasure.org", "min", Some("minute"), Some("minute")),
            (
                "http://unitsofmeasure.org",
                "mo",
                Some("month"),
                Some(
                    "month - Normal practice is to use the 'mo' code as a calendar month when calculating the next occurrence.",
                ),
            ),
            ("http://unitsofmeasure.org", "s", Some("second"), Some("second")),
            ("http://unitsofmeasure.org", "wk", Some("week"), Some("week")),
        ]
    }
...
impl super::super::bindings::ValueSetMembership<Code> for UnitsOfTime {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for UnitsOfTime {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for UnitsOfTime {
