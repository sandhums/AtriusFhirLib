...
///FHIR ValueSet: HandlingConditionSet
///Canonical URL: http://hl7.org/fhir/ValueSet/handling-condition
///Version: 5.0.0
///Title: Handling Condition Set
///Status: draft
...
impl super::super::bindings::ValueSetMembership<Code> for HandlingConditionSet {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for HandlingConditionSet {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for HandlingConditionSet {
