...
///FHIR ValueSet: MessageheaderResponseRequest
...
impl MessageheaderResponseRequest {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "always",
                Some("Always"),
                Some("initiator expects a response for this message."),
            ),
            (
                "http://hl7.org/fhir/messageheader-response-request",
                "never",
                Some("Never"),
                Some("initiator does not expect a response."),
            ),
            (
                "http://hl7.org/fhir/messageheader-response-request",
                "on-error",
                Some("Error/reject conditions only"),
                Some("initiator expects a response only if in error."),
            ),
            (
                "http://hl7.org/fhir/messageheader-response-request",
                "on-success",
                Some("Successful completion only"),
                Some("initiator expects a response only if successful."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/messageheader-response-request" => {
                super::super::code_systems::messageheader_response_request::MessageheaderResponseRequest::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for MessageheaderResponseRequest {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding>
for MessageheaderResponseRequest {
