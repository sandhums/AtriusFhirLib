...
///FHIR ValueSet: ObservationDataType
...
impl ObservationDataType {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                ...
                "Period",
                Some("Period"),
                Some("A time range defined by start and end date/time."),
            ),
            (
                "http://hl7.org/fhir/permitted-data-type",
                "Quantity",
                Some("Quantity"),
                Some("A measured amount."),
            ),
            (
                "http://hl7.org/fhir/permitted-data-type",
                "Range",
                Some("Range"),
                Some("A set of values bounded by low and high."),
            ),
            (
                "http://hl7.org/fhir/permitted-data-type",
                "Ratio",
                Some("Ratio"),
                Some("A ratio of two Quantity values - a numerator and a denominator."),
            ),
            (
                "http://hl7.org/fhir/permitted-data-type",
                "SampledData",
                Some("SampledData"),
                Some("A series of measurements taken by a device."),
            ),
            (
                "http://hl7.org/fhir/permitted-data-type",
                "boolean",
            ...
            (
                ...
                "integer",
                Some("integer"),
                Some("A signed integer."),
            ),
            (
                "http://hl7.org/fhir/permitted-data-type",
                "string",
                Some("string"),
                Some("A sequence of Unicode characters."),
            ),
            (
                "http://hl7.org/fhir/permitted-data-type",
                "time",
                Some("time"),
                Some("A time during the day, in the format hh:mm:ss."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/permitted-data-type" => {
                super::super::code_systems::permitted_data_type::ObservationDataType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ObservationDataType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ObservationDataType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ObservationDataType {
