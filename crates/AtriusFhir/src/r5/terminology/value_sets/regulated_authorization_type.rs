...
///FHIR ValueSet: RegulatedAuthorizationType
...
impl RegulatedAuthorizationType {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                "http://hl7.org/fhir/regulated-authorization-type",
                "Orphan",
                Some("Orphan Drug Authorization"),
                None,
            ),
            (
                "http://hl7.org/fhir/regulated-authorization-type",
                "Pediatric",
                Some("Pediatric Use Drug Authorization"),
                None,
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/regulated-authorization-type" => {
                super::super::code_systems::regulated_authorization_type::RegulatedAuthorizationType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for RegulatedAuthorizationType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for RegulatedAuthorizationType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for RegulatedAuthorizationType {
