...
///FHIR ValueSet: SubscriptionStatusCodes
...
impl SubscriptionStatusCodes {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ...
            ("http://hl7.org/fhir/subscription-status", "entered-in-error"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "active",
                Some("Active"),
                Some("The subscription is active."),
            ),
            (
                "http://hl7.org/fhir/subscription-status",
                "entered-in-error",
                Some("Entered in Error"),
                Some("This subscription has been flagged as incorrect."),
            ),
            (
                "http://hl7.org/fhir/subscription-status",
                "error",
                Some("Error"),
                Some("The server has an error executing the notification."),
            ),
            (
                "http://hl7.org/fhir/subscription-status",
                "off",
                Some("Off"),
                Some("Too many errors have occurred or the subscription has expired."),
            ),
            (
                "http://hl7.org/fhir/subscription-status",
                "requested",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/subscription-status" => {
                super::super::code_systems::subscription_status::SubscriptionStatus::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for SubscriptionStatusCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for SubscriptionStatusCodes {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for SubscriptionStatusCodes {
