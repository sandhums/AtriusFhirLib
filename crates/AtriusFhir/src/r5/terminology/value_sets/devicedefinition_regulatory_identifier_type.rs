...
///FHIR ValueSet: DeviceDefinitionRegulatoryIdentifierType
///Canonical URL: http://hl7.org/fhir/ValueSet/devicedefinition-regulatory-identifier-type
///Version: 5.0.0
///Title: Device Definition Regulatory Identifier Type
///Status: active
...
impl DeviceDefinitionRegulatoryIdentifierType {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/devicedefinition-regulatory-identifier-type", "basic"),
            (
                "http://hl7.org/fhir/devicedefinition-regulatory-identifier-type",
                "master",
            ),
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "basic",
                Some("Basic"),
                Some("EUDAMED's basic UDI-DI identifier."),
            ),
            (
                "http://hl7.org/fhir/devicedefinition-regulatory-identifier-type",
                "license",
                Some("License"),
                Some("The identifier is a license number."),
            ),
            (
                "http://hl7.org/fhir/devicedefinition-regulatory-identifier-type",
                "master",
                Some("Master"),
                Some("EUDAMED's master UDI-DI identifier."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/devicedefinition-regulatory-identifier-type" => {
                super::super::code_systems::devicedefinition_regulatory_identifier_type::DeviceRegulatoryIdentifierType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
for DeviceDefinitionRegulatoryIdentifierType {
