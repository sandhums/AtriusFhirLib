...
///FHIR ValueSet: CarePlanCategory
...
impl super::super::bindings::ValueSetMembership<Code> for CarePlanCategory {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for CarePlanCategory {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for CarePlanCategory {
