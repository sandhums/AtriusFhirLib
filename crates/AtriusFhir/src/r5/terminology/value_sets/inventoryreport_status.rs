...
///FHIR ValueSet: InventoryReportStatus
...
impl InventoryReportStatus {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/inventoryreport-status", "draft"),
            ("http://hl7.org/fhir/inventoryreport-status", "requested"),
            ("http://hl7.org/fhir/inventoryreport-status", "active"),
            ("http://hl7.org/fhir/inventoryreport-status", "entered-in-error"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "active",
                Some("Active"),
                Some("This report is submitted as current."),
            ),
            (
                "http://hl7.org/fhir/inventoryreport-status",
                "draft",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/inventoryreport-status" => {
                super::super::code_systems::inventoryreport_status::InventoryReportStatus::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for InventoryReportStatus {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for InventoryReportStatus {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for InventoryReportStatus {
