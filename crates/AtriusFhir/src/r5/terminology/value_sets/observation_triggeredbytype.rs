...
impl TriggeredBytype {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/observation-triggeredbytype", "reflex"),
            ("http://hl7.org/fhir/observation-triggeredbytype", "repeat"),
            ("http://hl7.org/fhir/observation-triggeredbytype", "re-run"),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/observation-triggeredbytype" => {
                super::super::code_systems::observation_triggeredbytype::TriggeredBytype::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for TriggeredBytype {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for TriggeredBytype {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for TriggeredBytype {
