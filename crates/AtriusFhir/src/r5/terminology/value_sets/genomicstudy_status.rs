...
///FHIR ValueSet: GenomicStudyStatus
...
impl GenomicStudyStatus {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/genomicstudy-status", "registered"),
            ("http://hl7.org/fhir/genomicstudy-status", "available"),
            ("http://hl7.org/fhir/genomicstudy-status", "cancelled"),
            ("http://hl7.org/fhir/genomicstudy-status", "entered-in-error"),
            ("http://hl7.org/fhir/genomicstudy-status", "unknown"),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/genomicstudy-status" => {
                super::super::code_systems::genomicstudy_status::GenomicStudyStatus::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for GenomicStudyStatus {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for GenomicStudyStatus {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for GenomicStudyStatus {
