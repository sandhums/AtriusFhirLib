...
impl EndpointStatus {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "active",
                Some("Active"),
                Some("This endpoint is expected to be active and can be used."),
            ),
            (
                "http://hl7.org/fhir/endpoint-status",
                "entered-in-error",
            ...
            (
                ...
                "off",
                Some("Off"),
                Some("This endpoint is no longer to be used."),
            ),
            (
                "http://hl7.org/fhir/endpoint-status",
                "suspended",
                Some("Suspended"),
                Some("This endpoint is temporarily unavailable."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/endpoint-status" => {
                super::super::code_systems::endpoint_status::EndpointStatus::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for EndpointStatus {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for EndpointStatus {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for EndpointStatus {
