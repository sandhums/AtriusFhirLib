...
///FHIR ValueSet: MeasureImprovementNotation
///Canonical URL: http://hl7.org/fhir/ValueSet/measure-improvement-notation
///Version: 5.0.0
///Title: Measure Improvement Notation
///Status: draft
...
impl super::super::bindings::ValueSetMembership<Code> for MeasureImprovementNotation {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for MeasureImprovementNotation {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for MeasureImprovementNotation {
