...
///FHIR ValueSet: ClinicalUseDefinitionCategory
...
impl ClinicalUseDefinitionCategory {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                "http://hl7.org/fhir/clinical-use-definition-category",
                "DriveAndMachines",
                Some("Effects on Ability to Drive and Use Machines"),
                None,
            ),
            (
                "http://hl7.org/fhir/clinical-use-definition-category",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/clinical-use-definition-category" => {
                super::super::code_systems::clinical_use_definition_category::ClinicalUseDefinitionCategory::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ClinicalUseDefinitionCategory {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding>
for ClinicalUseDefinitionCategory {
