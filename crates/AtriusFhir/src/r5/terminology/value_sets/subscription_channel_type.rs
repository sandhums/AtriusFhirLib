...
///FHIR ValueSet: SubscriptionChannelType
...
impl super::super::bindings::ValueSetMembership<Code> for SubscriptionChannelType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for SubscriptionChannelType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for SubscriptionChannelType {
