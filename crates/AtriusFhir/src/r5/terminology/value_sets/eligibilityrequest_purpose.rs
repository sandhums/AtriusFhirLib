...
///FHIR ValueSet: EligibilityRequestPurpose
...
impl EligibilityRequestPurpose {
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/eligibilityrequest-purpose" => {
                super::super::code_systems::eligibilityrequest_purpose::EligibilityRequestPurpose::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for EligibilityRequestPurpose {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for EligibilityRequestPurpose {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for EligibilityRequestPurpose {
