...
///FHIR ValueSet: RelatedArtifactType
...
impl super::super::bindings::ValueSetMembership<Code> for RelatedArtifactType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for RelatedArtifactType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for RelatedArtifactType {
