...
///FHIR ValueSet: GuidanceResponseStatus
...
impl GuidanceResponseStatus {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                ...
                Some("The response was entered in error."),
            ),
            (
                "http://hl7.org/fhir/guidance-response-status",
                "failure",
                Some("Failure"),
                Some("The request was not processed successfully."),
            ),
            (
                "http://hl7.org/fhir/guidance-response-status",
                "in-progress",
                Some("In Progress"),
                Some("The request is currently being processed."),
            ),
            (
                "http://hl7.org/fhir/guidance-response-status",
                "success",
                Some("Success"),
                Some("The request was processed successfully."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/guidance-response-status" => {
                super::super::code_systems::guidance_response_status::GuidanceResponseStatus::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for GuidanceResponseStatus {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for GuidanceResponseStatus {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for GuidanceResponseStatus {
