...
///FHIR ValueSet: SpecimenProcessingMethod
///Canonical URL: http://hl7.org/fhir/ValueSet/specimen-processing-method
///Version: 5.0.0
///Title: Specimen Processing Method
///Status: draft
...
impl super::super::bindings::ValueSetMembership<Code> for SpecimenProcessingMethod {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for SpecimenProcessingMethod {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for SpecimenProcessingMethod {
