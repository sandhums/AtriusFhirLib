...
///FHIR ValueSet: DetectedIssueSeverity
...
impl DetectedIssueSeverity {
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/detectedissue-severity" => {
                super::super::code_systems::detectedissue_severity::DetectedIssueSeverity::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for DetectedIssueSeverity {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for DetectedIssueSeverity {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for DetectedIssueSeverity {
