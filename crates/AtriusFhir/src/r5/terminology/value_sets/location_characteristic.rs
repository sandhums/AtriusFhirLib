...
///FHIR ValueSet: LocationCharacteristic
...
impl LocationCharacteristic {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/location-characteristic", "wheelchair"),
            ("http://hl7.org/fhir/location-characteristic", "has-translation"),
            ("http://hl7.org/fhir/location-characteristic", "has-oxy-nitro"),
            ("http://hl7.org/fhir/location-characteristic", "has-neg-press"),
            ("http://hl7.org/fhir/location-characteristic", "has-iso-ward"),
            ("http://hl7.org/fhir/location-characteristic", "has-icu"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "has-icu",
                Some("has ICU"),
                Some("The location is or has an intensive care unit"),
            ),
            (
                "http://hl7.org/fhir/location-characteristic",
                "has-iso-ward",
                Some("isolation ward"),
                Some("The location is or has an isolation ward"),
            ),
            (
                "http://hl7.org/fhir/location-characteristic",
                "has-neg-press",
                Some("negative pressure rooms available"),
                Some("The location has negative pressure rooms available"),
            ),
            (
                "http://hl7.org/fhir/location-characteristic",
                "has-oxy-nitro",
                Some("oxygen/nitrogen available"),
                Some("The location has oxygen and nitrogen services available"),
            ),
            (
                "http://hl7.org/fhir/location-characteristic",
                "has-translation",
                Some("translation services available"),
                Some("The location has translation services available"),
            ),
            (
                "http://hl7.org/fhir/location-characteristic",
                "wheelchair",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/location-characteristic" => {
                super::super::code_systems::location_characteristic::LocationCharacteristic::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for LocationCharacteristic {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for LocationCharacteristic {
