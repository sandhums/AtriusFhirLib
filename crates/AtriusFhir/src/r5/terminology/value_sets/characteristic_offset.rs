...
///FHIR ValueSet: CharacteristicOffset
...
impl CharacteristicOffset {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/characteristic-offset", "UNL"),
            ("http://hl7.org/fhir/characteristic-offset", "LNL"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                "http://hl7.org/fhir/characteristic-offset",
                "LNL",
                Some("Lower Normal Limit"),
                Some("The lower bound of the reference range."),
            ),
            (
                "http://hl7.org/fhir/characteristic-offset",
                "UNL",
                Some("Upper Normal Limit"),
                Some("The upper bound of the reference range."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/characteristic-offset" => {
                super::super::code_systems::characteristic_offset::CharacteristicOffset::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for CharacteristicOffset {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for CharacteristicOffset {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for CharacteristicOffset {
