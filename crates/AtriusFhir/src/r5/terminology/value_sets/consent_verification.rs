...
///FHIR ValueSet: ConsentVerificationCodes
///Canonical URL: http://hl7.org/fhir/ValueSet/consent-verification
///Version: 5.0.0
///Title: Consent Vefication Codes
///Status: draft
...
impl super::super::bindings::ValueSetMembership<Code> for ConsentVerificationCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ConsentVerificationCodes {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ConsentVerificationCodes {
