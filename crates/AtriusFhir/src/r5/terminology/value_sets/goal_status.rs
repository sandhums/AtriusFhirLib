...
///FHIR ValueSet: GoalLifecycleStatus
...
impl GoalLifecycleStatus {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "accepted",
                Some("Accepted"),
                Some("A proposed goal was accepted or acknowledged."),
            ),
            (
                "http://hl7.org/fhir/goal-status",
                "active",
                Some("Active"),
                Some("The goal is being sought actively."),
            ),
            (
                "http://hl7.org/fhir/goal-status",
                "cancelled",
                Some("Cancelled"),
                Some("The goal has been abandoned."),
            ),
            (
                "http://hl7.org/fhir/goal-status",
                "completed",
                Some("Completed"),
                Some("The goal is no longer being sought."),
            ),
            (
                "http://hl7.org/fhir/goal-status",
                "entered-in-error",
                Some("Entered in Error"),
                Some("The goal was entered in error and voided."),
            ),
            (
                "http://hl7.org/fhir/goal-status",
                "on-hold",
            ...
            (
                ...
                "planned",
                Some("Planned"),
                Some("A goal is planned for this patient."),
            ),
            (
                "http://hl7.org/fhir/goal-status",
                "proposed",
                Some("Proposed"),
                Some("A goal is proposed for this patient."),
            ),
            (
                "http://hl7.org/fhir/goal-status",
                "rejected",
                Some("Rejected"),
                Some("A proposed goal was rejected."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/goal-status" => {
                super::super::code_systems::goal_status::GoalLifecycleStatus::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for GoalLifecycleStatus {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for GoalLifecycleStatus {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for GoalLifecycleStatus {
