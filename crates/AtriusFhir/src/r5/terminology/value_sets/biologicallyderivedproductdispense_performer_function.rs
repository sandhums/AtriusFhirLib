...
///FHIR ValueSet: BiologicallyDerivedProductDispensePerformerFunction
...
impl BiologicallyDerivedProductDispensePerformerFunction {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                "http://hl7.org/fhir/CodeSystem/biologicallyderivedproductdispense-performer-function",
                "antibody-identification",
                Some("Antibody Identification"),
                Some("Antibody identification procedure"),
            ),
            (
                "http://hl7.org/fhir/CodeSystem/biologicallyderivedproductdispense-performer-function",
                "antibody-screen",
                Some("Antibody Screen"),
                Some("Antibody screening procedure"),
            ),
            (
                "http://hl7.org/fhir/CodeSystem/biologicallyderivedproductdispense-performer-function",
                "crossmatch",
                Some("Crossmatch"),
                Some("Serological or electronic crossmatch procedure"),
            ),
            (
                "http://hl7.org/fhir/CodeSystem/biologicallyderivedproductdispense-performer-function",
                "group-and-type",
                Some("Group and Type"),
                Some("ABO and RhD blood grouping procedure"),
            ),
            (
                "http://hl7.org/fhir/CodeSystem/biologicallyderivedproductdispense-performer-function",
                "receipt",
                Some("Receipt"),
                Some("Receipt of product for clinical application"),
            ),
            (
                "http://hl7.org/fhir/CodeSystem/biologicallyderivedproductdispense-performer-function",
                "release",
                Some("Release"),
                Some("Approval for release for clinical application"),
            ),
            (
                "http://hl7.org/fhir/CodeSystem/biologicallyderivedproductdispense-performer-function",
                "transport",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/CodeSystem/biologicallyderivedproductdispense-performer-function" => {
                super::super::code_systems::biologicallyderivedproductdispense_performer_function::BiologicallyDerivedProductDispensePerformerFunction::try_from_code(
                        code,
                    )
                    .is_ok()
            }
