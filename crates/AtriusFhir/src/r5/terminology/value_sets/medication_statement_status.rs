...
///FHIR ValueSet: MedicationStatementStatusCodes
...
impl MedicationStatementStatusCodes {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/CodeSystem/medication-statement-status", "recorded"),
            (
                "http://hl7.org/fhir/CodeSystem/medication-statement-status",
                "entered-in-error",
            ),
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "draft",
                Some("Draft"),
                Some("The medication usage is draft or preliminary."),
            ),
            (
                "http://hl7.org/fhir/CodeSystem/medication-statement-status",
                "entered-in-error",
            ...
            (
                ...
                "recorded",
                Some("Recorded"),
                Some("The action of recording the medication statement is finished."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/CodeSystem/medication-statement-status" => {
                super::super::code_systems::medication_statement_status::MedicationStatementStatusCodes::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
for MedicationStatementStatusCodes {
