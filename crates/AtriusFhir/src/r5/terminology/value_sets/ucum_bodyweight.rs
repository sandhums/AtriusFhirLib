...
impl BodyWeightUnits {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ("http://unitsofmeasure.org", "[lb_av]", None, None),
            ("http://unitsofmeasure.org", "g", None, None),
            ("http://unitsofmeasure.org", "kg", None, None),
        ]
    }
...
impl super::super::bindings::ValueSetMembership<Code> for BodyWeightUnits {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for BodyWeightUnits {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for BodyWeightUnits {
