...
///FHIR ValueSet: NutritionProductStatus
...
impl NutritionProductStatus {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                ...
                "inactive",
                Some("Inactive"),
                Some("The product is not expected or allowed to be used."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/nutritionproduct-status" => {
                super::super::code_systems::nutritionproduct_status::NutritionProductStatus::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for NutritionProductStatus {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for NutritionProductStatus {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for NutritionProductStatus {
