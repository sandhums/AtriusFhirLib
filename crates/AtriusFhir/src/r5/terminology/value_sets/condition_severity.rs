...
///FHIR ValueSet: ConditionDiagnosisSeverity
...
impl ConditionDiagnosisSeverity {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ("http://snomed.info/sct", "24484000", None, None),
            ("http://snomed.info/sct", "255604002", None, None),
            ("http://snomed.info/sct", "6736007", None, None),
        ]
    }
...
impl super::super::bindings::ValueSetMembership<Code> for ConditionDiagnosisSeverity {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ConditionDiagnosisSeverity {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ConditionDiagnosisSeverity {
