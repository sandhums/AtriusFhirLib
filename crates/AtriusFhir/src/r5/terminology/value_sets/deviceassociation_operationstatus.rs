...
///FHIR ValueSet: FHIRDeviceAssociationOperationStatus
///Canonical URL: http://hl7.org/fhir/ValueSet/deviceassociation-operationstatus
///Version: 5.0.0
///Title: FHIR Device Association Operation Status
///Status: draft
...
impl FHIRDeviceAssociationOperationStatus {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/deviceassociation-operationstatus", "on"),
            ("http://hl7.org/fhir/deviceassociation-operationstatus", "off"),
            ("http://hl7.org/fhir/deviceassociation-operationstatus", "standby"),
            ("http://hl7.org/fhir/deviceassociation-operationstatus", "defective"),
            ("http://hl7.org/fhir/deviceassociation-operationstatus", "unknown"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                ...
                "off",
                Some("Off"),
                Some("The device is inactive, switched off, or deactivated."),
            ),
            (
                "http://hl7.org/fhir/deviceassociation-operationstatus",
                "on",
                Some("On"),
                Some("The device is working or switched on, i.e. active."),
            ),
            (
                "http://hl7.org/fhir/deviceassociation-operationstatus",
                "standby",
            ...
            (
                ...
                "unknown",
                Some("Unknown"),
                Some("The operational status of the device has not been determined."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/deviceassociation-operationstatus" => {
                super::super::code_systems::deviceassociation_operationstatus::FHIRDeviceAssociationOperationStatus::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
for FHIRDeviceAssociationOperationStatus {
