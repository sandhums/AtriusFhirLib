...
///FHIR ValueSet: DeviceDispenseStatusReasonCodes
...
impl DeviceDispenseStatusReasonCodes {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                ...
                "out-of-stock",
                Some("Out of Stock"),
                Some("The device was not dispensed because it was not available."),
            ),
            (
                "http://hl7.org/fhir/CodeSystem/devicedispense-status-reason",
                "verbal-order",
                Some("Verbal order"),
                Some("The device not dispensed because there was a verbal order."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/CodeSystem/devicedispense-status-reason" => {
                super::super::code_systems::devicedispense_status_reason::DeviceDispenseStatusReasonCodes::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
for DeviceDispenseStatusReasonCodes {
