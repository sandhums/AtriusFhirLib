...
impl TaskStatus {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                ...
                "cancelled",
                Some("Cancelled"),
                Some("The task was not completed."),
            ),
            (
                "http://hl7.org/fhir/task-status",
                "completed",
                Some("Completed"),
                Some("The task has been completed."),
            ),
            (
                "http://hl7.org/fhir/task-status",
                "draft",
                Some("Draft"),
                Some("The task is not yet ready to be acted upon."),
            ),
            (
                "http://hl7.org/fhir/task-status",
                "entered-in-error",
            ...
            (
                ...
                "in-progress",
                Some("In Progress"),
                Some("The task has been started but is not yet complete."),
            ),
            (
                "http://hl7.org/fhir/task-status",
                "on-hold",
                Some("On Hold"),
                Some("The task has been started but work has been paused."),
            ),
            (
                "http://hl7.org/fhir/task-status",
                "ready",
            ...
            (
                ...
                "requested",
                Some("Requested"),
                Some("The task is ready to be acted upon and action is sought."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/task-status" => {
                super::super::code_systems::task_status::TaskStatus::try_from_code(code)
                    .is_ok()
            }
            _ => false,
        }
...
impl super::super::bindings::ValueSetMembership<Code> for TaskStatus {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for TaskStatus {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for TaskStatus {
