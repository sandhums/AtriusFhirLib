...
///FHIR ValueSet: FHIRDeviceOperationMode
...
impl FHIRDeviceOperationMode {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/device-operation-mode", "normal"),
            ("http://hl7.org/fhir/device-operation-mode", "demo"),
            ("http://hl7.org/fhir/device-operation-mode", "service"),
            ("http://hl7.org/fhir/device-operation-mode", "maintenance"),
            ("http://hl7.org/fhir/device-operation-mode", "test"),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/device-operation-mode" => {
                super::super::code_systems::device_operation_mode::FHIRDeviceOperationMode::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for FHIRDeviceOperationMode {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for FHIRDeviceOperationMode {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for FHIRDeviceOperationMode {
