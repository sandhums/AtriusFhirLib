...
///FHIR ValueSet: ReportRelationshipType
...
impl ReportRelationshipType {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                ...
                "replaces",
                Some("Replaces"),
                Some("This document replaces or supersedes the target document."),
            ),
            (
                "http://hl7.org/fhir/report-relation-type",
                "transformedWith",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/report-relation-type" => {
                super::super::code_systems::report_relation_type::ReportRelationshipType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ReportRelationshipType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ReportRelationshipType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ReportRelationshipType {
