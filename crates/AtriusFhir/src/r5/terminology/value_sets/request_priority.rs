...
impl RequestPriority {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                ...
                "routine",
                Some("Routine"),
                Some("The request has normal priority."),
            ),
            (
                "http://hl7.org/fhir/request-priority",
                "stat",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/request-priority" => {
                super::super::code_systems::request_priority::RequestPriority::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for RequestPriority {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for RequestPriority {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for RequestPriority {
