    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                "http://snomed.info/sct",
                "308283009",
                Some("Discharge from hospital"),
                None,
            ),
            ("http://snomed.info/sct", "32485007", Some("Admission to hospital"), None),
            ("http://snomed.info/sct", "386216000", Some("Childbirth"), None),
            (
                "http://snomed.info/sct",
                "442137000",
                Some("Completion time of procedure"),
                None,
            ),
        ]
    }
...
impl super::super::bindings::ValueSetMembership<Code> for GoalStartEvent {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for GoalStartEvent {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for GoalStartEvent {
