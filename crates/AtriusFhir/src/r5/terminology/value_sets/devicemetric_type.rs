...
///FHIR ValueSet: DeviceMetricAndComponentTypes
...
impl super::super::bindings::ValueSetMembership<Code> for DeviceMetricAndComponentTypes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding>
for DeviceMetricAndComponentTypes {
