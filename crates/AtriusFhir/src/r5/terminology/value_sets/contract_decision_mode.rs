...
///FHIR ValueSet: ContractResourceDecisionModeCodes
...
impl ContractResourceDecisionModeCodes {
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/contract-decision-mode" => {
                super::super::code_systems::contract_decision_mode::ContractDecisionMode::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
for ContractResourceDecisionModeCodes {
