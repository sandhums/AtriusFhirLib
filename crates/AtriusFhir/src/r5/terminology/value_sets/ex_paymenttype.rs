...
///FHIR ValueSet: ExamplePaymentTypeCodes
...
impl super::super::bindings::ValueSetMembership<Code> for ExamplePaymentTypeCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ExamplePaymentTypeCodes {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ExamplePaymentTypeCodes {
