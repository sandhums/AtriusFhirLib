...
///FHIR ValueSet: MedicinalProductType
...
impl MedicinalProductType {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                Some("Investigational Medicinal Product"),
                Some("An investigational medicinal product."),
            ),
            (
                "http://hl7.org/fhir/medicinal-product-type",
                "MedicinalProduct",
                Some("Medicinal Product"),
                Some("A standard medicinal product."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/medicinal-product-type" => {
                super::super::code_systems::medicinal_product_type::MedicinalProductType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for MedicinalProductType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for MedicinalProductType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for MedicinalProductType {
