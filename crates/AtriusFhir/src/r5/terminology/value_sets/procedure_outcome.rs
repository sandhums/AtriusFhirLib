...
///FHIR ValueSet: ProcedureOutcomeCodesSNOMEDCT
...
impl ProcedureOutcomeCodesSNOMEDCT {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ("http://snomed.info/sct", "385669000", None, None),
            ("http://snomed.info/sct", "385670004", None, None),
            ("http://snomed.info/sct", "385671000", None, None),
        ]
    }
...
impl super::super::bindings::ValueSetMembership<Code> for ProcedureOutcomeCodesSNOMEDCT {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding>
for ProcedureOutcomeCodesSNOMEDCT {
