...
///FHIR ValueSet: ContractResourceExpirationTypeCodes
...
impl ContractResourceExpirationTypeCodes {
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/contract-expiration-type" => {
                super::super::code_systems::contract_expiration_type::ContractExpirationType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
for ContractResourceExpirationTypeCodes {
