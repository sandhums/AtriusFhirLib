...
///FHIR ValueSet: SNOMEDCTFormCodes
...
impl super::super::bindings::ValueSetMembership<Code> for SNOMEDCTFormCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for SNOMEDCTFormCodes {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for SNOMEDCTFormCodes {
