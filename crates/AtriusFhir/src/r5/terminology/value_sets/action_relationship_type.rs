...
///FHIR ValueSet: ActionRelationshipType
...
impl ActionRelationshipType {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "after",
                Some("After"),
                Some("The action must be performed after the related action."),
            ),
            (
                "http://hl7.org/fhir/action-relationship-type",
                "before",
                Some("Before"),
                Some("The action must be performed before the related action."),
            ),
            (
                "http://hl7.org/fhir/action-relationship-type",
                "concurrent",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/action-relationship-type" => {
                super::super::code_systems::action_relationship_type::ActionRelationshipType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ActionRelationshipType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ActionRelationshipType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ActionRelationshipType {
