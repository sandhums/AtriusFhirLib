...
///FHIR ValueSet: ProductConfidentiality
...
impl ProductConfidentiality {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                "http://hl7.org/fhir/medicinal-product-confidentiality",
                "NotCommerciallySensitive",
                Some("Not Commercially Sensitive"),
                Some("Not Commercially Sensitive"),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/medicinal-product-confidentiality" => {
                super::super::code_systems::medicinal_product_confidentiality::ProductConfidentiality::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ProductConfidentiality {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ProductConfidentiality {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ProductConfidentiality {
