...
///FHIR ValueSet: ArtifactContributionInstanceType
...
impl ArtifactContributionInstanceType {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/artifact-contribution-instance-type", "reviewed"),
            ("http://hl7.org/fhir/artifact-contribution-instance-type", "approved"),
            ("http://hl7.org/fhir/artifact-contribution-instance-type", "edited"),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/artifact-contribution-instance-type" => {
                super::super::code_systems::artifact_contribution_instance_type::ArtifactContributionInstanceType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
for ArtifactContributionInstanceType {
