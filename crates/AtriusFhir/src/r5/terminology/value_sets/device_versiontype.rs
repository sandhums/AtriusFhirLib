...
///FHIR ValueSet: DeviceVersionType
...
impl DeviceVersionType {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("urn:iso:std:iso:11073:10101", "531974"),
            ("urn:iso:std:iso:11073:10101", "531975"),
            ("urn:iso:std:iso:11073:10101", "531976"),
            ("urn:iso:std:iso:11073:10101", "531977"),
            ("urn:iso:std:iso:11073:10101", "532352"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            ("urn:iso:std:iso:11073:10101", "531974", Some("Hardware revision"), None),
            ("urn:iso:std:iso:11073:10101", "531975", Some("Software revision"), None),
            ("urn:iso:std:iso:11073:10101", "531976", Some("Firmware revision"), None),
            ("urn:iso:std:iso:11073:10101", "531977", Some("Protocol revision"), None),
            ("urn:iso:std:iso:11073:10101", "532352", Some("Continua version"), None),
        ]
    }
...
impl super::super::bindings::ValueSetMembership<Code> for DeviceVersionType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for DeviceVersionType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for DeviceVersionType {
