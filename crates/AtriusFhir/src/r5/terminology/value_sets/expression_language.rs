...
///FHIR ValueSet: ExpressionLanguage
...
impl ExpressionLanguage {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ...
            ("urn:ietf:bcp:13", "text/fhirpath"),
            ("urn:ietf:bcp:13", "text/x-fhir-query"),
            ("urn:ietf:bcp:13", "text/cql-identifier"),
            ("urn:ietf:bcp:13", "text/cql-expression"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "text/cql",
                Some("CQL"),
                Some("Clinical Quality Language"),
            ),
            (
                "urn:ietf:bcp:13",
                "text/cql-expression",
                Some("CQL Expression"),
                Some("A Clinical Quality Language expression,"),
            ),
            (
                "urn:ietf:bcp:13",
                "text/cql-identifier",
            ...
            ("urn:ietf:bcp:13", "text/fhirpath", Some("FHIRPath"), Some("FHIRPath")),
            (
                "urn:ietf:bcp:13",
                "text/x-fhir-query",
                Some("FHIR Query"),
...
impl super::super::bindings::ValueSetMembership<Code> for ExpressionLanguage {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ExpressionLanguage {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for ExpressionLanguage {
