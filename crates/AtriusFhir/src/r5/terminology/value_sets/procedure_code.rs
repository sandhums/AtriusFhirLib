...
///FHIR ValueSet: ProcedureCodesSNOMEDCT
...
impl super::super::bindings::ValueSetMembership<Code> for ProcedureCodesSNOMEDCT {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ProcedureCodesSNOMEDCT {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ProcedureCodesSNOMEDCT {
