...
///FHIR ValueSet: AdverseEventOutcome
...
impl AdverseEventOutcome {
    ...
    pub fn filter_rules() -> &'static [(&'static str, &'static str, &'static str)] {
        &[("concept", "descendent-of", "405533003")]
    }
...
impl super::super::bindings::ValueSetMembership<Code> for AdverseEventOutcome {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for AdverseEventOutcome {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for AdverseEventOutcome {
