...
///FHIR ValueSet: ServiceRequestOrderDetailParameterCode
///Canonical URL: http://hl7.org/fhir/ValueSet/servicerequest-orderdetail-parameter-code
///Version: 5.0.0
///Title: Servicerequest OrderDetail Parameter Code
///Status: draft
...
impl ServiceRequestOrderDetailParameterCode {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "body-elevation",
                Some("Body Elevation"),
                Some("Describes elevation instructions."),
            ),
            (
                "http://hl7.org/fhir/servicerequest-orderdetail-parameter-code",
                "catheter-insertion",
                Some("Catheter Insertion"),
                Some("Describes insertion instructions."),
            ),
            (
                "http://hl7.org/fhir/servicerequest-orderdetail-parameter-code",
                "device-configuration",
                Some("Device Configuration"),
                Some("Describes configuration details"),
            ),
            (
                "http://hl7.org/fhir/servicerequest-orderdetail-parameter-code",
                "device-settings",
                Some("Device Settings"),
                Some("Describes setting details."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/servicerequest-orderdetail-parameter-code" => {
                super::super::code_systems::servicerequest_orderdetail_parameter_code::ServiceRequestOrderDetailParameterCode::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
for ServiceRequestOrderDetailParameterCode {
