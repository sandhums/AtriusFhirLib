...
///FHIR ValueSet: DeviceMetricCategory
...
impl DeviceMetricCategory {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                ...
                "measurement",
                Some("Measurement"),
                Some("Observations generated for this DeviceMetric are measured."),
            ),
            (
                "http://hl7.org/fhir/metric-category",
                "setting",
            ...
            (
                ...
                "unspecified",
                Some("Unspecified"),
                Some("The category of this DeviceMetric is unspecified."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/metric-category" => {
                super::super::code_systems::metric_category::DeviceMetricCategory::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for DeviceMetricCategory {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for DeviceMetricCategory {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for DeviceMetricCategory {
