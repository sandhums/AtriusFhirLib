...
///FHIR ValueSet: MedicationCostCategoryCodes
...
impl MedicationCostCategoryCodes {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/medication-cost-category", "banda"),
            ("http://hl7.org/fhir/medication-cost-category", "bandb"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "banda",
                Some("Band A"),
                Some("Tier A cost for this medication"),
            ),
            (
                "http://hl7.org/fhir/medication-cost-category",
                "bandb",
                Some("Band B"),
                Some("Tier B cost for this medication"),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/medication-cost-category" => {
                super::super::code_systems::medication_cost_category::MedicationCostCategoryCodes::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for MedicationCostCategoryCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for MedicationCostCategoryCodes {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for MedicationCostCategoryCodes {
