...
///FHIR ValueSet: UndesirablEffectFrequency
...
impl UndesirablEffectFrequency {
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/undesirable-effect-frequency" => {
                super::super::code_systems::undesirable_effect_frequency::UndesirablEffectFrequency::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for UndesirablEffectFrequency {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for UndesirablEffectFrequency {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for UndesirablEffectFrequency {
