...
///FHIR ValueSet: SecurityLabelExamples
...
impl super::super::bindings::ValueSetMembership<Code> for SecurityLabelExamples {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for SecurityLabelExamples {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for SecurityLabelExamples {
