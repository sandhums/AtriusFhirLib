...
///FHIR ValueSet: ClinicalImpressionChangePatter
///Canonical URL: http://hl7.org/fhir/ValueSet/clinicalimpression-change-pattern
///Version: 5.0.0
///Title: ClinicalImpression Change Pattern
///Status: draft
...
impl ClinicalImpressionChangePatter {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://snomed.info/sct", "230993007"),
            ("http://snomed.info/sct", "385633008"),
            ("http://snomed.info/sct", "260388006"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            ("http://snomed.info/sct", "230993007", None, None),
            ("http://snomed.info/sct", "260388006", None, None),
            ("http://snomed.info/sct", "385633008", None, None),
        ]
    }
...
for ClinicalImpressionChangePatter {
