...
///FHIR ValueSet: MedicationStatementAdherenceCodes
...
impl MedicationStatementAdherenceCodes {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "not-taking",
                Some("Not Taking"),
                Some("The medication is not being taken."),
            ),
            (
                "http://hl7.org/fhir/CodeSystem/medication-statement-adherence",
                "on-hold",
                Some("On Hold"),
                Some("The medication is on hold."),
            ),
            (
                "http://hl7.org/fhir/CodeSystem/medication-statement-adherence",
                "on-hold-as-directed",
                Some("On Hold As Directed"),
                Some("The medication is on hold as directed."),
            ),
            (
                "http://hl7.org/fhir/CodeSystem/medication-statement-adherence",
                "on-hold-not-as-directed",
                Some("On Hold Not As Directed"),
                Some("The medication is on hold not as directed."),
            ),
            (
                "http://hl7.org/fhir/CodeSystem/medication-statement-adherence",
                "stopped",
                Some("Stopped"),
                Some("The medication is stopped."),
            ),
            (
                "http://hl7.org/fhir/CodeSystem/medication-statement-adherence",
                "stopped-as-directed",
                Some("Stopped As Directed"),
                Some("The medication is stopped as directed."),
            ),
            (
                "http://hl7.org/fhir/CodeSystem/medication-statement-adherence",
                "stopped-not-as-directed",
                Some("Stopped Not As Directed"),
                Some("The medication is stopped not as directed."),
            ),
            (
                "http://hl7.org/fhir/CodeSystem/medication-statement-adherence",
                "taking",
                Some("Taking"),
                Some("The medication is being taken."),
            ),
            (
                "http://hl7.org/fhir/CodeSystem/medication-statement-adherence",
                "taking-as-directed",
                Some("Taking As Directed"),
                Some("The medication is being taken as directed."),
            ),
            (
                "http://hl7.org/fhir/CodeSystem/medication-statement-adherence",
                "taking-not-as-directed",
                Some("Taking Not As Directed"),
                Some("The medication is not being taken as directed."),
            ),
            (
                "http://hl7.org/fhir/CodeSystem/medication-statement-adherence",
                "unknown",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/CodeSystem/medication-statement-adherence" => {
                super::super::code_systems::medication_statement_adherence::MedicationStatementAdherenceCodes::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
for MedicationStatementAdherenceCodes {
