...
///FHIR ValueSet: EncounterSubjectStatus
...
impl super::super::bindings::ValueSetMembership<Code> for EncounterSubjectStatus {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for EncounterSubjectStatus {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for EncounterSubjectStatus {
