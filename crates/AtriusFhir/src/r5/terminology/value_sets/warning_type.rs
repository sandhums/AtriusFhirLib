...
impl WarningType {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                "http://hl7.org/fhir/warning-type",
                "P313",
                Some("Get medical advice/attention."),
                Some("Get medical advice/attention."),
            ),
            (
                "http://hl7.org/fhir/warning-type",
                "P314",
                Some("Get medical advice/attention if you feel unwell."),
                Some("Get medical advice/attention if you feel unwell."),
            ),
            (
                "http://hl7.org/fhir/warning-type",
                "P315",
                Some("Get immediate medical advice/attention."),
                Some("Get immediate medical advice/attention."),
            ),
            (
                "http://hl7.org/fhir/warning-type",
                "P320",
                Some("Specific treatment is urgent (see ... on this label)."),
                Some("Specific treatment is urgent (see ... on this label)."),
            ),
            (
                "http://hl7.org/fhir/warning-type",
                "P321",
                Some("Specific treatment (see ... on this label)."),
                Some("Specific treatment (see ... on this label)."),
            ),
            (
                "http://hl7.org/fhir/warning-type",
                "P322",
                Some("Specific measures (see ... on this label)."),
                Some("Specific measures (see ... on this label)."),
            ),
            (
                "http://hl7.org/fhir/warning-type",
            ...
            (
                "http://hl7.org/fhir/warning-type",
                "P331",
                Some("Do NOT induce vomiting."),
                Some("Do NOT induce vomiting."),
            ),
            (
                "http://hl7.org/fhir/warning-type",
                "P361",
                Some("Remove/Take off immediately all contaminated clothing."),
                Some("Remove/Take off immediately all contaminated clothing."),
            ),
            (
                "http://hl7.org/fhir/warning-type",
                "P363",
                Some("Wash contaminated clothing before reuse.."),
                Some("Wash contaminated clothing before reuse."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/warning-type" => {
                super::super::code_systems::warning_type::WarningType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for WarningType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for WarningType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for WarningType {
