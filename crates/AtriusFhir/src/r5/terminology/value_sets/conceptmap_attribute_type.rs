...
///FHIR ValueSet: ConceptMapAttributeType
...
impl ConceptMapAttributeType {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/conceptmap-attribute-type", "code"),
            ("http://hl7.org/fhir/conceptmap-attribute-type", "Coding"),
            ("http://hl7.org/fhir/conceptmap-attribute-type", "string"),
            ("http://hl7.org/fhir/conceptmap-attribute-type", "boolean"),
            ("http://hl7.org/fhir/conceptmap-attribute-type", "Quantity"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "Coding",
                Some("Coding"),
                Some("The attribute value is a code defined in a code system."),
            ),
            (
                "http://hl7.org/fhir/conceptmap-attribute-type",
                "Quantity",
            ...
            (
                ...
                "boolean",
                Some("boolean"),
                Some("The attribute value is a boolean true | false."),
            ),
            (
                "http://hl7.org/fhir/conceptmap-attribute-type",
                "code",
            ...
            (
                ...
                "string",
                Some("string"),
                Some("The attribute value is a string."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/conceptmap-attribute-type" => {
                super::super::code_systems::conceptmap_attribute_type::ConceptMapAttributeType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ConceptMapAttributeType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ConceptMapAttributeType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ConceptMapAttributeType {
