...
///FHIR ValueSet: MedicationDispenseAdministrationLocationCodes
///Canonical URL: http://hl7.org/fhir/ValueSet/medicationdispense-admin-location
///Version: 5.0.0
///Title: MedicationDispense Administration Location Codes
///Status: draft
...
impl MedicationDispenseAdministrationLocationCodes {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/medicationdispense-admin-location", "inpatient"),
            ("http://hl7.org/fhir/medicationdispense-admin-location", "outpatient"),
            ("http://hl7.org/fhir/medicationdispense-admin-location", "community"),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/medicationdispense-admin-location" => {
                super::super::code_systems::medicationdispense_admin_location::MedDispenseAdminLocationCodes::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
for MedicationDispenseAdministrationLocationCodes {
