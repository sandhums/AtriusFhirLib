...
///FHIR ValueSet: ClinicalUseDefinitionType
...
impl ClinicalUseDefinitionType {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                Some("A reason for not giving the medication."),
            ),
            (
                "http://hl7.org/fhir/clinical-use-definition-type",
                "indication",
                Some("Indication"),
                Some("A reason for giving the medication."),
            ),
            (
                "http://hl7.org/fhir/clinical-use-definition-type",
                "interaction",
                Some("Interaction"),
                Some("Interactions between the medication and other substances."),
            ),
            (
                "http://hl7.org/fhir/clinical-use-definition-type",
                "undesirable-effect",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/clinical-use-definition-type" => {
                super::super::code_systems::clinical_use_definition_type::ClinicalUseDefinitionType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ClinicalUseDefinitionType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ClinicalUseDefinitionType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ClinicalUseDefinitionType {
