...
///FHIR ValueSet: CarePlanActivityPerformed
///Canonical URL: http://hl7.org/fhir/ValueSet/care-plan-activity-performed
///Version: 5.0.0
///Title: Care Plan Activity Performed
///Status: draft
...
impl super::super::bindings::ValueSetMembership<Code> for CarePlanActivityPerformed {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for CarePlanActivityPerformed {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for CarePlanActivityPerformed {
