...
impl SubstanceForm {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/substance-form", "salt"),
            ("http://hl7.org/fhir/substance-form", "base"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                "http://hl7.org/fhir/substance-form",
                "base",
                Some("Base of substance"),
                None,
            ),
            (
                "http://hl7.org/fhir/substance-form",
                "salt",
                Some("Salt of substance"),
                None,
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/substance-form" => {
                super::super::code_systems::substance_form::SubstanceForm::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for SubstanceForm {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for SubstanceForm {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for SubstanceForm {
