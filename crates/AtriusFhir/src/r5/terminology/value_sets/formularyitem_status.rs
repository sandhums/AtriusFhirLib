...
///FHIR ValueSet: FormularyItemStatusCodes
...
impl FormularyItemStatusCodes {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/CodeSystem/formularyitem-status", "active"),
            ("http://hl7.org/fhir/CodeSystem/formularyitem-status", "entered-in-error"),
            ("http://hl7.org/fhir/CodeSystem/formularyitem-status", "inactive"),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/CodeSystem/formularyitem-status" => {
                super::super::code_systems::formularyitem_status::FormularyItemStatusCodes::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for FormularyItemStatusCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for FormularyItemStatusCodes {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for FormularyItemStatusCodes {
