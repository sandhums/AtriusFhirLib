...
///FHIR ValueSet: TaskStatusReason
...
impl TaskStatusReason {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/task-status-reason", "missing"),
            ("http://hl7.org/fhir/task-status-reason", "misidentified"),
            ("http://hl7.org/fhir/task-status-reason", "equipment-issue"),
            ("http://hl7.org/fhir/task-status-reason", "environmental-issue"),
            ("http://hl7.org/fhir/task-status-reason", "personnel-issue"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                ...
                "misidentified",
                Some("Misidentified"),
                Some("Something related to the task was misidentified."),
            ),
            (
                "http://hl7.org/fhir/task-status-reason",
                "missing",
                Some("Missing"),
                Some("An item nessary for task completion is missing."),
            ),
            (
                "http://hl7.org/fhir/task-status-reason",
                "personnel-issue",
                Some("Personnel-issue"),
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/task-status-reason" => {
                super::super::code_systems::task_status_reason::TaskStatusReason::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for TaskStatusReason {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for TaskStatusReason {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for TaskStatusReason {
