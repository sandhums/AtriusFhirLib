...
///FHIR ValueSet: ClaimAdjudicationDecisionsCodes
...
impl ClaimAdjudicationDecisionsCodes {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/claim-decision", "denied"),
            ("http://hl7.org/fhir/claim-decision", "approved"),
            ("http://hl7.org/fhir/claim-decision", "partial"),
            ("http://hl7.org/fhir/claim-decision", "pending"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "approved",
                Some("Approved"),
                Some("The claim, or individual services, are approved as submitted."),
            ),
            (
                "http://hl7.org/fhir/claim-decision",
                "denied",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/claim-decision" => {
                super::super::code_systems::claim_decision::ClaimAdjudicationDecisionCodes::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
for ClaimAdjudicationDecisionsCodes {
