...
///FHIR ValueSet: ResearchStudyReasonStopped
///Canonical URL: http://hl7.org/fhir/ValueSet/research-study-reason-stopped
///Version: 5.0.0
///Title: Research Study Reason Stopped
///Status: draft
...
impl ResearchStudyReasonStopped {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/research-study-reason-stopped", "accrual-goal-met"),
            (
                "http://hl7.org/fhir/research-study-reason-stopped",
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                "http://hl7.org/fhir/research-study-reason-stopped",
                "accrual-goal-met",
                Some("Accrual Goal Met"),
                Some("The study prematurely ended because the accrual goal was met."),
            ),
            (
                "http://hl7.org/fhir/research-study-reason-stopped",
                "closed-due-to-lack-of-study-progress",
                Some("Closed due to lack of study progress"),
                Some("The study prematurely ended due to lack of study progress."),
            ),
            (
                "http://hl7.org/fhir/research-study-reason-stopped",
                "closed-due-to-toxicity",
                Some("Closed due to toxicity"),
                Some("The study prematurely ended due to toxicity."),
            ),
            (
                "http://hl7.org/fhir/research-study-reason-stopped",
                "temporarily-closed-per-study-design",
                Some("Temporarily closed per study design"),
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/research-study-reason-stopped" => {
                super::super::code_systems::research_study_reason_stopped::ResearchStudyReasonStopped::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ResearchStudyReasonStopped {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ResearchStudyReasonStopped {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ResearchStudyReasonStopped {
