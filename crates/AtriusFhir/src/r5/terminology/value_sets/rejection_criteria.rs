...
///FHIR ValueSet: RejectionCriterion
...
impl super::super::bindings::ValueSetMembership<Code> for RejectionCriterion {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for RejectionCriterion {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for RejectionCriterion {
