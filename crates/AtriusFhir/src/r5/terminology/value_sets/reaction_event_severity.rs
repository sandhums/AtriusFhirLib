...
///FHIR ValueSet: AllergyIntoleranceSeverity
...
impl AllergyIntoleranceSeverity {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "mild",
                Some("Mild"),
                Some("Causes mild physiological effects."),
            ),
            (
                "http://hl7.org/fhir/reaction-event-severity",
                "moderate",
                Some("Moderate"),
                Some("Causes moderate physiological effects."),
            ),
            (
                "http://hl7.org/fhir/reaction-event-severity",
                "severe",
                Some("Severe"),
                Some("Causes severe physiological effects."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/reaction-event-severity" => {
                super::super::code_systems::reaction_event_severity::AllergyIntoleranceSeverity::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for AllergyIntoleranceSeverity {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for AllergyIntoleranceSeverity {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for AllergyIntoleranceSeverity {
