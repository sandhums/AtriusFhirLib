...
///FHIR ValueSet: MedicationAdministrationSubpotentReason
///Canonical URL: http://hl7.org/fhir/ValueSet/administration-subpotent-reason
///Version: 5.0.0
///Title: MedicationAdministration Subpotent Reason
///Status: draft
...
impl MedicationAdministrationSubpotentReason {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ...
            ("http://hl7.org/fhir/CodeSystem/administration-subpotent-reason", "recall"),
            (
                "http://hl7.org/fhir/CodeSystem/administration-subpotent-reason",
                "adversestorage",
            ),
            ("http://hl7.org/fhir/CodeSystem/administration-subpotent-reason", "expired"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                "http://hl7.org/fhir/CodeSystem/administration-subpotent-reason",
                "adversestorage",
                Some("Adverse Storage"),
                Some("The medication experienced adverse storage conditions."),
            ),
            (
                "http://hl7.org/fhir/CodeSystem/administration-subpotent-reason",
                "coldchainbreak",
                Some("Cold Chain Break"),
                Some("The medication experienced a cold chain break."),
            ),
            (
                "http://hl7.org/fhir/CodeSystem/administration-subpotent-reason",
                "expired",
                Some("Expired Product"),
                Some("The medication was expired at the time of administration."),
            ),
            (
                "http://hl7.org/fhir/CodeSystem/administration-subpotent-reason",
                "partialdose",
            ...
            (
                "http://hl7.org/fhir/CodeSystem/administration-subpotent-reason",
                "recall",
                Some("Manufacturer Recall"),
                Some("The medication was recalled by the manufacturer."),
            ),
            (
                "http://hl7.org/fhir/CodeSystem/administration-subpotent-reason",
                "vomited",
                Some("Vomited"),
                Some("The patient vomited part of the dose."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/CodeSystem/administration-subpotent-reason" => {
                super::super::code_systems::administration_subpotent_reason::AdministrationSubPotentReason::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
for MedicationAdministrationSubpotentReason {
