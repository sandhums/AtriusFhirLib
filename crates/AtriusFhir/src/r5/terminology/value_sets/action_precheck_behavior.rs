...
///FHIR ValueSet: ActionPrecheckBehavior
...
impl ActionPrecheckBehavior {
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/action-precheck-behavior" => {
                super::super::code_systems::action_precheck_behavior::ActionPrecheckBehavior::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ActionPrecheckBehavior {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ActionPrecheckBehavior {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ActionPrecheckBehavior {
