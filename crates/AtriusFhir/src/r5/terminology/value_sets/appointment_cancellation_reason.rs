...
///FHIR ValueSet: AppointmentCancellationReason
...
impl super::super::bindings::ValueSetMembership<Code> for AppointmentCancellationReason {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding>
for AppointmentCancellationReason {
