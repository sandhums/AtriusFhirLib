...
///FHIR ValueSet: SNOMEDCTSubstanceCodes
///Canonical URL: http://hl7.org/fhir/ValueSet/substance-codes
///Version: 5.0.0
///Title: SNOMED CT Substance Codes
///Status: draft
...
impl super::super::bindings::ValueSetMembership<Code> for SNOMEDCTSubstanceCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for SNOMEDCTSubstanceCodes {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for SNOMEDCTSubstanceCodes {
