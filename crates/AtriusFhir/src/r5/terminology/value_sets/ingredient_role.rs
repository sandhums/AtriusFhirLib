...
impl IngredientRole {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                "http://hl7.org/fhir/ingredient-role",
                "100000136065",
                Some("Starting material for excipient"),
                None,
            ),
            (
                "http://hl7.org/fhir/ingredient-role",
                "100000136066",
                Some("Solvent / Diluent"),
                None,
            ),
            (
                "http://hl7.org/fhir/ingredient-role",
                "100000136178",
                Some("Raw materials used in the manufacture of the product"),
                None,
            ),
            (
                "http://hl7.org/fhir/ingredient-role",
                "100000136179",
                Some("Starting material for active substance"),
                None,
            ),
            (
                "http://hl7.org/fhir/ingredient-role",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/ingredient-role" => {
                super::super::code_systems::ingredient_role::IngredientRole::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for IngredientRole {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for IngredientRole {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for IngredientRole {
