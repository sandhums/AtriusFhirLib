...
impl ActionCode {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/action-code", "send-message"),
            ("http://hl7.org/fhir/action-code", "collect-information"),
            ("http://hl7.org/fhir/action-code", "prescribe-medication"),
            ("http://hl7.org/fhir/action-code", "recommend-immunization"),
            ("http://hl7.org/fhir/action-code", "order-service"),
            ("http://hl7.org/fhir/action-code", "propose-diagnosis"),
            ("http://hl7.org/fhir/action-code", "record-detected-issue"),
            ("http://hl7.org/fhir/action-code", "record-inference"),
            ("http://hl7.org/fhir/action-code", "report-flag"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                ...
                Some("Recommend an immunization"),
                Some(
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/action-code" => {
                super::super::code_systems::action_code::ActionCode::try_from_code(code)
                    .is_ok()
            }
            _ => false,
        }
...
impl super::super::bindings::ValueSetMembership<Code> for ActionCode {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ActionCode {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for ActionCode {
