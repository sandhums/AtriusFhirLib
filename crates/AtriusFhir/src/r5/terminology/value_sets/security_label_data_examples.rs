...
///FHIR ValueSet: SecurityLabelDataExamples
...
impl SecurityLabelDataExamples {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ("http://terminology.hl7.org/CodeSystem/v3-ActCode", "ETH", None, None),
            ("http://terminology.hl7.org/CodeSystem/v3-ActCode", "PSY", None, None),
            ("http://terminology.hl7.org/CodeSystem/v3-ActCode", "STD", None, None),
            (
                "http://terminology.hl7.org/CodeSystem/v3-Confidentiality",
                "N",
                None,
            ...
            ("http://terminology.hl7.org/CodeSystem/v3-Confidentiality", "R", None, None),
        ]
    }
...
impl super::super::bindings::ValueSetMembership<Code> for SecurityLabelDataExamples {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for SecurityLabelDataExamples {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for SecurityLabelDataExamples {
