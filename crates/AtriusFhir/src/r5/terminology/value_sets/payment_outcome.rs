...
impl PaymentOutcome {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/payment-outcome", "queued"),
            ("http://hl7.org/fhir/payment-outcome", "complete"),
            ("http://hl7.org/fhir/payment-outcome", "error"),
            ("http://hl7.org/fhir/payment-outcome", "partial"),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/payment-outcome" => {
                super::super::code_systems::payment_outcome::ClaimProcessingCodes::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for PaymentOutcome {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for PaymentOutcome {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for PaymentOutcome {
