...
impl CodesForVaccineFundingPrograms {
    ...
    fn include_entries() -> &'static [(
        ...
        &[("http://loinc.org", "64994-7", None, None)]
    }
...
for CodesForVaccineFundingPrograms {
