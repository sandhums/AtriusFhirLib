...
///FHIR ValueSet: CommunicationTopic
...
impl super::super::bindings::ValueSetMembership<Code> for CommunicationTopic {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for CommunicationTopic {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for CommunicationTopic {
