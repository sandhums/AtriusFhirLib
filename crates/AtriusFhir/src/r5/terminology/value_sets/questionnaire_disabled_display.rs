...
///FHIR ValueSet: QuestionnaireItemDisabledDisplay
...
impl QuestionnaireItemDisabledDisplay {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/questionnaire-disabled-display", "hidden"),
            ("http://hl7.org/fhir/questionnaire-disabled-display", "protected"),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/questionnaire-disabled-display" => {
                super::super::code_systems::questionnaire_disabled_display::QuestionnaireItemDisabledDisplay::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
for QuestionnaireItemDisabledDisplay {
