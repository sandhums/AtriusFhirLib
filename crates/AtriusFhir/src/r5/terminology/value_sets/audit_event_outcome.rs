...
///FHIR ValueSet: AuditEventOutcome
...
impl AuditEventOutcome {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ...
            ("http://hl7.org/fhir/issue-severity", "success"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "error",
                Some("Error"),
                Some("The issue is sufficiently important to cause the action to fail."),
            ),
            (
                "http://hl7.org/fhir/issue-severity",
                "fatal",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/issue-severity" => {
                super::super::code_systems::issue_severity::IssueSeverity::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for AuditEventOutcome {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for AuditEventOutcome {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for AuditEventOutcome {
