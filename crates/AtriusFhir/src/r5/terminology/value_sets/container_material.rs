...
///FHIR ValueSet: ContainerMaterials
...
impl ContainerMaterials {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ("http://snomed.info/sct", "32039001", Some("glass"), None),
            ("http://snomed.info/sct", "425620007", Some("metal"), None),
            ("http://snomed.info/sct", "61088005", Some("plastic"), None),
        ]
    }
...
impl super::super::bindings::ValueSetMembership<Code> for ContainerMaterials {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ContainerMaterials {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for ContainerMaterials {
