...
///FHIR ValueSet: ParticipationStatus
...
impl super::super::bindings::ValueSetMembership<Code> for ParticipationStatus {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ParticipationStatus {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ParticipationStatus {
