...
///FHIR ValueSet: ContextOfUseValueSet
...
impl super::super::bindings::ValueSetMembership<Code> for ContextOfUseValueSet {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ContextOfUseValueSet {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ContextOfUseValueSet {
