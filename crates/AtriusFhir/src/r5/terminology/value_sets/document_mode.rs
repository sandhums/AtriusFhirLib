...
impl DocumentMode {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "consumer",
                Some("Consumer"),
                Some("The application consumes documents of the specified type."),
            ),
            (
                "http://hl7.org/fhir/document-mode",
                "producer",
                Some("Producer"),
                Some("The application produces documents of the specified type."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/document-mode" => {
                super::super::code_systems::document_mode::DocumentMode::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for DocumentMode {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for DocumentMode {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for DocumentMode {
