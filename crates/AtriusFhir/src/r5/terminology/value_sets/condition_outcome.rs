...
///FHIR ValueSet: ConditionOutcomeCodes
...
impl super::super::bindings::ValueSetMembership<Code> for ConditionOutcomeCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ConditionOutcomeCodes {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ConditionOutcomeCodes {
