...
///FHIR ValueSet: ContractResourceDefinitionTypeCodes
...
impl ContractResourceDefinitionTypeCodes {
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/contract-definition-type" => {
                super::super::code_systems::contract_definition_type::ContractDefinitionType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
for ContractResourceDefinitionTypeCodes {
