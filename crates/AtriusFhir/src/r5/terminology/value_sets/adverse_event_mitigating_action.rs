...
///FHIR ValueSet: AdverseEventMitigatingAction
...
impl super::super::bindings::ValueSetMembership<Code> for AdverseEventMitigatingAction {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding>
for AdverseEventMitigatingAction {
