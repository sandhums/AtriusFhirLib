...
///FHIR ValueSet: ConditionQuestionnairePurpose
...
impl ConditionQuestionnairePurpose {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/condition-questionnaire-purpose", "preadmit"),
            ("http://hl7.org/fhir/condition-questionnaire-purpose", "diff-diagnosis"),
            ("http://hl7.org/fhir/condition-questionnaire-purpose", "outcome"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "diff-diagnosis",
                Some("Diff Diagnosis"),
                Some("A questionnaire that helps with diferential diagnosis."),
            ),
            (
                "http://hl7.org/fhir/condition-questionnaire-purpose",
                "outcome",
                Some("Outcome"),
                Some("A questionnaire to check on outcomes for the patient."),
            ),
            (
                "http://hl7.org/fhir/condition-questionnaire-purpose",
                "preadmit",
                Some("Pre-admit"),
                Some("A pre-admit questionnaire."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/condition-questionnaire-purpose" => {
                super::super::code_systems::condition_questionnaire_purpose::ConditionQuestionnairePurpose::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ConditionQuestionnairePurpose {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding>
for ConditionQuestionnairePurpose {
