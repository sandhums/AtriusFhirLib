...
///FHIR ValueSet: TypeRestfulInteraction
...
impl TypeRestfulInteraction {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ("http://hl7.org/fhir/restful-interaction", "create", None, None),
            ("http://hl7.org/fhir/restful-interaction", "delete", None, None),
            ("http://hl7.org/fhir/restful-interaction", "history-instance", None, None),
            ("http://hl7.org/fhir/restful-interaction", "history-type", None, None),
            ("http://hl7.org/fhir/restful-interaction", "patch", None, None),
            ("http://hl7.org/fhir/restful-interaction", "read", None, None),
            ("http://hl7.org/fhir/restful-interaction", "search-type", None, None),
            ("http://hl7.org/fhir/restful-interaction", "update", None, None),
            ("http://hl7.org/fhir/restful-interaction", "vread", None, None),
        ]
    }
...
impl super::super::bindings::ValueSetMembership<Code> for TypeRestfulInteraction {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for TypeRestfulInteraction {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for TypeRestfulInteraction {
