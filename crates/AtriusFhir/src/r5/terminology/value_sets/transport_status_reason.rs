...
///FHIR ValueSet: TransportStatusReason
///Canonical URL: http://hl7.org/fhir/ValueSet/transport-status-reason
///Version: 5.0.0
///Title: Transport Status Reason
///Status: draft
...
impl TransportStatusReason {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/transport-status-reason", "declined-by-patient"),
            ("http://hl7.org/fhir/transport-status-reason", "refused-by-recipient"),
            ("http://hl7.org/fhir/transport-status-reason", "patient-not-available"),
            ("http://hl7.org/fhir/transport-status-reason", "specimen-not-available"),
            ("http://hl7.org/fhir/transport-status-reason", "wrong-request-data"),
            ("http://hl7.org/fhir/transport-status-reason", "in-route-accident"),
            ("http://hl7.org/fhir/transport-status-reason", "request-not-acknowledged"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                "http://hl7.org/fhir/transport-status-reason",
                "declined-by-patient",
                Some("Declined by patient"),
                Some("Patient declined transport."),
            ),
            (
                "http://hl7.org/fhir/transport-status-reason",
                "in-route-accident",
                Some("In route accident"),
                Some("An accident has occurred in route."),
            ),
            (
                "http://hl7.org/fhir/transport-status-reason",
                "patient-not-available",
                Some("Patient not available"),
                Some("The patient was not available for transport."),
            ),
            (
                "http://hl7.org/fhir/transport-status-reason",
                "refused-by-recipient",
                Some("Refused by recipient"),
                Some("Transport was refused by recipient."),
            ),
            (
                "http://hl7.org/fhir/transport-status-reason",
                "request-not-acknowledged",
                Some("Request not acknowledged"),
                Some("The transport request was not acknowledged."),
            ),
            (
                "http://hl7.org/fhir/transport-status-reason",
                "specimen-not-available",
                Some("Specimen not available"),
                Some("The specimen was not available for transport."),
            ),
            (
                "http://hl7.org/fhir/transport-status-reason",
                "wrong-request-data",
                Some("Wrong request data"),
                Some("Wrong data in the transport request."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/transport-status-reason" => {
                super::super::code_systems::transport_status_reason::TransportStatus::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for TransportStatusReason {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for TransportStatusReason {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for TransportStatusReason {
