...
///FHIR ValueSet: ResourceVersionPolicy
...
impl ResourceVersionPolicy {
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/versioning-policy" => {
                super::super::code_systems::versioning_policy::ResourceVersionPolicy::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ResourceVersionPolicy {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ResourceVersionPolicy {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ResourceVersionPolicy {
