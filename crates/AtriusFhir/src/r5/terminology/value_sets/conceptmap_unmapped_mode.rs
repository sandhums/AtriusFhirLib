...
///FHIR ValueSet: ConceptMapGroupUnmappedMode
...
impl ConceptMapGroupUnmappedMode {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/conceptmap-unmapped-mode", "use-source-code"),
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/conceptmap-unmapped-mode" => {
                super::super::code_systems::conceptmap_unmapped_mode::ConceptMapGroupUnmappedMode::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ConceptMapGroupUnmappedMode {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ConceptMapGroupUnmappedMode {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ConceptMapGroupUnmappedMode {
