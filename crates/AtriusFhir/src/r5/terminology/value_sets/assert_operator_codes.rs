...
///FHIR ValueSet: AssertionOperatorType
...
impl AssertionOperatorType {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ...
            ("http://hl7.org/fhir/assert-operator-codes", "manualEval"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "contains",
                Some("contains"),
                Some("Compare value string contains a known value."),
            ),
            (
                "http://hl7.org/fhir/assert-operator-codes",
                "empty",
                Some("empty"),
                Some("Compare value is empty."),
            ),
            (
                "http://hl7.org/fhir/assert-operator-codes",
                "equals",
                Some("equals"),
                Some("Default value. Equals comparison."),
            ),
            (
                "http://hl7.org/fhir/assert-operator-codes",
                "eval",
                Some("evaluate"),
                Some("Evaluate the FHIRPath expression as a boolean condition."),
            ),
            (
                "http://hl7.org/fhir/assert-operator-codes",
                "greaterThan",
                Some("greaterThan"),
                Some("Compare value to be greater than a known value."),
            ),
            (
                "http://hl7.org/fhir/assert-operator-codes",
                "in",
                Some("in"),
                Some("Compare value within a known set of values."),
            ),
            (
                "http://hl7.org/fhir/assert-operator-codes",
                "lessThan",
                Some("lessThan"),
                Some("Compare value to be less than a known value."),
            ),
            (
                "http://hl7.org/fhir/assert-operator-codes",
                "manualEval",
            ...
            (
                ...
                "notContains",
                Some("notContains"),
                Some("Compare value string does not contain a known value."),
            ),
            (
                "http://hl7.org/fhir/assert-operator-codes",
                "notEmpty",
                Some("notEmpty"),
                Some("Compare value is not empty."),
            ),
            (
                "http://hl7.org/fhir/assert-operator-codes",
                "notEquals",
                Some("notEquals"),
                Some("Not equals comparison."),
            ),
            (
                "http://hl7.org/fhir/assert-operator-codes",
                "notIn",
                Some("notIn"),
                Some("Compare value not within a known set of values."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/assert-operator-codes" => {
                super::super::code_systems::assert_operator_codes::AssertionOperatorType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for AssertionOperatorType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for AssertionOperatorType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for AssertionOperatorType {
