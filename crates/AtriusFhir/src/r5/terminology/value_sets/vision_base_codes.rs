...
impl VisionBase {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            ("http://hl7.org/fhir/vision-base-codes", "up", Some("Up"), Some("top.")),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/vision-base-codes" => {
                super::super::code_systems::vision_base_codes::VisionBase::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for VisionBase {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for VisionBase {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for VisionBase {
