...
///FHIR ValueSet: SecurityLabelEventExamples
...
impl SecurityLabelEventExamples {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ("http://terminology.hl7.org/CodeSystem/v3-ActCode", "DELAU", None, None),
            ("http://terminology.hl7.org/CodeSystem/v3-ActCode", "NOAUTH", None, None),
            (
                "http://terminology.hl7.org/CodeSystem/v3-ActCode",
                "NORDSCLCD",
                None,
            ...
            ("http://terminology.hl7.org/CodeSystem/v3-ActReason", "ETREAT", None, None),
            ("http://terminology.hl7.org/CodeSystem/v3-ActReason", "HPAYMT", None, None),
            ("http://terminology.hl7.org/CodeSystem/v3-ActReason", "TREAT", None, None),
        ]
    }
...
impl super::super::bindings::ValueSetMembership<Code> for SecurityLabelEventExamples {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for SecurityLabelEventExamples {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for SecurityLabelEventExamples {
