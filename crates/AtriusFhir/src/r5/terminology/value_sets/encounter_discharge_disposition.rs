...
///FHIR ValueSet: DischargeDisposition
...
impl super::super::bindings::ValueSetMembership<Code> for DischargeDisposition {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for DischargeDisposition {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for DischargeDisposition {
