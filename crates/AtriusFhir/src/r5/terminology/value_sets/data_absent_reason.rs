...
///FHIR ValueSet: DataAbsentReason
...
impl super::super::bindings::ValueSetMembership<Code> for DataAbsentReason {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for DataAbsentReason {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for DataAbsentReason {
