...
///FHIR ValueSet: DocumentReferenceStatus
...
impl DocumentReferenceStatus {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "current",
                Some("Current"),
                Some("This is the current reference for this document."),
            ),
            (
                "http://hl7.org/fhir/document-reference-status",
                "entered-in-error",
                Some("Entered in Error"),
                Some("This reference was created in error."),
            ),
            (
                "http://hl7.org/fhir/document-reference-status",
                "superseded",
                Some("Superseded"),
                Some("This reference has been superseded by another reference."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/document-reference-status" => {
                super::super::code_systems::document_reference_status::DocumentReferenceStatus::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for DocumentReferenceStatus {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for DocumentReferenceStatus {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for DocumentReferenceStatus {
