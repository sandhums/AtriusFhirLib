...
impl CarePlanIntent {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ("http://hl7.org/fhir/request-intent", "directive", None, None),
...
impl super::super::bindings::ValueSetMembership<Code> for CarePlanIntent {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for CarePlanIntent {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for CarePlanIntent {
