...
///FHIR ValueSet: SubscriptionNotificationType
...
impl SubscriptionNotificationType {
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/subscription-notification-type" => {
                super::super::code_systems::subscription_notification_type::SubscriptionNotificationType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for SubscriptionNotificationType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding>
for SubscriptionNotificationType {
