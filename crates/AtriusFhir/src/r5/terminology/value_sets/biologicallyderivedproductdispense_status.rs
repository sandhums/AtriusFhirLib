...
///FHIR ValueSet: BiologicallyDerivedProductDispenseCodes
...
impl BiologicallyDerivedProductDispenseCodes {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ...
            ("http://hl7.org/fhir/biologicallyderivedproductdispense-status", "issued"),
            (
                "http://hl7.org/fhir/biologicallyderivedproductdispense-status",
                "unfulfilled",
            ),
            ...
            ("http://hl7.org/fhir/biologicallyderivedproductdispense-status", "unknown"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                ...
                "in-progress",
                Some("In Progress"),
                Some("The dispense process is in progress."),
            ),
            (
                "http://hl7.org/fhir/biologicallyderivedproductdispense-status",
                "issued",
            ...
            (
                ...
                "preparation",
                Some("Preparation"),
                Some("The dispense process has started but not yet completed."),
            ),
            (
                "http://hl7.org/fhir/biologicallyderivedproductdispense-status",
                "returned",
                Some("Returned"),
                Some("The dispensed product was returned."),
            ),
            (
                "http://hl7.org/fhir/biologicallyderivedproductdispense-status",
                "unfulfilled",
                Some("Unfulfilled"),
                Some("The dispense could not be completed."),
            ),
            (
                "http://hl7.org/fhir/biologicallyderivedproductdispense-status",
                "unknown",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/biologicallyderivedproductdispense-status" => {
                super::super::code_systems::biologicallyderivedproductdispense_status::BiologicallyDerivedProductDispense::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
for BiologicallyDerivedProductDispenseCodes {
