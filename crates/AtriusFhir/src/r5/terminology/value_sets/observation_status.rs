...
///FHIR ValueSet: ObservationStatus
...
impl super::super::bindings::ValueSetMembership<Code> for ObservationStatus {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ObservationStatus {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for ObservationStatus {
