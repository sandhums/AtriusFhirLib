...
///FHIR ValueSet: FluidConsistencyTypeCodes
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                "http://snomed.info/sct",
                "439021000124105",
                Some("nectar thick liquid"),
                None,
            ),
            (
                "http://snomed.info/sct",
                "439031000124108",
                Some("honey thick liquid"),
                None,
            ),
            (
                "http://snomed.info/sct",
                "439041000124103",
                Some("spoon thick liquid"),
                None,
            ),
            ("http://snomed.info/sct", "439081000124109", Some("thin liquid"), None),
        ]
    }
...
impl super::super::bindings::ValueSetMembership<Code> for FluidConsistencyTypeCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for FluidConsistencyTypeCodes {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for FluidConsistencyTypeCodes {
