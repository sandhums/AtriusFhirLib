...
///FHIR ValueSet: EncounterReasonUse
...
impl EncounterReasonUse {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/encounter-reason-use", "CC"),
            ("http://hl7.org/fhir/encounter-reason-use", "HC"),
            ("http://hl7.org/fhir/encounter-reason-use", "AD"),
            ("http://hl7.org/fhir/encounter-reason-use", "RV"),
            ("http://hl7.org/fhir/encounter-reason-use", "HM"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                "http://hl7.org/fhir/encounter-reason-use",
                "AD",
                Some("Admitting Diagnosis"),
                None,
            ),
            (
                "http://hl7.org/fhir/encounter-reason-use",
                "CC",
                Some("Chief Complaint"),
                None,
            ),
            (
                "http://hl7.org/fhir/encounter-reason-use",
            ...
            (
                "http://hl7.org/fhir/encounter-reason-use",
                "HM",
                Some("Health Maintenance (including screening)"),
                None,
            ),
            (
                "http://hl7.org/fhir/encounter-reason-use",
                "RV",
                Some("Reason for Visit"),
                None,
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/encounter-reason-use" => {
                super::super::code_systems::encounter_reason_use::EncounterReasonUse::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for EncounterReasonUse {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for EncounterReasonUse {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for EncounterReasonUse {
