...
///FHIR ValueSet: GraphCompartmentRule
...
impl GraphCompartmentRule {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                ...
                "different",
                Some("Different"),
                Some("The compartment must be different."),
            ),
            (
                "http://hl7.org/fhir/graph-compartment-rule",
                "identical",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/graph-compartment-rule" => {
                super::super::code_systems::graph_compartment_rule::GraphCompartmentRule::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for GraphCompartmentRule {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for GraphCompartmentRule {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for GraphCompartmentRule {
