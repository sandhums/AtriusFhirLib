...
///FHIR ValueSet: NutrientModifierCodes
...
impl NutrientModifierCodes {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ("http://snomed.info/sct", "33463005", Some("Fluid"), None),
            ("http://snomed.info/sct", "39972003", Some("Sodium"), None),
            ("http://snomed.info/sct", "88480006", Some("Potassium"), None),
        ]
    }
...
impl super::super::bindings::ValueSetMembership<Code> for NutrientModifierCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for NutrientModifierCodes {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for NutrientModifierCodes {
