...
///FHIR ValueSet: ClaimAdjudicationDecisionReasonCodes
...
impl ClaimAdjudicationDecisionReasonCodes {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/claim-decision-reason", "0001"),
            ("http://hl7.org/fhir/claim-decision-reason", "0002"),
            ("http://hl7.org/fhir/claim-decision-reason", "0003"),
            ("http://hl7.org/fhir/claim-decision-reason", "0004"),
            ("http://hl7.org/fhir/claim-decision-reason", "0005"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                "http://hl7.org/fhir/claim-decision-reason",
                "0002",
                Some("Prior authorization not obtained"),
                Some(
            ...
            (
                "http://hl7.org/fhir/claim-decision-reason",
                "0004",
                Some("Service inconsistent with patient age"),
                Some(
            ...
            (
                "http://hl7.org/fhir/claim-decision-reason",
                "0005",
                Some("Benefit limits exceeded"),
                Some("The patient or subscriber benefit's have been exceeded."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/claim-decision-reason" => {
                super::super::code_systems::claim_decision_reason::ClaimAdjudicationDecisionReasonCodes::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
for ClaimAdjudicationDecisionReasonCodes {
