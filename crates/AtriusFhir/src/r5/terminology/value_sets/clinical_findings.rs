...
///FHIR ValueSet: SNOMEDCTClinicalFindings
...
impl super::super::bindings::ValueSetMembership<Code> for SNOMEDCTClinicalFindings {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for SNOMEDCTClinicalFindings {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for SNOMEDCTClinicalFindings {
