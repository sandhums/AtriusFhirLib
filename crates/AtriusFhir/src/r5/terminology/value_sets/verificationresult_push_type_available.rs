...
///FHIR ValueSet: PushTypeAvailable
...
impl super::super::bindings::ValueSetMembership<Code> for PushTypeAvailable {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for PushTypeAvailable {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for PushTypeAvailable {
