...
///FHIR ValueSet: ContractResourceDefinitionSubtypeCodes
...
impl ContractResourceDefinitionSubtypeCodes {
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/contract-definition-subtype" => {
                super::super::code_systems::contract_definition_subtype::ContractDefinitionSubtype::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
for ContractResourceDefinitionSubtypeCodes {
