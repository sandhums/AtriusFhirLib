...
///FHIR ValueSet: ContractResourceScopeCodes
///Canonical URL: http://hl7.org/fhir/ValueSet/contract-security-category
///Version: 5.0.0
...
impl ContractResourceScopeCodes {
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/contract-security-category" => {
                super::super::code_systems::contract_security_category::ContractSecurityCategory::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ContractResourceScopeCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ContractResourceScopeCodes {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ContractResourceScopeCodes {
