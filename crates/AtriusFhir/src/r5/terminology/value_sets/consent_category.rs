...
///FHIR ValueSet: ConsentCategoryCodes
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                "http://loinc.org",
                "57016-8",
                Some("Privacy policy acknowledgement Document"),
                None,
            ),
            (
                "http://loinc.org",
                "57017-6",
                Some("Privacy policy Organization Document "),
                None,
            ),
            ("http://loinc.org", "59284-0", Some("Patient Consent "), None),
            (
                "http://loinc.org",
                "64292-6",
                Some("Release of information consent "),
                None,
            ),
        ]
    }
...
impl super::super::bindings::ValueSetMembership<Code> for ConsentCategoryCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ConsentCategoryCodes {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ConsentCategoryCodes {
