...
///FHIR ValueSet: TestReportActionResult
...
impl TestReportActionResult {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                ...
                "fail",
                Some("Fail"),
                Some("The action failed."),
            ),
            (
                "http://hl7.org/fhir/report-action-result-codes",
                "pass",
                Some("Pass"),
                Some("The action was successful."),
            ),
            (
                "http://hl7.org/fhir/report-action-result-codes",
                "skip",
                Some("Skip"),
                Some("The action was skipped."),
            ),
            (
                "http://hl7.org/fhir/report-action-result-codes",
                "warning",
                Some("Warning"),
                Some("The action passed but with warnings."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/report-action-result-codes" => {
                super::super::code_systems::report_action_result_codes::TestReportActionResult::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for TestReportActionResult {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for TestReportActionResult {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for TestReportActionResult {
