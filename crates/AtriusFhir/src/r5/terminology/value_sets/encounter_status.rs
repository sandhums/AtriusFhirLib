...
impl EncounterStatus {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ...
            ("http://hl7.org/fhir/encounter-status", "discontinued"),
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "cancelled",
                Some("Cancelled"),
                Some("The Encounter has ended before it has begun."),
            ),
            (
                "http://hl7.org/fhir/encounter-status",
                "completed",
                Some("Completed"),
                Some("The Encounter has ended."),
            ),
            (
                "http://hl7.org/fhir/encounter-status",
                "discharged",
            ...
            (
                ...
                "planned",
                Some("Planned"),
                Some("The Encounter has not yet started."),
            ),
            (
                "http://hl7.org/fhir/encounter-status",
                "unknown",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/encounter-status" => {
                super::super::code_systems::encounter_status::EncounterStatus::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for EncounterStatus {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for EncounterStatus {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for EncounterStatus {
