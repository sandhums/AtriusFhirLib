...
impl AccountStatus {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "active",
                Some("Active"),
                Some("This account is active and may be used."),
            ),
            (
                "http://hl7.org/fhir/account-status",
                "entered-in-error",
            ...
            (
                ...
                "on-hold",
                Some("On Hold"),
                Some("This account is on hold."),
            ),
            (
                "http://hl7.org/fhir/account-status",
                "unknown",
                Some("Unknown"),
                Some("The account status is unknown."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/account-status" => {
                super::super::code_systems::account_status::AccountStatus::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for AccountStatus {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for AccountStatus {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for AccountStatus {
