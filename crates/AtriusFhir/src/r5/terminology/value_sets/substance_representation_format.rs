...
///FHIR ValueSet: SubstanceRepresentationFormat
...
impl SubstanceRepresentationFormat {
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/substance-representation-format" => {
                super::super::code_systems::substance_representation_format::SubstanceRepresentationFormat::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for SubstanceRepresentationFormat {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding>
for SubstanceRepresentationFormat {
