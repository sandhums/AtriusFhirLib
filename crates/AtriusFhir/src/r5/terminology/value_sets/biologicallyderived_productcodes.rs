...
///FHIR ValueSet: BiologicallyDerivedProductCodes
...
impl BiologicallyDerivedProductCodes {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/biologicallyderived-productcodes", "e0398"),
            ("http://hl7.org/fhir/biologicallyderived-productcodes", "s1128"),
            ("http://hl7.org/fhir/biologicallyderived-productcodes", "s1194"),
            ("http://hl7.org/fhir/biologicallyderived-productcodes", "s1195"),
            ("http://hl7.org/fhir/biologicallyderived-productcodes", "s1310"),
            ("http://hl7.org/fhir/biologicallyderived-productcodes", "s1398"),
            ("http://hl7.org/fhir/biologicallyderived-productcodes", "s2598"),
            ("http://hl7.org/fhir/biologicallyderived-productcodes", "e4377"),
            ("http://hl7.org/fhir/biologicallyderived-productcodes", "t1396"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                "http://hl7.org/fhir/biologicallyderived-productcodes",
                "e0398",
                Some("RED BLOOD CELLS|CPD>AS5/450mL/refg|Irr|ResLeu"),
                Some("RED BLOOD CELLS|CPD>AS5/450mL/refg|Irr|ResLeu"),
            ),
            (
                "http://hl7.org/fhir/biologicallyderived-productcodes",
                "e4377",
                Some("Apheresis RED BLOOD CELLS|ACD-A/XX/refg|Irradiated|1st container"),
                Some(
            ...
            (
                "http://hl7.org/fhir/biologicallyderived-productcodes",
                "s1128",
                Some("HPC, APHERESIS/Citrate/XX/refg/Mobilized"),
                Some("HPC, APHERESIS/Citrate/XX/refg/Mobilized"),
            ),
            (
                "http://hl7.org/fhir/biologicallyderived-productcodes",
                "s1194",
                Some("HPC, APHERESIS|NS/XX/<=-120C|10% DMSO|Cryopreserved|Mobilized"),
                Some(
            ...
            (
                "http://hl7.org/fhir/biologicallyderived-productcodes",
                "s1195",
                Some("HPC, APHERESIS|NS/XX/<=-120C|5% DMSO|Cryopreserved|Mobilized"),
                Some(
            ...
            (
                "http://hl7.org/fhir/biologicallyderived-productcodes",
                "s1398",
                Some("HPC, MARROW|NS/XX/rt|Plasma reduced"),
                Some("HPC, Marrow, plasma reduced, stored at room temperature"),
            ),
            (
                "http://hl7.org/fhir/biologicallyderived-productcodes",
                "s2598",
            ...
            (
                "http://hl7.org/fhir/biologicallyderived-productcodes",
                "t1396",
                Some("BONE, FEMUR|Frozen|Right|Radiation sterilization"),
                Some(
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/biologicallyderived-productcodes" => {
                super::super::code_systems::biologicallyderived_productcodes::BiologicallyDerivedProductCodes::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
for BiologicallyDerivedProductCodes {
