...
///FHIR ValueSet: ImmunizationStatusReasonCodes
...
impl ImmunizationStatusReasonCodes {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ("http://terminology.hl7.org/CodeSystem/v3-ActReason", "IMMUNE", None, None),
            (
                "http://terminology.hl7.org/CodeSystem/v3-ActReason",
                "MEDPREC",
                None,
            ...
            ("http://terminology.hl7.org/CodeSystem/v3-ActReason", "OSTOCK", None, None),
            ("http://terminology.hl7.org/CodeSystem/v3-ActReason", "PATOBJ", None, None),
            (
                "http://terminology.hl7.org/CodeSystem/v3-ActReason",
                "PHILISOP",
                None,
            ...
            ("http://terminology.hl7.org/CodeSystem/v3-ActReason", "RELIG", None, None),
            ("http://terminology.hl7.org/CodeSystem/v3-ActReason", "VACEFF", None, None),
            ("http://terminology.hl7.org/CodeSystem/v3-ActReason", "VACSAF", None, None),
        ]
    }
...
impl super::super::bindings::ValueSetMembership<Code> for ImmunizationStatusReasonCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding>
for ImmunizationStatusReasonCodes {
