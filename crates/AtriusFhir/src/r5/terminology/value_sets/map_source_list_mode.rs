...
///FHIR ValueSet: StructureMapSourceListMode
...
impl StructureMapSourceListMode {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "first",
                Some("First"),
                Some("Only process this rule for the first in the list."),
            ),
            (
                "http://hl7.org/fhir/map-source-list-mode",
                "last",
                Some("Last"),
                Some("Only process this rule for the last in the list."),
            ),
            (
                "http://hl7.org/fhir/map-source-list-mode",
                "not_first",
                Some("All but the first"),
                Some("Process this rule for all but the first."),
            ),
            (
                "http://hl7.org/fhir/map-source-list-mode",
                "not_last",
                Some("All but the last"),
                Some("Process this rule for all but the last."),
            ),
            (
                "http://hl7.org/fhir/map-source-list-mode",
                "only_one",
                Some("Enforce only one"),
                Some("Only process this rule is there is only item."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/map-source-list-mode" => {
                super::super::code_systems::map_source_list_mode::StructureMapSourceListMode::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for StructureMapSourceListMode {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for StructureMapSourceListMode {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for StructureMapSourceListMode {
