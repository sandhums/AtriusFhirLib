...
///FHIR ValueSet: DiagnosticReportStatus
...
impl DiagnosticReportStatus {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ...
            ("http://hl7.org/fhir/diagnostic-report-status", "modified"),
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                ...
                "final",
                Some("Final"),
                Some("The report is complete and verified by an authorized person."),
            ),
            (
                "http://hl7.org/fhir/diagnostic-report-status",
                "modified",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/diagnostic-report-status" => {
                super::super::code_systems::diagnostic_report_status::DiagnosticReportStatus::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for DiagnosticReportStatus {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for DiagnosticReportStatus {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for DiagnosticReportStatus {
