...
///FHIR ValueSet: MedicationKnowledgeStatusCodes
...
impl MedicationKnowledgeStatusCodes {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/CodeSystem/medicationknowledge-status", "active"),
            (
                "http://hl7.org/fhir/CodeSystem/medicationknowledge-status",
                "entered-in-error",
            ),
            ("http://hl7.org/fhir/CodeSystem/medicationknowledge-status", "inactive"),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/CodeSystem/medicationknowledge-status" => {
                super::super::code_systems::medicationknowledge_status::MedicationKnowledgeStatusCodes::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
for MedicationKnowledgeStatusCodes {
