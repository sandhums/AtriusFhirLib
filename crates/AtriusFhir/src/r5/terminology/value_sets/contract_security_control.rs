...
///FHIR ValueSet: ContractResourceSecurityControlCodes
...
impl ContractResourceSecurityControlCodes {
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/contract-security-control" => {
                super::super::code_systems::contract_security_control::ContractSecurityControl::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
for ContractResourceSecurityControlCodes {
