...
///FHIR ValueSet: ContractResourcePublicationStatusCodes
...
impl ContractResourcePublicationStatusCodes {
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/contract-publicationstatus" => {
                super::super::code_systems::contract_publicationstatus::ContractPublicationStatus::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
for ContractResourcePublicationStatusCodes {
