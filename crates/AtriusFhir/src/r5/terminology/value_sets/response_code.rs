...
impl ResponseType {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                ...
                "ok",
                Some("OK"),
                Some("The message was accepted and processed without error."),
            ),
            (
                "http://hl7.org/fhir/response-code",
                "transient-error",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/response-code" => {
                super::super::code_systems::response_code::ResponseType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ResponseType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ResponseType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for ResponseType {
