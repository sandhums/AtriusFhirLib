...
///FHIR ValueSet: ImmunizationFunctionCodes
...
impl ImmunizationFunctionCodes {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ("http://terminology.hl7.org/CodeSystem/v2-0443", "AP", None, None),
            ("http://terminology.hl7.org/CodeSystem/v2-0443", "OP", None, None),
        ]
    }
...
impl super::super::bindings::ValueSetMembership<Code> for ImmunizationFunctionCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ImmunizationFunctionCodes {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ImmunizationFunctionCodes {
