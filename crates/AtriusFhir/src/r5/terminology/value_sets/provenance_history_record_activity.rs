...
///FHIR ValueSet: ProvenanceHistoryRecordActivityCodes
...
impl ProvenanceHistoryRecordActivityCodes {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ...
            ("http://terminology.hl7.org/CodeSystem/v3-DataOperation", "ABORT"),
            ("http://terminology.hl7.org/CodeSystem/v3-DataOperation", "HOLD"),
            ("http://terminology.hl7.org/CodeSystem/v3-DataOperation", "RELEASE"),
            ("http://terminology.hl7.org/CodeSystem/v3-DataOperation", "CANCEL"),
            ("http://terminology.hl7.org/CodeSystem/v3-DataOperation", "ACTIVATE"),
            ("http://terminology.hl7.org/CodeSystem/v3-DataOperation", "SUSPEND"),
            ("http://terminology.hl7.org/CodeSystem/v3-DataOperation", "RESUME"),
            ("http://terminology.hl7.org/CodeSystem/v3-DataOperation", "COMPLETE"),
            ("http://terminology.hl7.org/CodeSystem/v3-DataOperation", "NULLIFY"),
            ("http://terminology.hl7.org/CodeSystem/v3-DataOperation", "OBSOLETE"),
            ("http://terminology.hl7.org/CodeSystem/v3-DataOperation", "REACTIVATE"),
        ]
    }
...
for ProvenanceHistoryRecordActivityCodes {
