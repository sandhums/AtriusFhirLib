...
///FHIR ValueSet: EligibilityResponsePurpose
...
impl EligibilityResponsePurpose {
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/eligibilityresponse-purpose" => {
                super::super::code_systems::eligibilityresponse_purpose::EligibilityResponsePurpose::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for EligibilityResponsePurpose {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for EligibilityResponsePurpose {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for EligibilityResponsePurpose {
