...
///FHIR ValueSet: MedicationIntendedPerformerRole
...
impl MedicationIntendedPerformerRole {
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/CodeSystem/medication-intended-performer-role" => {
                super::super::code_systems::medication_intended_performer_role::MedicationIntendedPerformerRole::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
for MedicationIntendedPerformerRole {
