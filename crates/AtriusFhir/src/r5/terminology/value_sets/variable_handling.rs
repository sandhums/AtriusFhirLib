...
///FHIR ValueSet: EvidenceVariableHandling
...
impl EvidenceVariableHandling {
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/variable-handling" => {
                super::super::code_systems::variable_handling::EvidenceVariableHandling::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for EvidenceVariableHandling {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for EvidenceVariableHandling {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for EvidenceVariableHandling {
