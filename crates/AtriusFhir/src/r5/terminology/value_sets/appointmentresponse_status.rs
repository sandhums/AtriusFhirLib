...
///FHIR ValueSet: AppointmentResponseStatus
...
impl AppointmentResponseStatus {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                ...
                "accepted",
                Some("Accepted"),
                Some("The participant has accepted the appointment."),
            ),
            (
                "http://hl7.org/fhir/participationstatus",
                "declined",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            ...
            "http://hl7.org/fhir/participationstatus" => {
                super::super::code_systems::participationstatus::ParticipationStatus::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for AppointmentResponseStatus {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for AppointmentResponseStatus {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for AppointmentResponseStatus {
