...
///FHIR ValueSet: MeasureDefinitionExample
...
impl MeasureDefinitionExample {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/measure-definition-example", "screening"),
            (
                "http://hl7.org/fhir/measure-definition-example",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/measure-definition-example" => {
                super::super::code_systems::measure_definition_example::MeasureDefinitionExample::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for MeasureDefinitionExample {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for MeasureDefinitionExample {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for MeasureDefinitionExample {
