...
///FHIR ValueSet: BeneficiaryRelationshipCodes
...
impl BeneficiaryRelationshipCodes {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "1",
                Some("Self"),
                Some("The patient is the subscriber (policy holder)"),
            ),
            (
                "http://hl7.org/fhir/relationship",
                "2",
            ...
            (
                ...
                "3",
                Some("Child"),
                Some("The patient is the child of the subscriber (policy holder)"),
            ),
            (
                "http://hl7.org/fhir/relationship",
                "4",
                Some("Common Law Spouse"),
                Some(
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/relationship" => {
                super::super::code_systems::relationship::BeneficiaryRelationshipCodes::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for BeneficiaryRelationshipCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding>
for BeneficiaryRelationshipCodes {
