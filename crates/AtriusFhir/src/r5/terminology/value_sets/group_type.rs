...
impl GroupType {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ...
            ("http://hl7.org/fhir/group-type", "careteam"),
            ("http://hl7.org/fhir/group-type", "healthcareservice"),
            ("http://hl7.org/fhir/group-type", "location"),
            ("http://hl7.org/fhir/group-type", "organization"),
            ("http://hl7.org/fhir/group-type", "relatedperson"),
            ("http://hl7.org/fhir/group-type", "specimen"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "animal",
                Some("Animal"),
                Some("Group contains \"animal\" Patient resources."),
            ),
            (
                "http://hl7.org/fhir/group-type",
                "careteam",
                Some("CareTeam"),
                Some("Group contains CareTeam resources."),
            ),
            (
                "http://hl7.org/fhir/group-type",
                "device",
                Some("Device"),
                Some("Group contains Device resources."),
            ),
            (
                "http://hl7.org/fhir/group-type",
                "healthcareservice",
                Some("HealthcareService"),
                Some("Group contains HealthcareService resources."),
            ),
            (
                "http://hl7.org/fhir/group-type",
                "location",
                Some("Location"),
                Some("Group contains Location resources."),
            ),
            (
                "http://hl7.org/fhir/group-type",
                "organization",
                Some("Organization"),
                Some("Group contains Organization resources."),
            ),
            (
                "http://hl7.org/fhir/group-type",
                "person",
                Some("Person"),
                Some("Group contains \"person\" Patient resources."),
            ),
            (
                "http://hl7.org/fhir/group-type",
                "practitioner",
            ...
            (
                ...
                "relatedperson",
                Some("RelatedPerson"),
                Some("Group contains RelatedPerson resources."),
            ),
            (
                "http://hl7.org/fhir/group-type",
                "specimen",
                Some("Specimen"),
                Some("Group contains Specimen resources."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/group-type" => {
                super::super::code_systems::group_type::GroupType::try_from_code(code)
                    .is_ok()
            }
            _ => false,
        }
...
impl super::super::bindings::ValueSetMembership<Code> for GroupType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for GroupType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for GroupType {
