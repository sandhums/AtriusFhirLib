...
///FHIR ValueSet: ProcedurePerformerRoleCodes
...
impl super::super::bindings::ValueSetMembership<Code> for ProcedurePerformerRoleCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ProcedurePerformerRoleCodes {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ProcedurePerformerRoleCodes {
