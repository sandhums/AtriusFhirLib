...
impl AddressType {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                "http://hl7.org/fhir/address-type",
                "both",
                Some("Postal & Physical"),
                Some("An address that is both physical and postal."),
            ),
            (
                "http://hl7.org/fhir/address-type",
                "physical",
                Some("Physical"),
                Some("A physical address that can be visited."),
            ),
            (
                "http://hl7.org/fhir/address-type",
                "postal",
                Some("Postal"),
                Some("Mailing addresses - PO Boxes and care-of addresses."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/address-type" => {
                super::super::code_systems::address_type::AddressType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for AddressType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for AddressType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for AddressType {
