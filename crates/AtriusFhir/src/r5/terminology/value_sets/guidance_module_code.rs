...
///FHIR ValueSet: GuidanceModuleCode
...
impl GuidanceModuleCode {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/guidance-module-code", "bmi-calculator"),
            ("http://hl7.org/fhir/guidance-module-code", "mme-calculator"),
            ("http://hl7.org/fhir/guidance-module-code", "opioid-cds"),
            ("http://hl7.org/fhir/guidance-module-code", "anc-cds"),
            ("http://hl7.org/fhir/guidance-module-code", "chf-pathway"),
            ("http://hl7.org/fhir/guidance-module-code", "covid-19-severity"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "anc-cds",
                Some("ANC CDS"),
                Some("Clinical Decision Support for Antenatal Care."),
            ),
            (
                "http://hl7.org/fhir/guidance-module-code",
                "bmi-calculator",
                Some("BMI Calculator"),
                Some("A Body Mass Index (BMI) calculator."),
            ),
            (
                "http://hl7.org/fhir/guidance-module-code",
                "chf-pathway",
                Some("CHF Pathway"),
                Some("Congestive Heart Failure Pathway"),
            ),
            (
                "http://hl7.org/fhir/guidance-module-code",
                "covid-19-severity",
                Some("COVID-19 Severity Score"),
                Some("A COVID-19 Severity Score Calculator."),
            ),
            (
                "http://hl7.org/fhir/guidance-module-code",
                "mme-calculator",
                Some("MME Calculator"),
                Some("A Morphine Milligram Equivalent (MME) calculator."),
            ),
            (
                "http://hl7.org/fhir/guidance-module-code",
                "opioid-cds",
                Some("Opioid CDS"),
                Some("Clinical Decision Support for Opioid Prescribing."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/guidance-module-code" => {
                super::super::code_systems::guidance_module_code::GuidanceModuleCode::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for GuidanceModuleCode {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for GuidanceModuleCode {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for GuidanceModuleCode {
