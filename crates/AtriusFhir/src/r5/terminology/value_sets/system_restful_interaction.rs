...
///FHIR ValueSet: SystemRestfulInteraction
...
impl SystemRestfulInteraction {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ("http://hl7.org/fhir/restful-interaction", "batch", None, None),
            ("http://hl7.org/fhir/restful-interaction", "history-system", None, None),
            ("http://hl7.org/fhir/restful-interaction", "search-system", None, None),
            ("http://hl7.org/fhir/restful-interaction", "transaction", None, None),
        ]
    }
...
impl super::super::bindings::ValueSetMembership<Code> for SystemRestfulInteraction {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for SystemRestfulInteraction {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for SystemRestfulInteraction {
