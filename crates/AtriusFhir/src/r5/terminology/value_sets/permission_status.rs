...
///FHIR ValueSet: PermissionStatus
...
impl PermissionStatus {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/permission-status", "active"),
            ("http://hl7.org/fhir/permission-status", "entered-in-error"),
            ("http://hl7.org/fhir/permission-status", "draft"),
            ("http://hl7.org/fhir/permission-status", "rejected"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "active",
                Some("Active"),
                Some("Permission is given."),
            ),
            (
                "http://hl7.org/fhir/permission-status",
                "draft",
                Some("Draft"),
                Some("Permission is being defined."),
            ),
            (
                "http://hl7.org/fhir/permission-status",
                "entered-in-error",
                Some("Entered in Error"),
                Some("Permission was entered in error and is not active."),
            ),
            (
                "http://hl7.org/fhir/permission-status",
                "rejected",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/permission-status" => {
                super::super::code_systems::permission_status::PermissionStatus::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for PermissionStatus {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for PermissionStatus {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for PermissionStatus {
