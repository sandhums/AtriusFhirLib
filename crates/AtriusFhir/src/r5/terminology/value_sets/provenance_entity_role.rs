...
///FHIR ValueSet: ProvenanceEntityRole
...
impl ProvenanceEntityRole {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ...
            ("http://hl7.org/fhir/provenance-entity-role", "instantiates"),
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/provenance-entity-role" => {
                super::super::code_systems::provenance_entity_role::ProvenanceEntityRole::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ProvenanceEntityRole {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ProvenanceEntityRole {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ProvenanceEntityRole {
