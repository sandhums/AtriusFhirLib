...
impl SlicingRules {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                ...
                "open",
                Some("Open"),
                Some("Additional content is allowed anywhere in the list."),
            ),
            (
                "http://hl7.org/fhir/resource-slicing-rules",
                "openAtEnd",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/resource-slicing-rules" => {
                super::super::code_systems::resource_slicing_rules::SlicingRules::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for SlicingRules {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for SlicingRules {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for SlicingRules {
