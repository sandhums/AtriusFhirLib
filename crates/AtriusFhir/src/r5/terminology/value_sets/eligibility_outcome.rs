...
///FHIR ValueSet: EligibilityOutcome
...
impl EligibilityOutcome {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/eligibility-outcome", "queued"),
            ("http://hl7.org/fhir/eligibility-outcome", "complete"),
            ("http://hl7.org/fhir/eligibility-outcome", "error"),
            ("http://hl7.org/fhir/eligibility-outcome", "partial"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                Some("The processing has completed without errors"),
            ),
            (
                "http://hl7.org/fhir/eligibility-outcome",
                "error",
                Some("Error"),
                Some("One or more errors have been detected in the Claim"),
            ),
            (
                "http://hl7.org/fhir/eligibility-outcome",
                "partial",
                Some("Partial Processing"),
                Some(
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/eligibility-outcome" => {
                super::super::code_systems::eligibility_outcome::ClaimProcessingCodes::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for EligibilityOutcome {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for EligibilityOutcome {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for EligibilityOutcome {
