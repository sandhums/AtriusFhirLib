...
///FHIR ValueSet: ConditionCategoryCodes
...
impl super::super::bindings::ValueSetMembership<Code> for ConditionCategoryCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ConditionCategoryCodes {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ConditionCategoryCodes {
