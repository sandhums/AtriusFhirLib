...
///FHIR ValueSet: BiologicallyDerivedProductPropertyTypeCodes
...
impl BiologicallyDerivedProductPropertyTypeCodes {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "aborhd",
                Some("ABORhD"),
                Some("See https://www.isbt128.org/uri/ABORhD"),
            ),
            (
                "http://hl7.org/fhir/biologicallyderived-product-property-type-codes",
                "collectiontype",
                Some("Collection Type"),
                Some("See https://www.isbt128.org/uri/CollectionType"),
            ),
            (
                "http://hl7.org/fhir/biologicallyderived-product-property-type-codes",
                "redcellantigen",
                Some("Red Cell Antigen"),
                Some("See https://www.isbt128.org/uri/RedCellAntigen"),
            ),
            (
                "http://hl7.org/fhir/biologicallyderived-product-property-type-codes",
                "singleeuropeancode",
                Some("Single European Code"),
                Some("See https://www.isbt128.org/uri/SingleEuropeanCode"),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/biologicallyderived-product-property-type-codes" => {
                super::super::code_systems::biologicallyderived_product_property_type_codes::BiologicallyDerivedProductPropertyTypeCodes::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
for BiologicallyDerivedProductPropertyTypeCodes {
