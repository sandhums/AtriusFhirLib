...
///FHIR ValueSet: ContractResourceLegalStateCodes
...
impl ContractResourceLegalStateCodes {
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/contract-legalstate" => {
                super::super::code_systems::contract_legalstate::ContractLegalState::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
for ContractResourceLegalStateCodes {
