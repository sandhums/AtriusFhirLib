...
impl SpecimenStatus {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "available",
                Some("Available"),
                Some("The physical specimen is present and in good condition."),
            ),
            (
                "http://hl7.org/fhir/specimen-status",
                "entered-in-error",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/specimen-status" => {
                super::super::code_systems::specimen_status::SpecimenStatus::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for SpecimenStatus {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for SpecimenStatus {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for SpecimenStatus {
