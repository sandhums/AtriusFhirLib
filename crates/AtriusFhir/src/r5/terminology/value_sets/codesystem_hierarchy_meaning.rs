...
///FHIR ValueSet: CodeSystemHierarchyMeaning
...
impl CodeSystemHierarchyMeaning {
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/codesystem-hierarchy-meaning" => {
                super::super::code_systems::codesystem_hierarchy_meaning::CodeSystemHierarchyMeaning::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for CodeSystemHierarchyMeaning {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for CodeSystemHierarchyMeaning {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for CodeSystemHierarchyMeaning {
