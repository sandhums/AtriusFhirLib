...
///FHIR ValueSet: SubstanceRepresentationType
...
impl SubstanceRepresentationType {
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/substance-representation-type" => {
                super::super::code_systems::substance_representation_type::SubstanceRepresentationType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for SubstanceRepresentationType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for SubstanceRepresentationType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for SubstanceRepresentationType {
