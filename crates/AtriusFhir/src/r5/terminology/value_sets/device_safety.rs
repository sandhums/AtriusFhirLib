...
impl DeviceSafety {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("urn:oid:2.16.840.1.113883.3.26.1.1", "C106046"),
            ("urn:oid:2.16.840.1.113883.3.26.1.1", "C106045"),
            ("urn:oid:2.16.840.1.113883.3.26.1.1", "C106047"),
            ("urn:oid:2.16.840.1.113883.3.26.1.1", "C113844"),
            ("urn:oid:2.16.840.1.113883.3.26.1.1", "C101673"),
            ("urn:oid:2.16.840.1.113883.3.26.1.1", "C106038"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                "urn:oid:2.16.840.1.113883.3.26.1.1",
                "C101673",
                Some("Labeled as Containing Natural Rubber Latex"),
                Some("The device label indicates natural rubber latex as a component."),
            ),
            (
                "urn:oid:2.16.840.1.113883.3.26.1.1",
                "C106038",
                Some("Not Made with Natural Rubber Latex"),
                Some(
            ...
            (
                "urn:oid:2.16.840.1.113883.3.26.1.1",
                "C106046",
                Some("Magnetic Resonance Conditional"),
                Some(
            ...
            (
                "urn:oid:2.16.840.1.113883.3.26.1.1",
                "C106047",
                Some("Magnetic Resonance Unsafe"),
                Some(
            ...
            (
                "urn:oid:2.16.840.1.113883.3.26.1.1",
                "C113844",
                Some("Labeling does not Contain MRI Safety Information"),
                Some(
...
impl super::super::bindings::ValueSetMembership<Code> for DeviceSafety {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for DeviceSafety {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for DeviceSafety {
