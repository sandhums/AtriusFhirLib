...
impl SlotStatus {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                ...
                "free",
                Some("Free"),
                Some("Indicates that the time interval is free for scheduling."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/slotstatus" => {
                super::super::code_systems::slotstatus::SlotStatus::try_from_code(code)
                    .is_ok()
            }
            _ => false,
        }
...
impl super::super::bindings::ValueSetMembership<Code> for SlotStatus {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for SlotStatus {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for SlotStatus {
