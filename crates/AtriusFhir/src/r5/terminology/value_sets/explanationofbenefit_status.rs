...
///FHIR ValueSet: ExplanationOfBenefitStatus
...
impl ExplanationOfBenefitStatus {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "active",
                Some("Active"),
                Some("The resource instance is currently in-force."),
            ),
            (
                "http://hl7.org/fhir/explanationofbenefit-status",
                "cancelled",
                Some("Cancelled"),
                Some("The resource instance is withdrawn, rescinded or reversed."),
            ),
            (
                "http://hl7.org/fhir/explanationofbenefit-status",
                "draft",
                Some("Draft"),
                Some("A new resource instance the contents of which is not complete."),
            ),
            (
                "http://hl7.org/fhir/explanationofbenefit-status",
                "entered-in-error",
                Some("Entered In Error"),
                Some("The resource instance was entered in error."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/explanationofbenefit-status" => {
                super::super::code_systems::explanationofbenefit_status::ExplanationOfBenefitStatus::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ExplanationOfBenefitStatus {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ExplanationOfBenefitStatus {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ExplanationOfBenefitStatus {
