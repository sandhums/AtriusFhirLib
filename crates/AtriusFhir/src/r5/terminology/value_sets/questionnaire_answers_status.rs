...
///FHIR ValueSet: QuestionnaireResponseStatus
...
impl QuestionnaireResponseStatus {
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/questionnaire-answers-status" => {
                super::super::code_systems::questionnaire_answers_status::QuestionnaireResponseStatus::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for QuestionnaireResponseStatus {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for QuestionnaireResponseStatus {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for QuestionnaireResponseStatus {
