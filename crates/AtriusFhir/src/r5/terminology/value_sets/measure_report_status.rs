...
///FHIR ValueSet: MeasureReportStatus
...
impl MeasureReportStatus {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "complete",
                Some("Complete"),
                Some("The report is complete and ready for use."),
            ),
            (
                "http://hl7.org/fhir/measure-report-status",
                "error",
                Some("Error"),
                Some("An error occurred attempting to generate the report."),
            ),
            (
                "http://hl7.org/fhir/measure-report-status",
                "pending",
                Some("Pending"),
                Some("The report is currently being generated."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/measure-report-status" => {
                super::super::code_systems::measure_report_status::MeasureReportStatus::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for MeasureReportStatus {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for MeasureReportStatus {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for MeasureReportStatus {
