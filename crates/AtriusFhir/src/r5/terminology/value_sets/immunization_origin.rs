...
///FHIR ValueSet: ImmunizationOriginCodes
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            ...
            (
                "http://terminology.hl7.org/CodeSystem/immunization-origin",
                "recall",
                Some("Parent/Guardian/Patient Recall"),
                None,
            ),
            (
                "http://terminology.hl7.org/CodeSystem/immunization-origin",
...
impl super::super::bindings::ValueSetMembership<Code> for ImmunizationOriginCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ImmunizationOriginCodes {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ImmunizationOriginCodes {
