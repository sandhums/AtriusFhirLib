...
///FHIR ValueSet: ActionSelectionBehavior
...
impl ActionSelectionBehavior {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "all",
                Some("All"),
                Some("All the actions in the group must be selected as a single unit."),
            ),
            (
                "http://hl7.org/fhir/action-selection-behavior",
                "all-or-none",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/action-selection-behavior" => {
                super::super::code_systems::action_selection_behavior::ActionSelectionBehavior::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ActionSelectionBehavior {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ActionSelectionBehavior {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ActionSelectionBehavior {
