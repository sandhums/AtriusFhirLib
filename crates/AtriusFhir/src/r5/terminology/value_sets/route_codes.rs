...
///FHIR ValueSet: SNOMEDCTRouteCodes
...
impl super::super::bindings::ValueSetMembership<Code> for SNOMEDCTRouteCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for SNOMEDCTRouteCodes {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for SNOMEDCTRouteCodes {
