...
///FHIR ValueSet: FHIRDeviceAvailabilityStatus
...
impl FHIRDeviceAvailabilityStatus {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/device-availability-status", "lost"),
            ("http://hl7.org/fhir/device-availability-status", "damaged"),
            ("http://hl7.org/fhir/device-availability-status", "destroyed"),
            ("http://hl7.org/fhir/device-availability-status", "available"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "available",
                Some("Available"),
                Some("The device is available."),
            ),
            (
                "http://hl7.org/fhir/device-availability-status",
                "damaged",
                Some("Damaged"),
                Some("The device is damaged."),
            ),
            (
                "http://hl7.org/fhir/device-availability-status",
                "destroyed",
                Some("Destroyed"),
                Some("The device is destroyed."),
            ),
            (
                "http://hl7.org/fhir/device-availability-status",
                "lost",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/device-availability-status" => {
                super::super::code_systems::device_availability_status::FHIRDeviceAvailabilityStatus::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for FHIRDeviceAvailabilityStatus {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding>
for FHIRDeviceAvailabilityStatus {
