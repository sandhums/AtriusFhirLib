...
///FHIR ValueSet: ResearchStudyClassifiers
///Canonical URL: http://hl7.org/fhir/ValueSet/research-study-classifiers
///Version: 5.0.0
///Title: Research Study Classifiers
///Status: draft
...
impl ResearchStudyClassifiers {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/research-study-classifiers", "fda-regulated-drug"),
            ("http://hl7.org/fhir/research-study-classifiers", "fda-regulated-device"),
            ("http://hl7.org/fhir/research-study-classifiers", "mpg-paragraph-23b"),
            ("http://hl7.org/fhir/research-study-classifiers", "irb-exempt"),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/research-study-classifiers" => {
                super::super::code_systems::research_study_classifiers::ResearchStudyClassifiers::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ResearchStudyClassifiers {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ResearchStudyClassifiers {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for ResearchStudyClassifiers {
