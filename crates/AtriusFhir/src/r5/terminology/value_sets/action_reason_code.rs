...
///FHIR ValueSet: ActionReasonCode
...
impl ActionReasonCode {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/action-reason-code", "off-pathway"),
            ("http://hl7.org/fhir/action-reason-code", "risk-assessment"),
            ("http://hl7.org/fhir/action-reason-code", "care-gap"),
            ("http://hl7.org/fhir/action-reason-code", "drug-drug-interaction"),
            ("http://hl7.org/fhir/action-reason-code", "quality-measure"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                "http://hl7.org/fhir/action-reason-code",
                "care-gap",
                Some("Care gap detected"),
                Some("The action should be performed to address a detected care gap."),
            ),
            (
                "http://hl7.org/fhir/action-reason-code",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/action-reason-code" => {
                super::super::code_systems::action_reason_code::ActionReasonCode::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ActionReasonCode {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ActionReasonCode {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for ActionReasonCode {
