...
///FHIR ValueSet: AllergyIntoleranceCriticality
...
impl AllergyIntoleranceCriticality {
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/allergy-intolerance-criticality" => {
                super::super::code_systems::allergy_intolerance_criticality::AllergyIntoleranceCriticality::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for AllergyIntoleranceCriticality {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding>
for AllergyIntoleranceCriticality {
