...
///FHIR ValueSet: RegulatedAuthorizationBasis
...
impl RegulatedAuthorizationBasis {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                "http://hl7.org/fhir/regulated-authorization-basis",
                "Bibliographical",
                Some("Bibliographical application (stand-alone)"),
                None,
            ),
            (
                "http://hl7.org/fhir/regulated-authorization-basis",
                "Full",
                Some("Full application"),
                None,
            ),
            (
                "http://hl7.org/fhir/regulated-authorization-basis",
            ...
            (
                "http://hl7.org/fhir/regulated-authorization-basis",
                "KnownSubstance",
                Some("Known active substance"),
                None,
            ),
            (
                "http://hl7.org/fhir/regulated-authorization-basis",
                "NewSubstance",
                Some("New active substance"),
                None,
            ),
            (
                "http://hl7.org/fhir/regulated-authorization-basis",
                "ParallelTrade",
                Some("Parallel traded products"),
                None,
            ),
            (
                "http://hl7.org/fhir/regulated-authorization-basis",
                "SimilarBiological",
                Some("Similar biological application"),
                None,
            ),
            (
                "http://hl7.org/fhir/regulated-authorization-basis",
                "TemporaryUse",
                Some("Authorizations for temporary use"),
                None,
            ),
            (
                "http://hl7.org/fhir/regulated-authorization-basis",
            ...
            (
                "http://hl7.org/fhir/regulated-authorization-basis",
                "Well-establishedUse",
                Some("Well-established use application"),
                None,
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/regulated-authorization-basis" => {
                super::super::code_systems::regulated_authorization_basis::RegulatedAuthorizationBasis::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for RegulatedAuthorizationBasis {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for RegulatedAuthorizationBasis {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for RegulatedAuthorizationBasis {
