...
///FHIR ValueSet: EventCapabilityMode
...
impl EventCapabilityMode {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "receiver",
                Some("Receiver"),
                Some("The application receives requests and sends responses."),
            ),
            (
                "http://hl7.org/fhir/event-capability-mode",
                "sender",
                Some("Sender"),
                Some("The application sends requests and receives responses."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/event-capability-mode" => {
                super::super::code_systems::event_capability_mode::EventCapabilityMode::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for EventCapabilityMode {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for EventCapabilityMode {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for EventCapabilityMode {
