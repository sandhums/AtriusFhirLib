...
///FHIR ValueSet: ArtifactAssessmentDisposition
...
impl ArtifactAssessmentDisposition {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/artifactassessment-disposition", "unresolved"),
            ("http://hl7.org/fhir/artifactassessment-disposition", "not-persuasive"),
            ("http://hl7.org/fhir/artifactassessment-disposition", "persuasive"),
            (
                "http://hl7.org/fhir/artifactassessment-disposition",
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "not-persuasive",
                Some("Not Persuasive"),
                Some("The comment is not persuasive (rejected in full)"),
            ),
            (
                "http://hl7.org/fhir/artifactassessment-disposition",
                "not-persuasive-with-modification",
                Some("Not Persuasive with Modification"),
                Some(
            ...
            (
                ...
                "persuasive",
                Some("Persuasive"),
                Some("The comment is persuasive (accepted in full)"),
            ),
            (
                "http://hl7.org/fhir/artifactassessment-disposition",
                "persuasive-with-modification",
                Some("Persuasive with Modification"),
            ...
            (
                ...
                "unresolved",
                Some("Unresolved"),
                Some("The comment is unresolved"),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/artifactassessment-disposition" => {
                super::super::code_systems::artifactassessment_disposition::ArtifactAssessmentDisposition::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ArtifactAssessmentDisposition {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding>
for ArtifactAssessmentDisposition {
