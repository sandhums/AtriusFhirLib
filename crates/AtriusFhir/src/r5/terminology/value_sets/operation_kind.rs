...
impl OperationKind {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "operation",
                Some("Operation"),
                Some("This operation is invoked as an operation."),
            ),
            (
                "http://hl7.org/fhir/operation-kind",
                "query",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/operation-kind" => {
                super::super::code_systems::operation_kind::OperationKind::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for OperationKind {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for OperationKind {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for OperationKind {
