...
///FHIR ValueSet: BodyTemperatureUnits
...
impl BodyTemperatureUnits {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[("http://unitsofmeasure.org", "Cel"), ("http://unitsofmeasure.org", "[degF]")]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            ("http://unitsofmeasure.org", "Cel", None, None),
            ("http://unitsofmeasure.org", "[degF]", None, None),
        ]
    }
...
impl super::super::bindings::ValueSetMembership<Code> for BodyTemperatureUnits {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for BodyTemperatureUnits {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for BodyTemperatureUnits {
