...
impl ContributorType {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "author",
                Some("Author"),
                Some("An author of the content of the module."),
            ),
            (
                "http://hl7.org/fhir/contributor-type",
                "editor",
                Some("Editor"),
                Some("An editor of the content of the module."),
            ),
            (
                "http://hl7.org/fhir/contributor-type",
                "endorser",
                Some("Endorser"),
                Some("An endorser of the content of the module."),
            ),
            (
                "http://hl7.org/fhir/contributor-type",
                "reviewer",
                Some("Reviewer"),
                Some("A reviewer of the content of the module."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/contributor-type" => {
                super::super::code_systems::contributor_type::ContributorType::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for ContributorType {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for ContributorType {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for ContributorType {
