...
///FHIR ValueSet: LegalStatusOfSupply
...
impl LegalStatusOfSupply {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                "http://hl7.org/fhir/legal-status-of-supply",
                "100000072076",
                Some("Medicinal product not subject to medical prescription"),
                None,
            ),
            (
                "http://hl7.org/fhir/legal-status-of-supply",
            ...
            (
                "http://hl7.org/fhir/legal-status-of-supply",
                "100000072084",
                Some("Medicinal product subject to medical prescription"),
                None,
            ),
            (
                "http://hl7.org/fhir/legal-status-of-supply",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/legal-status-of-supply" => {
                super::super::code_systems::legal_status_of_supply::LegalStatusOfSupply::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for LegalStatusOfSupply {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for LegalStatusOfSupply {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for LegalStatusOfSupply {
