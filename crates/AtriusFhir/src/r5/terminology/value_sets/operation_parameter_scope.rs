...
///FHIR ValueSet: OperationParameterScope
///Canonical URL: http://hl7.org/fhir/ValueSet/operation-parameter-scope
///Version: 5.0.0
///Title: Operation Parameter Scope
///Status: active
...
impl OperationParameterScope {
    ...
    fn include_pairs() -> &'static [(&'static str, &'static str)] {
        &[
            ("http://hl7.org/fhir/operation-parameter-scope", "instance"),
            ("http://hl7.org/fhir/operation-parameter-scope", "type"),
            ("http://hl7.org/fhir/operation-parameter-scope", "system"),
        ]
    }
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "instance",
                Some("Instance"),
                Some("This is a parameter that can be used at the instance level."),
            ),
            (
                "http://hl7.org/fhir/operation-parameter-scope",
                "system",
                Some("System"),
                Some("This is a parameter that can be used at the system level."),
            ),
            (
                "http://hl7.org/fhir/operation-parameter-scope",
                "type",
                Some("Type"),
                Some("This is a parameter that can be used at the type level."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/operation-parameter-scope" => {
                super::super::code_systems::operation_parameter_scope::OperationParameterScope::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for OperationParameterScope {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for OperationParameterScope {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept>
for OperationParameterScope {
