...
impl AggregationMode {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "contained",
                Some("Contained"),
                Some("The reference is a local reference to a contained resource."),
            ),
            (
                "http://hl7.org/fhir/resource-aggregation-mode",
                "referenced",
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/resource-aggregation-mode" => {
                super::super::code_systems::resource_aggregation_mode::AggregationMode::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for AggregationMode {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding> for AggregationMode {
    fn contains(v: &Coding) -> bool {
        Self::contains_coding(v)
    }
}
impl super::super::bindings::ValueSetMembership<CodeableConcept> for AggregationMode {
