...
///FHIR ValueSet: DeviceMetricCalibrationState
...
impl DeviceMetricCalibrationState {
    ...
    fn include_entries() -> &'static [(
        ...
        &[
            (
                ...
                "calibrated",
                Some("Calibrated"),
                Some("The metric has been calibrated."),
            ),
            (
                "http://hl7.org/fhir/metric-calibration-state",
                "calibration-required",
                Some("Calibration Required"),
                Some("The metric needs to be calibrated."),
            ),
            (
                "http://hl7.org/fhir/metric-calibration-state",
                "not-calibrated",
                Some("Not Calibrated"),
                Some("The metric has not been calibrated."),
            ),
            (
                "http://hl7.org/fhir/metric-calibration-state",
                "unspecified",
                Some("Unspecified"),
                Some("The state of calibration of this metric is unspecified."),
            ),
        ]
    }
    ...
    pub fn contains_coding(coding: &Coding) -> bool {
        ...
        match system {
            "http://hl7.org/fhir/metric-calibration-state" => {
                super::super::code_systems::metric_calibration_state::DeviceMetricCalibrationState::try_from_code(
                        code,
                    )
                    .is_ok()
            }
...
impl super::super::bindings::ValueSetMembership<Code> for DeviceMetricCalibrationState {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding>
for DeviceMetricCalibrationState {
