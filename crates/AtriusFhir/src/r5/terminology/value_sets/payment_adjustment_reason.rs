...
///FHIR ValueSet: PaymentAdjustmentReasonCodes
...
impl super::super::bindings::ValueSetMembership<Code> for PaymentAdjustmentReasonCodes {
    fn contains(v: &Code) -> bool {
        Self::contains_code(v)
    }
}
impl super::super::bindings::ValueSetMembership<Coding>
for PaymentAdjustmentReasonCodes {
