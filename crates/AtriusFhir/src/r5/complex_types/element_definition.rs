...
#[fhir_invariant(key="eld-2", severity="error", human="Min <= Max", expr="min.empty() or max.empty() or (max = '*') or iif(max != '*', min <= max.toInteger())", path="ElementDefinition")]
#[fhir_invariant(key="eld-5", severity="error", human="if the element definition has a contentReference, it cannot have type, defaultValue, fixed, pattern, example, minValue, maxValue, maxLength, or binding", expr="contentReference.empty() or (type.empty() and defaultValue.empty() and fixed.empty() and pattern.empty() and example.empty() and minValue.empty() and maxValue.empty() and maxLength.empty() and binding.empty())", path="ElementDefinition")]
#[fhir_invariant(key="eld-6", severity="error", human="Fixed value may only be specified if there is one type", expr="fixed.empty() or (type.count()  <= 1)", path="ElementDefinition")]
#[fhir_invariant(key="eld-7", severity="error", human="Pattern may only be specified if there is one type", expr="pattern.empty() or (type.count() <= 1)", path="ElementDefinition")]
#[fhir_invariant(key="eld-8", severity="error", human="Pattern and fixed are mutually exclusive", expr="pattern.empty() or fixed.empty()", path="ElementDefinition")]
#[fhir_invariant(key="eld-11", severity="error", human="Binding can only be present for coded elements, string, and uri if using FHIR-defined types", expr="binding.empty() or type.code.empty() or type.code.contains(\":\") or type.select((code = 'code') or (code = 'Coding') or (code='CodeableConcept') or (code = 'Quantity') or (code = 'string') or (code = 'uri') or (code = 'Duration')).exists()", path="ElementDefinition")]
#[fhir_invariant(key="eld-13", severity="error", human="Types must be unique by code", expr="type.select(code).isDistinct()", path="ElementDefinition")]
#[fhir_invariant(key="eld-14", severity="error", human="Constraints must be unique by key", expr="constraint.select(key).isDistinct()", path="ElementDefinition")]
#[fhir_invariant(key="eld-15", severity="error", human="default value and meaningWhenMissing are mutually exclusive", expr="defaultValue.empty() or meaningWhenMissing.empty()", path="ElementDefinition")]
#[fhir_invariant(key="eld-16", severity="error", human="sliceName must be composed of proper tokens separated by \"/\"", expr="sliceName.empty() or sliceName.matches('^[a-zA-Z0-9\\\\/\\\\-_\\\\[\\\\]\\\\@]+$')", path="ElementDefinition")]
#[fhir_invariant(key="eld-18", severity="error", human="Must have a modifier reason if isModifier = true", expr="(isModifier.exists() and isModifier) implies isModifierReason.exists()", path="ElementDefinition")]
#[fhir_invariant(key="eld-19", severity="error", human="Element path SHALL be expressed as a set of '.'-separated components with each component restricted to a maximum of 64 characters and with some limits on the allowed choice of characters", expr="path.matches('^[^\\\\s\\\\.,:;\\\\\\'\"\\\\/|?!@#$%&*()\\\\[\\\\]{}]{1,64}(\\\\.[^\\\\s\\\\.,:;\\\\\\'\"\\\\/|?!@#$%&*()\\\\[\\\\]{}]{1,64}(\\\\[x\\\\])?(\\\\:[^\\\\s\\\\.]+)?)*$')", path="ElementDefinition")]
#[fhir_invariant(key="eld-20", severity="warning", human="The first component of the path should be UpperCamelCase.  Additional components (following a '.') should be lowerCamelCase.  If this syntax is not adhered to, code generation tools may be broken. Logical models may be less concerned about this implication.", expr="path.matches('^[A-Za-z][A-Za-z0-9]{0,63}(\\\\.[a-z][A-Za-z0-9]{0,63}(\\\\[x])?)*$')", path="ElementDefinition")]
#[fhir_invariant(key="eld-22", severity="error", human="sliceIsConstraining can only appear if slicename is present", expr="sliceIsConstraining.exists() implies sliceName.exists()", path="ElementDefinition")]
#[fhir_invariant(key="eld-24", severity="warning", human="pattern[x] should be used rather than fixed[x]", expr="fixed.exists().not()", path="ElementDefinition")]
#[fhir_invariant(key="eld-25", severity="warning", human="Order has no meaning (and cannot be asserted to have meaning), so enforcing rules on order is improper", expr="orderMeaning.empty() implies slicing.where(rules='openAtEnd' or ordered).exists().not()", path="ElementDefinition")]
#[fhir_invariant(key="eld-27", severity="warning", human="Mappings SHOULD be unique by key", expr="mapping.select(identity).isDistinct()", path="ElementDefinition")]
#[fhir_invariant(key="eld-28", severity="error", human="Can't have valueAlternatives if mustHaveValue is true", expr="mustHaveValue.value implies valueAlternatives.empty()", path="ElementDefinition")]
#[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition")]
pub struct ElementDefinition {
    ...
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.extension")]
    #[fhir_invariant(key="ext-1", severity="error", human="Must have either extensions or value[x], not both", expr="extension.exists() != value.exists()", path="ElementDefinition.extension")]
    ...
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.modifierExtension")]
    #[fhir_invariant(key="ext-1", severity="error", human="Must have either extensions or value[x], not both", expr="extension.exists() != value.exists()", path="ElementDefinition.modifierExtension")]
    ...
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.path")]
    pub path: String,
    ...
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.sliceName")]
    ...
    /// ## Conditions
    /// Used when: eld-22
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.sliceIsConstraining")]
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.label")]
    ...
    /// ## Conditions
    /// Used when: eld-25
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.slicing")]
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.short")]
    ...
    /// ## Aliases
    /// Description
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.definition")]
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.comment")]
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.requirements")]
    ...
    /// ## Aliases
    /// synonym, other name
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.alias")]
    ...
    /// ## Conditions
    /// Used when: eld-2
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.min")]
    ...
    /// ## Conditions
    /// Used when: eld-2
    #[fhir_invariant(key="eld-3", severity="error", human="Max SHALL be a number or \"*\"", expr="empty() or ($this = '*') or (toInteger() >= 0)", path="ElementDefinition.max")]
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.max")]
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.base")]
    ...
    /// ## Conditions
    /// Used when: eld-5
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.contentReference")]
    ...
    #[fhir_invariant(key="eld-4", severity="error", human="Aggregation may only be specified if one of the allowed types for the element is a reference", expr="aggregation.empty() or (code = 'Reference') or (code = 'canonical') or (code = 'CodeableReference')", path="ElementDefinition.type")]
    #[fhir_invariant(key="eld-17", severity="error", human="targetProfile is only allowed if the type is Reference or canonical", expr="(code='Reference' or code = 'canonical' or code = 'CodeableReference') or targetProfile.empty()", path="ElementDefinition.type")]
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.type")]
    ...
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.defaultValue[x]")]
    #[fhir_serde(flatten)]
    ...
    /// ## Conditions
    /// Used when: eld-15
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.meaningWhenMissing")]
    ...
    /// ## Conditions
    /// Used when: eld-25
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.orderMeaning")]
    ...
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.fixed[x]")]
    #[fhir_serde(flatten)]
    ...
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.pattern[x]")]
    #[fhir_serde(flatten)]
    ...
    /// ## Conditions
    /// Used when: eld-5
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.example")]
    ...
    /// ## Conditions
    /// Used when: eld-5
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.minValue[x]")]
    #[fhir_serde(flatten)]
    ...
    /// ## Conditions
    /// Used when: eld-5
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.maxValue[x]")]
    #[fhir_serde(flatten)]
    ...
    /// ## Conditions
    /// Used when: eld-5
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.maxLength")]
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.condition")]
    ...
    /// ## Conditions
    /// Used when: eld-14
    #[fhir_invariant(key="eld-21", severity="warning", human="Constraints should have an expression or else validators will not be able to enforce them", expr="expression.exists()", path="ElementDefinition.constraint")]
    #[fhir_invariant(key="eld-26", severity="error", human="Errors cannot be suppressed", expr="(severity = 'error') implies suppress.empty()", path="ElementDefinition.constraint")]
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.constraint")]
    ...
    /// ## Conditions
    /// Used when: eld-28
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.mustHaveValue")]
    ...
    /// ## Conditions
    /// Used when: eld-28
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.valueAlternatives")]
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.mustSupport")]
    ...
    /// ## Conditions
    /// Used when: eld-18
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.isModifier")]
    ...
    /// ## Conditions
    /// Used when: eld-18
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.isModifierReason")]
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.isSummary")]
    ...
    #[fhir_invariant(key="eld-12", severity="error", human="ValueSet SHALL start with http:// or https:// or urn: or #", expr="valueSet.exists() implies (valueSet.startsWith('http:') or valueSet.startsWith('https') or valueSet.startsWith('urn:') or valueSet.startsWith('#'))", path="ElementDefinition.binding")]
    #[fhir_invariant(key="eld-23", severity="error", human="binding SHALL have either description or valueSet", expr="description.exists() or valueSet.exists()", path="ElementDefinition.binding")]
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.binding")]
    ...
    /// ## Conditions
    /// Used when: eld-27
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.mapping")]
...
pub struct ElementDefinitionBase {
    ...
    /// ## Aliases
    /// extensions, user content
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.base.extension")]
    #[fhir_invariant(key="ext-1", severity="error", human="Must have either extensions or value[x], not both", expr="extension.exists() != value.exists()", path="ElementDefinition.base.extension")]
    pub extension: Option<Vec<Extension>>,
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.base.path")]
    pub path: String,
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.base.min")]
    pub min: UnsignedInt,
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.base.max")]
    pub max: String,
}
...
pub struct ElementDefinitionBinding {
    ...
    /// ## Aliases
    /// extensions, user content
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.binding.extension")]
    #[fhir_invariant(key="ext-1", severity="error", human="Must have either extensions or value[x], not both", expr="extension.exists() != value.exists()", path="ElementDefinition.binding.extension")]
    pub extension: Option<Vec<Extension>>,
    ...
    /// ## Conditions
    /// Used when: eld-23
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.binding.description")]
    ...
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.binding.valueSet")]
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.binding.additional")]
...
pub struct ElementDefinitionBindingAdditional {
    ...
    /// ## Aliases
    /// extensions, user content
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.binding.additional.extension")]
    #[fhir_invariant(key="ext-1", severity="error", human="Must have either extensions or value[x], not both", expr="extension.exists() != value.exists()", path="ElementDefinition.binding.additional.extension")]
    pub extension: Option<Vec<Extension>>,
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.binding.additional.valueSet")]
    #[fhir_serde(rename = "valueSet")]
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.binding.additional.documentation")]
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.binding.additional.shortDoco")]
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.binding.additional.usage")]
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.binding.additional.any")]
...
pub struct ElementDefinitionConstraint {
    ...
    /// ## Aliases
    /// extensions, user content
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.constraint.extension")]
    #[fhir_invariant(key="ext-1", severity="error", human="Must have either extensions or value[x], not both", expr="extension.exists() != value.exists()", path="ElementDefinition.constraint.extension")]
    pub extension: Option<Vec<Extension>>,
    ...
    /// ## Conditions
    /// Used when: eld-14
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.constraint.key")]
    pub key: Id,
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.constraint.requirements")]
    pub requirements: Option<Markdown>,
    /// error | warning
    /// 
    ...
    /// ## Conditions
    /// Used when: eld-26
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.constraint.suppress")]
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.constraint.human")]
    pub human: String,
    ...
    /// ## Conditions
    /// Used when: eld-21
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.constraint.expression")]
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.constraint.source")]
...
pub struct ElementDefinitionExample {
    ...
    /// ## Aliases
    /// extensions, user content
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.example.extension")]
    #[fhir_invariant(key="ext-1", severity="error", human="Must have either extensions or value[x], not both", expr="extension.exists() != value.exists()", path="ElementDefinition.example.extension")]
    pub extension: Option<Vec<Extension>>,
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.example.label")]
    pub label: String,
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.example.value[x]")]
    #[fhir_serde(flatten)]
...
pub struct ElementDefinitionMapping {
    ...
    /// ## Aliases
    /// extensions, user content
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.mapping.extension")]
    #[fhir_invariant(key="ext-1", severity="error", human="Must have either extensions or value[x], not both", expr="extension.exists() != value.exists()", path="ElementDefinition.mapping.extension")]
    pub extension: Option<Vec<Extension>>,
    ...
    /// ## Conditions
    /// Used when: eld-27
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.mapping.identity")]
    pub identity: Id,
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.mapping.map")]
    pub map: String,
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.mapping.comment")]
    pub comment: Option<Markdown>,
}
...
pub struct ElementDefinitionSlicing {
    ...
    /// ## Aliases
    /// extensions, user content
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.slicing.extension")]
    #[fhir_invariant(key="ext-1", severity="error", human="Must have either extensions or value[x], not both", expr="extension.exists() != value.exists()", path="ElementDefinition.slicing.extension")]
    pub extension: Option<Vec<Extension>>,
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.slicing.discriminator")]
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.slicing.description")]
    ...
    /// ## Conditions
    /// Used when: eld-25
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.slicing.ordered")]
...
pub struct ElementDefinitionSlicingDiscriminator {
    ...
    /// ## Aliases
    /// extensions, user content
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.slicing.discriminator.extension")]
    #[fhir_invariant(key="ext-1", severity="error", human="Must have either extensions or value[x], not both", expr="extension.exists() != value.exists()", path="ElementDefinition.slicing.discriminator.extension")]
    pub extension: Option<Vec<Extension>>,
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.slicing.discriminator.path")]
    pub path: String,
}
...
pub struct ElementDefinitionType {
    ...
    /// ## Aliases
    /// extensions, user content
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.type.extension")]
    #[fhir_invariant(key="ext-1", severity="error", human="Must have either extensions or value[x], not both", expr="extension.exists() != value.exists()", path="ElementDefinition.type.extension")]
    pub extension: Option<Vec<Extension>>,
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.type.profile")]
    ...
    /// ## Conditions
    /// Used when: eld-17
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.type.targetProfile")]
