...
#[fhir_invariant(key="cud-2", severity="error", human="ClinicalUseDefinition.contraindication can only be used when type is 'contraindication'", expr="ClinicalUseDefinition.contraindication.empty() or ClinicalUseDefinition.type='contraindication'", path="ClinicalUseDefinition")]
#[fhir_invariant(key="cud-3", severity="error", human="ClinicalUseDefinition.indication can only be used when type is 'indication'", expr="ClinicalUseDefinition.indication.empty() or ClinicalUseDefinition.type='indication'", path="ClinicalUseDefinition")]
#[fhir_invariant(key="cud-4", severity="error", human="ClinicalUseDefinition.undesirableEffect can only be used when type is 'undesirable-effect'", expr="ClinicalUseDefinition.undesirableEffect.empty() or ClinicalUseDefinition.type='undesirable-effect'", path="ClinicalUseDefinition")]
#[fhir_invariant(key="cud-5", severity="error", human="ClinicalUseDefinition.interaction can only be used when type is 'interaction'", expr="ClinicalUseDefinition.interaction.empty() or ClinicalUseDefinition.type='interaction'", path="ClinicalUseDefinition")]
#[fhir_invariant(key="cud-6", severity="error", human="ClinicalUseDefinition.warning can only be used when type is 'warning'", expr="ClinicalUseDefinition.warning.empty() or ClinicalUseDefinition.type='warning'", path="ClinicalUseDefinition")]
...
pub struct ClinicalUseDefinition {
    ...
    /// ## Conditions
    /// Used when: cud-1
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children or both", expr="hasValue() or (children().count() > id.count())", path="ClinicalUseDefinition.undesirableEffect")]
    ...
    /// ## Conditions
    /// Used when: cud-1
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children or both", expr="hasValue() or (children().count() > id.count())", path="ClinicalUseDefinition.indication")]
    ...
    /// ## Conditions
    /// Used when: cud-1
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children or both", expr="hasValue() or (children().count() > id.count())", path="ClinicalUseDefinition.contraindication")]
    ...
    /// ## Conditions
    /// Used when: cud-1
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children or both", expr="hasValue() or (children().count() > id.count())", path="ClinicalUseDefinition.interaction")]
    ...
    /// ## Conditions
    /// Used when: cud-1
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children or both", expr="hasValue() or (children().count() > id.count())", path="ClinicalUseDefinition.warning")]
...
pub struct ClinicalUseDefinitionContraindication {
    ...
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ClinicalUseDefinition.contraindication.management")]
...
pub struct ClinicalUseDefinitionIndication {
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children or both (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children or both", expr="hasValue() or (children().count() > id.count())", path="ClinicalUseDefinition.indication.otherTherapy")]
    #[fhir_serde(rename = "otherTherapy")]
    pub other_therapy: Option<Vec<ClinicalUseDefinitionIndicationOtherTherapy>>,
}
...
pub struct ClinicalUseDefinitionIndicationOtherTherapy {
    ...
    /// ## Aliases
    /// extensions, user content
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ClinicalUseDefinition.indication.otherTherapy.extension")]
    pub extension: Option<Vec<Extension>>,
    /// Extensions that cannot be ignored even if unrecognized
    /// 
    /// May be used to represent additional information that is not part of the basic
    ...
    /// ## Aliases
    /// extensions, user content, modifiers
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ClinicalUseDefinition.indication.otherTherapy.modifierExtension")]
    #[fhir_serde(rename = "modifierExtension")]
    pub modifier_extension: Option<Vec<Extension>>,
    ...
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ClinicalUseDefinition.indication.otherTherapy.relationshipType")]
    ...
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ClinicalUseDefinition.indication.otherTherapy.treatment")]
...
pub struct ClinicalUseDefinitionInteraction {
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children or both (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children or both", expr="hasValue() or (children().count() > id.count())", path="ClinicalUseDefinition.interaction.interactant")]
    ...
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ClinicalUseDefinition.interaction.severity")]
...
pub struct ClinicalUseDefinitionInteractionInteractant {
    ...
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ClinicalUseDefinition.interaction.interactant.route")]
...
pub struct ClinicalUseDefinitionUndesirableEffect {
    ...
    /// - **Description**: A type of management for an interaction, contraindication or undesirable effect of a medication or other substance.
    /// - **ValueSet**: http://hl7.org/fhir/ValueSet/interaction-management
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ClinicalUseDefinition.undesirableEffect.management")]
    pub management: Option<Vec<CodeableConcept>>,
}
