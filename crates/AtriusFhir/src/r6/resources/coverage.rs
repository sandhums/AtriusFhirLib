...
pub struct Coverage {
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="Coverage.statusReason")]
    ...
    #[fhir_invariant(key="cov-insured-1", severity="error", human="When patient is insured, insurer must exist.", expr="%resource.kind = 'insurance' implies (%resource.insurer.exists() and %resource.paymentBy.empty())", path="Coverage.kind")]
    #[fhir_invariant(key="cov-self-pay-1", severity="error", human="When patient is self-pay, paymentBy must exist.", expr="%resource.kind = 'self-pay' implies (%resource.insurer.empty() and %resource.paymentBy.exists())", path="Coverage.kind")]
    ...
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children or both", expr="hasValue() or (children().count() > id.count())", path="Coverage.paymentBy")]
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children or both (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children or both", expr="hasValue() or (children().count() > id.count())", path="Coverage.class")]
    ...
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children or both", expr="hasValue() or (children().count() > id.count())", path="Coverage.costToBeneficiary")]
...
pub struct CoverageCostToBeneficiary {
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children or both (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children or both", expr="hasValue() or (children().count() > id.count())", path="Coverage.costToBeneficiary.exception")]
