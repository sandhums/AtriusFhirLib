...
#[fhir_invariant(key="sdf-5", severity="error", human="If the structure defines an extension then the structure must have context information", expr="type != 'Extension' or baseDefinition != 'http://hl7.org/fhir/StructureDefinition/Extension' or derivation = 'specialization' or (context.exists())", path="StructureDefinition")]
...
#[fhir_invariant(key="sdf-9", severity="error", human="In any snapshot or differential, no requirements on an element without a \".\" in the path (e.g. the first element)", expr="children().element.where(path.contains('.').not()).requirements.empty()", path="StructureDefinition")]
...
#[fhir_invariant(key="sdf-30", severity="error", human="ContentReferences can only be defined in specializations, not constrained types", expr="differential.element.where(contentReference.empty().not()).exists() implies derivation = 'specialization'", path="StructureDefinition")]
pub struct StructureDefinition {
    ...
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children or both", expr="hasValue() or (children().count() > id.count())", path="StructureDefinition.mapping")]
    ...
    /// ## Conditions
    /// Used when: sdf-5
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children or both", expr="hasValue() or (children().count() > id.count())", path="StructureDefinition.context")]
    ...
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children or both", expr="hasValue() or (children().count() > id.count())", path="StructureDefinition.snapshot")]
    ...
    /// ## Conditions
    /// Used when: sdf-6
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children or both", expr="hasValue() or (children().count() > id.count())", path="StructureDefinition.differential")]
