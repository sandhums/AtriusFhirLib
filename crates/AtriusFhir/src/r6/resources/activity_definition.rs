...
pub struct ActivityDefinition {
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="adf-2", severity="warning", human="Dependencies of an ActivityDefinition should reference a resource", expr="type in ('depends-on' | 'part-of') implies ((resource.exists() xor resourceReference.exists()) or (artifact is canonical xor artifact is Reference))", path="ActivityDefinition.relatedArtifact")]
    #[fhir_invariant(key="adf-3", severity="warning", human="ActivityDefinition should not have components", expr="type != 'composed-of'", path="ActivityDefinition.relatedArtifact")]
    ...
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children or both", expr="hasValue() or (children().count() > id.count())", path="ActivityDefinition.participant")]
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children or both (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children or both", expr="hasValue() or (children().count() > id.count())", path="ActivityDefinition.dynamicValue")]
