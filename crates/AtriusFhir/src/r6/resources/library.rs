...
pub struct Library {
    ...
    #[fhir_invariant(key="lib-2", severity="warning", human="Dependencies and components of a Library should reference a resource", expr="type in ('depends-on' | 'composed-of' | 'part-of') implies ((resource.exists() xor resourceReference.exists()) or (artifact is canonical xor artifact is Reference))", path="Library.relatedArtifact")]
