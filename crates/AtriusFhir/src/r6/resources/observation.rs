...
#[fhir_invariant(key="obs-6", severity="error", human="Observation.dataAbsentReason SHALL only be present if Observation.value[x] is not present", expr="dataAbsentReason.empty() or value.empty()", path="Observation")]
#[fhir_invariant(key="obs-7", severity="error", human="If Observation.component.code is the same as Observation.code, then Observation.value SHALL NOT be present (the Observation.component.value[x] holds the value).", expr="value.empty() or component.code.where(coding.intersect(%resource.code.coding).exists()).empty()", path="Observation")]
#[fhir_invariant(key="obs-10", severity="error", human="Observation.component.dataAbsentReason SHALL only be present if Observation.component.value[x] is not present", expr="component.empty() or component.where(dataAbsentReason.exists()).all(value.empty())", path="Observation")]
#[fhir_invariant(key="obs-11", severity="error", human="if organizer exists and organizer = true, then value[x], dataAbsentReason and component SHALL NOT be present", expr="(organizer.exists() and organizer.allTrue()) implies (value.empty() and dataAbsentReason.empty() and component.empty())", path="Observation")]
#[fhir_invariant(key="obs-12", severity="warning", human="All observations SHOULD have a performer", expr="performer.exists()", path="Observation")]
pub struct Observation {
    ...
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children or both", expr="hasValue() or (children().count() > id.count())", path="Observation.triggeredBy")]
    ...
    /// ## Conditions
    /// Used when: obs-11
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="Observation.organizer")]
    ...
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="Observation.interpretationContext")]
    ...
    /// - **ValueSet**: http://hl7.org/fhir/ValueSet/body-site
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="Observation.bodyStructure")]
    ...
    #[fhir_invariant(key="obs-9", severity="error", human="If Observation.specimen is a reference to Group, the group can only have specimens", expr="(reference.resolve().exists() and reference.resolve() is Group) implies reference.resolve().member.entity.resolve().all($this is Specimen)", path="Observation.specimen")]
    ...
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children or both", expr="hasValue() or (children().count() > id.count())", path="Observation.referenceRange")]
    ...
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children or both", expr="hasValue() or (children().count() > id.count())", path="Observation.component")]
...
pub struct ObservationReferenceRange {
    ...
    #[fhir_invariant(key="obs-13", severity="error", human="If low.comparator exists, it must be '>=' or '>'.", expr="comparator.exists() implies (comparator = '>=' or comparator = '>')", path="Observation.referenceRange.low")]
    ...
    #[fhir_invariant(key="obs-14", severity="error", human="If high.comparator exists, it must be '<=' or '<'.", expr="comparator.exists() implies (comparator = '<=' or comparator = '<')", path="Observation.referenceRange.high")]
    ...
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="Observation.referenceRange.normalValue")]
...
pub struct ObservationTriggeredBy {
    ...
    /// ## Aliases
    /// extensions, user content
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="Observation.triggeredBy.extension")]
    pub extension: Option<Vec<Extension>>,
    /// Extensions that cannot be ignored even if unrecognized
    /// 
    /// May be used to represent additional information that is not part of the basic
    ...
    /// ## Aliases
    /// extensions, user content, modifiers
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="Observation.triggeredBy.modifierExtension")]
    #[fhir_serde(rename = "modifierExtension")]
    pub modifier_extension: Option<Vec<Extension>>,
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="Observation.triggeredBy.observation")]
    ...
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="Observation.triggeredBy.type")]
    #[fhir_serde(rename = "type")]
    pub r#type: Code,
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="Observation.triggeredBy.reason")]
