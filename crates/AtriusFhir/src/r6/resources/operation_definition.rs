...
pub struct OperationDefinition {
    ...
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="OperationDefinition.synchronicity")]
    ...
    /// ## Conditions
    /// Used when: opd-7
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children or both", expr="hasValue() or (children().count() > id.count())", path="OperationDefinition.parameter")]
    ...
    #[fhir_invariant(key="opd-8", severity="error", human="Min <= Max", expr="(max = '*') or iif(max != '*', min <= max.toInteger())", path="OperationDefinition.parameter")]
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children or both (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children or both", expr="hasValue() or (children().count() > id.count())", path="OperationDefinition.overload")]
...
pub struct OperationDefinitionParameter {
    ...
    #[fhir_invariant(key="opd-9", severity="error", human="Max SHALL be a number or \"*\"", expr="empty() or ($this = '*') or (toInteger() >= 0)", path="OperationDefinition.parameter.max")]
    pub max: String,
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children or both (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children or both", expr="hasValue() or (children().count() > id.count())", path="OperationDefinition.parameter.binding")]
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children or both (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children or both", expr="hasValue() or (children().count() > id.count())", path="OperationDefinition.parameter.referencedFrom")]
