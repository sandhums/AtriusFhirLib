...
pub struct ExampleScenario {
    ...
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children or both", expr="hasValue() or (children().count() > id.count())", path="ExampleScenario.actor")]
    ...
    #[fhir_invariant(key="exs-24", severity="error", human="actor SHALL have either a type or a definition but not both", expr="type.exists() xor definition.exists()", path="ExampleScenario.actor")]
    ...
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children or both", expr="hasValue() or (children().count() > id.count())", path="ExampleScenario.instance")]
    ...
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children or both", expr="hasValue() or (children().count() > id.count())", path="ExampleScenario.process")]
...
pub struct ExampleScenarioActor {
    ...
    /// ## Conditions
    /// Used when: exs-24
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ExampleScenario.actor.definition")]
...
pub struct ExampleScenarioInstance {
    ...
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children or both", expr="hasValue() or (children().count() > id.count())", path="ExampleScenario.instance.version")]
    ...
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children or both", expr="hasValue() or (children().count() > id.count())", path="ExampleScenario.instance.containedInstance")]
...
pub struct ExampleScenarioProcess {
    ...
    /// ## Conditions
    /// Used when: exs-5
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children or both", expr="hasValue() or (children().count() > id.count())", path="ExampleScenario.process.step")]
...
pub struct ExampleScenarioProcessStep {
    ...
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children or both", expr="hasValue() or (children().count() > id.count())", path="ExampleScenario.process.step.operation")]
    ...
    /// ## Conditions
    /// Used when: exs-13
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children or both", expr="hasValue() or (children().count() > id.count())", path="ExampleScenario.process.step.alternative")]
