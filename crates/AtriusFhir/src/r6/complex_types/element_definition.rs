...
#[fhir_invariant(key="eld-33", severity="warning", human="If there's more than one bindable type, it's usually an error for there to be a binding", expr="type.where(code in 'code' | 'Coding' | 'CodeableConcept' | 'CodeableReference' | 'uri' | 'string' | 'Quantity').count() > 1 implies binding.empty()", path="ElementDefinition")]
...
pub struct ElementDefinition {
    ...
    /// ## Conditions
    /// Used when: eld-25
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children or both", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.slicing")]
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children or both (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children or both", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.base")]
    ...
    #[fhir_invariant(key="eld-29", severity="warning", human="profiles SHOULD be unique", expr="profile.isDistinct()", path="ElementDefinition.type")]
    #[fhir_invariant(key="eld-30", severity="warning", human="targetProfiles SHOULD be unique", expr="targetProfile.isDistinct()", path="ElementDefinition.type")]
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children or both", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.type")]
    ...
    /// ## Conditions
    /// Used when: eld-5
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children or both", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.example")]
    ...
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children or both", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.constraint")]
    ...
    #[fhir_invariant(key="eld-32", severity="error", human="If the strength is 'descriptive' no value set can ve provided", expr="strength = 'descriptive' implies valueSet.empty()", path="ElementDefinition.binding")]
    #[fhir_invariant(key="eld-34", severity="warning", human="if there's a required binding with no usage, it should be the base binding", expr="strength != 'required' implies additional.where(purpose = 'required' and usage.empty()).empty()", path="ElementDefinition.binding")]
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children or both", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.binding")]
    ...
    /// ## Conditions
    /// Used when: eld-27
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children or both", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.mapping")]
...
pub struct ElementDefinitionBinding {
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children or both (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="eld-31", severity="warning", human="additionalBindings should have a key", expr="key.exists()", path="ElementDefinition.binding.additional")]
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children or both", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.binding.additional")]
...
pub struct ElementDefinitionBindingAdditional {
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.binding.additional.key")]
    pub key: Option<Id>,
...
pub struct ElementDefinitionSlicing {
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children or both (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_invariant(key="ele-1", severity="error", human="All FHIR elements must have a @value or children or both", expr="hasValue() or (children().count() > id.count())", path="ElementDefinition.slicing.discriminator")]
